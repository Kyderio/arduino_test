...
typedef struct ipsec_function {
	...
	void (*rtl_crypto_auth_sim)(const uint32_t authtype, const unsigned char *Key, const unsigned char *Text,
								unsigned char *pDigest);
	int (*rtl_crypto_esp_sim)(const unsigned char *Key, const unsigned char *Text, unsigned char *pResult,
							  unsigned char *pTag);
	int (*aead_chacha20_poly1305_enc)(unsigned char *out, const unsigned char *Text,  const unsigned char *non,
									  const unsigned char key[32]);
	int (*aead_chacha20_poly1305_dec)(unsigned char *out, const unsigned char *Text,  const unsigned char *non,
									  const unsigned char key[32]);
} ipsec_func_ns;
