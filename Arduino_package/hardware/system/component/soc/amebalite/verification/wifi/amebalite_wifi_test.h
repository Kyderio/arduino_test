...
#define RTL8720E_BB_REG_BASE	(WIFI_REG_BASE + 0x10000)
...
void WifiBasicTrxTest(PTXDESC ptxdesc);
void WifiTestSetTxdesc(PTXDESC ptxdesc, struct xmit_frame *pxmitframe);
void WifiIntTest(u32 isr0, u32 isr1, u32 isr2, u32 isr3);
#ifdef CONFIG_CSI
void WifiShowCsiPkt(struct rx_csi_data *csi_pkt);
#endif
void WifiTestSetMacAddr(PADAPTER padapter);
