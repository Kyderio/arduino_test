...
#define SEC_BIT_BOOT_CNT_LMT_EN       ((u32)0x00000001 << 30)           /*!<R/W 0  Enable boot cnt limit. 0'b0: disable 0'b1: enable */
...
//   * @{
//   */
// #define SEC_MASK_OTA_ADDR             ((u32)0x0000FFFF << 0)            /*!< PROT/R 16'hffff  */
// #define SEC_OTA_ADDR(x)               (((u32)((x) & 0x0000FFFF) << 0))
// #define SEC_GET_OTA_ADDR(x)           ((u32)(((x >> 0) & 0x0000FFFF)))
// #define SEC_MASK_BOOTLOADER_VERSION   ((u32)0x0000FFFF << 16)           /*!< PROT/R 16'hffff  */
