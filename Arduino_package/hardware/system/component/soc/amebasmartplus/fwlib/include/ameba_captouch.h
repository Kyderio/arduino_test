...
#define CT_BIT_AFIFO_FULL         ((u32)0x00000001 << 0)           /*!< R 0x0  0: Raw code FIFO not full 1: Raw code FIFO full*/
/** @} */
...
typedef struct {
	...
	__IO uint32_t RSVD4[156]             ;  /*!< Reserved,  Address offset:0x190-0x3FF */
