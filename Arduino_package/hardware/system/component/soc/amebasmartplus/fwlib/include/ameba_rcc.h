...
/** @defgroup UART_Clock_Source_define
  * @{
  */

#define UART01_RX_CLK_XTAL_40M	((u32)0x00000000) // XTAL40M, for UART0-1
#define UART01_RX_CLK_OSC_2M		((u32)0x00000001) // OSC2M, for UART0-1
#define UART01_RX_CLK_XTAL_2M		((u32)0x00000002) // XTAL2M, for UART0-1

#define UART23_TRX_CLK_XTAL_40M	  ((u32)0x00000003) // XTAL40M, for UART2-3
#define UART23_TRX_CLK_PLL_160M   ((u32)0x00000004) // PLL160M, for UART2-3
/**
  * @}
  */
