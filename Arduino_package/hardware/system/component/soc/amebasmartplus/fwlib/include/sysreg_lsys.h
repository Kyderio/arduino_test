...
/** @defgroup REG_LSYS_PWC
  ...
  * @{
  */
#define LSYS_BIT_PWC_SHRM         ((u16)0x00000001 << 15)           /*!< R/W 0x0  This is BT  share memory power switch , and is controlled by BT IP . 1: Enable BT share memory power switch 0: Disable*/
#define LSYS_PWC_SHRM(x)          ((u16)(((x) & 0x00000001) << 15))
#define LSYS_GET_PWC_SHRM(x)      ((u16)(((x >> 15) & 0x00000001)))
...
/** @defgroup REG_LSYS_POR
  ...
  * @{
  */
#define LSYS_BIT_POR_SHRM         ((u16)0x00000001 << 15)           /*!< R/W 0x0  0: reset PD_SHRM power domain 1: release por*/
#define LSYS_POR_SHRM(x)          ((u16)(((x) & 0x00000001) << 15))
#define LSYS_GET_POR_SHRM(x)      ((u16)(((x >> 15) & 0x00000001)))
...
/** @defgroup REG_LSYS_ISO
  ...
  * @{
  */
#define LSYS_BIT_ISO_SHRM         ((u32)0x00000001 << 15)           /*!< R/W 0x1  1: isolate signals from PD_SHRM to other power domain 0: release iso*/
#define LSYS_ISO_SHRM(x)          ((u32)(((x) & 0x00000001) << 15))
#define LSYS_GET_ISO_SHRM(x)      ((u32)(((x >> 15) & 0x00000001)))
...
#define LSYS_MASK_CKSL_UART                        ((u32)0x0000000F << 16)          /*!<R/W 0  Select uart rx/tx clock for every uart . 0x24[16] is cksl_uart[0]: 0: uart0_rxclk is xtal 40M 1: uart0_rxclk is 2M (osc2M or xtal divided 2M) note: uart0_txclk only use 40M 0x24[17] is cksl_uart[1]: 0: uart1_rxclk is xtal 40M 1: uart1_rxclk is 2M (osc2M or xtal divided 2M) note: uart1_txclk only use 40M 0x24[18] is cksl_uart[2]: 0: uart2_rxclk/txclk is xtal 40M 1: uart2_rxclk/txclk is pll_160m 0x24[19] is cksl_uart[3]: 0: uart3_rxclk/txclk is xtal 40M 1: uart3_rxclk/txclk is pll_160m */
#define LSYS_CKSL_UART(x)                          (((u32)((x) & 0x0000000F) << 16))
#define LSYS_GET_CKSL_UART(x)                      ((u32)(((x >> 16) & 0x0000000F)))
 ...
 * @{
 **/
#define LSYS_BIT_CKSL_UART2M                       ((u32)0x00000001 << 30)          /*!<R/W 0  Uart 2M seleck 0: osc4M divider 2 1: xtal 40M divider out */
#define LSYS_CKSL_UART2M(x)                        ((u32)(((x) & 0x00000001) << 30))
#define LSYS_GET_CKSL_UART2M(x)                    ((u32)(((x >> 30) & 0x00000001)))
...
#define LSYS_BIT_BT_ZIGBEE_EN                       ((u32)0x00000001 << 28)           /*!< R/W 0x0  1: enable ZB(inner BT) function*/
#define LSYS_BT_ZIGBEE_EN(x)                        ((u32)(((x) & 0x00000001) << 28))
#define LSYS_GET_BT_ZIGBEE_EN(x)                    ((u32)(((x >> 28) & 0x00000001)))
#define LSYS_BIT_ZB_USE_EXT_UART                    ((u32)0x00000001 << 27)           /*!< R/W 0x0  1: ZB(inner BT) use external uart(ext_zb pinmux) 0: ZB(inner BT) use internal uart(hs uart2)*/
#define LSYS_ZB_USE_EXT_UART(x)                     ((u32)(((x) & 0x00000001) << 27))
#define LSYS_GET_ZB_USE_EXT_UART(x)                 ((u32)(((x >> 27) & 0x00000001)))
