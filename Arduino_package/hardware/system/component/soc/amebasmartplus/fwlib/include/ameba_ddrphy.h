...
#define DDRPHY_BIT_INT_FIFO_PTR__EN     ((u32)0x00000001 << 24)           /*!< R/W ‘h0  fifo_prt_int enable*/
#define DDRPHY_INT_FIFO_PTR__EN(x)      ((u32)(((x) & 0x00000001) << 24))
...
/** @brief DDRPHY Register Declaration
  */
...
typedef struct {
	...
	__IO uint32_t RSVD0                             ;  /*!< Reserved,  Address offset:0x05C-0x05F */
	__IO uint32_t DDRPHY_CRT_CTL_2                  ;  /*!< Register,  Address offset:0x060 */
	__IO uint32_t RSVD1[5]                          ;  /*!< Reserved,  Address offset:0x064-0x077 */
	...
	__IO uint32_t RSVD3                             ;  /*!< Reserved,  Address offset:0x090-0x093 */
	...
	__IO uint32_t RSVD4[20]                         ;  /*!< Reserved,  Address offset:0x0B0-0x0FF */
	...
	__IO uint32_t RSVD5[2]                          ;  /*!< Reserved,  Address offset:0x134-0x13B */
	...
	__IO uint32_t RSVD6[48]                         ;  /*!< Reserved,  Address offset:0x348-0x407 */
	...
	__IO uint32_t RSVD7[52]                         ;  /*!< Reserved,  Address offset:0x528-0x5F7 */
