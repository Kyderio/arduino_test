...
#define BKUP_MASK_BOOT_CNT					((u32)0x000000FF << 24)   /*!<R/W 0  [7:0] bootcnt value */
#define BKUP_BOOT_CNT(x)						((u32)(((x) & 0x000000FF) << 24))
#define BKUP_GET_BOOT_CNT(x)					((u32)(((x >> 24) & 0x000000FF)))

#define BKUP_BIT_UARTBURN_DEBUG				BIT(15)	/*!<  this is SW set bit before reboot, for uart download debug */

#define BKUP_MASK_UARTBURN_BOOT				((u32)0x0000007F << 8)  /*!<R/W 0  [14:8] bootcnt value */
