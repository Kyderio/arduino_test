...
#define DDRC_BIT_PAGEMATCH_ENABLE      ((u32)0x00000001 << 16)           /*!< R/W 0x1  Choose page match transaction continuously*/
...
/** @defgroup DDRC_ELR_ADR0
  ...
  * @{
  */
#define DDRC_MASK_LOWER_PART_OF_ADDRESS   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Address[31:0] of the error request.*/
#define DDRC_LOWER_PART_OF_ADDRESS(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define DDRC_GET_LOWER_PART_OF_ADDRESS(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup DDRC_ELR_ADR1
  ...
  * @{
  */
#define DDRC_MASK_HIGHER_PART_OF_ADDRESS   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  Address[63:32] of the error request.*/
#define DDRC_HIGHER_PART_OF_ADDRESS(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define DDRC_GET_HIGHER_PART_OF_ADDRESS(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup DDRC_ELR_CODE
  ...
  * @{
  */
#define DDRC_MASK_ERROR_CORE   ((u32)0x000000FF << 0)           /*!< R 0x0  The error code of error request. 8'b0: Secure fault*/
#define DDRC_ERROR_CORE(x)     (((u32)((x) & 0x000000FF) << 0))
#define DDRC_GET_ERROR_CORE(x) ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
...
/** @defgroup DDRC_CFG_Px_RDQUEUE
  ...
  * @{
  */
#define DDRC_BIT_PAGEMATCH_LOCK     ((u32)0x00000001 << 3)           /*!< R/W 0x1  Lock page match port for dual port*/
...
/** @defgroup DDRC_CFG_Px_PORTCTRL
  ...
  * @{
  */
#define DDRC_BIT_BLOCK_COMMAND_REQUEST ((u32)0x00000001 << 0) /*!< R/W 0x1  Blocks new transactions from entering the front-end. 1: block AR and AW channels. 0: turn on AR and AW channels*/
/** @} */
...
/** @defgroup DDRC_CFG_Px_PORTSTATS
  ...
  * @{
  */
#define DDRC_BIT_BLOCK_COMMAND_STATUS ((u32)0x00000001 << 0) /*!< RO 0x0  AR and AW channel blocking status. 1: both AR and AW are blocked. 0: any of them is not blocked.*/
/** @} */
...
typedef struct {
	...
	__I  uint32_t DDRC_CFG_Px_PORTSTATS;  /*!< PORTx STATUS Register */
	__IO uint8_t RSVD0[29]            ;  /*!< Reserved */
} Port_Ctrl_TypeDef;
...
typedef struct {
	...
	__IO uint32_t RSVD1[30]                ;  /*!< Reserved,  Address offset:0x108-0x17F */
	...
	__IO uint32_t RSVD2[30]                ;  /*!< Reserved,  Address offset:0x188-0x1FF */
	__I  uint32_t DDRC_ELR_PLD0            ;  /*!< ERROR TRANSACTION INFORMATION 0 Register,  Address offset:0x200 */
	__I  uint32_t DDRC_ELR_PLD1            ;  /*!< ERROR TRANSACTION INFORMATION 1 Register,  Address offset:0x204 */
	...
	__I  uint32_t DDRC_ELR_CODE            ;  /*!< ERROR TYPE Register,  Address offset:0x214 */
	__IO uint32_t RSVD3[9]                 ;  /*!< Reserved,  Address offset:0x218-0x23B */
	__O  uint32_t DDRC_ELR_CTRL            ;  /*!< ERROR INTERRUPT CLEAR Register,  Address offset:0x23C */
	__IO uint32_t RSVD4[368]               ;  /*!< Reserved,  Address offset:0x240-0x7FF */
	Port_Ctrl_TypeDef Port[7]              ;  /*!< DDRC IP have 7 ports,  Address offset:0x800-0x9BC */
} DDRCF_TypeDef;
