...
typedef struct {
	...
	__IO uint32_t RSVD0[18]                       ;  /*!< Reserved,  Address offset:0x038-0x07F */
	LCDC_Layer_TypeDef LCDC_LAYER[3]              ;  /*!< LCDC IP have 3 ports,  Address offset:0x080-0x0DC */
} LCDC_TypeDef;
