...
_LONG_CALL_ u32 FLASH_Calibration(FLASH_InitTypeDef *FLASH_InitStruct, u8 SpicBitMode, u8 LineDelay, u32 pattern_addr);

_LONG_CALL_ u32 FLASH_PLLInit_ClockDiv(u8 Div);
_LONG_CALL_ u32 FLASH_CalibrationNew(FLASH_InitTypeDef *FLASH_InitStruct, u8 SpicBitMode, u8 Div, u8 CalStep, u8 LineDelay, u8 StartIdx, u32 pattern_addr);
...
_LONG_CALL_ void FLASH_ClockSwitch_Rom(u32 Source);
