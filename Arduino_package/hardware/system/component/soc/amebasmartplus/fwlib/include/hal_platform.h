...
#define MSP_RAM_LP			0x23002000						/* rom used, can not change, RISC-V kept 16-byte aligned */
#define MSPLIM_RAM_HP		0x30001000						/* rom used, can not change */
#define MSP_RAM_HP			0x30003000						/* rom used, can not change */
#define MSP_RAM_HP_NS		0x2001C000

#define BOOT_LOADER_START			0x30003000            /* rom used, can not change */
#define BOOT_LOADER_LIMIT			0x30040000						/* rom used, can not change */

#define FULLMAC_ADDR_START		0x30003000						/* rom used, can not change */
#define FULLMAC_ADDR_END			0x30040000						/* rom used, can not change */

#define CA32_FIP_MAX_SIZE				(0x00200000)  /* 2MB */

/*BT share mem with system*/
#define SHARE_MEM_BT_ADDRESS			HP_SRAM_EXT_BASE /*Size: 880KB*/
#define SHARE_MEM_BT_SIZE				(880*1024)
/*WiFi share mem with system */
#define SHARE_MEM_WL_ADDRESS			(HP_SRAM_EXT_BASE + 0x100000) /*Size: 40KB*/
#define SHARE_MEM_WL_SIZE				(40*1024)
