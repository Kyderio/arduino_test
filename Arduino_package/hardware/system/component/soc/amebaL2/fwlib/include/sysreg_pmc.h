...
#define WAKE_SRC_BT_SCB                              ((u32)0x00000001 << 1)
#define WAKE_SRC_BT_WAKE_HOST                        ((u32)0x00000001 << 2)
#define WAKE_SRC_IPC_KM4NS                           ((u32)0x00000001 << 3)
#define WAKE_SRC_IPC_KM4TZ                           ((u32)0x00000001 << 4)
#define WAKE_SRC_IWDG                                ((u32)0x00000001 << 5)
#define WAKE_SRC_Timer2                              ((u32)0x00000001 << 6)
#define WAKE_SRC_Timer3                              ((u32)0x00000001 << 7)
#define WAKE_SRC_Timer4                              ((u32)0x00000001 << 8)
#define WAKE_SRC_Timer5                              ((u32)0x00000001 << 9)
#define WAKE_SRC_AP_WAKE_IRQ                         ((u32)0x00000001 << 10)
#define WAKE_SRC_pmc_timer0                          ((u32)0x00000001 << 11)
#define WAKE_SRC_pmc_timer1                          ((u32)0x00000001 << 12)
#define WAKE_SRC_UART0                               ((u32)0x00000001 << 13)
#define WAKE_SRC_UART1                               ((u32)0x00000001 << 14)
#define WAKE_SRC_UART2                               ((u32)0x00000001 << 15)
#define WAKE_SRC_UART3                               ((u32)0x00000001 << 16)
#define WAKE_SRC_UART_LOG                            ((u32)0x00000001 << 17)
#define WAKE_SRC_GPIOA                               ((u32)0x00000001 << 18)
#define WAKE_SRC_GPIOB                               ((u32)0x00000001 << 19)
#define WAKE_SRC_GPIOC                               ((u32)0x00000001 << 20)
#define WAKE_SRC_CAN0                                ((u32)0x00000001 << 24)
#define WAKE_SRC_CAN1                                ((u32)0x00000001 << 25)
#define WAKE_SRC_RTC                                 ((u32)0x00000001 << 26)
#define WAKE_SRC_ADC                                 ((u32)0x00000001 << 27)
#define WAKE_SRC_CAPTOUCH                            ((u32)0x00000001 << 28)
#define WAKE_SRC_BOR                                 ((u32)0x00000001 << 29)
/** @} */
...
* @{
*****************************************************************************/
#define WAKE_SRC_PWR_DOWN                            ((u32)(3 << 30) | (0x00000001 << 0))
#define WAKE_SRC_RMII                                ((u32)(3 << 30) | (0x00000001 << 1))
#define WAKE_SRC_AON_TIM                             ((u32)(3 << 30) | (0x00000001 << 2))
#define WAKE_SRC_AON_WAKEPIN                         ((u32)(3 << 30) | (0x00000001 << 3))
#define WAKE_SRC_SDIO_WIFI                           ((u32)(3 << 30) | (0x00000001 << 4))
#define WAKE_SRC_SDIO_BT                             ((u32)(3 << 30) | (0x00000001 << 5))
#define WAKE_SRC_USB                                 ((u32)(3 << 30) | (0x00000001 << 6))
/** @} */
