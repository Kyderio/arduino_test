...
#define LDO_BIT_REG_FEEDBACK_SELECT  ((u32)0x00000001 << 16)           /*!< R/W 0x0  0: feedback from AVDD_0P9H_LDO_OUTPUT_PAD 1: feedback from AVDD_0P9H_LDO_VOFB*/
...
#define LDO_MASK_REG_STANDBY_L       ((u32)0x00000003 << 7)            /*!< R/W 2'b11  // [REGU][LDO] REG_CTRL // [1] Iq controll // 0: Normal Iq (default) // 1: Standby Iq // [0] pwrmos controll // 0: Normal pwrmos (default) // 1: Standby pwrmos*/
...
#define LDO_MASK_OPT_POR_DIS       ((u32)0x0000000F << 4)            /*!< R/W 4'h0  option to disable POR for power saving when enter DSLP [0]: AON_POR , 1:disable when DSLP , 0:enable [1]: CORE_POR [2]: V33_POR_BG [3]: V33_POR_VTH*/
