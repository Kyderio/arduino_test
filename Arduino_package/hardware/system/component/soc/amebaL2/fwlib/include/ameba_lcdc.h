...
/** @defgroup LCDC_IMG_CFG
  ...
  * @{
  */
#define LCDC_BIT_IMG_FORMAT_YUV ((u32)0x00000001 << 8)           /*!< R/W 0x0  enable yuv422torgb888*/
 ...
 * @{
 */
#define IS_LCDC_INTR_STATUS(TYPE)				((TYPE == LCDC_BIT_FRM_START_INTS) || \
												(TYPE == LCDC_BIT_IO_TIMEOUT_INTS) || \
												(TYPE == LCDC_BIT_LCD_LIN_INTS) || \
												(TYPE == LCDC_BIT_LCD_FRD_INTS) || \
												(TYPE == LCDC_BIT_PANEL_TE_INTS) || \
												(TYPE == LCDC_BIT_DMA_UN_INTS))
 ...
 * @{
 */
#define LCDC_INPUT_FORMAT_YUV					(BIT8)
...
#define IS_LCDC_INPUT_FORMAT(MODE)				((MODE == LCDC_INPUT_FORMAT_YUV) || (((MODE) <= LCDC_INPUT_FORMAT_BGR565) && ((MODE) != 0x7)))
