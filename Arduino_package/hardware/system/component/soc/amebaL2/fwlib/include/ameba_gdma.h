...
#define GDMA_HANDSHAKE_INTERFACE_I2C0_TX		  (18)
#define GDMA_HANDSHAKE_INTERFACE_I2C0_RX		  (19)
#define GDMA_HANDSHAKE_INTERFACE_I2C1_TX		  (20)
#define GDMA_HANDSHAKE_INTERFACE_I2C1_RX		  (21)

#define GDMA_HANDSHAKE_INTERFACE_I3C_TX		    (22)
#define GDMA_HANDSHAKE_INTERFACE_I3C_RX		    (23)

#define GDMA_HANDSHAKE_INTERFACE_CAN0_RX      (24)
#define GDMA_HANDSHAKE_INTERFACE_CAN1_RX      (25)

#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_RX	(26)
#define GDMA_HANDSHAKE_INTERFACE_UART_LOG_TX	(27)

#define GDMA_HANDSHAKE_INTERFACE_QSPI_TX		  (28)

#define GDMA_HANDSHAKE_INTERFACE_PWM3_TX			(29)

#define GDMA_HANDSHAKE_INTERFACE_CAPTOUCH_RX	(30)
/**
  * @}
  */
