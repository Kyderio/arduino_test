...
/**
 * @brief  QSPI Channel Mode and Addr length Structure Definition
 */
typedef enum {
	QSPI_CH144_ADDR4BYTE = 0,
	QSPI_CH114_ADDR3BYTE,
} QSPI_CHMOD_ADDRLEN_T;
/**
 * @}
 */
...
void QSPI_DC_Ctrl(u8 cmd_data_status);
