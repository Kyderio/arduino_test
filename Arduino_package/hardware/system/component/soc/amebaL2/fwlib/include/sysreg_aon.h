...
#define AON_BIT_G7_PAD_RSTB     ((u32)0x00000001 << 23)          /*!< R/W 0x1  1: Enable G7  group pad 0: Reset PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G6_PAD_RSTB     ((u32)0x00000001 << 22)          /*!< R/W 0x1  1: Enable G6  group pad 0: Reset PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G5_PAD_RSTB     ((u32)0x00000001 << 21)          /*!< R/W 0x1  1: Enable G5  group pad 0: Reset PAD DD_SEC: bpc_pmc*/
...
#define AON_BIT_G7_PAD_SHDN     ((u32)0x00000001 << 15)          /*!< R/W 0x1  1: Enable G7 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G6_PAD_SHDN     ((u32)0x00000001 << 14)          /*!< R/W 0x1  1: Enable G6 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G5_PAD_SHDN     ((u32)0x00000001 << 13)          /*!< R/W 0x1  1: Enable G5 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
...
/** @defgroup REG_AON_ISO
  ...
  * @{
  */
#define AON_BIT_G9_PAD_RSTB      ((u32)0x00000001 << 27) /*!< R/W 0x1  1: Enable G9  group pad 0: Reset PAD Note: This is AON pad group, direct connect to G5 pad,  aon pmc will auto release this bit in power on init seq DD_SEC: bpc_pmc*/
#define AON_BIT_G8_PAD_RSTB      ((u32)0x00000001 << 26) /*!< R/W 0x0  1: Enable G8  group pad 0: Reset PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G9_PAD_SHDN      ((u32)0x00000001 << 25) /*!< R/W 0x1  1: Enable G9 group pad 0: Shutdown PAD Note: This is AON pad group, direct connect to G5 pad,  aon pmc will auto release this bit in power on init seq DD_SEC: bpc_pmc*/
#define AON_BIT_G8_PAD_SHDN      ((u32)0x00000001 << 24) /*!< R/W 0x0  1: Enable G8 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G9_PAD_SHDN_CORE ((u32)0x00000001 << 17) /*!< R/W 0x1  1: Enable G9 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G8_PAD_SHDN_CORE ((u32)0x00000001 << 16) /*!< R/W 0x1  1: Enable G8 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G7_PAD_SHDN_CORE ((u32)0x00000001 << 15) /*!< R/W 0x1  1: Enable G7 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G6_PAD_SHDN_CORE ((u32)0x00000001 << 14) /*!< R/W 0x1  1: Enable G6 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G5_PAD_SHDN_CORE ((u32)0x00000001 << 13) /*!< R/W 0x1  1: Enable G5 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
...
#define AON_BIT_G0_PAD_SHDN_CORE ((u32)0x00000001 << 8)  /*!< R/W 0x1  1: Enable G0 group pad 0: Shutdown PAD Note:default is shutdown, wait pmc enable MLDO power DD_SEC: bpc_pmc*/
...
/** @defgroup REG_AON_GPIO_CTRL
  ...
  * @{
  */
#define AON_MASK_GPIO_WAK_SEL       ((u32)0x00000007 << 28)           /*!< R/W 0h  Wake pin0 selection 0: PC10 (default) 1: PC11 2: PC12 3: PC13 4: PC14*/
