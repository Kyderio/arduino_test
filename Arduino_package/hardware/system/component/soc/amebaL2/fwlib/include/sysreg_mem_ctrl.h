...
/** @defgroup REG_CTRL_MBIST_GRP_EN_CTRL0
  ...
  * @{
  */
#define CTRL_MASK_GRP_EN_KM4NS_CACHE_E0   ((u32)0x0000000F << 28)           /*!< R/W 0xf  */
#define CTRL_GRP_EN_KM4NS_CACHE_E0(x)     (((u32)((x) & 0x0000000F) << 28))
#define CTRL_GET_GRP_EN_KM4NS_CACHE_E0(x) ((u32)(((x >> 28) & 0x0000000F)))
#define CTRL_MASK_GRP_EN_KM4TZ_ITCM_E0    ((u32)0x00000007 << 25)           /*!< R/W 0x7  */
#define CTRL_GRP_EN_KM4TZ_ITCM_E0(x)      (((u32)((x) & 0x00000007) << 25))
#define CTRL_GET_GRP_EN_KM4TZ_ITCM_E0(x)  ((u32)(((x >> 25) & 0x00000007)))
#define CTRL_MASK_GRP_EN_KM4TZ_CACHE_E0   ((u32)0x0000000F << 21)           /*!< R/W 0xf  */
#define CTRL_GRP_EN_KM4TZ_CACHE_E0(x)     (((u32)((x) & 0x0000000F) << 21))
#define CTRL_GET_GRP_EN_KM4TZ_CACHE_E0(x) ((u32)(((x >> 21) & 0x0000000F)))
#define CTRL_MASK_GRP_EN_BT_E0            ((u32)0x00000007 << 18)           /*!< R/W 0x7  */
#define CTRL_GRP_EN_BT_E0(x)              (((u32)((x) & 0x00000007) << 18))
#define CTRL_GET_GRP_EN_BT_E0(x)          ((u32)(((x >> 18) & 0x00000007)))
...
/** @defgroup REG_CTRL_MBIST_GRP_EN_CTRL1
  ...
  * @{
  */
#define CTRL_MASK_GRP_EN_PPE_E1     ((u32)0x000000FF << 19)           /*!< R/W 0xff  */
#define CTRL_GRP_EN_PPE_E1(x)       (((u32)((x) & 0x000000FF) << 19))
#define CTRL_GET_GRP_EN_PPE_E1(x)   ((u32)(((x >> 19) & 0x000000FF)))
#define CTRL_MASK_GRP_EN_PPE_E0     ((u32)0x000000FF << 11)           /*!< R/W 0xff  */
#define CTRL_GRP_EN_PPE_E0(x)       (((u32)((x) & 0x000000FF) << 11))
#define CTRL_GET_GRP_EN_PPE_E0(x)   ((u32)(((x >> 11) & 0x000000FF)))
#define CTRL_MASK_GRP_EN_CAN_E0     ((u32)0x00000003 << 9)            /*!< R/W 0x3  */
#define CTRL_GRP_EN_CAN_E0(x)       (((u32)((x) & 0x00000003) << 9))
#define CTRL_GET_GRP_EN_CAN_E0(x)   ((u32)(((x >> 9) & 0x00000003)))
#define CTRL_MASK_GRP_EN_MJPEG_E2   ((u32)0x000001FF << 0)            /*!< R/W 0x1ff  */
#define CTRL_GRP_EN_MJPEG_E2(x)     (((u32)((x) & 0x000001FF) << 0))
#define CTRL_GET_GRP_EN_MJPEG_E2(x) ((u32)(((x >> 0) & 0x000001FF)))
/** @} */
...
/** @defgroup REG_CTRL_MBIST_DONE_STA0
  ...
  * @{
  */
#define CTRL_MASK_MBIST_DONE_26_0   ((u32)0x07FFFFFF << 0)           /*!< R 27'b0  */
#define CTRL_MBIST_DONE_26_0(x)     (((u32)((x) & 0x07FFFFFF) << 0))
#define CTRL_GET_MBIST_DONE_26_0(x) ((u32)(((x >> 0) & 0x07FFFFFF)))
/** @} */
...
/** @defgroup REG_CTRL_MBIST_START_PULSE0
  ...
  * @{
  */
#define CTRL_MASK_MBIST_START_PAUSE_26_0   ((u32)0x07FFFFFF << 0)           /*!< R 27'b0  */
#define CTRL_MBIST_START_PAUSE_26_0(x)     (((u32)((x) & 0x07FFFFFF) << 0))
#define CTRL_GET_MBIST_START_PAUSE_26_0(x) ((u32)(((x >> 0) & 0x07FFFFFF)))
/** @} */
...
/** @defgroup REG_CTRL_MBIST_NORM_FAIL2
  ...
  * @{
  */
#define CTRL_MASK_MBIST_NORM_FAIL_78_64   ((u32)0x00007FFF << 0)           /*!< R 15'b0  */
#define CTRL_MBIST_NORM_FAIL_78_64(x)     (((u32)((x) & 0x00007FFF) << 0))
#define CTRL_GET_MBIST_NORM_FAIL_78_64(x) ((u32)(((x >> 0) & 0x00007FFF)))
/** @} */
...
/** @defgroup REG_CTRL_MBIST_DRF_FAIL2
  ...
  * @{
  */
#define CTRL_MASK_MBIST_DRF_FAIL_78_64   ((u32)0x00007FFF << 0)           /*!< R 15'b0  */
#define CTRL_MBIST_DRF_FAIL_78_64(x)     (((u32)((x) & 0x00007FFF) << 0))
#define CTRL_GET_MBIST_DRF_FAIL_78_64(x) ((u32)(((x >> 0) & 0x00007FFF)))
/** @} */
...
/** @defgroup REG_CTRL_GRP_PWR_MSK0
  ...
  * @{
  */
#define CTRL_MASK_GRP_PMSK_BT_E0       ((u32)0x00000007 << 26)           /*!< R/W 0x7  */
#define CTRL_GRP_PMSK_BT_E0(x)         (((u32)((x) & 0x00000007) << 26))
#define CTRL_GET_GRP_PMSK_BT_E0(x)     ((u32)(((x >> 26) & 0x00000007)))
#define CTRL_BIT_GRP_PMSK_WPON_E1      ((u32)0x00000001 << 25)           /*!< R/W 0x1  */
#define CTRL_BIT_GRP_PMSK_WPON_E0      ((u32)0x00000001 << 24)           /*!< R/W 0x1  */
...
#define CTRL_BIT_GRP_PMSK_WPOFF_E1     ((u32)0x00000001 << 21)           /*!< R/W 0x1  */
#define CTRL_MASK_GRP_PMSK_WPOFF_E0    ((u32)0x0000003F << 15)           /*!< R/W 0x3f  */
#define CTRL_GRP_PMSK_WPOFF_E0(x)      (((u32)((x) & 0x0000003F) << 15))
#define CTRL_GET_GRP_PMSK_WPOFF_E0(x)  ((u32)(((x >> 15) & 0x0000003F)))
#define CTRL_BIT_GRP_PMSK_USB_E0       ((u32)0x00000001 << 14)           /*!< R/W 0x1  */
#define CTRL_MASK_GRP_PMSK_SDIO_E0     ((u32)0x00000003 << 12)           /*!< R/W 0x3  */
#define CTRL_GRP_PMSK_SDIO_E0(x)       (((u32)((x) & 0x00000003) << 12))
#define CTRL_GET_GRP_PMSK_SDIO_E0(x)   ((u32)(((x >> 12) & 0x00000003)))
...
/** @defgroup REG_CTRL_GRP_PWR_MSK1
  ...
  * @{
  */
#define CTRL_MASK_GRP_PMSK_PKE_E0           ((u32)0x00000003 << 30)           /*!< R/W 0x3  */
#define CTRL_GRP_PMSK_PKE_E0(x)             (((u32)((x) & 0x00000003) << 30))
#define CTRL_GET_GRP_PMSK_PKE_E0(x)         ((u32)(((x >> 30) & 0x00000003)))
#define CTRL_MASK_GRP_PMSK_CAN_E0           ((u32)0x00000003 << 28)           /*!< R/W 0x3  */
#define CTRL_GRP_PMSK_CAN_E0(x)             (((u32)((x) & 0x00000003) << 28))
#define CTRL_GET_GRP_PMSK_CAN_E0(x)         ((u32)(((x >> 28) & 0x00000003)))
#define CTRL_MASK_GRP_PMSK_GMAC_E0          ((u32)0x00000003 << 26)           /*!< R/W 0x3  */
#define CTRL_GRP_PMSK_GMAC_E0(x)            (((u32)((x) & 0x00000003) << 26))
#define CTRL_GET_GRP_PMSK_GMAC_E0(x)        ((u32)(((x >> 26) & 0x00000003)))
#define CTRL_MASK_GRP_PMSK_MJPEG_E2         ((u32)0x000001FF << 17)           /*!< R/W 0x1ff  */
#define CTRL_GRP_PMSK_MJPEG_E2(x)           (((u32)((x) & 0x000001FF) << 17))
#define CTRL_GET_GRP_PMSK_MJPEG_E2(x)       ((u32)(((x >> 17) & 0x000001FF)))
#define CTRL_MASK_GRP_PMSK_MJPEG_E1         ((u32)0x00000007 << 14)           /*!< R/W 0x7  */
#define CTRL_GRP_PMSK_MJPEG_E1(x)           (((u32)((x) & 0x00000007) << 14))
#define CTRL_GET_GRP_PMSK_MJPEG_E1(x)       ((u32)(((x >> 14) & 0x00000007)))
#define CTRL_BIT_GRP_PMSK_MJPEG_E0          ((u32)0x00000001 << 13)           /*!< R/W 0x1  */
#define CTRL_BIT_GRP_PMSK_LCDC_E0           ((u32)0x00000001 << 12)           /*!< R/W 0x1  */
#define CTRL_BIT_GRP_PMSK_KM4NS_ITCM_E0     ((u32)0x00000001 << 11)           /*!< R/W 0x1  */
#define CTRL_MASK_GRP_PMSK_KM4NS_CACHE_E0   ((u32)0x0000000F << 7)            /*!< R/W 0xf  */
#define CTRL_GRP_PMSK_KM4NS_CACHE_E0(x)     (((u32)((x) & 0x0000000F) << 7))
#define CTRL_GET_GRP_PMSK_KM4NS_CACHE_E0(x) ((u32)(((x >> 7) & 0x0000000F)))
#define CTRL_MASK_GRP_PMSK_KM4TZ_ITCM_E0    ((u32)0x00000007 << 4)            /*!< R/W 0x7  */
#define CTRL_GRP_PMSK_KM4TZ_ITCM_E0(x)      (((u32)((x) & 0x00000007) << 4))
#define CTRL_GET_GRP_PMSK_KM4TZ_ITCM_E0(x)  ((u32)(((x >> 4) & 0x00000007)))
#define CTRL_MASK_GRP_PMSK_KM4TZ_CACHE_E0   ((u32)0x0000000F << 0)            /*!< R/W 0xf  */
#define CTRL_GRP_PMSK_KM4TZ_CACHE_E0(x)     (((u32)((x) & 0x0000000F) << 0))
#define CTRL_GET_GRP_PMSK_KM4TZ_CACHE_E0(x) ((u32)(((x >> 0) & 0x0000000F)))
/** @} */
...
/** @defgroup REG_CTRL_GRP_PWR_MSK2
  ...
  * @{
  */
#define CTRL_MASK_GRP_PMSK_PPE_E1   ((u32)0x000000FF << 9)           /*!< R/W 0xff  */
#define CTRL_GRP_PMSK_PPE_E1(x)     (((u32)((x) & 0x000000FF) << 9))
#define CTRL_GET_GRP_PMSK_PPE_E1(x) ((u32)(((x >> 9) & 0x000000FF)))
#define CTRL_MASK_GRP_PMSK_PPE_E0   ((u32)0x000000FF << 1)           /*!< R/W 0xff  */
#define CTRL_GRP_PMSK_PPE_E0(x)     (((u32)((x) & 0x000000FF) << 1))
#define CTRL_GET_GRP_PMSK_PPE_E0(x) ((u32)(((x >> 1) & 0x000000FF)))
#define CTRL_BIT_GRP_PMSK_PKE_E1    ((u32)0x00000001 << 0)           /*!< R/W 0x1  */
/** @} */
...
/** @defgroup REG_CTRL_GRP_HSYS_E0_CTRL
  ...
  * @{
  */
#define CTRL_MASK_HSYS_E0_DS_K          ((u32)0x00000003 << 16)           /*!< R/W 2'b01  DS_K*/
#define CTRL_HSYS_E0_DS_K(x)            (((u32)((x) & 0x00000003) << 16))
#define CTRL_GET_HSYS_E0_DS_K(x)        ((u32)(((x >> 16) & 0x00000003)))
#define CTRL_BIT_HSYS_E0_TMCK           ((u32)0x00000001 << 15)           /*!< R/W 1'b0  TMCK*/
#define CTRL_MASK_HSYS_E0_DVS           ((u32)0x0000000F << 11)           /*!< R/W 4'b0001  DVS*/
#define CTRL_HSYS_E0_DVS(x)             (((u32)((x) & 0x0000000F) << 11))
#define CTRL_GET_HSYS_E0_DVS(x)         ((u32)(((x >> 11) & 0x0000000F)))
#define CTRL_BIT_HSYS_E0_DVSE           ((u32)0x00000001 << 10)           /*!< R/W 1'b1  DVSE*/
...
#define CTRL_MASK_LRET_E0_DVS           ((u32)0x0000000F << 11)           /*!< R/W 4'b0001  DVS*/
...
/** @defgroup REG_CTRL_GRP_WPON_E0_CTRL
  ...
  * @{
  */
#define CTRL_MASK_WPON_E0_WAEM         ((u32)0x0000000F << 18)           /*!< R/W 4'b1001  WAEM*/
...
#define CTRL_MASK_WPON_E0_DVS          ((u32)0x0000000F << 11)           /*!< R/W 4'b0001  DVS*/
...
/** @defgroup REG_CTRL_GRP_WPON_E1_CTRL
  ...
  * @{
  */
#define CTRL_MASK_WPON_E1_WAEM         ((u32)0x0000000F << 18)           /*!< R/W 4'b1001  WAEM*/
#define CTRL_WPON_E1_WAEM(x)           (((u32)((x) & 0x0000000F) << 18))
#define CTRL_GET_WPON_E1_WAEM(x)       ((u32)(((x >> 18) & 0x0000000F)))
#define CTRL_BIT_WPON_E1_WAE           ((u32)0x00000001 << 17)           /*!< R/W 1'b1  WAE*/
#define CTRL_BIT_WPON_E1_RAE           ((u32)0x00000001 << 16)           /*!< R/W 1'b1  RAE*/
#define CTRL_BIT_WPON_E1_TMCK          ((u32)0x00000001 << 15)           /*!< R/W 1'b0  TMCK*/
#define CTRL_MASK_WPON_E1_DVS          ((u32)0x0000000F << 11)           /*!< R/W 4'b0001  DVS*/
...
#define CTRL_MASK_BT_E0_DVS           ((u32)0x0000000F << 11)           /*!< R/W 4'b0001  DVS*/
...
/** @defgroup REG_CTRL_GRP_MJPEG_E0_CTRL
  ...
  * @{
  */
#define CTRL_BIT_MJPEG_E0_TEST1B         ((u32)0x00000001 << 21)           /*!< R/W 1'b0  TEST1B*/
#define CTRL_BIT_MJPEG_E0_TEST1A         ((u32)0x00000001 << 20)           /*!< R/W 1'b0  TEST1A*/
#define CTRL_MASK_MJPEG_E0_RMB           ((u32)0x0000000F << 16)           /*!< R/W 4'b0010  RMB*/
#define CTRL_MJPEG_E0_RMB(x)             (((u32)((x) & 0x0000000F) << 16))
#define CTRL_GET_MJPEG_E0_RMB(x)         ((u32)(((x >> 16) & 0x0000000F)))
#define CTRL_MASK_MJPEG_E0_RMA           ((u32)0x0000000F << 12)           /*!< R/W 4'b0010  RMA*/
#define CTRL_MJPEG_E0_RMA(x)             (((u32)((x) & 0x0000000F) << 12))
#define CTRL_GET_MJPEG_E0_RMA(x)         ((u32)(((x >> 12) & 0x0000000F)))
#define CTRL_BIT_MJPEG_E0_RMEB           ((u32)0x00000001 << 11)           /*!< R/W 1'b0  RMEB*/
#define CTRL_BIT_MJPEG_E0_RMEA           ((u32)0x00000001 << 10)           /*!< R/W 1'b0  RMEA*/
...
/** @defgroup REG_CTRL_GRP_MJPEG_E1_CTRL
  ...
  * @{
  */
#define CTRL_BIT_MJPEG_E1_TEST1B         ((u32)0x00000001 << 21)           /*!< R/W 1'b0  TEST1B*/
#define CTRL_BIT_MJPEG_E1_TEST1A         ((u32)0x00000001 << 20)           /*!< R/W 1'b0  TEST1A*/
#define CTRL_MASK_MJPEG_E1_RMB           ((u32)0x0000000F << 16)           /*!< R/W 4'b0010  RMB*/
#define CTRL_MJPEG_E1_RMB(x)             (((u32)((x) & 0x0000000F) << 16))
#define CTRL_GET_MJPEG_E1_RMB(x)         ((u32)(((x >> 16) & 0x0000000F)))
#define CTRL_MASK_MJPEG_E1_RMA           ((u32)0x0000000F << 12)           /*!< R/W 4'b0010  RMA*/
#define CTRL_MJPEG_E1_RMA(x)             (((u32)((x) & 0x0000000F) << 12))
#define CTRL_GET_MJPEG_E1_RMA(x)         ((u32)(((x >> 12) & 0x0000000F)))
#define CTRL_BIT_MJPEG_E1_RMEB           ((u32)0x00000001 << 11)           /*!< R/W 1'b0  RMEB*/
#define CTRL_BIT_MJPEG_E1_RMEA           ((u32)0x00000001 << 10)           /*!< R/W 1'b0  RMEA*/
...
/** @defgroup REG_CTRL_GRP_RSTN
  ...
  * @{
  */
#define CTRL_BIT_GRP_PPE_E1_RSTN         ((u32)0x00000001 << 25) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_PPE_E0_RSTN         ((u32)0x00000001 << 24) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_PKE_E1_RSTN         ((u32)0x00000001 << 23) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_PKE_E0_RSTN         ((u32)0x00000001 << 22) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_CAN_E0_RSTN         ((u32)0x00000001 << 21) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_GMAC_E0_RSTN        ((u32)0x00000001 << 20) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_MJPEG_E2_RSTN       ((u32)0x00000001 << 19) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_MJPEG_E1_RSTN       ((u32)0x00000001 << 18) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_MJPEG_E0_RSTN       ((u32)0x00000001 << 17) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_LCDC_E0_RSTN        ((u32)0x00000001 << 16) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_KM4NS_ITCM_E0_RSTN  ((u32)0x00000001 << 15) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_KM4NS_CACHE_E0_RSTN ((u32)0x00000001 << 14) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_KM4TZ_ITCM_E0_RSTN  ((u32)0x00000001 << 13) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_KM4TZ_CACHE_E0_RSTN ((u32)0x00000001 << 12) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_BT_E0_RSTN          ((u32)0x00000001 << 11) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_WPON_E1_RSTN        ((u32)0x00000001 << 10) /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_WPON_E0_RSTN        ((u32)0x00000001 << 9)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_WPOFF_E2_RSTN       ((u32)0x00000001 << 8)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_WPOFF_E1_RSTN       ((u32)0x00000001 << 7)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_WPOFF_E0_RSTN       ((u32)0x00000001 << 6)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_USB_E0_RSTN         ((u32)0x00000001 << 5)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_SDIO_E0_RSTN        ((u32)0x00000001 << 4)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_AONPMC_E0_RSTN      ((u32)0x00000001 << 3)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_LSPMC_E0_RSTN       ((u32)0x00000001 << 2)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
#define CTRL_BIT_GRP_LRET_E0_RSTN        ((u32)0x00000001 << 1)  /*!< R/W 1'b1  *0 - Reset mbist circuit of this memory group; *1 - Release mbist circuit of this memory group.*/
...
/** @defgroup REG_CTRL_SCAN_OCC_CTRL0
  ...
  * @{
  */
#define CTRL_MASK_SCAN_OCC_DBG_EN_I3C     ((u32)0x00000003 << 16)           /*!< R/W 0x0  scan occ dbg en i3c*/
#define CTRL_SCAN_OCC_DBG_EN_I3C(x)       (((u32)((x) & 0x00000003) << 16))
#define CTRL_GET_SCAN_OCC_DBG_EN_I3C(x)   ((u32)(((x >> 16) & 0x00000003)))
...
/** @defgroup REG_CTRL_SCAN_OCC_CTRL2
  ...
  * @{
  */
#define CTRL_MASK_SCAN_OCC_DBG_EN_USB       ((u32)0x00000003 << 28)           /*!< R/W 0x0  */
#define CTRL_SCAN_OCC_DBG_EN_USB(x)         (((u32)((x) & 0x00000003) << 28))
#define CTRL_GET_SCAN_OCC_DBG_EN_USB(x)     ((u32)(((x >> 28) & 0x00000003)))
...
/** @defgroup REG_CTRL_SCAN_OCC_CTRL3
  ...
  * @{
  */
#define CTRL_MASK_SCAN_OCC_DBG_EN_DVP        ((u32)0x00000003 << 20)           /*!< R/W 0x0  */
#define CTRL_SCAN_OCC_DBG_EN_DVP(x)          (((u32)((x) & 0x00000003) << 20))
#define CTRL_GET_SCAN_OCC_DBG_EN_DVP(x)      ((u32)(((x >> 20) & 0x00000003)))
#define CTRL_MASK_SCAN_OCC_DBG_EN_LTIM_5     ((u32)0x00000003 << 18)           /*!< R/W 0x0  */
#define CTRL_SCAN_OCC_DBG_EN_LTIM_5(x)       (((u32)((x) & 0x00000003) << 18))
#define CTRL_GET_SCAN_OCC_DBG_EN_LTIM_5(x)   ((u32)(((x >> 18) & 0x00000003)))
#define CTRL_MASK_SCAN_OCC_DBG_EN_LTIM_4     ((u32)0x00000003 << 16)           /*!< R/W 0x0  */
#define CTRL_SCAN_OCC_DBG_EN_LTIM_4(x)       (((u32)((x) & 0x00000003) << 16))
#define CTRL_GET_SCAN_OCC_DBG_EN_LTIM_4(x)   ((u32)(((x >> 16) & 0x00000003)))
...
#define REG_CTRL_MBIST_GRP_EN_BT_VIR_E00            0x00C
#define REG_CTRL_MBIST_DONE_STA0                    0x010
#define REG_CTRL_MBIST_START_PULSE0                 0x014
#define REG_CTRL_MBIST_NORM_FAIL0                   0x018
#define REG_CTRL_MBIST_NORM_FAIL1                   0x01C
#define REG_CTRL_MBIST_NORM_FAIL2                   0x020
#define REG_CTRL_MBIST_DRF_FAIL0                    0x024
#define REG_CTRL_MBIST_DRF_FAIL1                    0x028
#define REG_CTRL_MBIST_DRF_FAIL2                    0x02C
#define REG_CTRL_BT_VIR_E0_BIST_DONE0               0x030
#define REG_CTRL_BT_VIR_E0_BIST_FAIL0               0x034
#define REG_CTRL_BT_VIR_E0_BIST_DRF_PAUSE0          0x038
#define REG_CTRL_BT_VIR_E0_BIST_RPT                 0x03C
#define REG_CTRL_BT_VIR_E0_RPT_SEL                  0x040
#define REG_CTRL_MISR_DOUT_SEL                      0x044
#define REG_CTRL_LSPMC_E0_ROM_MISR0                 0x048
#define REG_CTRL_LSPMC_E0_ROM_MISR1                 0x04C
#define REG_CTRL_AONPMC_E0_ROM_MISR1                0x050
#define REG_CTRL_AONPMC_E0_ROM_MISR2                0x054
#define REG_CTRL_KM4TZ_ITCM_E0_ROM_MISR2            0x058
#define REG_CTRL_KM4TZ_ITCM_E0_ROM_MISR3            0x05C
#define REG_CTRL_KM4NS_ITCM_E0_ROM_MISR3            0x060
#define REG_CTRL_KM4NS_ITCM_E0_ROM_MISR4            0x064
#define REG_CTRL_PKE_E1_ROM_MISR4                   0x068
#define REG_CTRL_PKE_E1_ROM_MISR5                   0x06C
#define REG_CTRL_GRP_PWR_MSK0                       0x070
#define REG_CTRL_GRP_PWR_MSK1                       0x074
#define REG_CTRL_GRP_PWR_MSK2                       0x078
#define REG_CTRL_GRP_HSYS_E0_CTRL                   0x07C
#define REG_CTRL_GRP_LRET_E0_CTRL                   0x080
#define REG_CTRL_GRP_LSPMC_E0_CTRL                  0x084
#define REG_CTRL_GRP_AONPMC_E0_CTRL                 0x088
#define REG_CTRL_GRP_SDIO_E0_CTRL                   0x08C
#define REG_CTRL_GRP_USB_E0_CTRL                    0x090
#define REG_CTRL_GRP_WPOFF_E0_CTRL                  0x094
#define REG_CTRL_GRP_WPOFF_E1_CTRL                  0x098
#define REG_CTRL_GRP_WPOFF_E2_CTRL                  0x09C
#define REG_CTRL_GRP_WPON_E0_CTRL                   0x0A0
#define REG_CTRL_GRP_WPON_E1_CTRL                   0x0A4
#define REG_CTRL_GRP_BT_E0_CTRL                     0x0A8
#define REG_CTRL_GRP_KM4TZ_CACHE_E0_CTRL            0x0AC
#define REG_CTRL_GRP_KM4TZ_ITCM_E0_CTRL             0x0B0
#define REG_CTRL_GRP_KM4NS_CACHE_E0_CTRL            0x0B4
#define REG_CTRL_GRP_KM4NS_ITCM_E0_CTRL             0x0B8
#define REG_CTRL_GRP_LCDC_E0_CTRL                   0x0BC
#define REG_CTRL_GRP_MJPEG_E0_CTRL                  0x0C0
#define REG_CTRL_GRP_MJPEG_E1_CTRL                  0x0C4
#define REG_CTRL_GRP_MJPEG_E2_CTRL                  0x0C8
#define REG_CTRL_GRP_GMAC_E0_CTRL                   0x0CC
#define REG_CTRL_GRP_CAN_E0_CTRL                    0x0D0
#define REG_CTRL_GRP_PKE_E0_CTRL                    0x0D4
#define REG_CTRL_GRP_PKE_E1_CTRL                    0x0D8
#define REG_CTRL_GRP_PPE_E0_CTRL                    0x0DC
#define REG_CTRL_GRP_PPE_E1_CTRL                    0x0E0
#define REG_CTRL_GRP_BT_VIR_E0_CTRL                 0x0E4
#define REG_CTRL_GRP_RSTN                           0x0E8
#define REG_CTRL_PWR_MODE_SEL                       0x0EC
#define REG_CTRL_DUMMY                              0x0F0
