...
typedef struct {
	__IO uint32_t UVC_CTRL                  ;  /*!< Register,  Address offset:0x000 */
	__IO uint32_t UVC_CHNL0_CTRL            ;  /*!< Register,  Address offset:0x004 */
	__IO uint32_t UVC_CHNL1_CTRL            ;  /*!< Register,  Address offset:0x008 */
	__IO uint32_t UVC_INTR                  ;  /*!< Register,  Address offset:0x00C */
	...
	__IO uint32_t UVC_CH0_EP_CTRL           ;  /*!< Register,  Address offset:0x100 */
	__IO uint32_t UVC_CH1_EP_CTRL           ;  /*!< Register,  Address offset:0x104 */
	__IO uint32_t RSVD1                     ;  /*!< Reserved,  Address offset:0x108-0x10B */
	__IO uint32_t UVC_HST_FRREM_CTRL        ;  /*!< Register,  Address offset:0x10C */
