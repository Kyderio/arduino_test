...
u32 Ethernet_WriteData(ETH_InitTypeDef *ETH_InitStruct, u8 *data, u32 size);
u32 Ethernet_SendPkt(ETH_InitTypeDef *ETH_InitStruct);
u32 Ethernet_ReceivePkt(ETH_InitTypeDef *ETH_InitStruct);
u32 Ethernet_ReadData(ETH_InitTypeDef *ETH_InitStruct, u8 *data, u32 size);
