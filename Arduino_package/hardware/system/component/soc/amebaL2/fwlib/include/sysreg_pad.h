...
/** @defgroup REG_PAD_PU_3
  ...
  * @{
  */
#define PAD_MASK_PC_PU   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 700h  PAD pull up enable when system is in active.*/
...
/** @defgroup REG_PAD_PU_SLP_3
  ...
  * @{
  */
#define PAD_MASK_PC_PU_SLP   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 700h  PAD pull up enable when system is in sleep.*/
