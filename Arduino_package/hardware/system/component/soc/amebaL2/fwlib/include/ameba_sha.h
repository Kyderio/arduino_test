...
/** @defgroup SHA_LMOTS_CONFIGURATION
  * @brief LMOTS Configuration Register
  * @{
  */
#define SHA_BIT_LMOTS_CONST_LITTLE_ENDIAN    ((u32)0x00000001 << 31)           /*!< R/W 0x1  Data structure of LMOTS constant registers (0x98~0xAC) 0x0 : Big-endian 0x1 : Little-endian*/
#define SHA_MASK_LMOTS_J_ITERATION_END       ((u32)0x000000FF << 16)           /*!< R/W 0x0  Maximum iteration index j in LMOTS process*/
#define SHA_LMOTS_J_ITERATION_END(x)         (((u32)((x) & 0x000000FF) << 16))
#define SHA_GET_LMOTS_J_ITERATION_END(x)     ((u32)(((x >> 16) & 0x000000FF)))
#define SHA_MASK_LMOTS_J_ITERATION_INITIAL   ((u32)0x000000FF << 8)            /*!< R/W 0x0  Initial iteration index j in LMOTS process*/
#define SHA_LMOTS_J_ITERATION_INITIAL(x)     (((u32)((x) & 0x000000FF) << 8))
#define SHA_GET_LMOTS_J_ITERATION_INITIAL(x) ((u32)(((x >> 8) & 0x000000FF)))
#define SHA_BIT_LMOTS_MODE                   ((u32)0x00000001 << 0)            /*!< R/W 0x0  The operation of LMOTS mode 0x0 : Generate public-key (KeyGen) or generate signature (SigGen) 0x1 : Verify signature Note: This register is valid only when LMOTS_enable = 0x1 This register is valid available when engine support LMOTS*/
/** @} */

/** @defgroup SHA_LMOTS_CONTROL
  * @brief LMOTS Control Register
  * @{
  */
#define SHA_BIT_LMOTS_ENABLE ((u32)0x00000001 << 0) /*!< R/W 0x0  0x1 : enable engine to start LMOTS process Note: This register is clear automatically after LMOTS process complete.*/
/** @} */

/** @defgroup SHA_LMOTS_CONSTANT_x
  * @brief LMOTS Constant Register x
  * @{
  */
#define SHA_MASK_LMOTS_CONSTANT_x   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Key identifier [32*x+31:32*x]*/
#define SHA_LMOTS_CONSTANT_x(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define SHA_GET_LMOTS_CONSTANT_x(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup SHA_LMOTS_CONSTANT_4
  * @brief
  * @{
  */
#define SHA_MASK_LMOTS_Q   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Leaf index of LMOTS tree*/
#define SHA_LMOTS_Q(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define SHA_GET_LMOTS_Q(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup SHA_LMOTS_CONSTANT_5
  * @brief
  * @{
  */
#define SHA_MASK_LMOTS_I_BYTE_0   ((u32)0x0000007F << 24)           /*!< R/W 0x0  Digest byte index of LMOTS tree Note : The register is available only when LMOTS_const_little_endian = 0x0. Otherwise, it is always 0x0.*/
#define SHA_LMOTS_I_BYTE_0(x)     (((u32)((x) & 0x0000007F) << 24))
#define SHA_GET_LMOTS_I_BYTE_0(x) ((u32)(((x >> 24) & 0x0000007F)))
#define SHA_MASK_LMOTS_I_BYTE_1   ((u32)0x000000FF << 16)           /*!< R/W 0x0  Digest byte index of LMOTS tree Note : The register is available only when LMOTS_const_little_endian = 0x0. Otherwise, it is always 0x0.*/
#define SHA_LMOTS_I_BYTE_1(x)     (((u32)((x) & 0x000000FF) << 16))
#define SHA_GET_LMOTS_I_BYTE_1(x) ((u32)(((x >> 16) & 0x000000FF)))
#define SHA_MASK_LMOTS_I_BYTE_2   ((u32)0x000000FF << 8)            /*!< R/W 0x0  Digest byte index of LMOTS tree Note : The register is available only when LMOTS_const_little_endian = 0x1. Otherwise, it is always 0x0.*/
#define SHA_LMOTS_I_BYTE_2(x)     (((u32)((x) & 0x000000FF) << 8))
#define SHA_GET_LMOTS_I_BYTE_2(x) ((u32)(((x >> 8) & 0x000000FF)))
#define SHA_MASK_LMOTS_I_BYTE_3   ((u32)0x000000FF << 0)            /*!< R/W 0x0  Digest byte index of LMOTS tree Note : The register is available only when LMOTS_const_little_endian = 0x1. Otherwise, it is always 0x0.*/
#define SHA_LMOTS_I_BYTE_3(x)     (((u32)((x) & 0x000000FF) << 0))
#define SHA_GET_LMOTS_I_BYTE_3(x) ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
...
/** @defgroup SHA_LMOTS_SIG_ALIAS256_x
  * @brief LMOTS Signature Register x
  * @{
  */
#define SHA_MASK_LMOTS_SIGNATURE_x   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Signature value x of LMOTS*/
#define SHA_LMOTS_SIGNATURE_x(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define SHA_GET_LMOTS_SIGNATURE_x(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
typedef struct {
	...
	__IO uint32_t SHA_LMOTS_CONFIGURATION     ;  /*!< LMOTS CONFIGURATION REGISTER,  Address offset:0x090 */
	__IO uint32_t SHA_LMOTS_CONTROL           ;  /*!< LMOTS CONTROL REGISTER,  Address offset:0x094 */
	__IO uint32_t SHA_LMOTS_CONSTANT_x[4]     ;  /*!< LMOTS CONSTANT REGISTER x Register,  Address offset:0x098-0x0A4 */
	__IO uint32_t SHA_LMOTS_CONSTANT_4        ;  /*!< Register,  Address offset:0x0A8 */
	__IO uint32_t SHA_LMOTS_CONSTANT_5        ;  /*!< Register,  Address offset:0x0AC */
	__IO uint32_t RSVD2[20]                   ;  /*!< Reserved,  Address offset:0x0B0-0x0FF */
	...
	__IO uint32_t RSVD3[16]                   ;  /*!< Reserved,  Address offset:0x130-0x16F */
	__IO uint32_t SHA_LMOTS_SIG_ALIAS256_x[8] ;  /*!< LMOTS SIGNATURE REGISTER x Register,  Address offset:0x170-0x18C */
	__IO uint32_t RSVD4[732]                  ;  /*!< Reserved,  Address offset:0x190-0xCFF */
	...
	__IO uint32_t RSVD5[186]                  ;  /*!< Reserved,  Address offset:0xD08-0xFEF */
	__I  uint32_t SHA_CONFIGURATION           ;  /*!< CONFIGURATION INFORMATION REGISTER,  Address offset:0xFF0 */
	__IO uint32_t RSVD6                       ;  /*!< Reserved,  Address offset:0xFF4-0xFF7 */
