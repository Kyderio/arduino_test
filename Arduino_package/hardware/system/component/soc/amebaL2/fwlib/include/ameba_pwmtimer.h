...
#define TIM_MASK_CH_ID_DEADZONE_MAX   ((u32)0x00000007 << 28)           /*!< R/W 0x0  The channel ID with the maximum dead zone control time 0: ch0 1: ch1 ...... 5:ch5 6~ :reserve*/
...
/** @defgroup FIFO
  ...
  * @{
  */
#define TIM_MASK_FIFO_AF_LEVEL   ((u32)0x0000003F << 3)           /*!< R/W 6'd1  When writing a FIFO for the first time, you can configure this reg to allow the FIFO to reach a certain number before starting to read. Generally greater than the number of ch working in FIFO*/
#define TIM_FIFO_AF_LEVEL(x)     (((u32)((x) & 0x0000003F) << 3))
#define TIM_GET_FIFO_AF_LEVEL(x) ((u32)(((x >> 3) & 0x0000003F)))
#define TIM_BIT_FIFO_WFULL       ((u32)0x00000001 << 2)           /*!< R 0x0  */
#define TIM_BIT_FIFO_EMPTY       ((u32)0x00000001 << 1)           /*!< R 0x0  */
#define TIM_BIT_FIFO_CLR         ((u32)0x00000001 << 0)           /*!< WA0 0x0  */
/** @} */
...
#define IS_TIM_ONE_PULSE_TIM(PERIPH)	(((PERIPH) == TIM6) || \
										((PERIPH) == TIM7) || \
										((PERIPH) == TIM8) || \
										((PERIPH) == TIM9) || \
                    ((PERIPH) == TIM10) || \
...
#define IS_TIM_INPULSE_TIM(PERIPH)	(((PERIPH) == TIM10) || \
									((PERIPH) == TIM10_S))

#define IS_TIM_CCM_TIM(PERIPH)	(((PERIPH) == TIM6) || \
										((PERIPH) == TIM7) || \
										((PERIPH) == TIM8) || \
										((PERIPH) == TIM9) || \
                    ((PERIPH) == TIM10) || \
...
#define IS_TIM_PWM_TIM(PERIPH)	(((PERIPH) == TIM6) || \
										((PERIPH) == TIM7) || \
										((PERIPH) == TIM8) || \
										((PERIPH) == TIM9) || \
										((PERIPH) == TIM6_S) || \
...
#define IS_TIM_40M_TIM(PERIPH)  (((PERIPH) == TIM6) || \
										((PERIPH) == TIM7) || \
										((PERIPH) == TIM8) || \
										((PERIPH) == TIM9) || \
                    ((PERIPH) == TIM10) || \
