...
enum PSRAM_CLK_LIMIT {
	...
	PSRAM_DEVICE_CLK_NotClear = 0xF000000,
};
/**
  * @}
  */
 ...
 */
enum PSRAM_DQ_Type {
	PSRAM_DEVICE_DQ8 = 0x10000000,
	PSRAM_DEVICE_DQ16 = 0x20000000,

	PSRAM_DEVICE_DQ_NotClear = 0xF0000000,
};
/**
  * @}
  */
...
#define PSRAM_CLK_LIMIT_GET(x)		(x & 0xF000000)
#define PSRAM_DQNUM_GET(x)			(x & 0xF0000000)
...
#define PSRAM_APM64_DQ8 	PSRAM_DEVICE_DQ8|PSRAM_DEVICE_CLK_200 | PSRAM_VENDOR_APM | PSRAM_SIZE_64Mb | PSRAM_PAGE1024
#define PSRAM_APM128_DQ16 	PSRAM_DEVICE_DQ16|PSRAM_DEVICE_CLK_250 | PSRAM_VENDOR_APM | PSRAM_SIZE_128Mb | PSRAM_PAGE1024
#define PSRAM_APM256_DQ16 	PSRAM_DEVICE_DQ16|PSRAM_DEVICE_CLK_250 | PSRAM_VENDOR_APM | PSRAM_SIZE_256Mb | PSRAM_PAGE2048

#define PSRAM_WB955_DQ8  	PSRAM_DEVICE_DQ8|PSRAM_DEVICE_CLK_200 | PSRAM_VENDOR_WB | PSRAM_SIZE_32Mb | PSRAM_PAGE128
#define PSRAM_WB957_DQ16 	PSRAM_DEVICE_DQ16|PSRAM_DEVICE_CLK_250 | PSRAM_VENDOR_WB | PSRAM_SIZE_128Mb | PSRAM_PAGE2048
#define PSRAM_WB958_DQ16 	PSRAM_DEVICE_DQ16|PSRAM_DEVICE_CLK_250 | PSRAM_VENDOR_WB | PSRAM_SIZE_256Mb | PSRAM_PAGE1024
