...
/** @defgroup ADC_COM_CTC_ONLY1
  ...
  * @{
  */
#define ADC_COM_MASK_SEL_TOUCH_CUR   ((u32)0x0000001F << 0)           /*!< R/W 'b01000  Touch compensate current: When Cm 1800mV example: 20uA+<4:0>*5uA:  Current = (20uA +<4:0>*5uA)*(Vcm/180K)/10uA;  AIF default 01000,current 60uA;*/
