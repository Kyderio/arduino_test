...
/** @defgroup SYSPMC_CTRL
  ...
  * @{
  */
#define PMC_BIT_CPU_IS_AP     ((u32)0x00000001 << 28)           /*!< R 0x0  This bit indicate if current cpu who read this bit is used as NP 1: is NP 0: is AP*/
...
#define PMC_BIT_PST_G4_USE_MLDO  ((u32)0x00000001 << 25) /*!< R/W 0x1  1: G0 pad use MLDO 1.8v IO power 0: G0 pad use external power and can't shutdown by pmc DD_SEC: bpc_pmc*/
#define PMC_BIT_PST_G5_USE_MLDO  ((u32)0x00000001 << 24) /*!< R/W 0x1  1: G1 pad use MLDO 1.8v IO power(psram only) 0: G1 pad use external power and can't shutdown by pmc DD_SEC: bpc_pmc*/
...
#define PMC_BIT_PST_SLEP_G4PD    ((u32)0x00000001 << 7)  /*!< R/W 0x1  1: G0 pad used for 1.8v IO power , and will shutdown when LDO3318 off in slep, when dslp , it will always shutoff 0: G1 pad not used as 1.8v IO power DD_SEC: bpc_pmc*/
#define PMC_BIT_PST_SLEP_G5PD    ((u32)0x00000001 << 6)  /*!< R/W 0x1  1: G1 pad used for 1.8v IO power , and will shutdown when LDO3318 off in slep,, when dslp , it will always shutoff 0: G2 pad not used as 1.8v IO power DD_SEC: bpc_pmc*/
...
#define WAKE_SRC_BOR                                 ((u32)0x00000001 << 25)
#define WAKE_SRC_PWR_DOWN                            ((u32)0x00000001 << 26)
#define WAKE_SRC_AON_TIM                             ((u32)0x00000001 << 27)
#define WAKE_SRC_AON_WAKEPIN                         ((u32)0x00000001 << 28)
#define WAKE_SRC_SDIO_WIFI                           ((u32)0x00000001 << 29)
#define WAKE_SRC_SDIO_BT                             ((u32)0x00000001 << 30)
...
* @{
*****************************************************************************/
#define WAKE_SRC_BT_CTRL_LOW                         ((u32)(3 << 30) | (0x00000001 << 0))
/** @} */
