...
typedef struct {
	...
	__IO uint32_t ADC_DUMMY             ;  /*!< ADC DUMMY REGISTER,  Address offset:0x0BC */
} ADC_TypeDef;
...
/** @defgroup ADC_Input_Swing_Selection
  * @{
  */
#define ADC_IN_1V8						((u8)0x00) // 1.8V
#define ADC_IN_3V3						((u8)0x01) // 3.3V
#define ADC_IN_5V0						((u8)0x02) // 5V
/**
  * @}
  */
...
#define VREF_SEL_ADDR			0x7EE // OTP address for vref selection
/**
  * @}
  */
