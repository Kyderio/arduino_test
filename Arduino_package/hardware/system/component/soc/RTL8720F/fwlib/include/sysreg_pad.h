...
/** @defgroup REG_PAD_PU_1
  ...
  * @{
  */
#define PAD_MASK_PA_PU   ((u32)0xFFFFFFFF << 0)           /*!< R/W 40004020h  PAD pull up enable when system is in active.*/
...
/** @defgroup REG_PAD_PU_2
  ...
  * @{
  */
#define PAD_MASK_PB_PU   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0h  PAD pull up enable when system is in active.*/
...
/** @defgroup REG_PAD_PU_3
  ...
  * @{
  */
#define PAD_MASK_PC_PU   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 7000h  PAD pull up enable when system is in active.*/
...
/** @defgroup REG_PAD_PD_3
  ...
  * @{
  */
#define PAD_MASK_PC_PD   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 0h  PAD pull down enable when system is in active.*/
...
/** @defgroup REG_PAD_PU_SLP_1
  ...
  * @{
  */
#define PAD_MASK_PA_PU_SLP   ((u32)0xFFFFFFFF << 0)           /*!< R/W 40004020h  PAD pull up enable when system is in sleep.*/
...
/** @defgroup REG_PAD_PU_SLP_3
  ...
  * @{
  */
#define PAD_MASK_PC_PU_SLP   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 7000h  PAD pull up enable when system is in sleep.*/
...
/** @defgroup REG_PAD_PD_SLP_3
  ...
  * @{
  */
#define PAD_MASK_PC_PD_SLP   ((u32)0xFFFFFFFF << 0)           /*!< R/W/ES 0h  PAD pull down enable when system is in sleep.*/
...
#define PAD_MASK_GPIO_SWR_EN_MASK   ((u32)0x0000001F << 4)           /*!< R/W 5'b00010  Regu pmc will set one of aon pin to pullup/pulldn to control external SWR. 5'b00001: PC10 5'b00010: PC11 5'b00100: PC12 5'b01000: PC13 5'b10000: PC14*/
#define PAD_GPIO_SWR_EN_MASK(x)     (((u32)((x) & 0x0000001F) << 4))
#define PAD_GET_GPIO_SWR_EN_MASK(x) ((u32)(((x >> 4) & 0x0000001F)))
/** @} */
...
#define PAD_MASK_IQ_SW_EN         ((u32)0x00000003 << 8)           /*!< R/W 0h  rfafe 5v sw enable, active 1 [0]: G3 group sw [1]: G7 group sw*/
#define PAD_IQ_SW_EN(x)           (((u32)((x) & 0x00000003) << 8))
#define PAD_GET_IQ_SW_EN(x)       ((u32)(((x >> 8) & 0x00000003)))
#define PAD_BIT_G2_H5L3318_LV     ((u32)0x00000001 << 16)          /*!< R/W 0x1  VDDPST=5V   H533L18 = 1   H518L33 = 1   H5L3318 = 1 VDDPST=3.3V   H533L18 = 1   H518L33 = 0   H5L3318 = 0 VDDPST=1.8V   H533L18 = 0   H518L33 = 1   H5L3318 = 0 when PAD SHUTDOWN, pad will ISO this three value to 111 for safety .*/
#define PAD_BIT_G2_H533L18_LV     ((u32)0x00000001 << 17)          /*!< R/W 0x1  */
#define PAD_BIT_G2_H518L33_LV     ((u32)0x00000001 << 18)          /*!< R/W 0x1  */
#define PAD_BIT_G3_H5L3318_LV     ((u32)0x00000001 << 20)          /*!< R/W 0x1  */
#define PAD_BIT_G3_H533L18_LV     ((u32)0x00000001 << 21)          /*!< R/W 0x1  */
#define PAD_BIT_G3_H518L33_LV     ((u32)0x00000001 << 22)          /*!< R/W 0x1  */
#define PAD_BIT_G7_H5L3318_LV     ((u32)0x00000001 << 24)          /*!< R/W 0x1  */
#define PAD_BIT_G7_H533L18_LV     ((u32)0x00000001 << 25)          /*!< R/W 0x1  */
#define PAD_BIT_G7_H518L33_LV     ((u32)0x00000001 << 26)          /*!< R/W 0x1  */
/** @} */
