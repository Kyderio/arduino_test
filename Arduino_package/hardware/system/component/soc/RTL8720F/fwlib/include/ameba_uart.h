...
/** @defgroup TH_RETI
  ...
  * @{
  */
#define RUART_MASK_TH_RETI   ((u32)0x000FFFFF << 0)           /*!< R/W 0x0  Set rxfifo empty timeout interrupt, when rxfifo is empty for longer than TH_RETI*/
#define RUART_TH_RETI(x)     (((u32)((x) & 0x000FFFFF) << 0))
#define RUART_GET_TH_RETI(x) ((u32)(((x >> 0) & 0x000FFFFF)))
/** @} */
