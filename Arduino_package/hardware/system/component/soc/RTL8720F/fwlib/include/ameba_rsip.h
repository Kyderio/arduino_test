...
/** @defgroup RSIP_REGION_x_TAG_BASE
  ...
  * @{
  */
#define RSIP_MASK_REGION_x_TAG_BASE_ADDR   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Region x GCM tag base address*/
...
/** @brief RSIP Port
  */
typedef struct {
	__IO uint32_t RSIP_REMAPxBAR;  /*!< REMAP x REGION BASE ADDRESS REGISTER */
	__IO uint32_t RSIP_REMAPxEAR;  /*!< REMAP x REGION END ADDRESS REGISTER */
...
typedef struct {
	...
	__IO uint32_t RSVD3[24]                       ;  /*!< Reserved,  Address offset:0x0A0-0x0FF */
	OTF_Region_TypeDef OTF_REGION[8]              ;  /*!< RSIP IP have 8 ports,  Address offset:0x100-0x17C */
	RSIP_MMU_TypeDef FLASH_MMU[8]                 ;  /*!< RSIP IP have 8 ports,  Address offset:0x180-0x1DC */
	__IO uint32_t RSVD4[8]                        ;  /*!< Reserved,  Address offset:0x1E0-0x1FF */
