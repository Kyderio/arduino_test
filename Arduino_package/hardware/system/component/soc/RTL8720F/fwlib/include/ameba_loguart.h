...
#define LOGUART_MASK_AGG_TO         ((u32)0x00003FFF << 12)           /*!< R/W 0xBB8  AGG timeout Data should be sent from log FIFO to tx_fifo if idle time > AGG timeout, even if there is just only one byte in log FIFO of the path. when agg_en=0: Unit is 25ns. when agg_en=1: Unit is one baudrate period of loguart Tx, default is 1ms if Tx baudrate is 3Mbps.*/
...
#define LOGUART_RX_FIFOTRIG_LEVEL_QUARTER		((u32)0x00000001)
#define LOGUART_RX_FIFOTRIG_LEVEL_HALF			((u32)0x00000002)
#define LOGUART_RX_FIFOTRIG_LEVEL_MINUS2		((u32)0x00000003)
