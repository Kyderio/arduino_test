...
#define PLL_MASK_SS_SCALEDOWN_MODE   ((u32)0x00000003 << 14)           /*!< R/W 0h  use scaled-down timing values for usb, resulting in faster simulations*/
#define PLL_SS_SCALEDOWN_MODE(x)     (((u32)((x) & 0x00000003) << 14))
#define PLL_GET_SS_SCALEDOWN_MODE(x) ((u32)(((x >> 14) & 0x00000003)))
#define PLL_BIT_SUSPEND_WAK_MSK      ((u32)0x00000001 << 4)            /*!< R/W 0x0  set 0 to mask usb suspendm(keep 1) at normal state after receiving usb suspend interrupt, set this bit to 1 to enable resume(from suspend) wake event*/
#define PLL_BIT_Z0_TUNE_EN           ((u32)0x00000001 << 3)            /*!< R/W 0x1  Zo_Tune , 45Ωauto calibration(Port-1 only) 0: Zo_Tune disable 1: Zo_Tune enable*/
#define PLL_BIT_UA_LV2HV_EN          ((u32)0x00000001 << 2)            /*!< R/W 0x0  enable usb comparator l2h level shifter*/
#define PLL_BIT_PWC_UAHV_EN          ((u32)0x00000001 << 1)            /*!< R/W 0x0  enable usb comparator 3.3v power cut*/
#define PLL_BIT_FS_COMP_EN           ((u32)0x00000001 << 0)            /*!< R/W 0x0  enable usb full-speed differential comparator*/
/** @} */
