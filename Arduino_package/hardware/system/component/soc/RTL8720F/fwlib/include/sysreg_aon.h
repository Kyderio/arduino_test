...
/** @defgroup REG_AON_ISO
  ...
  * @{
  */
#define AON_BIT_G9_PAD_RSTB      ((u32)0x00000001 << 27) /*!< R/W 0x1  1: Enable G9  group pad 0: Reset PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G8_PAD_RSTB      ((u32)0x00000001 << 26) /*!< R/W 0x0  1: Enable G8  group pad 0: Reset PAD Note: This is AON pad group,  aon pmc will auto release this bit in power on init seq DD_SEC: bpc_pmc*/
#define AON_BIT_G9_PAD_SHDN      ((u32)0x00000001 << 25) /*!< R/W 0x1  1: Enable G9 group pad 0: Shutdown PAD DD_SEC: bpc_pmc*/
#define AON_BIT_G8_PAD_SHDN      ((u32)0x00000001 << 24) /*!< R/W 0x0  1: Enable G8 group pad 0: Shutdown PAD Note: This is AON pad group,  aon pmc will auto release this bit in power on init seq DD_SEC: bpc_pmc*/
