...
/** @defgroup REG_LSYS_CKSL_GRP0
  * @brief  Name: IRDA / PSRAM / SPIC / HPERI / OTPC / LPERI / HP
  * @{
  */
...
/** @defgroup REG_LSYS_CKD_GRP0
  * @brief  Name: XTAL_LTIM / XTAL_ADC / SRAM / ROM
  * @{
  */
...
/** @defgroup REG_LSYS_CKD_FEN_SYS_PLL
  * @brief  Name: SYS_PLL_IRDA / SYS_PLL_PSRAM / SYS_PLL_SPIC / SYS_PLL_HPERI / SYS_PLL_HP
  * @{
  */
#define LSYS_BIT_FEN_SYS_PLL_IRDA     ((u32)0x00000001 << 4)           /*!< R/W 1h  sys_pll_divider for irda enable 1:enable 0:disable DD_SEC: bpc_irda*/
#define LSYS_FEN_SYS_PLL_IRDA(x)      ((u32)(((x) & 0x00000001) << 4))
#define REG_LSYS_CKD_FEN_SYS_PLL_IRDA REG_LSYS_CKD_FEN_SYS_PLL
#define LSYS_GET_FEN_SYS_PLL_IRDA(x)  ((u32)(((x >> 4) & 0x00000001)))
...
/** @defgroup REG_LSYS_FEN_USB_PLL
  ...
  * @{
  */
#define LSYS_BIT_FEN_USB_PLL_IRDA     ((u32)0x00000001 << 4)           /*!< R/W 1h  usb_pll_divider for irda enable 1:enable 0:disable DD_SEC: bpc_irda*/
#define LSYS_FEN_USB_PLL_IRDA(x)      ((u32)(((x) & 0x00000001) << 4))
#define LSYS_GET_FEN_USB_PLL_IRDA(x)  ((u32)(((x >> 4) & 0x00000001)))
...
/** @defgroup REG_LSYS_CKD_SYS_PLL_GRP0
  ...
  * @{
  */
#define LSYS_MASK_CKD_SYS_PLL_IRDA    ((u32)0x0000000F << 16)           /*!< R/WPD 3h  sys_pll divider for irda 0: Not support 1: div2 ... DIV_MIN:1 DD_SEC: bpc_irda*/
#define LSYS_CKD_SYS_PLL_IRDA(x)      (((u32)((x) & 0x0000000F) << 16))
#define REG_LSYS_CKD_SYS_PLL_IRDA     REG_LSYS_CKD_SYS_PLL_GRP0
#define LSYS_GET_CKD_SYS_PLL_IRDA(x)  ((u32)(((x >> 16) & 0x0000000F)))
...
/** @defgroup REG_LSYS_CKD_USB_PLL_GRP0
  * @brief  Name: USB_PLL_IRDA / USB_PLL_PSRAM / USB_PLL_SPIC / USB_PLL_HPERI / USB_PLL_HP
  * @{
  */
#define LSYS_MASK_CKD_USB_PLL_IRDA    ((u32)0x0000000F << 16)           /*!< R/WPD 9h  usb_pll divider for irda, source is 960M 0: div1 1: div2 ... DIV_MIN:0 DD_SEC: bpc_irda*/
#define LSYS_CKD_USB_PLL_IRDA(x)      (((u32)((x) & 0x0000000F) << 16))
#define REG_LSYS_CKD_USB_PLL_IRDA     REG_LSYS_CKD_USB_PLL_GRP0
#define LSYS_GET_CKD_USB_PLL_IRDA(x)  ((u32)(((x >> 16) & 0x0000000F)))
...
#define LSYS_MASK_DVP_DUMMY_DATA        ((u32)0x000000FF << 8)            /*!< R/W 0xff  dvp dummy data*/
#define LSYS_DVP_DUMMY_DATA(x)          (((u32)((x) & 0x000000FF) << 8))
#define LSYS_GET_DVP_DUMMY_DATA(x)      ((u32)(((x >> 8) & 0x000000FF)))
#define LSYS_BIT_DVP_DUMMY_DATA_EN      ((u32)0x00000001 << 7)            /*!< R/W 0x0  dvp dummy data enable 1: enable extra dummy data fliter, only work in the end of frame 0: disable extra dummy data fliter, only flitir out 0xffff*/
#define LSYS_DVP_DUMMY_DATA_EN(x)       ((u32)(((x) & 0x00000001) << 7))
#define LSYS_GET_DVP_DUMMY_DATA_EN(x)   ((u32)(((x >> 7) & 0x00000001)))
...
#define LSYS_BIT_AUXADC_VCCOFFB         ((u32)0x00000001 << 3)            /*!< R/W 0x0  1: enable auxadc power cut 0: shutdown auxadc all power cut for power saving when scan mode , it will tie0,  also ISO signal must tie 1*/
#define LSYS_AUXADC_VCCOFFB(x)          ((u32)(((x) & 0x00000001) << 3))
#define LSYS_GET_AUXADC_VCCOFFB(x)      ((u32)(((x >> 3) & 0x00000001)))
...
* LTIM5 / OTPC / PSRAM / SPIC / SYS_32K / UART0 / UART1 / UART2
* UART3
* -------------------------------------------------------------
*
...
*  Div_Name: min_div - max_div
* -------------------------------------------------------------
* ROM / SRAM / SYS_PLL_HP / SYS_PLL_HPERI / SYS_PLL_IRDA / SYS_PLL_PSRAM / SYS_PLL_SPIC / USB_PLL_HP
* USB_PLL_HPERI / USB_PLL_IRDA / USB_PLL_PSRAM / USB_PLL_SPIC / XTAL_ADC / XTAL_DTIM / XTAL_LTIM
* -------------------------------------------------------------
* @param  Div_Name: As listed in the table above, brief "Name" at group REG_LSYS_CKD_XXX
*/
...
* -------------------------------------------------------------
* SYS_PLL_HP / SYS_PLL_HPERI / SYS_PLL_IRDA / SYS_PLL_PSRAM / SYS_PLL_SPIC / XTAL_ADC / XTAL_DTIM / XTAL_LTIM
* -------------------------------------------------------------
...
typedef struct {
	...
	__IO u8 CHIP_INFO;
	u8 GBSS_SYS_RSVD[45];/* resvd for system */
} GBSS_TypeDef;

Compile_Assert(sizeof(GBSS_TypeDef) == 64, "GBSS_TypeDef size shall be 64");
