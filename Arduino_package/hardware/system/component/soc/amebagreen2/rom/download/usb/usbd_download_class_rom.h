...
#ifndef __USBD_DOWNLOAD_CLASS_ROM_H
#define __USBD_DOWNLOAD_CLASS_ROM_H
...
#define CDC_RX_BUF_ADDR                             (CDC_DESC_BUF_ADDR + 128) /* Length >= CDC_DATA_OUT_TRANSFER_SIZE */
#define CDC_TX_BUF_ADDR                             (CDC_RX_BUF_ADDR + 2056) /* Length >= CDC_DATA_IN_TRANSFER_SIZE */
...
#endif  /* __USBD_DOWNLOAD_CLASS_ROM_H */
