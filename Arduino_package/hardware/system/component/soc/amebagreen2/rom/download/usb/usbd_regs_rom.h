...
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL					0x300A4UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P0E0			0x300E0UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P0E4			0x300E4UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P1E0			0x300E8UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P1E4			0x300ECUL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P0F0			0x300F0UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P0F4			0x300F4UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P1F4			0x300F8UL
#define USB_OTG_ADDON_REG_AUTOLOAD_UPHY_P2E4			0x300FCUL
...
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL_BIT_SQNUM_ROM			BIT(0)
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL_BIT_REMOTE_WAKEUP		BIT(1)
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL_BIT_SELF_POWER_EN		BIT(2)
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL_BIT_AUTOLOAD_UPHY_EN	BIT(3)
#define USB_OTG_ADDON_REG_AUTOLOAD_CTRL_BIT_AUTOLOAD_DESC_EN	BIT(4)
