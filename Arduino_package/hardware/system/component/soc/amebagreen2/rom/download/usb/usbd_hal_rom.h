...
#define USBD_DESC_BUF_ADDR                     (USBD_SN_STR_BUF_ADDR + USBD_MAX_STR_LEN) /* Length >= USBD_WIFI_ONLY_MODE_CONFIG_DESC_SIZE, set to 48 */
#define USBD_CTRL_BUF_ADDR                     (USBD_DESC_BUF_ADDR + 48) /* Length >= UBURN_PKT_DESC_SIZE, set to 32 */
#define USBD_TX_BUF_ADDR                       (USBD_CTRL_BUF_ADDR + 32) /* Length >= UBURN_PKT_DESC_SIZE, set to 24 */
#define USBD_RX_BUF_ADDR                       (USBD_TX_BUF_ADDR + 24) /* Length >= UBURN_PKT_DESC_SIZE + 2048, max 2400 */
...
/* USB registers */
#define USB_GLOBAL     ((USB_OTG_GlobalTypeDef *)(USB_REG_BASE))
#define USB_PCGCCTL    *(__IO u32 *)(USB_REG_BASE + USB_OTG_PCGCCTL_BASE)
#define USB_DEVICE     ((USB_OTG_DeviceTypeDef *)(USB_REG_BASE + USB_OTG_DEVICE_BASE))
#define USB_INEP(i)    ((USB_OTG_INEndpointTypeDef *)(USB_REG_BASE + USB_OTG_IN_ENDPOINT_BASE + ((i) * USB_OTG_EP_REG_SIZE)))
#define USB_OUTEP(i)   ((USB_OTG_OUTEndpointTypeDef *)(USB_REG_BASE + USB_OTG_OUT_ENDPOINT_BASE + ((i) * USB_OTG_EP_REG_SIZE)))
