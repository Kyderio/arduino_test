...
#define ROM_VECTOR_TABLE1_SECTION               SECTION(".rom_vector_table1")
...
#define HAL_ROM_DATA_SECTION_BANK               SECTION(".hal.rom.bank.rodata")
#define HAL_ROM_BSS_SECTION                     SECTION(".hal.rom.bss")
#define HAL_ROM_BSS_SECTION_BANK                SECTION(".hal.rom.bank.bss")

#define SHARE_ROM_SECTION                       SECTION(".share.rom.text")
