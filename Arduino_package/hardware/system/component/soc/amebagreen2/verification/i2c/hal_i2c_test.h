...
//================= I2C HAL START  ==========================
// I2C debug output
#define ROLE_IS_MASTER


#define I2C_PREFIX      "RTL8195A[i2c]: "
#define I2C_PREFIX_LVL  "PORT2 [i2c_DBG]: "
#define I2C_PORT_LOG  "PORT2:"
#ifdef ROLE_IS_MASTER
#define I2C_PORT  "MASTER "
#else
#define I2C_PORT  "SLAVE "
#endif
#define I2C_END  "END "
#define I2C_FAIL "RTK_FAIL "
#define I2C_SUCCESS "RTK_SUCCESS "
...
typedef struct _SAL_I2C_MNGT_ADPT_ {
	...
	u32                     I2CExd;             //I2C extended options: _I2C_EXD_SUPPORT_
	u32                     PinMux;             //I2C extended options: _I2C_EXD_SUPPORT_
