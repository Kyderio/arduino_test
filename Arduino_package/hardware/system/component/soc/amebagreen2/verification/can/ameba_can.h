...
/** @defgroup RCAN_dma_functions
  * @{
  */
_LONG_CALL_ bool RCAN_TXGDMA_Init(u8 CANIndex, GDMA_InitTypeDef *GDMA_InitStruct, void *CallbackData,
								  IRQ_FUN CallbackFunc, u8 *pTxBuf, int TxCount);
_LONG_CALL_ bool RCAN_RXGDMA_Init(u8 CANIndex, GDMA_InitTypeDef *GDMA_InitStruct, void *CallbackData,
