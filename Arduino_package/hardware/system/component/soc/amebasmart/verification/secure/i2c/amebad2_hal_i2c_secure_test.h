...
HAL_Status RtkI2CInit(IN  PSAL_I2C_MNGT_ADPT  pSalI2CMngtAdpt, IN  u32 DEVSEC);
HAL_Status RtkI2CDeInit(IN  PSAL_I2C_MNGT_ADPT  pSalI2CMngtAdpt, IN  u32 DEVSEC);
HAL_Status RtkI2CSend(IN  PSAL_I2C_MNGT_ADPT  pSalI2CMngtAdpt, IN  u32 DEVSEC);
HAL_Status RtkI2CReceive(IN  PSAL_I2C_MNGT_ADPT  pSalI2CMngtAdpt, IN  u32 DEVSEC);
//================= I2C SAL END   ===========================

//======================================================
extern void I2CISRHandle(IN  void *Data, IN  u32 DEVSEC);
