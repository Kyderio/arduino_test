...
typedef struct _SAL_I2C_TRANSFER_BUF_ {
	u32     DataLen;                        //I2C Transmfer Length
...
typedef struct _SAL_I2C_MNGT_ADPT_ {
	...
	//          0 for NOT supported,
	//          1 for supported
	//bit 3: I2C Slave-No-Ack supported
	//          0 for NOT supported,
	//          1 for supported
	//bit 4: I2C bus loading,
	//          0 for 100pf,
	//          1 for 400pf
	//bit 5: I2C slave ack to General Call,
	//bit 6: I2C User register address,
	//bit 7: I2C 2-Byte User register address,
	//bit 8: I2C slave address no ack retry, It's only for Master mode, when slave doesn't ack the address,
	//bit 9: Master dynamically updates slave address,
	//bit10: Master doesn't generate STOP when the FIFO is empty. This would make Master hold,
	//bit 31~bit 11: Reserved
