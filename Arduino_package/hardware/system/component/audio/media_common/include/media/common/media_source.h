...
#ifndef AMEBA_FWK_MEDIA_PLAYBACK_COMMON_MEDIA_COMMON_MEDIA_SOURCE_H
#define AMEBA_FWK_MEDIA_PLAYBACK_COMMON_MEDIA_COMMON_MEDIA_SOURCE_H
...
class MediaSource : public RefPtr
{
public:
	MediaSource() {}
	...
	// Returns a new rbuffer of data. Call blocks until a
	// buffer is available, an error is encountered of the end of the stream
	// is reached.
	virtual ssize_t Read(
		sptr<RBuffer> *buffer, const ReadProperties *properties = NULL) = 0;
...
#endif  // AMEBA_FWK_MEDIA_PLAYBACK_COMMON_MEDIA_COMMON_MEDIA_SOURCE_H
