...
#ifndef AMEBA_FWK_MEDIA_PLAYBACK_TESTS_MY_DATA_SOURCE_H
#define AMEBA_FWK_MEDIA_PLAYBACK_TESTS_MY_DATA_SOURCE_H
...
#endif  // AMEBA_FWK_MEDIA_PLAYBACK_TESTS_MY_DATA_SOURCE_H