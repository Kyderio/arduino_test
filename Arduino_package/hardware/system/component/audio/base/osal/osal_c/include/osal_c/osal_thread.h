...
int32_t osal_create_raw_thread(osal_thread_id_t *thread_id,
...
int32_t osal_thread_request_exit(osal_thread_t *thread);    
int32_t osal_thread_request_exitAndWait(osal_thread_t *thread);
int32_t osal_thread_join(osal_thread_t *thread);
