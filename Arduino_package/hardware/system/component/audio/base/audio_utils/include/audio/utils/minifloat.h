...
typedef uint32_t float_gain_pack;
...
static inline float_gain_pack gain_minifloat_pack(gain_minifloat_t left,
		gain_minifloat_t right)
{
	return (right << 16) | left;
}

static inline gain_minifloat_t gain_minifloat_unpack_left(float_gain_pack packed)
{
	return packed & 0xFFFF;
}

static inline gain_minifloat_t gain_minifloat_unpack_right(float_gain_pack packed)
{
	return packed >> 16;
}
