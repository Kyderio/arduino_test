...
void scale_volume_24bit(uint8_t *samples, uint8_t *dst, uint32_t frame_count, float vol, uint32_t channels);

void scale_volume_16bit(uint8_t *samples, uint8_t *dst, uint32_t frame_count, float vol, uint32_t channels);

void scale_volume_32bit(uint8_t *samples, uint8_t *dst, uint32_t frame_count, float vol, uint32_t channels);
