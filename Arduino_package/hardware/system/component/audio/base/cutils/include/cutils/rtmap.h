...
status_t RTIntMap_Destroy(RTIntMap *self);
status_t RTIntMap_Clear(RTIntMap *self);
status_t RTIntMap_Put(RTIntMap *self, int32_t key, void *value, RTMapEntryInfo *previous);
RTIntMapEntry *RTIntMap_Get(RTIntMap *self, int32_t key);
status_t RTIntMap_Remove(RTIntMap *self, int32_t key, RTMapEntryInfo *entry_info);
...
status_t RTRBMap_Destroy(RTRBMap *self);
status_t RTRBMap_Clear(RTRBMap *self);
status_t RTRBMap_Put(RTRBMap *self, void *key, void *value, RTMapEntryInfo *previous);
RTRBMapEntry *RTRBMap_Get(RTRBMap *self, void *key);
status_t RTRBMap_Remove(RTRBMap *self, void *key, RTMapEntryInfo *entry_info);
