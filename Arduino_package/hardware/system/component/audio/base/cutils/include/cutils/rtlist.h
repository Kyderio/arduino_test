...
status_t RTList_Destroy(RTList *self);
status_t RTList_Clear(RTList *self);

RTListNode *RTList_CreateNode(RTList *self);
status_t RTList_DestroyNode(RTList *self, RTListNode *node);

status_t RTList_AppendNode(RTList *self, RTListNode *node);
RTListNode *RTList_AppendData(RTList *self, void *data);

status_t RTList_InsertNode(RTList *self, RTListNode *where, RTListNode *node);
RTListNode *RTList_InsertData(RTList *self, RTListNode *where, void *data);

status_t RTList_RemoveNode(RTList *self, RTListNode *node);
status_t RTList_RemoveData(RTList *self, void *data);
status_t RTList_DetachNode(RTList *self, RTListNode *node);
...
status_t RTListNode_SetData(RTListNode *self, void *data);
