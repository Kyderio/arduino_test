...
// record track
class RecordTrack : public ServerThreadBase::ServerTrackBase
{
    friend class RecordThread;
public:
    RecordTrack(RecordThread *thread, uint32_t sample_rate, uint32_t format, uint32_t channel_count,
                size_t frame_count);
    virtual             ~RecordTrack();
...
private:
    ...
    virtual int32_t      GetNextAvailBuffer(TrackServerBufferAgent::Buffer *buffer,
