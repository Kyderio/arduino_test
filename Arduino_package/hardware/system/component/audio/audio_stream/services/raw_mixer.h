...
public:
	...
	void        SetTrackTimeStretch(int track_mask, const AudioPlayRate &playbackRate);
...
private:
	...
	struct TrackInMixer {
		...
		int32_t        PrepareForReformat();
		void           UnprepareForReformat();
		bool           SetPlayRate(const AudioPlayRate &playbackRate);

		AudioPlayRate                          mPlaybackRate;
		union {
