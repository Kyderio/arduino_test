...
public:
    ...
    static res_t     SetAmplifierEnPin(uint32_t amp_pin);
    static res_t     GetLatency(uint32_t audio_type, uint32_t *latency);
    static AudioIoId GetOutput(int32_t category, uint32_t rate, int32_t format,
