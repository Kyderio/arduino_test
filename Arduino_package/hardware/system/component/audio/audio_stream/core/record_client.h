...
public:
	 ...
	 * @version 1.0
	 */
	int32_t  Read(void *buffer, size_t size, bool blocking = true);
...
private:
	...
	struct AudioHwCard           *audio_card_;
	struct AudioHwStreamIn       *audio_stream_in_;
	struct AudioHwCardDescriptor *audio_card_desc_;
	AudioHwPort                   audio_port_;
