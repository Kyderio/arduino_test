...
#ifndef AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_OUTPUT_LITE_H
#define AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_OUTPUT_LITE_H

#include "osal_cxx/mutex.h"
#include "audio/audio_track.h"

#include "audio_render_sink_lite.h"

namespace ameba::media
{

class AudioOutputLite : public AudioRenderSinkLite
{
public:
	AudioOutputLite();
	virtual ~AudioOutputLite();
...
#endif // AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_OUTPUT_LITE_H
