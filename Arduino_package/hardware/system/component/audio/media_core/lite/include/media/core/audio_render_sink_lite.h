...
#ifndef AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_RENDER_SINK_LITE_H
#define AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_RENDER_SINK_LITE_H
...
class AudioRenderSinkLite : public RefPtr
{
public:
	virtual             ~AudioRenderSinkLite() {}
	...
	virtual int64_t     GetPlayedOutDurationNs(int64_t now_ns) const = 0;
	 ...
	 * When |blocking| is false, AudioRenderSinkLite will immediately return after
	 * part of or full |buffer| is copied over.
	 * When |blocking| is true, AudioRenderSinkLite will wait to copy the entire
...
#endif // AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_AUDIO_RENDER_SINK_LITE_H