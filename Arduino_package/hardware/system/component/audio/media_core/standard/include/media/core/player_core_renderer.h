...
#if defined(MEDIA_SINK_BT) || defined(MEDIA_SINK_UAC)
        kReasonDeviceSendFail,  // bt/uac send fail. need to notify error to app layer.
#endif
    };
...
private:
    ...
    void AdjustVolume(sptr<CodecBufferInfo> buffer);
