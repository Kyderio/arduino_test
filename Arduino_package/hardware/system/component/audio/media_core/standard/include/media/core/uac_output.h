...
#ifndef AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_UAC_OUTPUT_H
#define AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_UAC_OUTPUT_H
...
class UACOutput : public DeviceOutput
{
public:
    UACOutput();
    virtual ~UACOutput();
...
#endif // AMEBA_FWK_MEDIA_PLAYBACK_CORE_MEDIA_CORE_UAC_OUTPUT_H
