#ifndef _RL6845_REG_PAGE6_H_
#define _RL6845_REG_PAGE6_H_
...
#define BIT_MASK_WMAC_RXUC_BBYE_MACID              ((u32)0x0000007F << 8)          /*!<R 0  hw latch macid when rx my unicast bye-bye frame in relay mode 7E:rxpktbuf full 7F:not valid macid */
#define BIT_WMAC_RXUC_BBYE_MACID(x)                (((u32)((x) & 0x0000007F) << 8))
#define BIT_GET_WMAC_RXUC_BBYE_MACID(x)            ((u32)(((x >> 8) & 0x0000007F)))
...
#define BIT_WMAC_EN_EOF                            ((u32)0x00000001 << 27)          /*!<R/W 0  when set to 1, enable single ampdu for qos packet. In early mode,not set to 1. */
...
#define BIT_VHT_DACK                               ((u32)0x00000001 << 26)          /*!<R/W 0  This bit to control response type for vht single mpdu data packet. 1： ACK as response 0： BA as response */
...
#define BIT_CBSSID_MGNT                            ((u32)0x00000001 << 7)          /*!<R/W 0  Check port0 BSSID_BCN When set to 1, MAC will check the BSSID of RX management type frame to determine if this packet belongs to this BSSID. */
#define BIT_CBSSID_DATA                            ((u32)0x00000001 << 6)          /*!<R/W 0  Check port0 BSSID_DATA, To DS, From DS Match Packet. When set to 1, MAC will check the Rx data type frame‟s BSSID, To DS, and From DS fields, to determine if it is set to Link OK in an Infrastructure or Ad hoc network. Note this setting is independent of nettype. Driver must set this bit in ad hoc mode and client mode. */
...
#define BIT_MASK_RX_DLK_TIME                       ((u32)0x000000FF << 8)          /*!<R/W 0x04  macrx dead lock timer timeout value (unit in 2us). As CCA is deasserted and no RXD is received but macrx still waits coming RXD, the deadlock timer will be enabled in this case */
 ...
 * @{
 **/
#define BIT_MASK_MACID_V1                          ((u32)0xFFFFFFFF << 0)          /*!<   MAC Identification Number Register BIT[31:0] */
 ...
 * @{
 **/
#define BIT_WIFI_TUNNEL_MODE                             ((u32)0x00000001 << 27)          /*!<R/W 0  when set, means relay mesh is eable and must enable address cam for rx */
#define BIT_SUP_ADDR3_EN                           ((u32)0x00000001 << 26)          /*!<R/W 0  when set, rx filter only check supper address3 and fcs */
#define BIT_MACRX_RESET                            ((u32)0x00000001 << 25)          /*!<WA0 0  when set, generate one pulse and reset macrx */
#define BIT_WLAN_RX_REQ_SIFS_CLR                   ((u32)0x00000001 << 24)          /*!<R/W 0x1  when set, enable SIFS reach clear wlan_rx_req */
#define BIT_CHKBSSID_MGNT_P1                       ((u32)0x00000001 << 23)          /*!<R/W 0  when set, enable check port1 management frame bssid */
#define BIT_CHKBSSID_DATA_P1                       ((u32)0x00000001 << 22)          /*!<R/W 0  when set, enable check port1 data frame bssid */
#define BIT_AP_BSSID_FIT_UC                        ((u32)0x00000001 << 21)          /*!<R/W 0x1  When set1,bssid fit when AP port0 rx unciast data packet */
 ...
 * @{
 **/
#define BIT_MBIDCAM_POLL                           ((u32)0x00000001 << 31)          /*!<R 0  Pooling bit. */
...
#define BIT_MASK_UDF_THSD_VALUE                    ((u32)0x0000007F << 16)          /*!<R/W 0x4  Underflow threshold */
#define BIT_UDF_THSD_VALUE(x)                      (((u32)((x) & 0x0000007F) << 16))
#define BIT_GET_UDF_THSD_VALUE(x)                  ((u32)(((x >> 16) & 0x0000007F)))
#define BIT_MASK_WMAC_TCR_TSFT_OFS                 ((u32)0x0000FFFF << 0)          /*!<R/W 0  BIT_WMAC_TCR_TSFT_OFS[7:0] is for cck stamp time offset; BIT_WMAC_TCR_TSFT_OFS[15:8] is for other rate time offset; */
 ...
 * @{
 **/
#define BIT_MASK_WMAC_TXTIMEOUT                    ((u32)0x000000FF << 8)          /*!<R/W 0  BIT_WMAC_TXTIMEOUT[7]=1: enable mac tx timeout function;r_WMAC_TXTIMEOUT[7]=0, disable mac tx timeout function; BIT_WMAC_TXTIMEOUT[6:0]: timeout threshold */
#define BIT_WMAC_TXTIMEOUT(x)                      (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_WMAC_TXTIMEOUT(x)                  ((u32)(((x >> 8) & 0x000000FF)))
...
#define BIT_MASK_ACKTO_CCK                         ((u32)0x000000FF << 8)          /*!<R/W 0x14  This register sets the Ack time out value after Tx unicast packet with CCK rate. It is in units of us. */
#define BIT_ACKTO_CCK(x)                           (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_ACKTO_CCK(x)                       ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_USTIME_EDCA                       ((u32)0x000000FF << 0)          /*!<R/W 0x14  Sets the microsecond time unit used by MAC EDCA clock. */
#define BIT_USTIME_EDCA(x)                         (((u32)((x) & 0x000000FF) << 0))
#define BIT_GET_USTIME_EDCA(x)                     ((u32)(((x >> 0) & 0x000000FF)))
/** @} */

/** @defgroup REG_RESP_SIFS
 * @brief Response SIFS for CCK_OFDM Register
 * @{
 **/
#define BIT_MASK_R2T_SIFS_OFDM                     ((u32)0x000000FF << 24)          /*!<R/W 0x0E  This register sets the SIFS time required for any immediate response for example Data-Ack. It is in unit of us. */
#define BIT_R2T_SIFS_OFDM(x)                       (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_R2T_SIFS_OFDM(x)                   ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_T2T_SIFS_OFDM                     ((u32)0x000000FF << 16)          /*!<R/W 0x0E  This register sets the SIFS time required for consecutive TX events for example CTS-Data, or broadcast bursting. It is in unit of us. */
#define BIT_T2T_SIFS_OFDM(x)                       (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_T2T_SIFS_OFDM(x)                   ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_R2T_SIFS_CCK                      ((u32)0x000000FF << 8)          /*!<R/W 0x0A  This register sets the SIFS time required for any immediate response for example Data-Ack. It is in unit of us. */
#define BIT_R2T_SIFS_CCK(x)                        (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_R2T_SIFS_CCK(x)                    ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_T2T_SIFS_CCK                      ((u32)0x000000FF << 0)          /*!<R/W 0x0A  This register sets the SIFS time required for consecutive TX events for example CTS-Data, or broadcast bursting. It is in unit of us. */
#define BIT_T2T_SIFS_CCK(x)                        (((u32)((x) & 0x000000FF) << 0))
#define BIT_GET_T2T_SIFS_CCK(x)                    ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
...
#define BIT_MASK_CTS2TO                            ((u32)0x000000FF << 8)          /*!<R/W 0x7E  This register sets the CTS2 time out value after CTS1 in Dual CTS sequence. It is in units of us. */
#define BIT_CTS2TO(x)                              (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_CTS2TO(x)                          ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_ACKTO                             ((u32)0x000000FF << 0)          /*!<R/W 0x2D  This register sets the Ack time out value after Tx unicast packet. It is in units of us. */
#define BIT_ACKTO(x)                               (((u32)((x) & 0x000000FF) << 0))
#define BIT_GET_ACKTO(x)                           ((u32)(((x >> 0) & 0x000000FF)))
/** @} */

/** @defgroup REG_ADDRCAM_CTL
 * @brief
 * @{
 **/
...
#define BIT_IDUNMATCH_CN_CLR                       ((u32)0x00000001 << 6)          /*!<WA0 0  when set, generate one pulse and reset cca_idunmatch_cnt */
#define BIT_MACID_STATIC_SEL                       ((u32)0x00000001 << 5)          /*!<R/W 0x0  when set, statistic only A1 match packet；otherwise statistic A1 match and my bc/mc packet for macid_match_no_fcs */
#define BIT_DIS_ADDRCAM                            ((u32)0x00000001 << 4)          /*!<R/W 0x1  when set, disable address cam, filter follow old base */
#define BIT_MASK_ADDRCAM_NUM                       ((u32)0x0000000F << 0)          /*!<R/W 0xb  rx address cam number for rx filter, the max number is 12 */
#define BIT_ADDRCAM_NUM(x)                         (((u32)((x) & 0x0000000F) << 0))
#define BIT_GET_ADDRCAM_NUM(x)                     ((u32)(((x >> 0) & 0x0000000F)))
/** @} */
...
/** @defgroup REG_TXOPOWNER_H
 * @brief
 * @{
 **/
#define BIT_RESP_HTC_EN                            ((u32)0x00000001 << 16)          /*!<R/W 0  Enable responder response with HTC field when receiving pkt with HTC field */
#define BIT_MASK_R_TXOPOWNER_ADDR_H                ((u32)0x0000FFFF << 0)          /*!<R/W 0x00ff  txopowner mac address Register BIT[47:32] */
#define BIT_R_TXOPOWNER_ADDR_H(x)                  (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_R_TXOPOWNER_ADDR_H(x)              ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_RXNAV_CTRL
 * @brief RXNAV Control Register
 * @{
 **/
...
#define BIT_WMAC_BITMAP_WINDOW_SEL                 ((u32)0x00000001 << 6)          /*!<R/W 0  1:maintain 32bit bitmap(63:32=0) 0:matain 64bit bitmap */
...
#define BIT_BITMAP_SSNBK_COUNTER_CLR               ((u32)0x00000001 << 25)          /*!<WA0 0  Clear BIT_BITMAP_SSNBK_COUNTER. */
...
#define BIT_MASK_LBK_DLY                           ((u32)0x0000001F << 0)          /*!<R/W 0x10  Loopback Delay. In unit of 'us'; indicates the delay after which the tdrdy_mac starts. In wep/tkip mode, the delay should be larger than 15, because the initial delay of security is about 1320 cycles, approximately to 16.5 us. */
 ...
 * @{
 **/
#define BIT_MASK_RXERR_RPT_SEL_V1_3_0              ((u32)0x0000000F << 28)          /*!<R/W 0  Rx packet counter report selection bit3~bit0 RXERR_RPT_SEL[4:0]: Counter description 5'd0: OFDM MPDU OK counter 5'd1: OFDM MPDU Fail counter 5'd2: OFDM False Alarm counter 5'd3: CCK MPDU OK counter 5'd4: CCK MPDU Fail counter 5'd5: CCK False Alarm counter; 5'd6: HT MPDU OK counter 5'd7: HT MPDU Fail counter 5'd8: HT PPDU counter 5'd9: HT False Alarm counter 5'd10: Rx full drop packet counter 5'd11: RSVD 5'd12: user define 0 counter 5'd13: user define 1 counter 5'd14: user define 2 counter 5'd15: user define 3 counter 5'd16: VHT MPDU OK counter 5'd17: VHT MPDU Fail counter 5'd18: VHT PPDU counter 5'd19: VHT False Alarm counter 5'd23: invalid_pkt counter */
#define BIT_RXERR_RPT_SEL_V1_3_0(x)                (((u32)((x) & 0x0000000F) << 28))
#define BIT_GET_RXERR_RPT_SEL_V1_3_0(x)            ((u32)(((x >> 28) & 0x0000000F)))
#define BIT_RXERR_RPT_RST                          ((u32)0x00000001 << 27)          /*!<W 0  Write “one” to set the counter to zero. */
#define BIT_RXERR_RPT_SEL_V1_4                     ((u32)0x00000001 << 26)          /*!<R/W 0  Rx packet counter report selection bit4 */
#define BIT_MASK_UD_SELECT_BSSID_2_1               ((u32)0x00000003 << 24)          /*!<R/W 0  {25,24,22} Select BSSID: 3'b0: Port 0 3'b1: Port 1 3'b2: Port 2 3'b3: Port 3 3'b4: Port 4 */
#define BIT_UD_SELECT_BSSID_2_1(x)                 (((u32)((x) & 0x00000003) << 24))
#define BIT_GET_UD_SELECT_BSSID_2_1(x)             ((u32)(((x >> 24) & 0x00000003)))
#define BIT_W1S                                    ((u32)0x00000001 << 23)          /*!<R/W 0  Write One Setting, it is only valid for RXERR_RPT_SEL (4'd12 ~ 4'd15) */
#define BIT_UD_SELECT_BSSID                        ((u32)0x00000001 << 22)          /*!<R/W 0  Select BSSID: 0: Port 0 1: Port 1 */
...
#define BIT_MASK_RPT_COUNTER                       ((u32)0x0000FFFF << 0)          /*!<R 0  The reported counter value corresponding to Report type selected. */
...
#define BIT_DIS_UPD_MYRXPKTNAV                     ((u32)0x00000001 << 23)          /*!<R/W 0  Do not update NAV, while receiving my packet. */
...
#define BIT_EARLY_TXACK_RXWEPTKIP                  ((u32)0x00000001 << 9)          /*!<R/W 0  While phyrxon down, mac_rxactive on. Ignore mac rx busy, respond ACK when receive wep/tkip */
...
#define BIT_TXACK_WITH_A1MATCH                     ((u32)0x00000001 << 2)          /*!<R/W 0  SET TO 1 :check every bit of a1 of rxpkt when need to response */
...
#define BIT_WEPTKIP_USE_ELY_FCS                    ((u32)0x00000001 << 11)          /*!<R/W 0  when rx is wep/tkip,use fcs from rxfifo to start response flow */
...
#define BIT_KEYCAM_CLEAR                           ((u32)0x00000001 << 30)          /*!<W 0  Set to 1 to clear all valid bits in CAM. After reset will self clear to 0. */
#define BIT_MFBCAM_CLEAR                           ((u32)0x00000001 << 29)          /*!<W 0  Write 1 to clear all MFB value in CAM to 7'h7F. After reset will self clear to 0 */
...
#define BIT_DIS_GCLK_TKIP                          ((u32)0x00000001 << 13)          /*!<R/W 0  not used */
 ...
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG0_L            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  address table user defined address0, low 32 bit */
#define BIT_ADDR_TABLE_USER_REG0_L(x)              (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG0_L(x)          ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
 ...
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG1_L            ((u32)0x0000FFFF << 16)          /*!<R/W 0  address table user defined address1, low 16 bit */
#define BIT_ADDR_TABLE_USER_REG1_L(x)              (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_ADDR_TABLE_USER_REG1_L(x)          ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_ADDR_TABLE_USER_REG0_H            ((u32)0x0000FFFF << 0)          /*!<R/W 0  address table user defined address0, high 16 bit */
#define BIT_ADDR_TABLE_USER_REG0_H(x)              (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG0_H(x)          ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
 ...
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG1_H            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  address table user defined address1, high 32 bit */
#define BIT_ADDR_TABLE_USER_REG1_H(x)              (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG1_H(x)          ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
#define BIT_RXCTRLIN0                              ((u32)0x00000001 << 20)          /*!<R/W 0  It is set to 1 if NIC received control frame with correct DA. */
#define BIT_RXMGTIN0                               ((u32)0x00000001 << 19)          /*!<R/W 0  It is set to 1 if NIC received management frame with correct BSSID and DA (including unicast and BMC). */
#define BIT_RXDATAIN2                              ((u32)0x00000001 << 18)          /*!<R/W 0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC). */
#define BIT_RXDATAIN1                              ((u32)0x00000001 << 17)          /*!<R/W 0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC). */
#define BIT_RXDATAIN0                              ((u32)0x00000001 << 16)          /*!<R/W 0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC). */
...
#define BIT_HAS_MY_BC0                             ((u32)0x00000001 << 15)          /*!<R 0  indicate has mc/bc frame */
#define BIT_HAS_MY_BSSID0                          ((u32)0x00000001 << 14)          /*!<R 0  Indicate my non-transmitted bssid has packet */
#define BIT_HAS_MYAID0                             ((u32)0x00000001 << 13)          /*!<R 0  Indicate MACID0 AID is set to 1 in the bit map control field of the TIM element of Rx Beacon frame */
#define BIT_RPT_VALID0                             ((u32)0x00000001 << 12)          /*!<R 0  1 means tim report is vaild */
#define BIT_MASK_PS_AID_0                          ((u32)0x000007FF << 0)          /*!<R/W 0  AID0 for MACID0 */
 ...
 * @{
 **/
#define BIT_MASK_STATE_SEL                         ((u32)0x0000001F << 24)          /*!<R/W 0  WMAC FSM selection */
#define BIT_STATE_SEL(x)                           (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_STATE_SEL(x)                       ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_STATE_INFO                        ((u32)0x000001FF << 7)          /*!<R 0  Report the other relation information about FSM */
#define BIT_STATE_INFO(x)                          (((u32)((x) & 0x000001FF) << 7))
#define BIT_GET_STATE_INFO(x)                      ((u32)(((x >> 7) & 0x000001FF)))
#define BIT_MASK_CUR_STATE                         ((u32)0x0000007F << 0)          /*!<R/W 0  Indicate the FSM current state */
...
#define BIT_MACTX_ERR_5                            ((u32)0x00000001 << 5)          /*!<R 0  Indicate no phytx timeout */
#define BIT_MACTX_ERR_4                            ((u32)0x00000001 << 4)          /*!<R 0  Indicate pre tx error/tx plcp error */
#define BIT_MACTX_ERR_3                            ((u32)0x00000001 << 3)          /*!<R 0  Indicate beamforming nsts error */
#define BIT_MACTX_ERR_2                            ((u32)0x00000001 << 2)          /*!<R 0  Indicate TXD FIFO underflow when MAC Tx cmpba */
#define BIT_MACTX_ERR_1                            ((u32)0x00000001 << 1)          /*!<R 0  Indicate TXD FIFO underflow */
#define BIT_MACTX_ERR_0                            ((u32)0x00000001 << 0)          /*!<R 0  Indicate PHY finish TX before MAC */
/** @} */
...
#define BIT_CSI_GID_SEL                            ((u32)0x00000001 << 12)          /*!<R/W    */
 ...
 * @{
 **/
#define BIT_MASK_NOA_RPT                           ((u32)0xFFFFFFFF << 0)          /*!<R 0   */
 ...
 * @{
 **/
#define BIT_MASK_NOA_RPT_1                         ((u32)0xFFFFFFFF << 0)          /*!<R 0   */
 ...
 * @{
 **/
#define BIT_MASK_NOA_RPT_2                         ((u32)0xFFFFFFFF << 0)          /*!<R 0   */
 ...
 * @{
 **/
#define BIT_MASK_NOA_RPT_3                         ((u32)0x000000FF << 0)          /*!<R 0   */
 ...
 * @{
 **/
#define BIT_RXAI_INFO_RST                          ((u32)0x00000001 << 7)          /*!<R/W 0  Write 1 to reset the RXAI events */
 ...
 * @{
 **/
#define BIT_TXPKTCNT_RST                           ((u32)0x00000001 << 11)          /*!<R/W 0  Reset tx packet counter, write “one” to set the counter to zero */
#define BIT_TX_UDPKTCNT_SET                        ((u32)0x00000001 << 10)          /*!<R/W 0  Set user define packet configure, write one setting, it is only valid for r_wmac_txpktcnt_sel (4'd0 ~ 4'd3) */
#define BIT_MASK_WMAC_TXPKTCNT_SEL                 ((u32)0x0000000F << 6)          /*!<R/W 0  Tx packet counter report selection 4'd0: user define 0 counter 4'd1: user define 1 counter 4'd2: user define 2 counter 4'd3: user define 3 counter 4'd4: HT mpdu tx ok counter 4'd5: VHT SU mpdu tx ok counter 4'd6: CCK ppdu tx ok counter 4'd7: OFDM ppdu tx ok counter 4'd8: HT ppdu tx ok counter 4'd9: VHT SU ppdu tx ok counter 4'd10~4'd15: RSVD */
#define BIT_WMAC_TXPKTCNT_SEL(x)                   (((u32)((x) & 0x0000000F) << 6))
#define BIT_GET_WMAC_TXPKTCNT_SEL(x)               ((u32)(((x >> 6) & 0x0000000F)))
#define BIT_MASK_WMAC_TXPKTCNT_CFG                 ((u32)0x0000003F << 0)          /*!<R/W 0  Tx packet conuter user define configuration [5:2]:subtype [1:0]:type */
 ...
 * @{
 **/
#define BIT_MASK_WMAC_TXPKTCNT_RPT                 ((u32)0x03FFFFFF << 0)          /*!<R 0  [25:22]:Tx packet counter report selection,r_wmac_txpktcnt_sel [21:16]:user define->tx packet type,[21:18]:subtype,[17:16]:type; others->6'h0 [15:0]:The tx reported counter value corresponding to Report type selected */
#define BIT_WMAC_TXPKTCNT_RPT(x)                   (((u32)((x) & 0x03FFFFFF) << 0))
#define BIT_GET_WMAC_TXPKTCNT_RPT(x)               ((u32)(((x >> 0) & 0x03FFFFFF)))
/** @} */
...
#define BIT_MASK_WMAC_PAUSE_BB_CLR_TH              ((u32)0x000000FF << 8)          /*!<R/W 0x48  MAC_PAUSE_BB High to Low clear threshold of csidma syncff read-write pointer */
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE2_3
 * @brief
 * @{
 **/
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE4_5
 * @brief
 * @{
 **/
#define BIT_STATUS_BFEE5                           ((u32)0x00000001 << 26)          /*!<R 0  beamforming report status of beamformee5 0: fail 1: success */
...
#define BIT_STATUS_BFEE4                           ((u32)0x00000001 << 10)          /*!<R 0  beamforming report status of beamformee4 0: fail, 1: success */
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE6_7
 * @brief
 * @{
 **/
#define BIT_STATUS_BFEE7                           ((u32)0x00000001 << 26)          /*!<R 0  beamforming report status of beamformee7 0: fail 1: success */
...
#define BIT_STATUS_BFEE6                           ((u32)0x00000001 << 10)          /*!<R 0  beamforming report status of beamformee6 0: fail 1: success */
 ...
 * @{
 **/
#define BIT_RST_ALL_COUNTER                        ((u32)0x00000001 << 31)          /*!<WA0 0  Write one to reset all counters to zero. */
...
#define BIT_MASK_WMAC_PLCP_RDSIG_SEL               ((u32)0x00000007 << 28)          /*!<R/W 0  Selection of plcp header signal field 0:LSIG 1:HTSIG1/VHTSIGA1 2:HTSIG2/VHTSIGA2 3:VHTSIGB 4: SERVICE field */
#define BIT_WMAC_PLCP_RDSIG_SEL(x)                 (((u32)((x) & 0x00000007) << 28))
#define BIT_GET_WMAC_PLCP_RDSIG_SEL(x)             ((u32)(((x >> 28) & 0x00000007)))
#define BIT_MASK_WMAC_RATE_IDX                     ((u32)0x0000000F << 24)          /*!<R 0  4'b0001 : CCK rate 4'b0010 : OFDM rate 4'b0110 : HT rate 4'b1010 : VHT rate */
 ...
 * @{
 **/
#define BIT_MASK_CSI_SEG_SIZE                      ((u32)0x00000FFF << 16)          /*!<R/W 0xF16  CSI data segmentation size (bytes) = Max. MPDU length - mac hdr (24) - act type (1) - category (1) – mimo ctrl (3) – FCS (4) */
#define BIT_CSI_SEG_SIZE(x)                        (((u32)((x) & 0x00000FFF) << 16))
#define BIT_GET_CSI_SEG_SIZE(x)                    ((u32)(((x >> 16) & 0x00000FFF)))
#define BIT_MASK_CSI_START_PAGE                    ((u32)0x00000FFF << 0)          /*!<R/W 0x7CE  The starting page number of csi buffer in TXPKTBUF */
 ...
 * @{
 **/
#define BIT_MASK_TA0_V1                            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  Transmitter address for port 0 for beacon/probresp check */
 ...
 * @{
 **/
#define BIT_MASK_TA0_H_V1                          ((u32)0x0000FFFF << 0)          /*!<R/W 0  Transmitter address for port 0 for beacon/probresp check */
 ...
 * @{
 **/
#define BIT_MASK_TA1_V1                            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  Transmitter address for port 1 for beacon/probresp check */
 ...
 * @{
 **/
#define BIT_MASK_TA1_H_V1                          ((u32)0x0000FFFF << 0)          /*!<R/W 0  Transmitter address for port 1 for beacon/probresp check */
#define BIT_TA1_H_V1(x)                            (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_TA1_H_V1(x)                        ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_ADDRESS_TABLE3
 * @brief
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG2_L            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  address table user defined address2, low 32 bit */
#define BIT_ADDR_TABLE_USER_REG2_L(x)              (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG2_L(x)          ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_ADDRESS_TABLE4
 * @brief
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG3_L            ((u32)0x0000FFFF << 16)          /*!<R/W 0  address table user defined address3, low 16 bit */
#define BIT_ADDR_TABLE_USER_REG3_L(x)              (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_ADDR_TABLE_USER_REG3_L(x)          ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_ADDR_TABLE_USER_REG2_H            ((u32)0x0000FFFF << 0)          /*!<R/W 0  address table user defined address2, high 16 bit */
#define BIT_ADDR_TABLE_USER_REG2_H(x)              (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG2_H(x)          ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_ADDRESS_TABLE5
 * @brief
 * @{
 **/
#define BIT_MASK_ADDR_TABLE_USER_REG3_H            ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  address table user defined address3, high 32 bit */
#define BIT_ADDR_TABLE_USER_REG3_H(x)              (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_ADDR_TABLE_USER_REG3_H(x)          ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_MACTRX_LA_DBG_CFG
 * @brief
 * @{
 **/
#define BIT_MASK_TXTRIG_TYPE                       ((u32)0x0000003F << 16)          /*!<R/W 0  iqdump la TX trigger stop condition: frame type */
#define BIT_TXTRIG_TYPE(x)                         (((u32)((x) & 0x0000003F) << 16))
#define BIT_GET_TXTRIG_TYPE(x)                     ((u32)(((x >> 16) & 0x0000003F)))
#define BIT_MASK_RXTRIG_TYPE                       ((u32)0x0000003F << 10)          /*!<R/W 0  iqdump la RX trigger stop condition: frame type */
#define BIT_RXTRIG_TYPE(x)                         (((u32)((x) & 0x0000003F) << 10))
#define BIT_GET_RXTRIG_TYPE(x)                     ((u32)(((x >> 10) & 0x0000003F)))
#define BIT_MASK_TXTRIG_STOP_SEL                   ((u32)0x0000001F << 5)          /*!<R/W 0  iqdump la TX trigger stop condition select */
#define BIT_TXTRIG_STOP_SEL(x)                     (((u32)((x) & 0x0000001F) << 5))
#define BIT_GET_TXTRIG_STOP_SEL(x)                 ((u32)(((x >> 5) & 0x0000001F)))
#define BIT_MASK_RXTRIG_STOP_SEL                   ((u32)0x0000001F << 0)          /*!<R/W 0  iqdump la RX trigger stop condition select */
#define BIT_RXTRIG_STOP_SEL(x)                     (((u32)((x) & 0x0000001F) << 0))
#define BIT_GET_RXTRIG_STOP_SEL(x)                 ((u32)(((x >> 0) & 0x0000001F)))
/** @} */

/** @defgroup REG_SUPPER_ADDRESS3_H
 * @brief
 * @{
 **/
#define BIT_MASK_SUP_ADDR3_L                       ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  supper address3 for rx filter check, valid only when 0x617[1] is vaild */
#define BIT_SUP_ADDR3_L(x)                         (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_SUP_ADDR3_L(x)                     ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_SUPPER_ADDRESS3_L
 * @brief
 * @{
 **/
#define BIT_MASK_SUP_ADDR3_H                       ((u32)0x0000FFFF << 0)          /*!<R/W 0  supper address3 for rx filter check, valid only when 0x617[1] is vaild */
#define BIT_SUP_ADDR3_H(x)                         (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_SUP_ADDR3_H(x)                     ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup REG_NAN_ADDR_FILTER
 * @brief
 * @{
 **/
#define BIT_R_RX_NAN_ADDR_FILTER_EN                ((u32)0x00000001 << 13)          /*!<R/W 0  enable of rx nan beacon address filter */
#define BIT_MASK_R_NAN_START_ADDR_OFFSET           ((u32)0x00001FFF << 0)          /*!<R/W 0x153  Start offset Location of NAN beacon report FIFO. Unit: 8bytes */
 ...
 * @{
 **/
#define BIT_MASK_R_RX_NAN_ADDR_FILTER              ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  bitmap for rx nan beacon address filter */
 ...
 * @{
 **/
#define BIT_R_WMAC_BCN_MBSSID_MASK                 ((u32)0x00000001 << 31)          /*!<R/W 0  Tim hit and tim no hit of my non-transmitted bssid frame mask */
 ...
 * @{
 **/
#define BIT_R_TIM_NO_HIT_REJECT                    ((u32)0x00000001 << 9)          /*!<R/W 0  when set, reject tim_no_hit beacon during LPSOFFLOAD */
#define BIT_R_WMAC_BCN_BMC_MASK                    ((u32)0x00000001 << 8)          /*!<R/W 0  when set, mask tim_hit and tim_no_hit interrupt due to aid0 during LPSOFFLOAD */
 ...
 * @{
 **/
#define BIT_MASK_R_CHINFO_TX_ADDR_L                ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  tx address for trigger channel info, Low 32bits */
 ...
 * @{
 **/
#define BIT_R_CHINFO_FCS                           ((u32)0x00000001 << 28)          /*!<R/W 0  when set, ignore fcs fail when trigger channel info */
#define BIT_R_CHINFO_WTM_OUT                       ((u32)0x00000001 << 27)          /*!<WA0 0  BB does’t send channel info when timeout occur */
#define BIT_R_CHINFO_TIME_OUT                      ((u32)0x00000001 << 26)          /*!<WA0 0  BB send channel info length is less than report length */
#define BIT_R_CSI_BUFF_FULL                        ((u32)0x00000001 << 25)          /*!<WA0 0  Indicate rxcsibuff full occur */
#define BIT_MASK_R_CHINFO_TIMER                    ((u32)0x00000007 << 22)          /*!<R/W 0x4  Wait timeout value, unit 4 mac clock cycles */
#define BIT_R_CHINFO_TIMER(x)                      (((u32)((x) & 0x00000007) << 22))
#define BIT_GET_R_CHINFO_TIMER(x)                  ((u32)(((x >> 22) & 0x00000007)))
#define BIT_MASK_R_CHINFO_MODE                     ((u32)0x00000003 << 17)          /*!<R/W 0  channel info mode setting. Valid when r_CHINFO_EN is 1 0: enable normal rx trigger; 1: enable ndpa trigger; note: Not support in dplus repsonse mode decided by tx descriptor. */
...
#define BIT_MASK_R_CHINFO_TX_ADDR_H                ((u32)0x0000FFFF << 0)          /*!<R/W 0  tx address for trigger channel info, High 16bits */
...
#define BIT_MASK_R_CSIBUF_ENDADDR                  ((u32)0x000000FF << 0)          /*!<R/W 0xFF  End address of rxcsibuffer, unit 8bytes. Rxcsibuffer is 2K bytes */
 ...
 * @{
 **/
#define BIT_MASK_R_BT_ZB_COEX_TABLE                ((u32)0xFFFFFFFF << 0)          /*!<R/W 0  NO zigbee,NO USE */
 ...
 * @{
 **/
#define BIT_R_RX_VENDOR_TSFT_EN                    ((u32)0x00000001 << 26)          /*!<R/W 0  when set, enable rx parsing vendor tsft element in beacon and tsft sync */
#define BIT_MASK_R_RX_VENDOR_NS_OFFSET             ((u32)0x000003FF << 16)          /*!<R/W 0  rx vendor tsft element offset,start from payload */
#define BIT_R_RX_VENDOR_NS_OFFSET(x)               (((u32)((x) & 0x000003FF) << 16))
#define BIT_GET_R_RX_VENDOR_NS_OFFSET(x)           ((u32)(((x >> 16) & 0x000003FF)))
#define BIT_R_TX_VENDOR_TSFT_EN                    ((u32)0x00000001 << 10)          /*!<R/W 0  when set, enable tx carry vendor tsft element in beacon */
#define BIT_MASK_R_TX_VENDOR_NS_OFFSET             ((u32)0x000003FF << 0)          /*!<R/W 0  tx vendor tsft element offset,start from payload */
 ...
 * @{
 **/
#define BIT_MASK_WMAC_TCR_TSFT_NS_OFS              ((u32)0x000FFFFF << 0)          /*!<R/W 0  BIT_WMAC_TCR_TSFT_OFS[9:0] is for cck stamp time offset of ns part BIT_WMAC_TCR_TSFT_OFS[19:10] is for other rate time offset of ns part */
#define BIT_WMAC_TCR_TSFT_NS_OFS(x)                (((u32)((x) & 0x000FFFFF) << 0))
#define BIT_GET_WMAC_TCR_TSFT_NS_OFS(x)            ((u32)(((x >> 0) & 0x000FFFFF)))
/** @} */
...
#define REG_TCR_TSFT_OFS_AND_UDFL_CTL                0x0630
#define REG_STMP_THSD                                0x0634
#define REG_USTIME_EDCA                              0x0638
#define REG_RESP_SIFS                                0x063C
#define REG_ACKTO                                    0x0640
#define REG_ADDRCAM_CTL                              0x0644
#define REG_TXOPOWNER_L                              0x0648
#define REG_TXOPOWNER_H                              0x064C
#define REG_RXNAV_CTRL                               0x0650
...
#define REG_ADDRESS_TABLE0                           0x0684
#define REG_ADDRESS_TABLE1                           0x0688
#define REG_ADDRESS_TABLE2                           0x068C
...
#define REG_BBPSF_CSI_CTRL                           0x06DC
...
#define REG_MASK_LA_TRX_DBG_L                        0x1638
#define REG_MASK_LA_TRX_DBG_H                        0x163C
#define REG_MACID4                                   0x1640
#define REG_MACID4_H                                 0x1644
#define REG_REF_LA_TRX_DBG_L                         0x1648
#define REG_REF_LA_TRX_DBG_H                         0x164C
...
#define REG_TRX_PKTCNT_CTRL                          0x1670
#define REG_TRX_PKTCNT_RPT                           0x1674
#define REG_CSI_RRSR                                 0x1678
#define REG_MU_BF_OPTION                             0x167C
#define REG_WMAC_MU_BF_CTL                           0x1680
#define REG_WMAC_ASSOCIATED_MU_BFMEE2_3              0x1684
#define REG_WMAC_ASSOCIATED_MU_BFMEE4_5              0x1688
#define REG_WMAC_ASSOCIATED_MU_BFMEE6_7              0x168C
...
#define REG_ADDRESS_TABLE3                           0x16B0
#define REG_ADDRESS_TABLE4                           0x16B4
#define REG_ADDRESS_TABLE5                           0x16B8
#define REG_MACTRX_LA_DBG_CFG                        0x16BC
#define REG_SUPPER_ADDRESS3_H                        0x16C0
#define REG_SUPPER_ADDRESS3_L                        0x16C4
...
#define REG_VENDOR_TSFT_CTL                          0x16F8
#define REG_WMAC_TCR_TSFT_OFS                        0x16FC
