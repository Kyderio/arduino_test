#ifndef _RL6845_REG_PAGE5_H_
#define _RL6845_REG_PAGE5_H_
 ...
 * @{
 **/
#define BIT_DIS_ZGBCCA                      ((u32)0x00000001 << 31)          /*!<R/W 0x0  Disable zigbee CCA */
...
#define BIT_MASK_RXBCN_TIME_DIFF            ((u32)0x3FFFFFFF << 0)          /*!<R   unit:1us wmac_rx_tsf - TSFT (selected by 0x1520[0]). */
#define BIT_RXBCN_TIME_DIFF(x)              (((u32)((x) & 0x3FFFFFFF) << 0))
#define BIT_GET_RXBCN_TIME_DIFF(x)          ((u32)(((x >> 0) & 0x3FFFFFFF)))
/** @} */

/** @defgroup REG_SCHEDULER_COUNTER
 * @brief
 * @{
 **/
#define BIT_MASK_SCHEDULER_COUNTER          ((u32)0x0000FFFF << 16)          /*!<R 0x0  The reported counter value corresponding to Report type selected. */
#define BIT_SCHEDULER_COUNTER(x)            (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_SCHEDULER_COUNTER(x)        ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_SCHEDULER_COUNTER_RST           ((u32)0x00000001 << 8)          /*!<R/W 0x0  write "1" to set the count to zero */
#define BIT_MASK_SCHEDULER_COUNTER_SEL      ((u32)0x000000FF << 0)          /*!<R/W 0x0  0: No count 1: If backoff finished but CCA still assert, this counter plus one. */
#define BIT_SCHEDULER_COUNTER_SEL(x)        (((u32)((x) & 0x000000FF) << 0))
#define BIT_GET_SCHEDULER_COUNTER_SEL(x)    ((u32)(((x >> 0) & 0x000000FF)))
/** @} */
...
#define BIT_CLR_RXBCN_GT_THRES_CNT          ((u32)0x00000001 << 6)          /*!<RW1C 0x0  clear the BIT_RXBCN_GT_THRES_CNT to 0 */
 ...
 * @{
 **/
#define BIT_MASK_TSFT_AT_HIOE_RFON_L        ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  when hioe_int_chn_on asserted, latch the tsft[31:0] (select port by 0x1530[0]) 0x1550[[30] BIT_EN_BCNELY_LATCH_TSFT = 1, when bcn_early_int of port0 asserted, latch TSFT */
 ...
 * @{
 **/
#define BIT_MASK_TSFT_AT_HIOE_RFON_H        ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  when hioe_int_chn_on asserted, latch the tsft[63:32] (select port by 0x1530[0]) 0x1550[[30] BIT_EN_BCNELY_LATCH_TSFT = 1, when bcn_early_int of port0 asserted, latch TSFT */
 ...
 * @{
 **/
#define BIT_MASK_TSFT_AT_BCN_CCA_UP_L       ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  when CCA asserted, latch the tsft[31:0] (select port by 0x1530[0]). updated to this register after judging that it is a beacon frame */
 ...
 * @{
 **/
#define BIT_MASK_TSFT_AT_BCN_CCA_UP_H       ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  when CCA asserted, latch the tsft[63:32] (select port by 0x1530[0]). updated to this register after judging that it is a beacon frame */
...
/** @defgroup REG_AUDIO_TSFT_CFG1
 * @brief
 * @{
 **/
#define BIT_SEL_TRIG_INC                    ((u32)0x00000001 << 13)          /*!<R/W 0x0  1: current is TX mode,select P0/P1's tsft for audio tsft sync,according P0/P1's net mode 0: current is RX mode, select P0's beacon timestamp for audio tsft sync */
#define BIT_EN_AUDIO_CNT                    ((u32)0x00000001 << 12)          /*!<R/W 0x0  1: enable counter, count according to BIT_SEL_TRIG_INC */
#define BIT_MASK_AUDIO_LAT_TSFT_PRD         ((u32)0x00000FFF << 0)          /*!<R/W 0xA  indicates the period of rxbcn(P0 rx mode) or TBTT(P1/P0 tx mode), if the counter reaches the BIT_LAT_TSFT_PRD, generate an interrupt */
#define BIT_AUDIO_LAT_TSFT_PRD(x)           (((u32)((x) & 0x00000FFF) << 0))
#define BIT_GET_AUDIO_LAT_TSFT_PRD(x)       ((u32)(((x >> 0) & 0x00000FFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_CTRL0
 * @brief
 * @{
 **/
#define BIT_MASK_WMAC_TSF_NS_LAT            ((u32)0x000003FF << 4)          /*!<R 0x0  wmac_tsf_ns latch value */
#define BIT_WMAC_TSF_NS_LAT(x)              (((u32)((x) & 0x000003FF) << 4))
#define BIT_GET_WMAC_TSF_NS_LAT(x)          ((u32)(((x >> 4) & 0x000003FF)))
#define BIT_INC_I2S_TSF_WL                  ((u32)0x00000001 << 3)          /*!<R/W 0x0  when set to 1, i2s tsf counter begin to count, when set to 0 i2s tsf counter pause */
#define BIT_CLR_I2S_TSF_WL                  ((u32)0x00000001 << 2)          /*!<RW1C 0x0  when set to 1, clear i2s tsf counter */
#define BIT_INIT_I2S_TSF_WL                 ((u32)0x00000001 << 1)          /*!<RW1C 0x0  set i2s tsf initial value when set to 1, set i2s tsf counter value to r_i2s_tsf_tmp[63:0] */
#define BIT_LAT_I2S_TSF_DRIFT_WL            ((u32)0x00000001 << 0)          /*!<RW1C 0x0  add/sub drift to i2s tsf counter when set to 1, add/sub r_i2s_tsf_drift[31:0] to i2s tsf counter */
/** @} */

/** @defgroup REG_AUDIO_TSFT_CTRL1
 * @brief
 * @{
 **/
#define BIT_MASK_I2S_TSF_DRIFT              ((u32)0xFFFFFFFF << 0)          /*!<R/W 0x0  i2s tsf counter drift value */
#define BIT_I2S_TSF_DRIFT(x)                (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_I2S_TSF_DRIFT(x)            ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_CTRL2
 * @brief
 * @{
 **/
#define BIT_MASK_I2S_TSF_TMP_L              ((u32)0xFFFFFFFF << 0)          /*!<R/W 0x0  low 32bit of i2s tsf counter initial value */
#define BIT_I2S_TSF_TMP_L(x)                (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_I2S_TSF_TMP_L(x)            ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_CTRL3
 * @brief
 * @{
 **/
#define BIT_MASK_I2S_TSF_TMP_H              ((u32)0xFFFFFFFF << 0)          /*!<R/W 0x0  high 32bit of i2s tsf counter initial value */
#define BIT_I2S_TSF_TMP_H(x)                (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_I2S_TSF_TMP_H(x)            ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_LATCH0
 * @brief
 * @{
 **/
#define BIT_MASK_WMAC_TSF_US_LAT_L          ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  low 32bit of wmac_tsf_us latch value */
#define BIT_WMAC_TSF_US_LAT_L(x)            (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_WMAC_TSF_US_LAT_L(x)        ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_LATCH1
 * @brief
 * @{
 **/
#define BIT_MASK_WMAC_TSF_US_LAT_H          ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  high 32bit of wmac_tsf_us latch value */
#define BIT_WMAC_TSF_US_LAT_H(x)            (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_WMAC_TSF_US_LAT_H(x)        ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_LATCH2
 * @brief
 * @{
 **/
#define BIT_MASK_I2S_TSF_LAT_L              ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  low 32bit of i2s_tsf latch value */
#define BIT_I2S_TSF_LAT_L(x)                (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_I2S_TSF_LAT_L(x)            ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_LATCH3
 * @brief
 * @{
 **/
#define BIT_MASK_I2S_TSF_LAT_H              ((u32)0xFFFFFFFF << 0)          /*!<R 0x0  high 32bit of i2s_tsf latch value */
#define BIT_I2S_TSF_LAT_H(x)                (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_I2S_TSF_LAT_H(x)            ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
#define REG_RXBCN_TSFT_STATISTIC                     0x154C
#define REG_PS_TIMER_D_L                             0x1550
#define REG_PS_TIMER_D_H                             0x1554
#define REG_PS_TIMER_E_L                             0x1558
#define REG_PS_TIMER_E_H                             0x155C
#define REG_TSFT_HIOE_RFON_L                         0x1560
#define REG_TSFT_HIOE_RFON_H                         0x1564
#define REG_TSFT_BCN_CCAUP_L                         0x1568
#define REG_TSFT_BCN_CCAUP_H                         0x156C
#define REG_POF_BCNELY_AGG_TBTT                      0x1570
#define REG_LPSOFFLOAD_RXBCN_DIFF_CFG0               0x1574
#define REG_TSFT_AVG_VALUE                           0x1578
#define REG_AUDIO_TSFT_CFG0                          0x157C
#define REG_AUDIO_TSFT_CFG1                          0x1580
#define REG_AUDIO_TSFT_CTRL0                         0x1584
#define REG_AUDIO_TSFT_CTRL1                         0x1588
#define REG_AUDIO_TSFT_CTRL2                         0x158C
#define REG_AUDIO_TSFT_CTRL3                         0x1590
#define REG_AUDIO_TSFT_LATCH0                        0x1594
#define REG_AUDIO_TSFT_LATCH1                        0x1598
#define REG_AUDIO_TSFT_LATCH2                        0x159C
#define REG_AUDIO_TSFT_LATCH3                        0x15A0
