#ifndef _AMEBAD2_REG_PAGE2_H_
#define _AMEBAD2_REG_PAGE2_H_
...
#define BIT_BCN_VALID                  ((u32)0x00000001 << 16)          /*!<RW1C 0  When this bit is set, the beacon packet has finished to write to txpktbuffer. Clear by SW */
 ...
 * @{
 **/
#define BIT_HI_OQT_UDN                 ((u32)0x00000001 << 17)          /*!<RW1C 0  High Priority Queue_Tx OQT underflow */
#define BIT_HI_OQT_OVF                 ((u32)0x00000001 << 16)          /*!<RW1C 0  High Priority Queue_Tx OQT overflow */
#define BIT_PAYLOAD_CHKSUM_ERR         ((u32)0x00000001 << 15)          /*!<RW1C 0  Payload checksum error */
#define BIT_PAYLOAD_UDN                ((u32)0x00000001 << 14)          /*!<RW1C 0  Payload is under the packet length of Tx descriptor. Clear by SW. */
#define BIT_PAYLOAD_OVF                ((u32)0x00000001 << 13)          /*!<RW1C 0  Payload is over the packet length of Tx descriptor. Clear by SW. */
#define BIT_DSC_CHKSUM_FAIL            ((u32)0x00000001 << 12)          /*!<RW1C 0  Tx descriptor checksum error. Clear by SW. */
#define BIT_UNKNOWN_QSEL               ((u32)0x00000001 << 11)          /*!<RW1C 0  An unknown QSEL of Tx descriptor is detected. Clear by SW. */
#define BIT_EP_QSEL_DIFF               ((u32)0x00000001 << 10)          /*!<RW1C 0  Tx Endpoint is unmatched with the QSEL of descriptor. Clear by SW. */
#define BIT_TX_OFFS_UNMATCH            ((u32)0x00000001 << 9)          /*!<RW1C 0  Tx offset is unmatched. Clear by SW. */
#define BIT_TXOQT_UDN                  ((u32)0x00000001 << 8)          /*!<RW1C 0  TXOQT Underflow. Clear by SW. */
#define BIT_TXOQT_OVF                  ((u32)0x00000001 << 7)          /*!<RW1C 0  TXOQT Overflow. Clear by SW. */
#define BIT_SFF_UDN                    ((u32)0x00000001 << 6)          /*!<RW1C 0  TXDMA Sync FIFO Underflow. Clear by SW. */
#define BIT_SFF_OVF                    ((u32)0x00000001 << 5)          /*!<RW1C 0  TXDMA Sync FIFO Overflow. Clear by SW. */
#define BIT_FREE_PG_FF                 ((u32)0x00000001 << 4)          /*!<RW1C 0  TXDMA reads NULL page. Clear by SW. */
#define BIT_PAGE_UNDER                 ((u32)0x00000001 << 3)          /*!<RW1C 0  Total pages included PTCL un-return pages are under the total reserved pages minus the page threshold. Clear by SW. */
#define BIT_PAGE_OVER                  ((u32)0x00000001 << 2)          /*!<RW1C 0  Total pages included PTCL un-return pages are over the total reserved pages. Clear by SW. */
#define BIT_PG_UDN                     ((u32)0x00000001 << 1)          /*!<RW1C 0  TXFF page underflow in TDE page controller. Clear by SW. */
#define BIT_PG_OVF                     ((u32)0x00000001 << 0)          /*!<RW1C 0  TXFF page overflow in TDE page controller.. Clear by SW. */
/** @} */
...
/** @defgroup REG_TDE_RESET_CTRL
 * @brief
 * @{
 **/
#define BIT_TDE_CTRL_RST               ((u32)0x00000001 << 2)          /*!<WA0 0  Write this bit reset FSM of tde_ctrl, ioreg_txfail */
#define BIT_TDE_PAGE_RST               ((u32)0x00000001 << 1)          /*!<WA0 0  Write this bit reset FSM of tde_page_cs, ioreg_txfail */
#define BIT_TDE_PTR_RST                ((u32)0x00000001 << 0)          /*!<WA0 0  Write this bit reset FSM of tde_ptr_cs, ioreg_txfail */
/** @} */
...
#define BIT_RXPKT_RELEASE_POLL         ((u32)0x00000001 << 16)          /*!<RW1C 0  When this bit is set, RXDMA will decrease RX PKT counter by one. Before this bit is polled, FW shall update RXFF_RD_PTR first. */
 ...
 * @{
 **/
#define BIT_C2H_PKT_OVF                ((u32)0x00000001 << 7)          /*!<RW1C 0  CH2 pkt overflow. Clr by SW */
#define BIT_AGG_CONFGI_ISSUE           ((u32)0x00000001 << 6)          /*!<RW1C 0  rxdma agg config error. Clr by SW */
#define BIT_FW_POLL_ISSUE              ((u32)0x00000001 << 5)          /*!<RW1C 0  FW Release Poll Error. Clear by SW. */
#define BIT_RX_DATA_UDN                ((u32)0x00000001 << 4)          /*!<RW1C 0  FW Release Poll Error. Clear by SW. */
#define BIT_RX_SFF_UDN                 ((u32)0x00000001 << 3)          /*!<RW1C 0  RX Sync FIFO Underflow. Clear by SW. */
#define BIT_RX_SFF_OVF                 ((u32)0x00000001 << 2)          /*!<RW1C 0  RX Sync FIFO Overflow. Clear by SW. */
#define BIT_RXPKT_OVF                  ((u32)0x00000001 << 0)          /*!<RW1C 0  When RX Packet is more than 255 packets remaining in FF. Clear by SW. */
/** @} */
...
/** @defgroup REG_CSI_RELEASE
 * @brief
 * @{
 **/
#define BIT_MASK_CSI_RADDR             ((u32)0x000000FF << 24)          /*!<R 0  read starting address of next csi segment,8byte unit */
#define BIT_CSI_RADDR(x)               (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_CSI_RADDR(x)           ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_CSI_WADDR             ((u32)0x000000FF << 16)          /*!<R 0  write starting address of next csi segment,8byte unit */
#define BIT_CSI_WADDR(x)               (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_CSI_WADDR(x)           ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_CSI_SEG_NUM           ((u32)0x000000FF << 8)          /*!<R 0  csi segment number in csibuffer */
#define BIT_CSI_SEG_NUM(x)             (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_CSI_SEG_NUM(x)         ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_R_FW_CSI_POLL              ((u32)0x00000001 << 0)          /*!<WA0 0   */
/** @} */
...
#define REG_TDE_RESET_CTRL                           0x0231
