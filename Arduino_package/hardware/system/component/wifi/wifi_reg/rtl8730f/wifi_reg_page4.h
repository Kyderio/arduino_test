#ifndef _AMEBAD2_REG_PAGE4_H_
#define _AMEBAD2_REG_PAGE4_H_
...
#define BIT_EN_H2C_PKT_DROP                            ((u32)0x00000001 << 0)          /*!<R/W 0x0  1: enable h2c pkt drop */
/** @} */
...
#define BIT_MASK_DROP_PKT_NUM                          ((u32)0x0000FFFF << 0)          /*!<RWC 0x0  Statistic the number of dropped packets */
 ...
 * @{
 **/
#define BIT_EN_HTC_RATE_ADPT                           ((u32)0x00000001 << 31)          /*!<R/W 0x1  1: if tx data rate fallback to CCK/OFDM rate, HW will remove HTC field in mac header Note: CCUT ECO, txpkt cannot set txraw = 1 */
#define BIT_MASK_DUMMY_REG_1                           ((u32)0x00001FFF << 18)          /*!<R/W 0x1FFF  dummy reg */
#define BIT_DUMMY_REG_1(x)                             (((u32)((x) & 0x00001FFF) << 18))
#define BIT_GET_DUMMY_REG_1(x)                         ((u32)(((x >> 18) & 0x00001FFF)))
...
#define BIT_MASK_DUMMY_REG_0                           ((u32)0x0000007F << 10)          /*!<R/W 0x70  dummy reg */
#define BIT_DUMMY_REG_0(x)                             (((u32)((x) & 0x0000007F) << 10))
#define BIT_GET_DUMMY_REG_0(x)                         ((u32)(((x >> 10) & 0x0000007F)))
#define BIT_EN_ONLY_TB_HTC                             ((u32)0x00000001 << 9)          /*!<R/W 0x0  1: only TB PPDU can carry HTC field */
#define BIT_DUMMY_REG                                  ((u32)0x00000001 << 8)          /*!<R/W 0x1  dummy reg */
...
#define BIT_EN_RTS_RTYCNT                              ((u32)0x00000001 << 2)          /*!<R/W 0x0  1: update rts_rtycnt to txrpt 0: update txok/txfail bitmap of ampdu to txrpt (reuse RTS_RTYCNT field) */
#define BIT_IGNORE_QOS_NULL                            ((u32)0x00000001 << 1)          /*!<R/W 0x0  1: will not TX qos null when RX basic trigger */
#define BIT_SEL_DESC_IDX                               ((u32)0x00000001 << 0)          /*!<R/W 0x0  1: select rate index from txdesc */
/** @} */
