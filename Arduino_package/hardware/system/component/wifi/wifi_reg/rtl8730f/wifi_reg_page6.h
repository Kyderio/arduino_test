#ifndef _AMEBAD2_REG_PAGE6_H_
#define _AMEBAD2_REG_PAGE6_H_
...
#define BIT_R_DIS_ABORT_TB_ELY                     ((u32)0x00000001 << 7)          /*!<R/W 0  1:will abort ptcl generating tb data when macrx_active is low 0:will abort ptcl generating tb data when new rxtrig req_in is assert */
...
#define BIT_R_TRIGGER_TSFT_EN                      ((u32)0x00000001 << 1)          /*!<R/W 0   */
...
#define BIT_ACK_CBSSID                             ((u32)0x00000001 << 12)          /*!<R/W 0  The field effects behavior of response frame,except TB. 0:Only A1 match to send response frame. 1:A1 match and satisfy BSSID condition will send response frame. */
...
#define BIT_R_RESP_DCM_DISUSE_RX                   ((u32)0x00000001 << 12)          /*!<R/W 0  0:rx dcm will response tx dcm when ctrl info is valid */
...
/** @defgroup REG_MACID_NOMATCH_CNT
 * @brief
 * @{
 **/
...
#define BIT_R_IDUNMATCH_CNT_CLR                    ((u32)0x00000001 << 7)          /*!<WA0 0  when set, generate one pulse and reset cca_idunmatch_cnt */
...
#define BIT_KEYCAM_CLEAR                           ((u32)0x00000001 << 30)          /*!<RW1C 0  Set to 1 to clear all valid bits in CAM. After reset will self clear to 0. */
#define BIT_MFBCAM_CLEAR                           ((u32)0x00000001 << 29)          /*!<RW1C 0  Write 1 to clear all MFB value in CAM to 7'h7F. After reset will self clear to 0 */
 ...
 * @{
 **/
#define BIT_RST_ALL_COUNTER                        ((u32)0x00000001 << 31)          /*!<RW1C 0  Write one to reset all counters to zero. */
...
#define BIT_R_CHINFO_WTM_OUT                       ((u32)0x00000001 << 27)          /*!<RW1C 0  BB does’t send channel info when timeout occur */
#define BIT_R_CHINFO_TIME_OUT                      ((u32)0x00000001 << 26)          /*!<RW1C 0  BB send channel info length is less than report length */
#define BIT_R_CSI_BUFF_FULL                        ((u32)0x00000001 << 25)          /*!<RW1C 0  Indicate rxcsibuff full occur */
...
#define BIT_DFS_BUFF_FULL                          ((u32)0x00000001 << 18)          /*!<RW1C 0  dfs buffer is full */
...
#define REG_MACID_NOMATCH_CNT                        0x0644
