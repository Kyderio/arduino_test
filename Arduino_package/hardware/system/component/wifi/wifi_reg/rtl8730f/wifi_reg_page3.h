#ifndef _AMEBAD2_REG_PAGE3_H_
#define _AMEBAD2_REG_PAGE3_H_
 ...
 * @{
 **/
#define BIT_MASK_VOQ_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  VO queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_VIQ_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  VI queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_BEQ_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  BE queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_BKQ_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  BK queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MGQ_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MG queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_RXNRML_HW_IDX            ((u32)0x00000FFF << 16)          /*!<R/W 0  RX queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ0_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ0 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ1_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ1 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ2_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ2 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ3_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ3 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ4_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ4 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ5_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ5 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ6_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ6 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_MASK_MQ7_HW_IDX               ((u32)0x00000FFF << 16)          /*!<R/W 0  MQ7 queue descriptor’s hardware index */
 ...
 * @{
 **/
#define BIT_SETBCNERR7                    ((u32)0x00000001 << 31)          /*!<RW1C 0  setbcnderr7, beacon queue error, mbssid=7 */
#define BIT_SETBCNERR6                    ((u32)0x00000001 << 30)          /*!<RW1C 0  setbcnderr6, beacon queue error, mbssid=6 */
#define BIT_SETBCNERR5                    ((u32)0x00000001 << 29)          /*!<RW1C 0  setbcnderr5, beacon queue error, mbssid=5 */
#define BIT_SETBCNERR4                    ((u32)0x00000001 << 28)          /*!<RW1C 0  setbcnderr4, beacon queue error, mbssid=4 */
#define BIT_SETBCNERR3                    ((u32)0x00000001 << 27)          /*!<RW1C 0  setbcnderr3, beacon queue error, mbssid=3 */
#define BIT_SETBCNERR2                    ((u32)0x00000001 << 26)          /*!<RW1C 0  setbcnderr2, beacon queue error, mbssid=2 */
#define BIT_SETBCNERR1                    ((u32)0x00000001 << 25)          /*!<RW1C 0  setbcnderr1, beacon queue error, mbssid=1 */
#define BIT_SETBCNERR0                    ((u32)0x00000001 << 24)          /*!<RW1C 0  setbcnderr0, beacon queue error, mbssid=0 */
#define BIT_SETBCNOK7                     ((u32)0x00000001 << 23)          /*!<RW1C 0  setbcndok7, beacon queue ok, mbssid=7 */
#define BIT_SETBCNOK6                     ((u32)0x00000001 << 22)          /*!<RW1C 0  setbcndok6, beacon queue ok, mbssid=6 */
#define BIT_SETBCNOK5                     ((u32)0x00000001 << 21)          /*!<RW1C 0  setbcndok5, beacon queue ok, mbssid=5 */
#define BIT_SETBCNOK4                     ((u32)0x00000001 << 20)          /*!<RW1C 0  setbcndok4, beacon queue ok, mbssid=4 */
#define BIT_SETBCNOK3                     ((u32)0x00000001 << 19)          /*!<RW1C 0  setbcndok3, beacon queue ok, mbssid=3 */
#define BIT_SETBCNOK2                     ((u32)0x00000001 << 18)          /*!<RW1C 0  setbcndok2, beacon queue ok, mbssid=2 */
#define BIT_SETBCNOK1                     ((u32)0x00000001 << 17)          /*!<RW1C 0  setbcndok1, beacon queue ok, mbssid=1 */
#define BIT_SETBCNOK0                     ((u32)0x00000001 << 16)          /*!<RW1C 0  setbcndok0, beacon queue ok, mbssid=0 */
#define BIT_SETHIGHDOK                    ((u32)0x00000001 << 8)          /*!<RW1C 0  sethighdok, high queue ok */
#define BIT_SETH2CDOK                     ((u32)0x00000001 << 7)          /*!<RW1C 0  seth2cdok, h2c queue ok */
#define BIT_SETMGDOK                      ((u32)0x00000001 << 6)          /*!<RW1C 0  setmgdok, manage queue ok */
#define BIT_SETBKDOK                      ((u32)0x00000001 << 5)          /*!<RW1C 0  setbkdok, bk queue ok */
#define BIT_SETBEDOK                      ((u32)0x00000001 << 4)          /*!<RW1C 0  setbedok, be queue ok */
#define BIT_SETVIDOK                      ((u32)0x00000001 << 3)          /*!<RW1C 0  setvidok, vi queue ok */
#define BIT_SETVODOK                      ((u32)0x00000001 << 2)          /*!<RW1C 0  setvodok, vo queue ok */
#define BIT_SET_RDY                       ((u32)0x00000001 << 1)          /*!<RW1C 0  set_rdu, rx descriptor unavailable */
#define BIT_SETRXOK                       ((u32)0x00000001 << 0)          /*!<RW1C 0  setrxok, rx dma ok */
/** @} */
 ...
 * @{
 **/
#define BIT_SETBCNERR7_EN                 ((u32)0x00000001 << 31)          /*!<R/W 0  setbcnderr7, beacon queue error, mbssid=7 */
#define BIT_SETBCNERR6_EN                 ((u32)0x00000001 << 30)          /*!<R/W 0  setbcnderr6, beacon queue error, mbssid=6 */
#define BIT_SETBCNERR5_EN                 ((u32)0x00000001 << 29)          /*!<R/W 0  setbcnderr5, beacon queue error, mbssid=5 */
#define BIT_SETBCNERR4_EN                 ((u32)0x00000001 << 28)          /*!<R/W 0  setbcnderr4, beacon queue error, mbssid=4 */
#define BIT_SETBCNERR3_EN                 ((u32)0x00000001 << 27)          /*!<R/W 0  setbcnderr3, beacon queue error, mbssid=3 */
#define BIT_SETBCNERR2_EN                 ((u32)0x00000001 << 26)          /*!<R/W 0  setbcnderr2, beacon queue error, mbssid=2 */
#define BIT_SETBCNERR1_EN                 ((u32)0x00000001 << 25)          /*!<R/W 0  setbcnderr1, beacon queue error, mbssid=1 */
#define BIT_SETBCNERR0_EN                 ((u32)0x00000001 << 24)          /*!<R/W 0  setbcnderr0, beacon queue error, mbssid=0 */
#define BIT_SETBCNOK7_EN                  ((u32)0x00000001 << 23)          /*!<R/W 0  setbcndok7, beacon queue ok, mbssid=7 */
#define BIT_SETBCNOK6_EN                  ((u32)0x00000001 << 22)          /*!<R/W 0  setbcndok6, beacon queue ok, mbssid=6 */
#define BIT_SETBCNOK5_EN                  ((u32)0x00000001 << 21)          /*!<R/W 0  setbcndok5, beacon queue ok, mbssid=5 */
#define BIT_SETBCNOK4_EN                  ((u32)0x00000001 << 20)          /*!<R/W 0  setbcndok4, beacon queue ok, mbssid=4 */
#define BIT_SETBCNOK3_EN                  ((u32)0x00000001 << 19)          /*!<R/W 0  setbcndok3, beacon queue ok, mbssid=3 */
#define BIT_SETBCNOK2_EN                  ((u32)0x00000001 << 18)          /*!<R/W 0  setbcndok2, beacon queue ok, mbssid=2 */
#define BIT_SETBCNOK1_EN                  ((u32)0x00000001 << 17)          /*!<R/W 0  setbcndok1, beacon queue ok, mbssid=1 */
#define BIT_SETBCNOK0_EN                  ((u32)0x00000001 << 16)          /*!<R/W 0  setbcndok0, beacon queue ok, mbssid=0 */
#define BIT_SETHIGHDOK_EN                 ((u32)0x00000001 << 8)          /*!<R/W 0  sethighdok, high queue ok */
#define BIT_SETH2CDOK_EN                  ((u32)0x00000001 << 7)          /*!<R/W 0  seth2cdok, h2c queue ok */
#define BIT_SETMGDOK_EN                   ((u32)0x00000001 << 6)          /*!<R/W 0  setmgdok, manage queue ok */
#define BIT_SETBKDOK_EN                   ((u32)0x00000001 << 5)          /*!<R/W 0  setbkdok, bk queue ok */
#define BIT_SETBEDOK_EN                   ((u32)0x00000001 << 4)          /*!<R/W 0  setbedok, be queue ok */
#define BIT_SETVIDOK_EN                   ((u32)0x00000001 << 3)          /*!<R/W 0  setvidok, vi queue ok */
#define BIT_SETVODOK_EN                   ((u32)0x00000001 << 2)          /*!<R/W 0  setvodok, vo queue ok */
#define BIT_SET_RDY_EN                    ((u32)0x00000001 << 1)          /*!<R/W 0  set_rdu, rx descriptor unavailable */
#define BIT_SETRXOK_EN                    ((u32)0x00000001 << 0)          /*!<R/W 0  setrxok, rx dma ok */
/** @} */
