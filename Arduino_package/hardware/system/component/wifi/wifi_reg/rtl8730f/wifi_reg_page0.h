...
#define BIT_WL_SAVE_EN                       ((u32)0x00000001 << 2)          /*!<R/W 1  1 to 0:gen req to restore register in power on flow 1:gen req to backup register in power on flow */
#define BIT_WL_ACTIVE_PWM_SEL                ((u32)0x00000001 << 1)          /*!<R/W 1  ECO ADD. 1: wl request SWR PWM mode when quit LPS 0：keep the same swr mode as lps when quit lps */
 ...
 * @{
 **/
#define BIT_HIOE_BYPASS_CHN_BCN_MODE         ((u32)0x00000001 << 4)          /*!<R/W 1  BYPASS HW trig hioe to do switch bcn mode to normal rx(enable ofdm) flow */
#define BIT_HIOE_BYPASS_CHN_OFF              ((u32)0x00000001 << 3)          /*!<R/W 1  BYPASS HW trig hioe to do rf off flow */
#define BIT_HIOE_BYPASS_CHN_ON               ((u32)0x00000001 << 2)          /*!<R/W 1  BYPASS HW trig hioe to do rf on flow */
#define BIT_HW_AUTO_ENTER_LPS_EN             ((u32)0x00000001 << 1)          /*!<R/W 0  enable HW enter lps after hioe_off_int rise when BIT_FS_RXBCN_LPS_EN=1 */
#define BIT_RXBCN_LPSOFFLOAD_EN              ((u32)0x00000001 << 0)          /*!<R/W 0  enable lps offload flow when rxbcn frame in port0 acting as a non-AP STA. */
/** @} */
...
#define BIT_HS_TXRPT_INT_EN                  ((u32)0x00000001 << 27)          /*!<R/W 0  TX report interrupt */
#define BIT_HS_TXCCX_INT_EN                  ((u32)0x00000001 << 26)          /*!<R/W 0  CCX PKT TX Report Interrupt */
...
#define BIT_HS_TXRPT_INT                     ((u32)0x00000001 << 27)          /*!<RW1C 0  TX report interrupt */
#define BIT_HS_TXCCX_INT                     ((u32)0x00000001 << 26)          /*!<RW1C 0  CCX PKT TX Report Interrupt */
...
#define BIT_HS_P2P_RFON2_INT_EN              ((u32)0x00000001 << 30)          /*!<R/W 0  P2P NoA RF on time indication 2 interrupt */
#define BIT_HS_P2P_RFON1_INT_EN              ((u32)0x00000001 << 29)          /*!<R/W 0  P2P NoA RF on time indication 1 interrupt */
#define BIT_HS_P2P_RFON0_INT_EN              ((u32)0x00000001 << 28)          /*!<R/W 0  P2P NoA RF on time indication 0 interrupt */
#define BIT_HS_P2P_RFOFF2_INT_EN             ((u32)0x00000001 << 27)          /*!<R/W 0  P2P NoA RF off time indication 2 interrupt */
#define BIT_HS_P2P_RFOFF1_INT_EN             ((u32)0x00000001 << 26)          /*!<R/W 0  P2P NoA RF off time indication 1 interrupt */
...
#define BIT_HS_P2P_RFOFF0_INT_EN             ((u32)0x00000001 << 10)          /*!<R/W 0  P2P NoA RF off time indication 0 interrupt */
...
#define BIT_HS_P2P_RFON2_INT                 ((u32)0x00000001 << 30)          /*!<RW1C 0  P2P NoA RF on time indication 2 interrupt */
#define BIT_HS_P2P_RFON1_INT                 ((u32)0x00000001 << 29)          /*!<RW1C 0  P2P NoA RF on time indication 1 interrupt */
#define BIT_HS_P2P_RFON0_INT                 ((u32)0x00000001 << 28)          /*!<RW1C 0  P2P NoA RF on time indication 0 interrupt */
#define BIT_HS_P2P_RFOFF2_INT                ((u32)0x00000001 << 27)          /*!<RW1C 0  P2P NoA RF off time indication 2 interrupt */
#define BIT_HS_P2P_RFOFF1_INT                ((u32)0x00000001 << 26)          /*!<RW1C 0  P2P NoA RF off time indication 1 interrupt */
...
#define BIT_HS_P2P_RFOFF0_INT                ((u32)0x00000001 << 10)          /*!<RW1C 0  P2P NoA RF off time indication 0 interrupt */
...
#define REG_LPS_OFFLOAD_CTRL                         0x002C
...
#define REG_FW_DBG0                                  0x0050
#define REG_FW_DBG1                                  0x0054
#define REG_FW_DBG2                                  0x0058
#define REG_FW_DBG3                                  0x005C
#define REG_FW_DBG4                                  0x0060
#define REG_FW_DBG5                                  0x0064
#define REG_FW_DBG6                                  0x0068
