#ifndef _AMEBAD2_REG_PAGE7_H_
#define _AMEBAD2_REG_PAGE7_H_
...
#define BIT_GNT_BT_RX_SW                          ((u32)0x00000001 << 30)          /*!<R/W 0  SW control GNT_BT_RX */
#define BIT_GNT_BT_RX_SW_EN                       ((u32)0x00000001 << 29)          /*!<R/W 0  SW control GNT_BT_RX enable */
...
#define BIT_GNT_BT_TX_SW                          ((u32)0x00000001 << 27)          /*!<R/W 0  SW control GNT_BT_TX */
#define BIT_GNT_BT_TX_SW_EN                       ((u32)0x00000001 << 26)          /*!<R/W 0  SW control GNT_BT_TX enable */
#define BIT_GRANTALL_WLMASK                       ((u32)0x00000001 << 25)          /*!<R/W 0  0: WLAN_ACT to BT is always 0 */
...
#define BIT_INNER_COMBO_MODE                      ((u32)0x00000001 << 9)          /*!<R/W 0  1: RTK combo IP parser zb_request or bt_request,zb_request will use wl-zb coex table co-work with BIT_BYPASS_COMBO_ZB_REQ = 0 */
#define BIT_BYPASS_COMBO_ZB_REQ                   ((u32)0x00000001 << 8)          /*!<R/W 0  1: ignore zb flag from RTK combo IP 0: distinguish zb_request and bt_request from RTK combo IP */
 ...
 * @{
 **/
#define BIT_MASK_PTA_GNT_INFO                     ((u32)0x000001FF << 23)          /*!<R 0  [0]: gnt_wl [1]: gnt_bt_bb [2]: gnt_bt_rfc [3]: gnt_zb_bb [4]: gnt_zb_rfc [5]: gnt_wl_tx [6]: gnt_wl_rx [7]: gnt_bt_tx [8]: gnt_bt_rx */
#define BIT_PTA_GNT_INFO(x)                       (((u32)((x) & 0x000001FF) << 23))
#define BIT_GET_PTA_GNT_INFO(x)                   ((u32)(((x >> 23) & 0x000001FF)))
#define BIT_GNT_WL_RX_SW                          ((u32)0x00000001 << 21)          /*!<R/W 0  SW control GNT_WL_RX */
#define BIT_GNT_WL_RX_SW_EN                       ((u32)0x00000001 << 20)          /*!<R/W 0  SW control GNT_WL_RX enable */
#define BIT_GNT_WL_TX_SW                          ((u32)0x00000001 << 19)          /*!<R/W 0  SW control GNT_WL_TX */
#define BIT_GNT_WL_TX_SW_EN                       ((u32)0x00000001 << 18)          /*!<R/W 0  SW control GNT_WL_TX enable */
#define BIT_GNT_WL_SW                             ((u32)0x00000001 << 17)          /*!<R/W 0  SW control GNT_WL */
#define BIT_GNT_WL_SW_EN                          ((u32)0x00000001 << 16)          /*!<R/W 0  SW control GNT_WL enable */
 ...
 * @{
 **/
#define BIT_R_RESP_ACK_NON_EOF                    ((u32)0x00000001 << 22)          /*!<R/W 0  Response ack when rx trig+mgnt ampdu eof=0 */
#define BIT_R_WMAC_MORE_DATA                      ((u32)0x00000001 << 21)          /*!<R/W 0  More data field of frame control for ACK/BA/MSTABA */
