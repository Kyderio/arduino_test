#ifndef _AMEBAD2_REG_PAGE5_H_
#define _AMEBAD2_REG_PAGE5_H_
...
#define BIT_EN_PAUSE_CLR_CPUMGQ                  ((u32)0x00000001 << 16)          /*!<R/W 0x1  1:clear cpumgq cmd when the next cpumgq is polling */
