#ifndef _AMEBAD2_REG_PAGE17_H_
#define _AMEBAD2_REG_PAGE17_H_
...
#define BIT_MASK_R_STS_CHKRX_COND           ((u32)0x0000000F << 19)          /*!<R/W 0  check macrx condition when receiving ppdu status 0：rxpkt receive to host 1: rxpkt plcp check ok 2: rxpkt address1 and crc32 match 3：rxpkt is ndp 4：rxpkt crc32 match F：do not check rxpkt, receive all physts otherwise, reservd */
...
#define BIT_SW_TXDFIFO_RDY                  ((u32)0x00000001 << 11)          /*!<R/W/ES 0  sw read txd fifo ready */
 ...
 * @{
 **/
#define BIT_R_UPH_CAS_QOS_SEL               ((u32)0x00000001 << 31)          /*!<R/W 0  UPH and CAS HTC control field enable */
 ...
 * @{
 */
#define BIT_TB_SIFS_USE_NORMAL ((u16)0x00000001 << 12)          /*!<R/W 0x0  1:choose 0x179c sifs when rx trigger 0:choose 0x17AA[11:0] sifs when rx trigger*/
