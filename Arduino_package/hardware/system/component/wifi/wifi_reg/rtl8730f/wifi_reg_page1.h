 ...
 * @brief Status register-FIFO status
 * @{
 **/
...
#define BIT_MASK_RXBCN_TIMEUP_THRES                  ((u32)0x000FFFFF << 0)          /*!<R/W 0x1F40  threshold for rxbcn timeout,UNIT:us default：8ms */
#define BIT_RXBCN_TIMEUP_THRES(x)                    (((u32)((x) & 0x000FFFFF) << 0))
#define BIT_GET_RXBCN_TIMEUP_THRES(x)                ((u32)(((x >> 0) & 0x000FFFFF)))
/** @} */
 ...
 * @{
 **/
#define BIT_HIOE_ACTIVE_CHN_BCN_MODE                 ((u32)0x00000001 << 31)          /*!<R 0  indicate HIOE CHN_bcn_mode is active */
#define BIT_HIOE_RESTORE_REQ_CHN_BCN_MODE            ((u32)0x00000001 << 25)          /*!<R 0  BB/RF enable OFDM mode request, clear by hw */
#define BIT_MASK_HIOE_END_ADDR_CHN_BCN_MODE          ((u32)0x00000FFF << 12)          /*!<R/W 0  HIOE command end address in txpktbuffer, unit:8byte */
...
#define BIT_MASK_HIOE_STR_ADDR_CHN_BCN_MODE          ((u32)0x00000FFF << 0)          /*!<R/W 0  HIOE command start address in txpktbuffer, unit:8byte */
...
#define BIT_FS_TBTT_AGG_INT_P0_EN                    ((u32)0x00000001 << 11)          /*!<R/W 0  This interrupt from the multiplt TBTT times for P0. */
#define BIT_FS_P0_TBTT_INT_EN                        ((u32)0x00000001 << 10)          /*!<R/W 0  This interrupt from the exact TBTT time for P0 MBSSID0. */
...
#define BIT_FS_TBTT_AGG_INT_P0                       ((u32)0x00000001 << 11)          /*!<RW1C 0  This interrupt from the multiplt TBTT times for P0. */
#define BIT_FS_P0_TBTT_INT                           ((u32)0x00000001 << 10)          /*!<RW1C 0  This interrupt from the exact TBTT time for P0 MBSSID0. */
...
#define BIT_FS_RX_MORE_TF0_INT_EN                    ((u32)0x00000001 << 1)          /*!<R/W 0  interrupt source from trigger frame with more TF field = 0 not addressed to us */
#define BIT_FS_RX_MORE_TF1_INT_EN                    ((u32)0x00000001 << 0)          /*!<R/W 0  Interrupt source from receiving trigger frame with more TF field = 1 not addressed to us */
/** @} */
...
#define BIT_FS_RX_MORE_TF0_INT                       ((u32)0x00000001 << 1)          /*!<RW1C 0  interrupt source from trigger frame with more TF field = 0 not addressed to us */
#define BIT_FS_RX_MORE_TF1_INT                       ((u32)0x00000001 << 0)          /*!<RW1C 0  Interrupt source from receiving trigger frame with more TF field = 1 not addressed to us */
/** @} */
...
#define BIT_FS_HIOE_CHN_BCN_MODE_INT_EN              ((u32)0x00000001 << 10)          /*!<R/W 0  hioe_chn_bcn_mode done interrupt */
/** @} */
...
#define BIT_FS_HIOE_CHN_BCN_MODE_INT                 ((u32)0x00000001 << 10)          /*!<RW1C 0  hioe_chn_bcn_mode done interrupt */
/** @} */
...
#define REG_HW_IOE_CR_CHN_BCN_MODE                   0x0190
