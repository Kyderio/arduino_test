#ifndef _RL7005_REG_PAGE7_H_
#define _RL7005_REG_PAGE7_H_
...
#define BIT_TIM_HAS_AID         ((u32)0x00000001 << 15)           /*!< R 0x0  indicate BC/MC packets are buffered at the AP or transimited BSSID*/
#define BIT_TIM_HAS_MY_BSSID    ((u32)0x00000001 << 14)           /*!< R 0x0  indicate BC/MC packets are buffered at nontransmitted BSSID, sw need to check corresponding dtim count field in multiple bssid index field*/
#define BIT_TIM_HAS_MYAID       ((u32)0x00000001 << 13)           /*!< R 0x0  my aid in the virtual bitmap is set*/
#define BIT_TIM_VALID           ((u32)0x00000001 << 12)           /*!< R 0x0  when set to 1 , indicate tim report valid*/
...
/** @defgroup REG_ASSOCIATED_BFMEE_SEL
  ...
  * @{
  */
#define BIT_BFMEE1_EN         ((u32)0x00000001 << 25)           /*!< R/W 0x0  If enabled, NDPA would be sent to beamformee1.*/
#define BIT_MASK_BFMEE1_AID   ((u32)0x000001FF << 16)           /*!< R/W 0x0  P_AID of the target beamformee1*/
#define BIT_BFMEE1_AID(x)     (((u32)((x) & 0x000001FF) << 16))
#define BIT_GET_BFMEE1_AID(x) ((u32)(((x >> 16) & 0x000001FF)))
#define BIT_BFMEE0_EN         ((u32)0x00000001 << 9)            /*!< R/W 0x0  If enabled, NDPA would be sent to beamformee0.*/
#define BIT_MASK_BFMEE0_AID   ((u32)0x000001FF << 0)            /*!< R/W 0x0  P_AID of the target beamformee0*/
...
#define BIT_R_WMAC_CHK_RPTPOLL_A2_DIS   ((u32)0x00000001 << 23)           /*!< R/W 0x0  1: For any A1-matched BF Rpt Poll, send back VHT-CB 0: If A1-matched BF Rpt Poll's A2 fails to match the previous receiving NDPA's A2, do not send VHT-CB*/
#define BIT_R_WMAC_CHK_UCNDPA_A2_DIS    ((u32)0x00000001 << 22)           /*!< R/W 0x0  0: If A1-matched NDPA's A2 fails to match 0x6E4 or 0x6EC, use default csi parameter 1: For any receiving A1-matched NDPA, use 0x6F4[11:0] as csi parameter*/
#define BIT_MASK_R_WMAC_HT_CATEGORY     ((u32)0x0000003F << 16)           /*!< R/W 0x0  csi report offset for ht mode*/
#define BIT_R_WMAC_HT_CATEGORY(x)       (((u32)((x) & 0x0000003F) << 16))
#define BIT_GET_R_WMAC_HT_CATEGORY(x)   ((u32)(((x >> 16) & 0x0000003F)))
#define BIT_R_WMAC_OFFSET_RPTPOLL_EN    ((u32)0x00000001 << 15)           /*!< R/W 0x0  1: If previous Tx pkt is BF Rpt Poll or VHT NDP, use vht csi start offset; otherwise ht csi start offset 0: If previous Tx pkt is vht rate, use vht csi start offset; otherwise ht csi start offset*/
#define BIT_R_WMAC_CSI_CHKSUM_DIS       ((u32)0x00000001 << 14)           /*!< R/W 0x0  1:Disable check 16bit checksum value of csi report from BB   0:Enable check 16bit checksum value of csi report from BB*/
...
#define BIT_R_WMAC_USE_NSTS             ((u32)0x00000001 << 7)            /*!< R/W 0x1  1: use Nsts as Nr, 0: use register value as Nr*/
...
/** @defgroup REG_BEAMFORM_STATUS
  ...
  * @{
  */
#define BIT_WRITE_ENABLE                 ((u32)0x00000001 << 31)          /*!< R 0x0  Access flag. '0' for read. '1' for write, 0x72C[15:0] must be sett before this bit is set*/
...
/** @defgroup REG_NSARP_CFG
  ...
  * @{
  */
#define BIT_MASK_WMAC_CSI_TIMER   ((u32)0x000000FF << 16)           /*!< R/W 0x42  A timeout value for csi_wait_poll. (unit: 512us)*/
#define BIT_WMAC_CSI_TIMER(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_WMAC_CSI_TIMER(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_NSARP_RESPEN          ((u32)0x00000001 << 15)           /*!< R/W 0x0  NAARP parser enable*/
#define BIT_NSARP_PARP            ((u32)0x00000001 << 9)            /*!< R/W 0x0  when set to 1, reject ARP*/
#define BIT_NSARP_RIPV6           ((u32)0x00000001 << 8)            /*!< R/W 0x0  when set to 1, reject IPV6*/
#define BIT_MASK_NSARP_MODEN      ((u32)0x00000003 << 6)            /*!< R/W 0x0  r_WMAC_NSARP_MODEN[0]: when set to 1, enable arp request; r_WMAC_NSARP_MODEN[1]: when set to 1, enable ipv6 request;*/
#define BIT_NSARP_MODEN(x)        (((u32)((x) & 0x00000003) << 6))
#define BIT_GET_NSARP_MODEN(x)    ((u32)(((x >> 6) & 0x00000003)))
#define BIT_MASK_NSARP_RSPFTP     ((u32)0x00000003 << 4)            /*!< R/W 0x0  used to select Response_type and TID*/
#define BIT_NSARP_RSPFTP(x)       (((u32)((x) & 0x00000003) << 4))
#define BIT_GET_NSARP_RSPFTP(x)   ((u32)(((x >> 4) & 0x00000003)))
#define BIT_MASK_NSARP_RSPSEC     ((u32)0x0000000F << 0)            /*!< R/W 0x0  select response packet security type*/
...
/** @defgroup REG_BEAMFORMING_INFO_NSARP
  ...
  * @{
  */
#define BIT_MASK_UPD_BFMEE_USERID   ((u32)0x00000007 << 13)           /*!< R/W 0x0  Select BFMEE User ID*/
#define BIT_UPD_BFMEE_USERID(x)     (((u32)((x) & 0x00000007) << 13))
#define BIT_GET_UPD_BFMEE_USERID(x) ((u32)(((x >> 13) & 0x00000007)))
#define BIT_UPD_BFMEE_FBTP          ((u32)0x00000001 << 12)           /*!< R/W 0x0  Feedback Type(B11) of VHT MIMO Control field, HT is no used*/
#define BIT_MASK_UPD_BFMEE_BW       ((u32)0x00000003 << 10)           /*!< R/W 0x0  Channel Width of VHT MIMO control field (B7-6) and (B4) when HT mode*/
#define BIT_UPD_BFMEE_BW(x)         (((u32)((x) & 0x00000003) << 10))
#define BIT_GET_UPD_BFMEE_BW(x)     ((u32)(((x >> 10) & 0x00000003)))
#define BIT_MASK_UPD_BFMEE_CB       ((u32)0x00000003 << 8)            /*!< R/W 0x0  Codebook Information of MIMO control field [8] for VHT (B10) and (B10-9) when HT mode*/
#define BIT_UPD_BFMEE_CB(x)         (((u32)((x) & 0x00000003) << 8))
#define BIT_GET_UPD_BFMEE_CB(x)     ((u32)(((x >> 8) & 0x00000003)))
#define BIT_MASK_UPD_BFMEE_NG       ((u32)0x00000003 << 6)            /*!< R/W 0x0  Grouping of MIMO control field [7:6] for VHT (B9-8) and (B6-5) when HT mode*/
#define BIT_UPD_BFMEE_NG(x)         (((u32)((x) & 0x00000003) << 6))
#define BIT_GET_UPD_BFMEE_NG(x)     ((u32)(((x >> 6) & 0x00000003)))
#define BIT_MASK_UPD_BFMEE_NR       ((u32)0x00000007 << 3)            /*!< R/W 0x0  Nr Index of MIMO control field [5:3] for VHT (B5-3) ,[4:3] for HT mode (B3-2)*/
#define BIT_UPD_BFMEE_NR(x)         (((u32)((x) & 0x00000007) << 3))
#define BIT_GET_UPD_BFMEE_NR(x)     ((u32)(((x >> 3) & 0x00000007)))
#define BIT_MASK_UPD_BFMEE_NC       ((u32)0x00000007 << 0)            /*!< R/W 0x0  Nc Index of MIMO control field [2:0] for VHT (B2-0) , [1:0] for HT mode (B1-0)*/
...
/** @defgroup REG_IPV6_0
  ...
  * @{
  */
#define BIT_MASK_IPV6_MYIPAD_0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_IPV6_1
  ...
  * @{
  */
#define BIT_MASK_IPV6_MYIPAD_1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_IPV6_2
  ...
  * @{
  */
#define BIT_MASK_IPV6_MYIPAD_2   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_IPV6_3
  ...
  * @{
  */
#define BIT_MASK_IPV6_MYIPAD_3   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_ZB_BREAK_TABLE
  ...
  * @{
  */
#define BIT_MASK_ZB_BREAK_TABLE_2   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  Table used to break ZB activity, when new WLAN request is coming and ZB is on transmitting or receiving*/
#define BIT_ZB_BREAK_TABLE_2(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_ZB_BREAK_TABLE_2(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_ZB_BREAK_TABLE_1   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  Table used to break WLAN activity, when new ZB request is coming and WLAN is on transmitting or receiving*/
...
/** @defgroup REG_WMAC_RTX_SWAES_RD_1
  ...
  * @{
  */
#define BIT_MASK_WMAC_SWAES_RD_0   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  */
...
/** @defgroup REG_WMAC_RTX_SWAES_RD_2
  ...
  * @{
  */
#define BIT_MASK_WMAC_SWAES_RD_1   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  */
...
/** @defgroup REG_WMAC_RTX_SWAES_RD_3
  ...
  * @{
  */
#define BIT_MASK_WMAC_SWAES_RD_2   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  */
...
#define BIT_GNT_BT_RX_SW        ((u32)0x00000001 << 30)           /*!< R/W 0x0  SW control GNT_BT_RX*/
#define BIT_GNT_BT_RX_SW_EN     ((u32)0x00000001 << 29)           /*!< R/W 0x0  SW control GNT_BT_RX enable*/
...
#define BIT_GNT_BT_TX_SW        ((u32)0x00000001 << 27)           /*!< R/W 0x0  SW control GNT_BT_TX*/
#define BIT_GNT_BT_TX_SW_EN     ((u32)0x00000001 << 26)           /*!< R/W 0x0  SW control GNT_BT_TX enable*/
#define BIT_GRANTALL_WLMASK     ((u32)0x00000001 << 25)           /*!< R/W 0x0  0: WLAN_ACT to BT is always 0*/
...
#define BIT_INNER_COMBO_MODE    ((u32)0x00000001 << 9)            /*!< R/W 0x0  1: RTK combo IP parser zb_request or bt_request,zb_request will use wl-zb coex table co-work with BIT_BYPASS_COMBO_ZB_REQ = 0*/
#define BIT_BYPASS_COMBO_ZB_REQ ((u32)0x00000001 << 8)            /*!< R/W 0x0  1: ignore zb flag from RTK combo IP 0: distinguish zb_request and bt_request from RTK combo IP*/
#define BIT_SWAES_REQ           ((u32)0x00000001 << 7)            /*!< R 0x0  software aes engine request polling*/
#define BIT_R_WMAC_SWAES_WE     ((u32)0x00000001 << 3)            /*!< R/W 0x0  Write enable of register ro_WMAC_SWAES_RD*/
#define BIT_R_WMAC_SWAES_SEL    ((u32)0x00000001 << 0)            /*!< R/W 0x0  When R_WMAC_SWAES_SEL =1,the content of register 0750-075F used to be aes engine data in or data out . When R_WMAC_SWAES_SEL =0, the content of register 0754-075F used to be aes engine security key*/
/** @} */
...
#define BIT_DIS_BT_DONT_CARE    ((u32)0x00000001 << 16)          /*!< R/W 0x0  1: break table of BT & WL can be all "1" 0: break table of BT & WL cannot be all "1"*/
#define BIT_DIS_ZB_DONT_CARE    ((u32)0x00000001 << 15)          /*!< R/W 0x0  1: break table of ZB & WL can be all "1" 0: break table of ZB & WL cannot be all "1"*/
#define BIT_BTG_LNA1_GAIN_SEL   ((u32)0x00000001 << 14)          /*!< R/W 0x0  control by Driver 0: mask for WL 1: original BTG*/
#define BIT_R_GNT_BT_RFC_SW     ((u32)0x00000001 << 12)          /*!< R/W 0x1  SW control BT RF*/
#define BIT_R_GNT_BT_RFC_SW_EN  ((u32)0x00000001 << 11)          /*!< R/W 0x1  SW control BT RF enable*/
#define BIT_R_GNT_BT_BB_SW      ((u32)0x00000001 << 10)          /*!< R/W 0x1  SW control BT baseband*/
#define BIT_R_GNT_BT_BB_SW_EN   ((u32)0x00000001 << 9)           /*!< R/W 0x1  SW control BT baseband enable*/
...
/** @defgroup REG_WLAN_ACT_MASK_CTRL
  ...
  * @{
  */
#define BIT_MASK_PTA_GNT_INFO      ((u32)0x000001FF << 23)           /*!< R 0x0  [0]: gnt_wl [1]: gnt_bt_bb [2]: gnt_bt_rfc [3]: gnt_zb_bb [4]: gnt_zb_rfc [5]: gnt_wl_tx [6]: gnt_wl_rx [7]: gnt_bt_tx [8]: gnt_bt_rx*/
#define BIT_PTA_GNT_INFO(x)        (((u32)((x) & 0x000001FF) << 23))
#define BIT_GET_PTA_GNT_INFO(x)    ((u32)(((x >> 23) & 0x000001FF)))
#define BIT_GNT_WL_RX_SW           ((u32)0x00000001 << 21)           /*!< R/W 0x0  SW control GNT_WL_RX*/
#define BIT_GNT_WL_RX_SW_EN        ((u32)0x00000001 << 20)           /*!< R/W 0x0  SW control GNT_WL_RX enable*/
#define BIT_GNT_WL_TX_SW           ((u32)0x00000001 << 19)           /*!< R/W 0x0  SW control GNT_WL_TX*/
#define BIT_GNT_WL_TX_SW_EN        ((u32)0x00000001 << 18)           /*!< R/W 0x0  SW control GNT_WL_TX enable*/
#define BIT_GNT_WL_SW              ((u32)0x00000001 << 17)           /*!< R/W 0x0  SW control GNT_WL*/
#define BIT_GNT_WL_SW_EN           ((u32)0x00000001 << 16)           /*!< R/W 0x0  SW control GNT_WL enable*/
...
/** @defgroup REG_WLAN_ACT_MASK_CTRL_1
  ...
  * @{
  */
#define BIT_MASK_BT_STAT_DELAY        ((u32)0x0000000F << 28)           /*!< R/W 0x0  For CSR, BT_PRI and BT_STAT go high form low at the same time. Thus, BT_STAT  need delay BT_STAT_DELAY time to trigger hardware. Unit: 1us*/
#define BIT_BT_STAT_DELAY(x)          (((u32)((x) & 0x0000000F) << 28))
#define BIT_GET_BT_STAT_DELAY(x)      ((u32)(((x >> 28) & 0x0000000F)))
#define BIT_MASK_BT_TRX_INIT_DETECT   ((u32)0x0000000F << 24)           /*!< R/W 0x0  After BT_PRI asserting for BT_TRX_INIT_DETECT us,  if BT_STAT is low, then BT will receive packets; otherwise, if BT goes high, BT will TX data. Unit 4us.*/
#define BIT_BT_TRX_INIT_DETECT(x)     (((u32)((x) & 0x0000000F) << 24))
#define BIT_GET_BT_TRX_INIT_DETECT(x) ((u32)(((x >> 24) & 0x0000000F)))
#define BIT_MASK_BT_PRI_DETECT_TO     ((u32)0x0000000F << 20)           /*!< R/W 0x0  After BT_PRI asserting, if BT_STAT is asserted within this TO duration, BT will initiate high priority activities; otherwise, if BT_STAT is not asserted within this duration, it would be low priority activities. Units 1us.*/
#define BIT_BT_PRI_DETECT_TO(x)       (((u32)((x) & 0x0000000F) << 20))
#define BIT_GET_BT_PRI_DETECT_TO(x)   ((u32)(((x >> 20) & 0x0000000F)))
#define BIT_STATIS_BT_RSTB            ((u32)0x00000001 << 19)           /*!< R/W 0x0  clear BT static info*/
#define BIT_STATIS_BT_EN              ((u32)0x00000001 << 18)           /*!< R/W 0x0  When this bit is set, the BT_ACT_STATISTICS counters starts counting*/
#define BIT_EN_WL_ACT_MASK            ((u32)0x00000001 << 17)           /*!< R/W 0x0  Enable WLAN_ACT Mask Function (related to 0x768h-0x76Dh)*/
#define BIT_ENHBT                     ((u32)0x00000001 << 16)           /*!< R/W 0x0  Enable Enhanced BT Interface (we suggest to use with BT mode 2)*/
#define BIT_WLRX_TER_BY_CTL_1         ((u32)0x00000001 << 11)           /*!< R/W 0x0  When wlan receive a control packet without fit address, whether the signal indicating wlan rx can be terminated as soon as the address check finish is not only controlled by r_WLRX_TER_BY_AD, but also should be refereed to this bit.  1: enable; 0: disable*/
#define BIT_WLRX_TER_BY_AD_1          ((u32)0x00000001 << 10)           /*!< R/W 0x0  When wlan receive the packet without fit address, the signal indicating wlan rx can be terminated as soon as the address check finish. This feature can be enabled by this bit.  1: en*/
#define BIT_ANT_DIVERSITY_SEL_1       ((u32)0x00000001 << 9)            /*!< R/W 0x0  Antenna diversity for 2 antenna mode: MAC_ANT_SEL = GNT_BT ^ ANT_DIVERDITY_SEL*/
#define BIT_ANTSEL_FOR_BT_CTRL_EN_1   ((u32)0x00000001 << 8)            /*!< R/W 0x0  Enable the control of antenna selection through GNT_BT: GNT_BT=1: ANT_SEL for BT device; GNT_BT=0: ANT_SEL for WL device.*/
#define BIT_WLACT_LOW_GNTWL_EN_1      ((u32)0x00000001 << 2)            /*!< R/W 0x0  When WLACT_LOW_GNTWL_EN = 1, the TRX of WLAN are blocked according  to the BTCOEX table arbitration during MASK OFF duration. WLACT_LOW_GNTWL_EN = 0, the TRX of WLAN are paused during MASK OFF duration..*/
#define BIT_WLACT_HIGH_GNTBT_EN_1     ((u32)0x00000001 << 1)            /*!< R/W 0x0  When WLACT_HIGH_GNTBT_EN = 1, the TRX of WLAN are blocked according  to the BTCOEX table arbitration during MASK ON duration. When WLACT_HIGH_ GNTBT_EN = 0, the TRX of WLAN are not paused during MASK OFF duration.*/
#define BIT_EN_WLACT_MASK_SYNC        ((u32)0x00000001 << 0)            /*!< R/W 0x0  When NAV update is beyond this value, then NAV update is aborted. When this field is 0x00, NAV_UPPER function is disable. The unit is 128us.*/
/** @} */
...
/** @defgroup REG_BT_ENHANCED_CTRL0
  ...
  * @{
  */
#define BIT_MASK_STATIS_BT_31_0   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  */
...
/** @defgroup REG_BT_ENHANCED_CTRL1
  ...
  * @{
  */
#define BIT_MASK_STATIS_BT_63_32   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  */
...
#define BIT_ENABLE_TDMA_HW_MODE             ((u32)0x00000001 << 4)            /*!< R/W 0x0  0: default, PTA TDMA mode is hardware mode. 1: enable firmware mode.*/
...
#define BIT_GPIO2_GPIO3_EXANGE_OR_NO_BT_CCA ((u32)0x00000001 << 1)            /*!< R/W 0x0  Enable GPIO2 and GPIO3 exchange. (Note: need to enable mode2 and enhance 3 wire) If Enable RTK BT mode, set this bit to 1 to disable granting to BT device when arbitration*/
...
#define BIT_MASK_BT_CMD_ID           ((u32)0x000000FF << 0)            /*!< R 0x0  command information from BT*/
...
/** @defgroup REG_BT_INTERRUPT_CONTROL_REGISTER
  ...
  * @{
  */
#define BIT_WLAN_RPT_NOTIFY          ((u32)0x00000001 << 31)           /*!< R/W 0x0  When firmware had prepared packet to send to BT, it need to set this bit to notify hardware that it can transmit. 0: There isn't a valid packet in register" WLAN_RPT_ PKT". 1: There is a valid packet in register" WLAN_RPT_ PKT".*/
...
#define BIT_EN_MAC_NULL_PKT_NOTIFY   ((u32)0x00000001 << 29)           /*!< R/W 0x0  When MAC had sent NULL packet for BT and firmware also set nav_for_bt bit, hardware triggers an interrupt to notify firmware. 0: Disable 1: Enable*/
#define BIT_EN_BT_STSTUS_RPT         ((u32)0x00000001 << 28)           /*!< R/W 0x0  When WLAN receive cmd_id "0", hardware trigger an interrupt to notify firmware. 0: Disable 1: Enable*/
#define BIT_EN_BT_POWER              ((u32)0x00000001 << 27)           /*!< R/W 0x0  When WLAN received the packet including BT Power and check register "BT_STATUS_RPT", if data contents aren't the same, hardware can trigger an interrupt to notify firmware. 0: Disable 1: Enable*/
#define BIT_EN_BT_CHANNEL            ((u32)0x00000001 << 26)           /*!< R/W 0x0  When WLAN received the packet including BT channel number, hardware can trigger an interrupt to notify firmware. 0: Disable 1: Enable*/
#define BIT_EN_BT_SLOT_CHANGE        ((u32)0x00000001 << 25)           /*!< R/W 0x0  When WLAN received the packet including that BT had multi-slots, hardware can trigger an interrupt to notify firmware. 0: Disable 1: Enable*/
#define BIT_EN_BT_PROFILE_OR_HID     ((u32)0x00000001 << 24)           /*!< R/W 0x0  Enable two interrupt 1) When WLAN received the packet including that WLAN specific profile and check register "BT_STATUS_RPT", if data contents aren't the same, hardware can trigger an interrupt to notify firmware. 2) When WLAN received the report packet including HID information, hardware will trigger an interrupt to notify firmware. 0: Disable 1: Enable*/
...
/** @defgroup REG_WLAN_REPORT_TIME_OUT_CONTROL_REGISTER
  ...
  * @{
  */
#define BIT_MASK_ISOLATION_CHK_0   ((u32)0x007FFFFF << 9)           /*!< R/W 0x0  0: leave PTA 1: enter PTA*/
#define BIT_ISOLATION_CHK_0(x)     (((u32)((x) & 0x007FFFFF) << 9))
#define BIT_GET_ISOLATION_CHK_0(x) ((u32)(((x >> 9) & 0x007FFFFF)))
#define BIT_ISOLATION_EN           ((u32)0x00000001 << 8)           /*!< R/W 0x0  Isolation table enable bit. 0: disable 1: enable*/
#define BIT_MASK_WLAN_RPT_TO       ((u32)0x000000FF << 0)           /*!< R/W 0x0  When WLANＨW received query packet, HW timer counts. If timer equals to WLAN_RPT_TO and HW can"t send packet, it will give up query packet at this time. When BT sent another query packet, WLAN HW need to send the previous packet and it shouldn't trigger an interrupt to firmware. Unit: 4us.*/
...
/** @defgroup REG_BT_INTERRUPT_STATUS_REGISTER
  ...
  * @{
  */
#define BIT_BT_HID_ISR              ((u32)0x00000001 << 31)          /*!< RW1C 0x0  When WLAN received the report packet including HID information, hardware will trigger an interrupt to notify firmware*/
#define BIT_BT_QUERY_ISR            ((u32)0x00000001 << 30)          /*!< RW1C 0x0  When WLAN received a query packet, hardware triggers an interrupt to notify firmware*/
#define BIT_MAC_NULL_PKT_NOTIFY_ISR ((u32)0x00000001 << 29)          /*!< RW1C 0x0  When MAC had sent NULL packet for BT and firmware also set nav_for_bt bit, hardware triggers an interrupt to notify firmware*/
#define BIT_WLAN_RPT_ISR            ((u32)0x00000001 << 28)          /*!< RW1C 0x0  When PTA sent the report packet successfully, hardware triggers an interrupt to notify firmware.*/
#define BIT_BT_POWER_ISR            ((u32)0x00000001 << 27)          /*!< RW1C 0x0  When WLAN received the packet including BT Power and check register "BT_STATUS_RPT", if data contents aren't the same, hardware can trigger an interrupt to notify firmware*/
#define BIT_BT_CHANNEL_ISR          ((u32)0x00000001 << 26)          /*!< RW1C 0x0  When WLAN received the packet including BT channel number, hardware can trigger an interrupt to notify firmware.*/
#define BIT_BT_SLOT_CHANGE_ISR      ((u32)0x00000001 << 25)          /*!< RW1C 0x0  When WLAN received the packet including that BT had multi-slots, hardware can trigger an interrupt to notify firmware*/
#define BIT_BT_PROFILE_ISR          ((u32)0x00000001 << 24)          /*!< RW1C 0x0  When WLAN received the packet including that WLAN specific profile and check register "BT_STATUS_RPT", if data contents aren't the same, hardware can trigger an interrupt to notify firmware.*/
...
/** @defgroup REG_BT_ACT_REGISTER
  ...
  * @{
  */
#define BIT_B_AX_BT_BLE_EN     ((u32)0x00000001 << 24)           /*!< R/W 0x0  Decide the GNT_BT_TX / RX  0: GNT_BT_TX = GNT_BT & BT_TX ;  GNT_BT_RX = GNT_BT & BT_RX 1: GNT_BT_TX = GNT_BT & (BT_TX | BT_BLE) ;  GNT_BT_RX = GNT_BT & (BT_RX | BT_BLE)*/
...
#define BIT_BT_ACT_FALLING_ISR ((u32)0x00000001 << 10)           /*!< RW1C 0x0  When BT_ACT signal is falling edge, it will trigger an interrupt.*/
#define BIT_BT_ACT_RISING_ISR  ((u32)0x00000001 << 9)            /*!< RW1C 0x0  When BT_ACT signal is raising edge, it will trigger an interrupt*/
#define BIT_TDMA_TO_ISR        ((u32)0x00000001 << 8)            /*!< RW1C 0x0  When BT_TIME expired, it will trigger an interrupt.*/
...
/** @defgroup REG_LTR_IDLE_LATENCY_V2
  ...
  * @{
  */
#define BIT_MASK_LTR_IDLE_LATENCY   ((u32)0x00000003 << 30)           /*!< R/W 0x0  LTR idle latency.*/
#define BIT_LTR_IDLE_LATENCY(x)     (((u32)((x) & 0x00000003) << 30))
#define BIT_GET_LTR_IDLE_LATENCY(x) ((u32)(((x >> 30) & 0x00000003)))
#define BIT_MASK_OBFF_STATE         ((u32)0x00000003 << 28)           /*!< R 0x0  */
...
#define BIT_MASK_OBFF_CTRL_0        ((u32)0x0000000F << 0)            /*!< R 0x0  */
...
#define BIT_LTR_IDLE_FLAG    ((u32)0x00000001 << 23)           /*!< R 0x0  */
#define BIT_LTR_ACT_FLAG     ((u32)0x00000001 << 22)           /*!< R 0x0  */
...
/** @defgroup REG_LTR_CTRL
  ...
  * @{
  */
#define BIT_RX_VENDOR_ADV_EN     ((u32)0x00000001 << 25)           /*!< R/W 0x1  when set, rx vendor adv function is true*/
#define BIT_TX_VENDOR_ADV_EN     ((u32)0x00000001 << 24)           /*!< R/W 0x1  when set, tx vendor adv function is true*/
...
/** @defgroup REG_ANTTRN_CTR_V1
  ...
  * @{
  */
#define BIT_MASK_TRAIN_STA_ADDR1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  The Address of the trained station. Only available when ADDR2_MATCH_EN = 1*/
...
/** @defgroup REG_ANTTRN_CTR_1_V1
  ...
  * @{
  */
#define BIT_ANTTRN_SWITCH           ((u32)0x00000001 << 19)          /*!< R/W 0x0  Smart antenna use address cam or port register to search A2. 0:Use address cam 1:Use port register*/
...
#define BIT_MASK_TRAIN_STA_ADDR2    ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  The Address of the trained station. Only available when ADDR2_MATCH_EN = 1*/
...
/** @defgroup REG_WMAC_PKTCNT_RWD
  ...
  * @{
  */
#define BIT_MASK_PKTCNT_BSSIDMAP   ((u32)0x0000000F << 4)           /*!< R 0x0  To decide this counter is for which MBSSID (16組), default : 0 for counter 0 1 for counter 1 2 for counter 2 3 for counter 3 4 for counter 4 5 for counter 5 6 for counter 6 7 for counter 7*/
#define BIT_PKTCNT_BSSIDMAP(x)     (((u32)((x) & 0x0000000F) << 4))
#define BIT_GET_PKTCNT_BSSIDMAP(x) ((u32)(((x >> 4) & 0x0000000F)))
#define BIT_PKTCNT_CNTRST          ((u32)0x00000001 << 1)           /*!< R 0x0  Write 1 to reset Counter   after DRV read all counters , DRV set this bit and HW return 0 after reset*/
/** @} */
...
/** @defgroup REG_WMAC_PKTCNT_CTRL
  ...
  * @{
  */
#define BIT_WMAC_PSF_BCNTIMER_RST    ((u32)0x00000001 << 19)          /*!< WA0 0x0  write pluse to reset fsm of wmac_psf_bcntimer*/
#define BIT_WMAC_TRXPTCL_TXCTL_RST   ((u32)0x00000001 << 18)          /*!< WA0 0x0  write pluse to reset fsm of wmac_trxptcl_txctl*/
#define BIT_WMAC_TRXPTCL_RESP_RST    ((u32)0x00000001 << 17)          /*!< WA0 0x0  write pluse to reset fsm of wmac_ptrxptcl_resp*/
#define BIT_WMAC_MACTX_CTL_RST       ((u32)0x00000001 << 16)          /*!< WA0 0x0  write pluse to reset fsm of ppdu control in mactx_ctl*/
...
/** @defgroup REG_IQ_DUMP
  ...
  * @{
  */
#define BIT_MASK_DUMP_OK_ADDR        ((u32)0x0000FFFF << 16)           /*!< R 0x0  [31] : dump signal addr has round up [30:16] : dump finish addr in txpktbuffer*/
...
#define BIT_EN_LA_MAC                ((u32)0x00000001 << 2)            /*!< R/W 0x0  enable dump mac dbg signal*/
...
/** @defgroup REG_MASK_LA_MAC
  ...
  * @{
  */
#define BIT_MASK_MASK_LA_MAC   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for mask one or more bits of debug port*/
...
/** @defgroup REG_MATCH_REF_MAC
  ...
  * @{
  */
#define BIT_MASK_MATCH_REF_MAC   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for compare with debug port*/
...
#define BIT_EN_TXD_DEBUG                   ((u32)0x00000001 << 15)           /*!< R/W 0x0  LA MODE function. enable mactx debug mode*/
#define BIT_EN_RXD_DEBUG                   ((u32)0x00000001 << 14)           /*!< R/W 0x0  LA MODE function. enable macrx debug mode*/
#define BIT_TRX_TRIG_SEL_DEBUG             ((u32)0x00000001 << 13)           /*!< R/W 0x0  LA MODE function. *1: select trig_stop signals from debug port, in MACTX/MACRX mode*/
#define BIT_TRX_TRIG_SEL_PATT              ((u32)0x00000001 << 12)           /*!< R/W 0x0  LA MODE function.  *1: select trig_stop signals from pattern match (see 0x17F0~0x17FC), in MACTX/MACRX mode*/
#define BIT_EN_IQD_LEN_BREAK               ((u32)0x00000001 << 11)           /*!< R/W 0x0  LA MODE function.  *1: after "trig_stop" signal asserted, if the iqdata's length over the BIT_IQD_LENGTH_REF, finish the iqdump process  *0: only used TRIG_TIME finish the iqdump process*/
#define BIT_MASK_IQD_LENGTH_REF            ((u32)0x00000007 << 8)            /*!< R/W 0x0  LA MODE function. Valid when BIT_EN_IQD_LEN_BREAK = 1 Used to finish IQDUMP, unit is (8KB + 1bit)*/
#define BIT_IQD_LENGTH_REF(x)              (((u32)((x) & 0x00000007) << 8))
#define BIT_GET_IQD_LENGTH_REF(x)          ((u32)(((x >> 8) & 0x00000007)))
#define BIT_TRX_TRIG_SEL_WMAC              ((u32)0x00000001 << 7)            /*!< R/W 0x1  LA MODE function.  *1: select trig_stop signals from mactx or macrx, in MACTX/MACRX mode*/
#define BIT_RXFTM_TXACK_SC                 ((u32)0x00000001 << 6)            /*!< R/W 0x0  When HW receive FTM pkt, HW will use RX FTM BW as response ACK TXBW.*/
#define BIT_RXFTM_TXACK_BW                 ((u32)0x00000001 << 5)            /*!< R/W 0x0  When HW receive FTM pkt, HW will use RX FTM SC as response ACK TXSC.*/
#define BIT_EN_TDE_DEBUG                   ((u32)0x00000001 << 4)            /*!< R/W 0x0  LA MODE function. enable txdma debug mode*/
#define BIT_RXFTM_EN                       ((u32)0x00000001 << 3)            /*!< R/W 0x0  If BIT_FTM_TYPE = 1 && BIT_RXFTM_EN=1,   HW will parsing rx packet, to find FTM request frame.*/
#define BIT_RXFTMREQ_BYDRV                 ((u32)0x00000001 << 2)            /*!< R/W 0x0  If set this bit to 1,Rx FTMREQ/FTM can be receive into rxpktbuffer.*/
...
#define BIT_R_WMAC_RX_SYNCFIFO_SYNC_1      ((u32)0x00000001 << 23)           /*!< R/W 0x1  */
#define BIT_R_WMAC_RXRST_DLY_1             ((u32)0x00000001 << 22)           /*!< R/W 0x0  when this bit is set 1, rxrst pulse lasts for 20 cycle of MAC clock, when this bit is set 0, rxrst pulse lasts for 10 cycle of MAC clock,*/
#define BIT_R_WMAC_SRCH_TXRPT_REF_DROP_1   ((u32)0x00000001 << 21)           /*!< R/W 0x0  when this bit is set 1, reference macid drop information when macid search*/
#define BIT_R_WMAC_SRCH_TXRPT_UA1_1        ((u32)0x00000001 << 20)           /*!< R/W 0x0  when this bit is set 1, use tx A1 to search txrpt when rx  ack/cts, when BIT_r_WMAC_SRCH_TXRPT_TYPE is set 0, BIT_r_WMAC_SRCH_TXRPT_UA1 should be set 1*/
#define BIT_R_WMAC_SRCH_TXRPT_TYPE_1       ((u32)0x00000001 << 19)           /*!< R/W 0x0  for rx ack/cts pkt not to search txrpt buffer macid*/
#define BIT_R_WMAC_NDP_RST_1               ((u32)0x00000001 << 18)           /*!< R/W 0x0  rx pkt is ndp to clr macrx_active*/
#define BIT_R_WMAC_POWINT_EN_1             ((u32)0x00000001 << 17)           /*!< R/W 0x0  enable rx pkt fc column power bit int for FISR*/
#define BIT_R_WMAC_SRCH_TXRPT_PERPKT_1     ((u32)0x00000001 << 16)           /*!< R/W 0x0  enable search txrpt buffer for macid every pkt*/
#define BIT_R_WMAC_SRCH_TXRPT_MID_1        ((u32)0x00000001 << 15)           /*!< R/W 0x1  enable search txrpt buffer for macid*/
#define BIT_R_WMAC_PFIN_TOEN_1             ((u32)0x00000001 << 14)           /*!< R/W 0x0  rx fifo fsm flush state timeout to error stage*/
#define BIT_R_WMAC_FIL_SECERR_1            ((u32)0x00000001 << 13)           /*!< R/W 0x1  sec len error drop(sec len is zero)*/
#define BIT_R_WMAC_FIL_CTLPKTLEN_1         ((u32)0x00000001 << 12)           /*!< R/W 0x0  drop the rx pkt if the rx ctrl pkt len large than r_WMAC_RX_FIL_LEN*/
#define BIT_R_WMAC_FIL_FCTYPE_1            ((u32)0x00000001 << 11)           /*!< R/W 0x0  drop the ofdm pkt if the rx ofdm leg pkt fc type is 2'b11*/
#define BIT_R_WMAC_FIL_FCPROVER_1          ((u32)0x00000001 << 10)           /*!< R/W 0x0  drop the ofdm pkt if the rx ofdm leg pkt fc version illegal*/
#define BIT_R_WMAC_PHYSTS_SNIF_1           ((u32)0x00000001 << 9)            /*!< R/W 0x0  append sniff info after rxdesc*/
#define BIT_R_WMAC_PHYSTS_PLCP_1           ((u32)0x00000001 << 8)            /*!< R/W 0x0  append plcp header after rxdesc*/
#define BIT_R_MAC_TCR_VBONF_RD_1           ((u32)0x00000001 << 7)            /*!< R/W 0x0  vbon neg edge to read all data of mac rx sync fifo for rx parser*/
#define BIT_R_WMAC_TCR_MPAR_NDP_1          ((u32)0x00000001 << 6)            /*!< R/W 0x0  nop ok check bb ndp vld & mac rx ndp check ok*/
#define BIT_R_WMAC_NDP_FILTER_1            ((u32)0x00000001 << 5)            /*!< R/W 0x0  mac rx ndp pkt set ppdu len to 0*/
#define BIT_R_WMAC_RXLEN_SEL_1             ((u32)0x00000001 << 4)            /*!< R/W 0x0  rx vht len sel lsig len VHT PPDU length selection 0: 收到VHT PPDU PKT 會根據 VHTSIGB PPDU length 來parsing 與計算 1: 收到VHT PPDU PKT 會根據 BB 算的 LSIG length 來parsing 與計算*/
#define BIT_R_WMAC_RXLEN_SEL1_1            ((u32)0x00000001 << 3)            /*!< R/W 0x0  rx vht len sel lsig len if sigb len is more than lsig len*/
#define BIT_R_OFDM_FILTER_1                ((u32)0x00000001 << 2)            /*!< R/W 0x0  RSVD*/
#define BIT_R_WMAC_CHK_OFDM_LEN_1          ((u32)0x00000001 << 1)            /*!< R/W 0x0  enable to check ofdm len*/
#define BIT_R_WMAC_CHK_CCK_LEN_1           ((u32)0x00000001 << 0)            /*!< R/W 0x0  enable to check rx cck len*/
/** @} */
...
/** @defgroup REG_RX_FILTER_FUNCTION
  ...
  * @{
  */
#define BIT_RXHANG_EN                     ((u32)0x00000001 << 31)          /*!< R/W 0x0  Force read error content from fifo to solve rxhang.*/
#define BIT_R_WMAC_MHRDDY_LATCH           ((u32)0x00000001 << 30)          /*!< R/W 0x0  Adjust mach_rdy timing if rx_parser and rxpktfifo FSM is not sync.*/
#define BIT_R_WMAC_MHRDDY_CLR             ((u32)0x00000001 << 29)          /*!< R/W 0x1  Reset mach_rdy_latch when rx parser begin parsing mac header.*/
#define BIT_R_RXPKTCTL_FSM_BASED_MPDURDY1 ((u32)0x00000001 << 28)          /*!< R/W 0x1  Adjust mpdu_rdy timing to solve FSM behavier error.*/
#define BIT_WMAC_DIS_VHT_PLCP_CHK_MU      ((u32)0x00000001 << 27)          /*!< R/W 0x0  Disable check sigb crc value of MU plcp header.*/
#define BIT_R_CHK_DELIMIT_LEN             ((u32)0x00000001 << 26)          /*!< R/W 0x0  Drop mpdu if delimeter mpdu length smaller than mac header length + 4.*/
#define BIT_R_REAPTER_ADDR_MATCH          ((u32)0x00000001 << 25)          /*!< R/W 0x0  when this bit is set 1, physical address is matched when rx A1 is equal to tx A2, used in repeater mode*/
#define BIT_R_RXPKTCTL_FSM_BASED_MPDURDY  ((u32)0x00000001 << 24)          /*!< R/W 0x0  when this bit is set 1, rxpktfifo_ctl FSM jumps based on mpdu_valid(all MPDU data has been transferred to rxpktbuffer), when this bit is set 0, rxpktfifo_ctl FSM jumps based on fcs_valid(all MPDU data has been parsed by rx_parser)*/
#define BIT_R_LATCH_MACHRDY               ((u32)0x00000001 << 23)          /*!< R/W 0x1  when this bit set 1,mach_rdy signal is latched to make sure that rxpktfifo_ctl can detect it*/
#define BIT_R_WMAC_RXFIL_REND             ((u32)0x00000001 << 22)          /*!< R/W 0x0  when this bit set 1,icvmic_valid signal is cleared when icvmic_rdy is valid(ICV/MIC is parsed)*/
#define BIT_R_WMAC_MPDURDY_CLR            ((u32)0x00000001 << 21)          /*!< R/W 0x0  when the bit is set 1,  the last MPDU which will be transferred to rxpktfifo is ready and error occurs, mpdu_rdy signal is also valid(is means all MPDU data has been transferred to rxpktbuffer)*/
#define BIT_R_WMAC_CLRRXSEC               ((u32)0x00000001 << 20)          /*!< R/W 0x0  If new rx pkt is coming, reset the previous rx key search result.*/
#define BIT_R_WMAC_RXFIL_RDEL             ((u32)0x00000001 << 19)          /*!< R/W 0x0  If new rx pkt is coming, reset the rxpkt_ctl FSM after parsing plcp.*/
#define BIT_R_WMAC_RXFIL_FCSE             ((u32)0x00000001 << 18)          /*!< R/W 0x0  If rx pkt is not ampdu and rejected,  reset rxpkt_ctl FSM immediately after parsing header*/
#define BIT_R_WMAC_RXFIL_MESH_DEL         ((u32)0x00000001 << 17)          /*!< R/W 0x0  drop the ofdm pkt if the rx ofdm leg pkt fc type is 2'b11*/
#define BIT_R_WMAC_RXFIL_MASKM            ((u32)0x00000001 << 16)          /*!< R/W 0x1  drop the ofdm pkt if the rx ofdm leg pkt fc type is 2'b11*/
...
/** @defgroup REG_WMAC_OPTION_FUNCTION_3
  ...
  * @{
  */
#define BIT_R_SIFS_ABORT_TB          ((u32)0x00000001 << 22)          /*!< R/W 0x1  sifs_reach check fcs fail abort tx tb option*/
#define BIT_R_WMAC_MORE_DATA         ((u32)0x00000001 << 21)          /*!< R/W 0x0  more data field in FC for ack/ba/mba*/
...
/** @defgroup REG_WMAC_DBG_SEL
  ...
  * @{
  */
#define BIT_MASK_TXCMD_DBG_SHIFT   ((u32)0x00000007 << 8)           /*!< R/W 0x0  */
#define BIT_TXCMD_DBG_SHIFT(x)     (((u32)((x) & 0x00000007) << 8))
#define BIT_GET_TXCMD_DBG_SHIFT(x) ((u32)(((x >> 8) & 0x00000007)))
#define BIT_MASK_TXCMD_DBG_SEL     ((u32)0x00000003 << 0)           /*!< R/W 0x0  */
#define BIT_TXCMD_DBG_SEL(x)       (((u32)((x) & 0x00000003) << 0))
#define BIT_GET_TXCMD_DBG_SEL(x)   ((u32)(((x >> 0) & 0x00000003)))
/** @} */
...
/** @defgroup REG_WSEC_OPTION
  ...
  * @{
  */
#define BIT_RXDEC_BM_DIS_CHKFC     ((u32)0x00000001 << 23)           /*!< R/W 0x0  disenable check fc[14] when bip decryption*/
#define BIT_RXDEC_BM_MGNT          ((u32)0x00000001 << 22)           /*!< R/W 0x1  decryption enable of rx multicast management pkt, 0x680[3] shall also be set valid*/
#define BIT_TXENC_BM_MGNT          ((u32)0x00000001 << 21)           /*!< R/W 0x1  encryption enable of tx multicast management pkt, 0x680[2] shall also be set valid*/
...
#define BIT_WAPI_FC_NOMASK         ((u32)0x00000001 << 15)           /*!< R/W 0x0  If set to 1, enable old WAPI ADD format, don't mask FC bit4~6, bit8~15, If set to 0, enable new WAPI ADD format, mask FC bit15 to 0.*/
#define BIT_WAPI_QC_NOMASK         ((u32)0x00000001 << 14)           /*!< R/W 0x0  If set to 1, enable old WAPI ADD format, don't mask QC bit4~6, bit8~15, If set to 0, enable new WAPI ADD format, mask QC bit4~6, bit8~15 to 0.*/
#define BIT_GCM_WAPI_FC_NOMASK     ((u32)0x00000001 << 13)           /*!< R/W 0x0  If set to 1, enable old GCM-WAPI ADD format, don't mask FC bit4~6, bit8~15, If set to 0, enable new GCM-WAPI ADD format, mask FC bit15 to 0.*/
...
/** @defgroup REG_RTS_ADDRESS_0
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_RTS_ADDR0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  if 0x604[31]=1 & rts is multicast, use this value as Address1 of RTS*/
...
/** @defgroup REG_RTS_ADDRESS_0_1
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_RTS_ADDR0_1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  if 0x604[31]=1 & rts is multicast, use this value as Address1 of RTS*/
...
/** @defgroup REG_RTS_ADDRESS_1
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_RTS_ADDR1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  if 0x604[31]=1 & rts is multicast, use this value as Address1 of RTS*/
...
/** @defgroup REG_RTS_ADDRESS_1_1
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_RTS_ADDR1_1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  if 0x604[31]=1 & rts is multicast, use this value as Address1 of RTS*/
...
#define REG_NSARP_CFG                                       0x720
#define REG_ZB_STATISTIC_1                                  0x724
#define REG_ZB_STATISTIC_2                                  0x728
#define REG_BEAMFORMING_INFO_NSARP                          0x72C
#define REG_IPV6_0                                          0x730
#define REG_IPV6_1                                          0x734
#define REG_IPV6_2                                          0x738
#define REG_IPV6_3                                          0x73C
...
#define REG_WMAC_RTX_CTX_SUBTYPE                            0x750
#define REG_WMAC_RTX_SWAES_RD_1                             0x754
#define REG_WMAC_RTX_SWAES_RD_2                             0x758
#define REG_WMAC_RTX_SWAES_RD_3                             0x75C
...
#define REG_BT_INTERRUPT_STATUS_REGISTER                    0x78C
...
#define REG_WMAC_DBG_FTM_CTL                                0x7CC
...
#define REG_WMAC_DBG_SEL                                    0x7E4
#define REG_WMAC_DBG_SHIFT                                  0x7E8
#define REG_WSEC_OPTION                                     0x7EC
#define REG_RTS_ADDRESS_0                                   0x7F0
#define REG_RTS_ADDRESS_0_1                                 0x7F4
#define REG_RTS_ADDRESS_1                                   0x7F8
#define REG_RTS_ADDRESS_1_1                                 0x7FC
