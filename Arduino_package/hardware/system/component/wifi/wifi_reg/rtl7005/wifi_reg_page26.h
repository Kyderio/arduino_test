#ifndef _RL7005_REG_PAGE26_H_
#define _RL7005_REG_PAGE26_H_
...
/** @defgroup REG_PAGE26
  * @brief REG_PAGE26 driver modules
  * @{
  */
...
/** @defgroup REG_PAGE26_Register_Definitions REG_PAGE26 Register Definitions
  * @{
  */
...
/** @defgroup REG_TWT_BC_ID
  ...
  * @{
  */
#define BIT_MASK_R_BC_TWT_ID   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  TWT ID bitmap, each bit corresponding to a ID value*/
...
/** @defgroup REG_TWT_BC_RPT0_PERS
  ...
  * @{
  */
#define BIT_R_WMAC_BCN_TWT_PSR       ((u32)0x00000001 << 26)           /*!< R/W 0x0  enable bcn twt bc ie parser*/
#define BIT_MASK_R_TWT_PERSISTENCE   ((u32)0x000000FF << 18)           /*!< R/W 0x0  persistence vlaue, if persistence value in TWT IE is smaller than the reference, bcnpsf will lat the twt id rpt*/
...
/** @defgroup REG_TWT_BC_RPT1
  ...
  * @{
  */
#define BIT_MASK_TWT_RPT_2   ((u32)0x0000FFFF << 16)           /*!< R/W/ES 0x0  specified twt id report*/
...
/** @defgroup REG_TWT_BC_RPT2
  ...
  * @{
  */
#define BIT_MASK_TWT_RPT_4   ((u32)0x0000FFFF << 16)           /*!< R/W/ES 0x0  specified twt id report*/
#define BIT_TWT_RPT_4(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_TWT_RPT_4(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_TWT_RPT_3   ((u32)0x0000FFFF << 0)            /*!< R/W/ES 0x0  specified twt id report*/
...
#define BIT_MASK_OPS_DURATION_RPT   ((u32)0x000000FF << 0)           /*!< R/W/ES 0x0  ops frame duration field rpt*/
...
/** @defgroup REG_LA_EVENT_OPTION
  ...
  * @{
  */
#define BIT_MASK_R_LASTOP_FCS_ERROR   ((u32)0x00000003 << 3)           /*!< R/W 0x0  stop LA record when continue fcs error >= threshold 0:disable 1:4 2:8 3:12*/
#define BIT_R_LASTOP_FCS_ERROR(x)     (((u32)((x) & 0x00000003) << 3))
#define BIT_GET_R_LASTOP_FCS_ERROR(x) ((u32)(((x >> 3) & 0x00000003)))
#define BIT_R_LASTOP_RX_FSM_HANG      ((u32)0x00000001 << 2)           /*!< R/W 0x0  stop LA record when RX FSM timeout*/
#define BIT_R_LASTOP_PLCP_ERROR       ((u32)0x00000001 << 1)           /*!< R/W 0x0  stop LA record when RX PLCP error occur, include Length error, parity error or crc error*/
#define BIT_R_LASTOP_RX_INCOMP        ((u32)0x00000001 << 0)           /*!< R/W 0x0  stop LA record when RX content is incompleted, include PLCP is incompleted or PSDU is incompleted*/
/** @} */
...
/** @defgroup REG_RESP_AID_11
  ...
  * @{
  */
#define BIT_MASK_AID11   ((u32)0x000007FF << 0)           /*!< R/W 0x0  specified the aid of the sta that mactx responding to*/
...
/** @defgroup REG_MAC_PHY_CR
  ...
  * @{
  */
#define BIT_R_ID_MATH_MPDU             ((u32)0x00000001 << 21)           /*!< R/W 0x0  when set, per mpdu will trigger rx_id_match, else per ppdu trigger rx_id_match*/
...
/*==========REG_PAGE26 Register Address Definition==========*/
