#ifndef _RL7005_REG_PAGE17_H_
#define _RL7005_REG_PAGE17_H_
...
/** @defgroup REG_PAGE17
  * @brief REG_PAGE17 driver modules
  * @{
  */
...
/** @defgroup REG_PAGE17_Register_Definitions REG_PAGE17 Register Definitions
  * @{
  */
...
/** @defgroup REG_RX_CFG
  ...
  * @{
  */
#define BIT_R_VHTNDPA_SUAID_0_EN    ((u32)0x00000001 << 31)           /*!< R/W 0x0  when set, will receive vht/he su ndpa which aid field is set to 0.*/
#define BIT_R_DIS_HE_SIGB_CHK       ((u32)0x00000001 << 30)           /*!< R/W 0x0  when set, disable check he-mu sigb crc8*/
#define BIT_R_MBA_RSVD_AID_EN       ((u32)0x00000001 << 29)           /*!< R/W 0x0  enable parsing resevd aid msta-ba for pre-association*/
#define BIT_R_RXBCN_TIM_NO_HIT_EN   ((u32)0x00000001 << 28)           /*!< R/W 0x0  enable rxbcn_ok_int when receiving bcn with tim_no_hit,set 0: rxbcn_ok_int will only assert when tim_hit*/
#define BIT_R_TIM_NO_HIT_REJECT     ((u32)0x00000001 << 27)           /*!< R/W 0x0  enable reject tim no hit beacon*/
#define BIT_R_DIS_CHK_HENDP_LEN     ((u32)0x00000001 << 26)           /*!< R/W 0x0  disable check HE NDP lsig length value*/
#define BIT_R_CHK_MGNT_BSSID        ((u32)0x00000001 << 25)           /*!< R/W 0x0  enable check management frame bssid*/
#define BIT_R_CHK_CTL_BSSID         ((u32)0x00000001 << 24)           /*!< R/W 0x0  enable check trigger,vht/hendpa and block ack bssid*/
#define BIT_R_DIS_STS_GCLK          ((u32)0x00000001 << 23)           /*!< R/W 0x0  disable ppdu status clock gating*/
#define BIT_MASK_R_STS_CHKRX_COND   ((u32)0x0000000F << 19)           /*!< R/W 0x0  check macrx condition when receiving ppdu status*/
#define BIT_R_STS_CHKRX_COND(x)     (((u32)((x) & 0x0000000F) << 19))
#define BIT_GET_R_STS_CHKRX_COND(x) ((u32)(((x >> 19) & 0x0000000F)))
#define BIT_R_INTER_PPDU_REJECT     ((u32)0x00000001 << 18)           /*!< R/W 0x0  enable reject inter ppdu*/
#define BIT_R_EN_MACH_UPD_LEN       ((u32)0x00000001 << 17)           /*!< R/W 0x0  enable macrx_pktfifo_ctl update mpdu length in MACHDR_CHK state*/
#define BIT_R_SNIFFER_TB            ((u32)0x00000001 << 16)           /*!< R/W 0x0  enable to receive TB PPDU for debug mode*/
#define BIT_R_RXPSF_INTER_PLCP      ((u32)0x00000001 << 6)            /*!< R/W 0x0  enable invalid packet check for inter ppdu, inter ppdu valid when plcp is inter bss*/
#define BIT_R_RXPSF_INTER_MPDU      ((u32)0x00000001 << 5)            /*!< R/W 0x0  enable invalid packet check for inter ppdu, inter ppdu valid when plcp and mac header are inter bss*/
#define BIT_R_RXPSF_HE_MU_CHKEN     ((u32)0x00000001 << 4)            /*!< R/W 0x0  enable HE MU invalid packet check for mac header*/
#define BIT_R_RXPSF_HE_ERSU_CHKEN   ((u32)0x00000001 << 3)            /*!< R/W 0x0  enable HE ER SU invalid packet check for mac header*/
#define BIT_R_RXPSF_HE_SU_CHKEN     ((u32)0x00000001 << 2)            /*!< R/W 0x0  enable HE SU invalid packet check for mac header*/
#define BIT_R_RXPSF_VHT_MU_CHKEN    ((u32)0x00000001 << 1)            /*!< R/W 0x0  enable VHT MU invalid packet check for mac header*/
#define BIT_R_RXPSF_VHT_SU_CHKEN    ((u32)0x00000001 << 0)            /*!< R/W 0x0  enable VHT SU invalid packet check for mac header*/
/** @} */
...
/** @defgroup REG_RPL_CFG
  ...
  * @{
  */
#define BIT_MASK_R_RPLCFG_UPPER_DBM   ((u32)0x000001FF << 11)           /*!< R/W 0x0  rx power upper level*/
#define BIT_R_RPLCFG_UPPER_DBM(x)     (((u32)((x) & 0x000001FF) << 11))
#define BIT_GET_R_RPLCFG_UPPER_DBM(x) ((u32)(((x >> 11) & 0x000001FF)))
#define BIT_R_RPLCFG_UPPER_EN         ((u32)0x00000001 << 10)           /*!< R/W 0x0  enable use r_rplcfg_upper_dbm as rx power level*/
#define BIT_MASK_R_RPLCFG_DBM         ((u32)0x000001FF << 1)            /*!< R/W 0x0  rx power level*/
#define BIT_R_RPLCFG_DBM(x)           (((u32)((x) & 0x000001FF) << 1))
#define BIT_GET_R_RPLCFG_DBM(x)       ((u32)(((x >> 1) & 0x000001FF)))
#define BIT_R_RPLCFG_EN               ((u32)0x00000001 << 0)            /*!< R/W 0x0  enable use r_rplcfg_dbm as rx power level*/
/** @} */
...
/** @defgroup REG_AID
  ...
  * @{
  */
#define BIT_MASK_R_MAC_AID12_1   ((u32)0x00000FFF << 12)           /*!< R/W 0x0  aid1*/
#define BIT_R_MAC_AID12_1(x)     (((u32)((x) & 0x00000FFF) << 12))
#define BIT_GET_R_MAC_AID12_1(x) ((u32)(((x >> 12) & 0x00000FFF)))
#define BIT_MASK_R_MAC_AID12_0   ((u32)0x00000FFF << 0)            /*!< R/W 0x0  aid0*/
...
/** @defgroup REG_TRAN_BSSID0_L
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_TRANSBSSID0_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  lower 32 bits of transmitted bssid0*/
...
/** @defgroup REG_TRAN_BSSID0_H
  ...
  * @{
  */
#define BIT_R_MBSSID_CTLINFO_SRCH_EN    ((u32)0x00000001 << 24)           /*!< R/W 0x0  when set, rx trigger and vht/he ndpa, will search control info using assocaiated bssid*/
#define BIT_R_EN_PARTAID                ((u32)0x00000001 << 23)           /*!< R/W 0x0  enable inter ppdu decision according to partial aid for VHT ppdu*/
#define BIT_R_EN_MBSSID                 ((u32)0x00000001 << 22)           /*!< R/W 0x0  enable multibssid function*/
#define BIT_MASK_R_BSS_COLOR0           ((u32)0x0000003F << 16)           /*!< R/W 0x0  bss color of current BSS*/
#define BIT_R_BSS_COLOR0(x)             (((u32)((x) & 0x0000003F) << 16))
#define BIT_GET_R_BSS_COLOR0(x)         ((u32)(((x >> 16) & 0x0000003F)))
#define BIT_MASK_R_WMAC_TRANSBSSID0_H   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  higher 16 bits of transmitted bssid0*/
...
/** @defgroup REG_TRAN_BSSID1_L
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_TRANSBSSID1_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  lower 32 bits of transmitted bssid1*/
...
/** @defgroup REG_TRAN_BSSID1_H
  ...
  * @{
  */
#define BIT_MASK_R_BSS_COLOR2           ((u32)0x0000003F << 24)           /*!< R/W 0x0  bss color of port2*/
#define BIT_R_BSS_COLOR2(x)             (((u32)((x) & 0x0000003F) << 24))
#define BIT_GET_R_BSS_COLOR2(x)         ((u32)(((x >> 24) & 0x0000003F)))
#define BIT_MASK_R_BSS_COLOR1           ((u32)0x0000003F << 16)           /*!< R/W 0x0  bss color of current BSS*/
#define BIT_R_BSS_COLOR1(x)             (((u32)((x) & 0x0000003F) << 16))
#define BIT_GET_R_BSS_COLOR1(x)         ((u32)(((x >> 16) & 0x0000003F)))
#define BIT_MASK_R_WMAC_TRANSBSSID1_H   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  higher 16 bits of transmitted bssid1*/
...
/** @defgroup REG_GID_POS_EN_L
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION_EN_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position enable*/
...
/** @defgroup REG_GID_POS0
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION0   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position0*/
...
/** @defgroup REG_GID_POS1
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position1*/
...
/** @defgroup REG_GID_POS2
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION2   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position2*/
...
/** @defgroup REG_GID_POS3
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION3   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position3*/
...
/** @defgroup REG_BSSCOLOR_BITMAP_L
  ...
  * @{
  */
#define BIT_MASK_R_BSSCOLOR_BITMAP_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  low 32bits bss color bitmap*/
...
/** @defgroup REG_BSSCOLOR_BITMAP_H
  ...
  * @{
  */
#define BIT_MASK_R_BSSCOLOR_BITMAP_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  high 32bits bss color bitmap*/
...
/** @defgroup REG_PBSSID_BITMAP_L
  ...
  * @{
  */
#define BIT_MASK_R_PARTIAL_BSSID_BITMAP_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  low 32bits partial bssid bitmap*/
...
/** @defgroup REG_PBSSID_BITMAP_H
  ...
  * @{
  */
#define BIT_MASK_R_PARTIAL_BSSID_BITMAP_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  high 32bits partial bssid bitmap*/
...
/** @defgroup REG_SR_CFG0
  ...
  * @{
  */
#define BIT_R_SPRUSE_RSVD_EN   ((u32)0x00000001 << 3) /*!< R/W 0x0  enable spatial reuse when plcp header spatial reuse field value smaller than 14 or value is 15 and is srg ppdu*/
#define BIT_R_CTL_SRG_CHECK_EN ((u32)0x00000001 << 2) /*!< R/W 0x0  enable control packet srg ppdu check*/
#define BIT_R_SRG_CHECK_EN     ((u32)0x00000001 << 1) /*!< R/W 0x0  enable srg ppdu check*/
#define BIT_R_SR_EN            ((u32)0x00000001 << 0) /*!< R/W 0x0  enable spatial reuse function*/
/** @} */
...
/** @defgroup REG_SR_CFG1
  ...
  * @{
  */
#define BIT_MASK_R_NONSRG_OBSS_PD_MAX   ((u32)0x000000FF << 24)           /*!< R/W 0x0  the maximum value of non_SRG OBSS_PD*/
#define BIT_R_NONSRG_OBSS_PD_MAX(x)     (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_R_NONSRG_OBSS_PD_MAX(x) ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_R_NONSRG_OBSS_PD_MIN   ((u32)0x000000FF << 16)           /*!< R/W 0x0  the minimum value of non_SRG OBSS_PD*/
#define BIT_R_NONSRG_OBSS_PD_MIN(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_R_NONSRG_OBSS_PD_MIN(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_R_SRG_OBSS_PD_MAX      ((u32)0x000000FF << 8)            /*!< R/W 0x0  the maximum value of OBSS_PD*/
#define BIT_R_SRG_OBSS_PD_MAX(x)        (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_R_SRG_OBSS_PD_MAX(x)    ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_R_SRG_OBSS_PD_MIN      ((u32)0x000000FF << 0)            /*!< R/W 0x0  the minimum value of OBSS_PD*/
...
#define BIT_R_WMAC_SR_FIELD_EN          ((u32)0x00000001 << 17)           /*!< R/W 0x0  enable sr field reg cfg*/
#define BIT_R_WMAC_SR_VAL15_ALLOW       ((u32)0x00000001 << 16)           /*!< R/W 0x0  sr field can be the value 15*/
#define BIT_MASK_R_WMAC_PLCP_SR_FIELD   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  value of SR field*/
...
/** @defgroup REG_MACTX_MISC
  ...
  * @{
  */
#define BIT_R_TXTIME_CAL_DISGCLK           ((u32)0x00000001 << 30)           /*!< R/W 0x0  disable the clk gating for txtime compute module*/
...
#define BIT_R_WMAC_FORCE_READ_TXDFIFO      ((u32)0x00000001 << 3)            /*!< R/W 0x0  during tx procedure, force read txd fifo, which is only use at the situation when bb is hang.*/
#define BIT_R_WMAC_SW_RD                   ((u32)0x00000001 << 2)            /*!< R/W 0x0  eanble sw read txdfifo*/
...
/** @defgroup REG_MACTX_MHDR0
  ...
  * @{
  */
#define BIT_R_UPH_CAS_QOS_SEL                ((u32)0x00000001 << 31)           /*!< R/W 0x0  UPH and CAS HTC control field enable*/
#define BIT_R_QNULL_ACK_POL_VAL              ((u32)0x00000001 << 30)           /*!< R/W 0x1  basic trigger resp tb QOS NULL ack policy bit 0 value*/
#define BIT_R_WMAC_EN_HW_SSN                 ((u32)0x00000001 << 29)           /*!< R/W 0x1  enable the hw ssn for qos null frame.*/
#define BIT_R_TB_QOSNULL_PWRMGT_VAL          ((u32)0x00000001 << 28)           /*!< R/W 0x0  the power management bit value in tb qos null, used during twt operation*/
#define BIT_R_WMAC_MHDR_UPH_EN               ((u32)0x00000001 << 27)           /*!< R/W 0x0  eanble reg wirte HTC field of tb_ppdu, which contain UPH a-control(4)*/
#define BIT_R_TCR_BA_RSVD_VAL                ((u32)0x00000001 << 26)           /*!< R/W 0x0  multi-sta BA bactl rsvd filed value*/
#define BIT_MASK_R_QOS_NULL_TID_VAL          ((u32)0x0000000F << 22)           /*!< R/W 0x0  tid value of qos null*/
...
#define BIT_MASK_R_BQR_PRIMCH                ((u32)0x00000007 << 9)            /*!< R/W 0x0  shift bqr bitmap to the allocatied primary 20M channel*/
#define BIT_R_BQR_PRIMCH(x)                  (((u32)((x) & 0x00000007) << 9))
#define BIT_GET_R_BQR_PRIMCH(x)              ((u32)(((x >> 9) & 0x00000007)))
#define BIT_MASK_R_BQR_TID_VAL               ((u32)0x0000000F << 5)            /*!< R/W 0x0  bandwidth query report TID value*/
...
#define BIT_R_BSR_VO_TID_SEL                 ((u32)0x00000001 << 3)            /*!< R/W 0x0  1: tid 7; 0: tid 6;*/
#define BIT_R_BSR_VI_TID_SEL                 ((u32)0x00000001 << 2)            /*!< R/W 0x0  1: tid 5; 0: tid 4;*/
#define BIT_R_BSR_BE_TID_SEL                 ((u32)0x00000001 << 1)            /*!< R/W 0x0  1: tid 2; 0: tid 1;*/
#define BIT_R_BSR_BK_TID_SEL                 ((u32)0x00000001 << 0)            /*!< R/W 0x0  1: tid 3; 0: tid 0;*/
/** @} */
...
/** @defgroup REG_MACTX_MHDR1
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_NHDR_HTC   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  HTC field of tb_ppdu, which contain UPH a-control(4)*/
...
/** @defgroup REG_RXTRIG_TEST_CTRL1
  ...
  * @{
  */
#define BIT_MASK_RXTRIG_STATUS   ((u8)0x000000FF << 0)           /*!< R 0x0  [7:4]:trig_cntr [3:0]:ctl_state*/
#define BIT_RXTRIG_STATUS(x)     (((u8)((x) & 0x000000FF) << 0))
#define BIT_GET_RXTRIG_STATUS(x) ((u8)(((x >> 0) & 0x000000FF)))
/** @} */
...
/** @defgroup REG_RXTRIG_TEST_CTRL2
  ...
  * @{
  */
#define BIT_MASK_RXTRIG_DURATION   ((u16)0x0000FFFF << 0)           /*!< R/W 0x0  duration of trigger frame*/
#define BIT_RXTRIG_DURATION(x)     (((u16)((x) & 0x0000FFFF) << 0))
#define BIT_GET_RXTRIG_DURATION(x) ((u16)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup REG_AX_CLIENT_OM_CTRL
  ...
  * @{
  */
#define BIT_RXTRIG_RU26_DIS       ((u8)0x00000001 << 7)           /*!< R/W 0x0  disable response to trigger frame when ru_allocation addressed to me is 26-tone ru*/
#define BIT_CSI_LEN_ERR_FLAG      ((u8)0x00000001 << 6)           /*!< R 0x0  csi_length error flag*/
#define BIT_CLR_CSI_ERR_FLAG      ((u8)0x00000001 << 5)           /*!< R/W 0x0  clear csi_length error flag*/
#define BIT_WMAC_RXTB_IGNOREA2    ((u8)0x00000001 << 4)           /*!< R/W 0x1  will not check a2 when receive tb ppdu*/
#define BIT_MASK_UL_MU_DIS        ((u8)0x00000003 << 2)           /*!< R/W 0x0  Disable to respond UL response triggered by any trigger frame. Per port config.*/
#define BIT_UL_MU_DIS(x)          (((u8)((x) & 0x00000003) << 2))
#define BIT_GET_UL_MU_DIS(x)      ((u8)(((x >> 2) & 0x00000003)))
#define BIT_MASK_UL_MU_DATA_DIS   ((u8)0x00000003 << 0)           /*!< R/W 0x0  Disable to respond UL data triggered by basic trigger frame. Per port config. (BA/ACK/BSR/BQR are still allowed to Tx)*/
#define BIT_UL_MU_DATA_DIS(x)     (((u8)((x) & 0x00000003) << 0))
#define BIT_GET_UL_MU_DATA_DIS(x) ((u8)(((x >> 0) & 0x00000003)))
/** @} */
...
/** @defgroup REG_AX_TB_TIMING_CTRL
  ...
  * @{
  */
#define BIT_MASK_WMAC_SIFS_BUSY_DELAY   ((u32)0x00000FFF << 12)           /*!< R/W 0x0  This register sets the sifs_busy delay timer, when CCA fall need delay to check edcca or edcca_per20_bitmap It is in unit of 100ns.(default:0us)*/
#define BIT_WMAC_SIFS_BUSY_DELAY(x)     (((u32)((x) & 0x00000FFF) << 12))
#define BIT_GET_WMAC_SIFS_BUSY_DELAY(x) ((u32)(((x >> 12) & 0x00000FFF)))
#define BIT_MASK_TB_TIMEOUT_REF         ((u32)0x00000FFF << 0)            /*!< R/W 0x78  This register sets the max time for tb data aggragation, It is in unit of 100ns.(default:12us)*/
...
/** @defgroup REG_SR_CONTROL_DBG1
  ...
  * @{
  */
#define BIT_MASK_SR_USABLE_TIMER_THRES   ((u8)0x000000FF << 0)           /*!< R/W 0x4  If received pkt can operate spatial reuse,the min threshold for sr_timer_tx. unit:256us(default:1024us)*/
#define BIT_SR_USABLE_TIMER_THRES(x)     (((u8)((x) & 0x000000FF) << 0))
#define BIT_GET_SR_USABLE_TIMER_THRES(x) ((u8)(((x >> 0) & 0x000000FF)))
/** @} */
...
/** @defgroup REG_RX_NAV_CTRL
  ...
  * @{
  */
#define BIT_WMAC_PLCP_UP_NAV_EN  ((u8)0x00000001 << 4) /*!< R/W 0x0  1:enable using txop_dur in plcp header to update nav*/
#define BIT_WMAC_TF_UP_NAV_EN    ((u8)0x00000001 << 3) /*!< R/W 0x1  1:enable updating intra nav when receiving trigger frame*/
#define BIT_SRCTRL_PLCP_EN       ((u8)0x00000001 << 2) /*!< R/W 0x0  1:use txop_dur as sr_tx_timer*/
#define BIT_WMAC_INTRANAV_INTXOP ((u8)0x00000001 << 1) /*!< R/W 0x1  enable updating intra nav in my txop*/
#define BIT_WMAC_BASICNAV_INTXOP ((u8)0x00000001 << 0) /*!< R/W 0x1  enable updating basic nav in my txop*/
/** @} */

/** @defgroup REG_AX_TB_TIMING_CTRL1
  * @brief
  * @{
  */
#define BIT_TB_SIFS_USE_NORMAL ((u16)0x00000001 << 12)          /*!< R/W 0x0  1:choose 0x179c sifs when rx trigger 0:choose 0x17A0[11:0] sifs when rx trigger*/
#define BIT_MASK_TB_SIFS_REF   ((u16)0x00000FFF << 0)           /*!< R/W 0x7e  This register sets the SIFS time required for tb response when receiving trigger frame. It is in unit of 100ns.(default:12.6us)*/
#define BIT_TB_SIFS_REF(x)     (((u16)((x) & 0x00000FFF) << 0))
#define BIT_GET_TB_SIFS_REF(x) ((u16)(((x >> 0) & 0x00000FFF)))
/** @} */
...
/** @defgroup REG_NAV_STATUS
  ...
  * @{
  */
#define BIT_MASK_WMAC_INTRA_NAV_UPD   ((u32)0x00000003 << 30)           /*!< R 0x0  intra nav updated by 10: plcp header 01: mac header*/
...
#define BIT_MASK_WMAC_BASIC_NAV_UPD   ((u32)0x00000003 << 14)           /*!< R 0x0  inter nav updated by 10: plcp header 01: mac header*/
...
#define BIT_RESP_STBC_EN           ((u32)0x00000001 << 28)           /*!< R/W 0x0  enable stbc when need to response*/
...
#define BIT_RESP_RXTRIG_CHK_INSIFS ((u32)0x00000001 << 22)           /*!< R/W 0x0  check whether channel is idle during sifs, if csreq=1 in trigger frame, will not reply with tb ppdu*/
...
#define BIT_RESP_CHK_SEC_CCA40     ((u32)0x00000001 << 18)           /*!< R/W 0x0  check sec 40 cca when response*/
#define BIT_RESP_CHK_SEC_CCA80     ((u32)0x00000001 << 17)           /*!< R/W 0x0  check sec 80 cca when response*/
#define BIT_RESP_EARLY_LEG_SEC     ((u32)0x00000001 << 16)           /*!< R/W 0x1  when receive pkt of tkip or wep, While phyrxon down, mac_rxactive on. Ignore mac rx busy or physts_on, respond  immediately.*/
...
#define BIT_RESP_CHK_EDCCA_PER20   ((u32)0x00000001 << 11)           /*!< R/W 0x0  check edcca_per20_bitmap_sifs[0] when response*/
...
#define BIT_WMAC_HE_NDPA_EN           ((u32)0x00000001 << 0)            /*!< R/W 0x1  Set to 1, MAC would inform BB of preparing to receive NDP if the received NDPA is valid.*/
/** @} */
...
/** @defgroup REG_GID_POS_EN_H
  ...
  * @{
  */
#define BIT_MASK_R_GID_POSITION_EN_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  VHT group id position enable*/
...
/** @defgroup REG_TRX_PKTCNT_CTRL
  ...
  * @{
  */
#define BIT_R_TXPKTCNT_RST             ((u32)0x00000001 << 11)          /*!< R/W 0x0  Reset tx packet counter, write "one" to set the counter to zero*/
#define BIT_R_TX_UDPKTCNT_SET          ((u32)0x00000001 << 10)          /*!< R/W 0x0  Set user define packet configure, write one setting, it is only valid for r_wmac_txpktcnt_sel (4'd0 ~ 4'd3)*/
#define BIT_MASK_R_WMAC_TXPKTCNT_SEL   ((u32)0x0000000F << 6)           /*!< R/W 0x0  Tx packet counter report selection  4'd0: user define 0 counter 4'd1: user define 1 counter 4'd2: user define 2 counter 4'd3: user define 3 counter 4'd4: HT mpdu tx ok counter 4'd5: VHT SU mpdu tx ok counter 4'd6: HE SU mpdu tx ok counter 4'd7: HE TB mpdu tx ok counter 4'd8: CCK ppdu tx ok counter 4'd9: OFDM ppdu tx ok counter 4'd10: HT ppdu tx ok counter 4'd11: VHT SU ppdu tx ok counter 4'd12: HE SU ppdu tx ok counter 4'd13: HE TB ppdu tx ok counter 4'd14~4'd15: RSVD*/
#define BIT_R_WMAC_TXPKTCNT_SEL(x)     (((u32)((x) & 0x0000000F) << 6))
#define BIT_GET_R_WMAC_TXPKTCNT_SEL(x) ((u32)(((x >> 6) & 0x0000000F)))
#define BIT_MASK_R_WMAC_TXPKTCNT_CFG   ((u32)0x0000003F << 0)           /*!< R/W 0x0  Tx packet conuter user define configuration [5:2]:subtype [1:0]:type*/
...
/** @defgroup REG_TRX_PKTCNT_RPT
  ...
  * @{
  */
#define BIT_MASK_RO_WMAC_TXPKTCNT_RPT   ((u32)0x03FFFFFF << 0)           /*!< R 0x0  [25:22]:Tx packet counter report selection,r_wmac_txpktcnt_sel [21:16]:user define->tx packet type,[21:18]:subtype,[17:16]:type; others->6'h0 [15:0]:The tx reported counter value corresponding to Report type selected*/
...
/** @defgroup REG_BEAMFORMING_MIMO_STATUS
  ...
  * @{
  */
#define BIT_MASK_RO_WMAC_HE_CSI_MIMO_H   ((u32)0x00FFFFFF << 0)           /*!< R 0x0  msb 24bit of he csi mimo field*/
...
/** @defgroup REG_RESP_CONTROL_1
  ...
  * @{
  */
#define BIT_RESP_TX_WITH_FCSERR      ((u32)0x00000001 << 19)          /*!< R/W 0x0  1:if resp_chk_fcs is low and mactx starts to generate mpdu,will tx response with wrong crc32*/
#define BIT_RESP_CHK_FCS_ABORT_TX    ((u32)0x00000001 << 18)          /*!< R/W 0x0  If set to 1, will not response ack if fcs is not rdy when sifs reach if set to 0, will response ack if fcs is not rdy when sifs reach*/
#define BIT_WMAC_TXRAW_IGNOREA1      ((u32)0x00000001 << 17)          /*!< R/W 0x1  If set to 1, will not check A1 of rxpkt when txraw*/
#define BIT_RESP_ACTRL_BQR_EN        ((u32)0x00000001 << 16)          /*!< R/W 0x1  If set to 1, HW would update BQR info to A-CTRL*/
#define BIT_RESP_ACTRL_UPH_EN        ((u32)0x00000001 << 15)          /*!< R/W 0x1  If set to 1, HW would update UPH info to A-CTRL*/
#define BIT_RESP_ACTRL_BSR_EN        ((u32)0x00000001 << 14)          /*!< R/W 0x1  If set to 1, HW would update BSR info to A-CTRL*/
#define BIT_RESP_ACTRL_CAS_EN        ((u32)0x00000001 << 13)          /*!< R/W 0x1  If set to 1, HW would update CAS info to A-CTRL*/
#define BIT_RESP_LDPC_SEL            ((u32)0x00000001 << 12)          /*!< R/W 0x1  1: follow ctrl reg(0x668[15]) 0: follow rxpkt*/
#define BIT_RESP_GID_SEL             ((u32)0x00000001 << 11)          /*!< R/W 0x1  HE SIG-A content 1 :  group id=0, 0 :  group id=63*/
#define BIT_MASK_RESP_DOPPLER_CTRL   ((u32)0x00000003 << 9)           /*!< R/W 0x0  0: Doppler unsupported 1: Doppler supported without moving 2: 10 symbol midamble periodicity 3: 20 symbol midamble periodicity*/
#define BIT_RESP_DOPPLER_CTRL(x)     (((u32)((x) & 0x00000003) << 9))
#define BIT_GET_RESP_DOPPLER_CTRL(x) ((u32)(((x >> 9) & 0x00000003)))
#define BIT_RESP_DOPPLER_SEL         ((u32)0x00000001 << 8)           /*!< R/W 0x0  1: follow ctrl reg(0x17E0[10]) 0: follow rxpkt*/
#define BIT_RESP_DCM_SEL             ((u32)0x00000001 << 7)           /*!< R/W 0x0  1: follow ctrl reg(0x17b4[25]) 0: follow rxpkt*/
#define BIT_RESP_BSR_FORMAT          ((u32)0x00000001 << 6)           /*!< R/W 0x0  0: legacy format of queue size 1: HE*/
#define BIT_MASK_RESP_NOMINAL_PAD    ((u32)0x00000003 << 4)           /*!< R/W 0x0  nominal pkt pad info when response*/
#define BIT_RESP_NOMINAL_PAD(x)      (((u32)((x) & 0x00000003) << 4))
#define BIT_GET_RESP_NOMINAL_PAD(x)  ((u32)(((x >> 4) & 0x00000003)))
#define BIT_RESP_EARLY_START         ((u32)0x00000001 << 3)           /*!< R/W 0x1  when set to 1:use mac header rdy when rx data frame and use aid fit when rx trigger frame, and use fcsok otherwise to start responding process when set to 0:use fcs ok to start responding process when rx any frame need reply*/
#define BIT_RESP_USE_EARLY_FCS       ((u32)0x00000001 << 2)           /*!< R/W 0x1  use fcs result from rxpktfifo instead of macrx_parser when receive packet used wep/tkip*/
#define BIT_RESP_ALLACK_EN           ((u32)0x00000001 << 1)           /*!< R/W 0x0  enable response with all-ack MBA*/
/** @} */
...
/** @defgroup REG_SPATIAL_REUSE_CONTROL
  ...
  * @{
  */
#define BIT_MASK_TXPWR_CH20_DATA   ((u32)0x000000FF << 1)           /*!< R/W 0x0  indicate which 20M channel is punctured in RU*/
#define BIT_TXPWR_CH20_DATA(x)     (((u32)((x) & 0x000000FF) << 1))
#define BIT_GET_TXPWR_CH20_DATA(x) ((u32)(((x >> 1) & 0x000000FF)))
#define BIT_TXPWR_FAST_MODE_EN     ((u32)0x00000001 << 0)           /*!< R/W 0x1  fast mode enable for txpwr_ctrl,tie 1 for AMEBAD2*/
/** @} */
...
/** @defgroup REG_RX_SUPPER_ADDRESS3_L
  ...
  * @{
  */
#define BIT_MASK_R_SUP_ADDR3_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Address3 for data packet check. When address3 is match, RX will receive the packet to RXFF without considering other filter condition except crc32*/
...
/** @defgroup REG_RX_SUPPER_ADDRESS3_H
  ...
  * @{
  */
#define BIT_R_SUP_ADDR3_EN       ((u32)0x00000001 << 16)          /*!< R/W 0x0  when set, enable check supper Address3*/
#define BIT_MASK_R_SUP_ADDR3_H   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Address3 for data packet check. When address3 is match, RX will receive the mpdu to RXFF without considering other filter condition except crc32*/
...
/** @defgroup REG_MASK_LA_TRX_DBG_L
  ...
  * @{
  */
#define BIT_MASK_LA_TRX_PATTERN_MASK_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for mask one or more bits of debug port*/
...
/** @defgroup REG_MASK_LA_TRX_DBG_H
  ...
  * @{
  */
#define BIT_MASK_LA_TRX_PATTERN_MASK_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for mask one or more bits of debug port*/
...
/** @defgroup REG_REF_LA_TRX_DBG_L
  ...
  * @{
  */
#define BIT_MASK_LA_TRX_PATTERN_REF_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for mask one or more bits of debug port*/
...
/** @defgroup REG_REF_LA_TRX_DBG_H
  ...
  * @{
  */
#define BIT_MASK_LA_TRX_PATTERN_REF_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  used for mask one or more bits of debug port*/
#define BIT_LA_TRX_PATTERN_REF_H(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_LA_TRX_PATTERN_REF_H(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/*==========REG_PAGE17 Register Address Definition==========*/
...
#define REG_AX_TB_TIMING_CTRL1               0x17AA
