#ifndef _RL7005_REG_PAGE6_PATCH_H_
#define _RL7005_REG_PAGE6_PATCH_H_
...
/** @defgroup REG_TCR_TSFT_OFS
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_TCR_TSFT_NS_OFS_OFDM   ((u32)0x000003FF << 10)           /*!< R/W 0x0  TCR TSFT NS OFS OFDM*/
#define BIT_R_WMAC_TCR_TSFT_NS_OFS_OFDM(x)     (((u32)((x) & 0x000003FF) << 10))
#define BIT_GET_R_WMAC_TCR_TSFT_NS_OFS_OFDM(x) ((u32)(((x >> 10) & 0x000003FF)))
#define BIT_MASK_R_WMAC_TCR_TSFT_NS_OFS_CCK   ((u32)0x000003FF << 0)           /*!< R/W 0x0  TCR TSFT NS OFS CCK*/
#define BIT_R_WMAC_TCR_TSFT_NS_OFS_CCK(x)     (((u32)((x) & 0x000003FF) << 0))
#define BIT_GET_R_WMAC_TCR_TSFT_NS_OFS_CCK(x) ((u32)(((x >> 0) & 0x000003FF)))
/** @} */
