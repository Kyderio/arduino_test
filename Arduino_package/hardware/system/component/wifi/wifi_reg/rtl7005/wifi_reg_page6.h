#ifndef _RL7005_REG_PAGE6_H_
#define _RL7005_REG_PAGE6_H_
...
/** @defgroup REG_WMAC_CR
  ...
  * @{
  */
#define BIT_TXPWR_CTL_CLK_EN            ((u32)0x00000001 << 31)           /*!< R/W 0x0  IF set to 1, txpwr_ctrl clock enable, only work when BIT_TXPWR_CTL_ENGCLK set to 1,*/
#define BIT_TXPWR_CTL_ENGCLK            ((u32)0x00000001 << 30)           /*!< R/W 0x0  If set to 1, enable txpwr_ctrl clock gating function.*/
#define BIT_WLAN_RX_REQ_SIFS_CLR        ((u32)0x00000001 << 29)           /*!< R/W 0x0  When set, enable sifs clear wlan_rx_req*/
#define BIT_DIS_WAIT_HE_SIGB            ((u32)0x00000001 << 28)           /*!< R/W 0x0  When set, will not wait and check he mu sigb and ndp info*/
#define BIT_WMAC_20MHZBW                ((u32)0x00000001 << 27)           /*!< R/W 0x1  */
#define BIT_WMAC_M11J                   ((u32)0x00000001 << 26)           /*!< R/W 0x0  */
#define BIT_MASK_WMAC_RXUC_BBYE_MACID   ((u32)0x0000007F << 19)           /*!< R 0x0  hw latch macid when rx my unicast bye-bye frame in relay mode 7E:rxpktbuf full 7F:not valid macid*/
#define BIT_WMAC_RXUC_BBYE_MACID(x)     (((u32)((x) & 0x0000007F) << 19))
#define BIT_GET_WMAC_RXUC_BBYE_MACID(x) ((u32)(((x >> 19) & 0x0000007F)))
#define BIT_DATA_FW_STS_FILTER          ((u32)0x00000001 << 18)           /*!< R/W 0x0  When this bit is set,Accept data frame in partial length condition. It will take effect when RxFilter3-5 is disabled and RxFilter 0-2 is enabled.*/
#define BIT_CTRL_FW_STS_FILTER          ((u32)0x00000001 << 17)           /*!< R/W 0x0  When this bit is set,Accept control frame in partial length condition. It will take effect when RxFilter3-5 is disabled and RxFilter 0-2 is enabled.*/
#define BIT_MGNT_FW_STS_FILTER          ((u32)0x00000001 << 16)           /*!< R/W 0x0  When this bit is set,Accept management frame in partial length condition. It will take effect when RxFilter3-5 is disabled and RxFilter 0-2 is enabled.*/
#define BIT_FWRX_EN                     ((u32)0x00000001 << 15)           /*!< R/W 0x0  Enable to receive pkt into FWFF, default 1'b0. When Fw needs to receive pkt, this bit must be set to 1'b1*/
#define BIT_PHYSTS_PKT_CTRL             ((u32)0x00000001 << 14)           /*!< R/W 0x0  If set to 1,HW will send interrupt (0x124[26]) only when there is phy status valid fwsts pkt written into FWFF*/
#define BIT_APPHDR_MIDSRCH_FAIL         ((u32)0x00000001 << 12)           /*!< R/W 0x0  If set to 1, Hw will append 16 bytes MAC header into FWFF when MACID search fail*/
#define BIT_FWPARSING_EN                ((u32)0x00000001 << 11)           /*!< R/W 0x0  If set to 1, mac header and rx desc of the pkt into rx buff are also received into FWFF.*/
#define BIT_MASK_APPEND_MHDR_LEN        ((u32)0x00000007 << 8)            /*!< R/W 0x0  Appended MAC header length, unit in 32 bytes*/
#define BIT_APPEND_MHDR_LEN(x)          (((u32)((x) & 0x00000007) << 8))
#define BIT_GET_APPEND_MHDR_LEN(x)      ((u32)(((x >> 8) & 0x00000007)))
#define BIT_APSDOFF                     ((u32)0x00000001 << 6)            /*!< R/W 0x0  1:MAC issue sleep signal to disable BB/AFE/RF TRX function. After MAC has finished, APSDOFF_STATUS will report"1". 0:MAC issue wakeup signal to recall BB/AFE/RF back to RX idle mode. After MAC has finished,APSDOFF _STATUS will report "0".*/
#define BIT_R_RXTRIG_DIS_UPD_AID        ((u32)0x00000001 << 4)            /*!< R/W 0x0  1:will only update aid_fit info when the first trigger in a ppdu is parsered 0:will update aid_fit info every time when two or more trigger aggregate in a ppdu*/
#define BIT_R_RXTRIG_DIS_CHK_A1         ((u32)0x00000001 << 3)            /*!< R/W 0x0  1:will not check if A1 of trigger frame is my unicast or broadcast address 0:will check if A1 of trigger frame is my unicast or broadcast address*/
#define BIT_R_DIS_CHK_NEW_TBREQ         ((u32)0x00000001 << 2)            /*!< R/W 0x0  1:rxtrig req_in will assert every time when aid fit if two or more trigger aggregate in a ppdu 0:rxtrig req_in will not assert again when there is already a correct trigger received*/
#define BIT_R_DIS_ABORT_TB_ELY          ((u32)0x00000001 << 1)            /*!< R/W 0x0  1:will abort ptcl generating tb data when macrx_active is low 0:will abort ptcl generating tb data when new rxtrig req_in is assert*/
...
/** @defgroup REG_TCR
  ...
  * @{
  */
#define BIT_WMAC_EN_RTS_ADDR         ((u32)0x00000001 << 31) /*!< R/W 0x0  when set to 1, enable change RTS multicast address*/
#define BIT_WMAC_DISABLE_CCK         ((u32)0x00000001 << 30) /*!< R/W 0x0  when set to 1, disable cck rate packet*/
#define BIT_WMAC_RAW_LEN             ((u32)0x00000001 << 29) /*!< R/W 0x1  1: use raw ppdu_len 0: use 4byte alignment ppdu_len*/
#define BIT_WMAC_NOTX_IN_RXNDP       ((u32)0x00000001 << 28) /*!< R/W 0x0  1: block original tx when receiving NDP packet*/
#define BIT_WMAC_EN_EOF              ((u32)0x00000001 << 27) /*!< R/W 0x1  when set to 1, enable single ampdu for qos packet. In  early mode,not set to 1.*/
...
#define BIT_WMAC_ANTMODE_SEL         ((u32)0x00000001 << 25) /*!< R/W 0x0  0:4x1 mode, 1:8x1 mode*/
#define BIT_WMAC_TCRPWRMGT_HWCTL     ((u32)0x00000001 << 24) /*!< R/W 0x0  If this bit is set to 1, MAC will overwrite power bit of frame control according to  PWR_ST.  (only for RTS/CTS/ACK/CFEND/BA/BAR frames)*/
...
#define BIT_UNDERFLOWEN_CMPLEN_SEL   ((u32)0x00000001 << 21) /*!< R/W 0x1  compare length selector for enable condition of underflow, consider plcp header when set 1*/
...
#define BIT_WMAC_TCR_EN_20MST        ((u32)0x00000001 << 19) /*!< R/W 0x0  when set to 1, enable ndpa signaling TA when BW =20MHz*/
...
#define BIT_WMAC_CFENDFOR            ((u32)0x00000001 << 9)  /*!< R/W 0x0  CF-End Frame Format.The Address 2 field of CF-End is defined to be the address of the STA contained in the AP, but in 802.11n a STA can also send CF-End.The Address 2 field is not specified clearly in this case. This register chooses between MAC ID of the STA or BSSID of the network. 0: BSSID 1: MAC ID*/
...
#define BIT_WMAC_TCR_UPD_HGQMD       ((u32)0x00000001 << 4)  /*!< R/W 0x0  when set to 1, enable HGQ  set moredata bit in Frame control field*/
...
#define BIT_VHT_DACK      ((u32)0x00000001 << 26) /*!< R/W 0x1  This bit to control response type for vht single mpdu data packet. 1: ACK as response 0: BA as response*/
#define BIT_TCPOFLD_EN    ((u32)0x00000001 << 25) /*!< R/W 0x0  When set,Enable TCP checksum offload*/
...
#define BIT_DISCHKPPDLLEN ((u32)0x00000001 << 21) /*!< R/W 0x0  When set,do not check PPDU while the PPDU length is smaller than 14 byte.*/
#define BIT_PKTCTL_DLKEN  ((u32)0x00000001 << 20) /*!< R/W 0x0  When set,while rx path dead lock occurs, reset rx path*/
#define BIT_DISGCLK       ((u32)0x00000001 << 19) /*!< R/W 0x0  When set,disable macrx clock gating control*/
#define BIT_TIMPSR_EN     ((u32)0x00000001 << 18) /*!< R/W 0x0  When set, enable RX Beacon TIM Parser*/
...
#define BIT_CHK_PREVTXA2  ((u32)0x00000001 << 13) /*!< R/W 0x0  When set,enable check rxa1 with txa2.*/
#define BIT_ACK_CBSSID    ((u32)0x00000001 << 12) /*!< R/W 0x0  The field effects behavior of response frame,except TB.                                                                                       0:Only A1 match to send response frame.                                                                                                1:A1 match and satisfy BSSID condition will send response frame.*/
#define BIT_CHKTA_MGNT    ((u32)0x00000001 << 11) /*!< R/W 0x0  Check Transmitter_BCN When set to 1, MAC will check the Transmitter Address (A2) of RX beacon or Probe response to determine if this packet belongs to this Transmitter Address (Address 2) . Both in  Infrastructure mode and  Ad-hoc mode.*/
...
/** @defgroup REG_RXPKT_CTL
  ...
  * @{
  */
#define BIT_APP_PHYSTS_PER_SUBMPDU ((u32)0x00000001 << 31)           /*!< R/W 0x0  When this bit is set to 1,append phy status for each mpdu if phy status is valid. Otherwise,append phy status for each ppdu.*/
#define BIT_APP_MH_SHIFT_VAL       ((u32)0x00000001 << 30)           /*!< R/W 0x0  When this bit is set to 1,append MAC header shift value in rx descriptor,otherwise, not append*/
#define BIT_WMAC_ENSHIFT           ((u32)0x00000001 << 29)           /*!< R/W 0x0  MAC header shift function enable signal in MACRX*/
...
#define BIT_MBID_EN                ((u32)0x00000001 << 23)           /*!< R/W 0x0  */
#define BIT_MASK_MBID_BCNNO        ((u32)0x00000007 << 20)           /*!< R/W 0x0  */
...
/** @defgroup REG_MACID
  ...
  * @{
  */
#define BIT_MASK_MACID_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  MAC Identification Number Register BIT[31:0]*/
...
/** @defgroup REG_MACID_H
  ...
  * @{
  */
#define BIT_R_MACRX_RESET     ((u32)0x00000001 << 25)          /*!< WA0 0x0  set 1 to reset macrx.One pulse*/
#define BIT_R_CHKBSSID_NAN_P2 ((u32)0x00000001 << 23)          /*!< R/W 0x0  When set 1,enable check port2 bssid.*/
#define BIT_EN_PORT2          ((u32)0x00000001 << 22)          /*!< R/W 0x0  When set 1,enable NAN PORT2*/
#define BIT_R_AP_BSSID_FIT_UC ((u32)0x00000001 << 21)          /*!< R/W 0x1  When set 1,bssid fit when AP port0 rx unciast data packet*/
#define BIT_CHKBSSID_DATA_P1  ((u32)0x00000001 << 20)          /*!< R/W 0x0  When set,enable check port1 data frame bssid*/
#define BIT_CHKBSSID_CTL_P1   ((u32)0x00000001 << 19)          /*!< R/W 0x0  When set,enable check port1 bssid of trigger/vhtndpa/hendpa/ba*/
#define BIT_CHKBSSID_MGNT_P1  ((u32)0x00000001 << 18)          /*!< R/W 0x0  When set,enable check port1 mgnt frame bssid*/
#define BIT_EN_PORT1          ((u32)0x00000001 << 17)          /*!< R/W 0x1  When set 1,enable PORT1*/
#define BIT_EN_PORT0          ((u32)0x00000001 << 16)          /*!< R/W 0x1  When set 1,enable PORT0*/
...
/** @defgroup REG_MBIDCAMCFG_1
  ...
  * @{
  */
#define BIT_MASK_MBIDCAM_WDATA_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  BSSID[31:0]*/
...
#define BIT_MBIDCAM_DA_EN           ((u32)0x00000001 << 29)           /*!< R/W 0x1  CAM Direct Acess Enable*/
#define BIT_MASK_MBIDCAM_ADDR_V1    ((u32)0x0000001F << 24)           /*!< R/W 0x0  CAM Address*/
...
#define BIT_R_RESP_ERSU_DISUSE_RX ((u32)0x00000001 << 13)           /*!< R/W 0x0  0:rx er su will response tx er su*/
#define BIT_R_RESP_DCM_DISUSE_RX  ((u32)0x00000001 << 12)           /*!< R/W 0x0  0:rx dcm will response tx dcm when ctrl info is valid and inf0_dcm=1*/
...
/** @defgroup REG_ADDRESS_CAM_CTL
  * @brief
  * @{
  */
#define BIT_MASK_CCA_IDUNMATCH_CNT   ((u32)0x0000FFFF << 16)           /*!< R 0x0  macid no match counter for mpdu*/
#define BIT_CCA_IDUNMATCH_CNT(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_CCA_IDUNMATCH_CNT(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_R_IDUNMATCH_CNT_CLR      ((u32)0x00000001 << 7)            /*!< WA0 0x0  when set, generate one pulse and reset cca_idunmatch_cnt*/
#define BIT_R_MACID_STATIC_SEL       ((u32)0x00000001 << 6)            /*!< R/W 0x0  when set, statistic only A1 match packet;otherwise statistic A1 match and my bc/mc packet for macid_match_no_fcs*/
#define BIT_R_RELAY_MODE             ((u32)0x00000001 << 5)            /*!< R/W 0x0  when set, enable relay mesh function*/
#define BIT_R_DIS_ADDRCAM            ((u32)0x00000001 << 4)            /*!< R/W 0x1  when set, disable address cam filter function*/
#define BIT_MASK_R_ADDRCAM_NUM       ((u32)0x0000000F << 0)            /*!< R/W 0xF  address filter cam number, up to 16 entries*/
#define BIT_R_ADDRCAM_NUM(x)         (((u32)((x) & 0x0000000F) << 0))
#define BIT_GET_R_ADDRCAM_NUM(x)     ((u32)(((x >> 0) & 0x0000000F)))
/** @} */

/** @defgroup REG_TXOPOWNER_L
  * @brief
  * @{
  */
#define BIT_MASK_R_TXOPOWNER_ADDR_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x80010  txopowner mac address Register BIT[31:0]*/
#define BIT_R_TXOPOWNER_ADDR_L(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_R_TXOPOWNER_ADDR_L(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup REG_NAV_THRSHOLD
  ...
  * @{
  */
#define BIT_MASK_NAV_UPBDY     ((u32)0x000000FF << 16)           /*!< R/W 0x0  When NAV update is beyond this value, then NAV update is aborted. When this field is 0x00, NAV_UPPER function is disable. The unit is 128us.*/
...
#define BIT_BACAM_RST        ((u32)0x00000001 << 17)           /*!< RW1C 0x0  Set 1 to reset BA CAM. Hardware will set the invalid bit for all entries. After reset is finished this bit is reset to 0.*/
...
#define BIT_RXBACAM_DA_EN    ((u32)0x00000001 << 13)           /*!< R/W 0x1  CAM Direct Acess enable*/
#define BIT_MASK_BACAM_AD    ((u32)0x0000003F << 0)            /*!< R/W 0x0  BA CAM address. Memory is double-word access.*/
...
/** @defgroup REG_LBK_DLY
  ...
  * @{
  */
#define BIT_BITMAP_FLAG_VO              ((u32)0x00000001 << 31)           /*!< RW1C 0x0  When BIT_BITMAP_VO = 1,  HW will check received packet's sequence number by BIT_BITMAP_CONDITION, and clear the bit after occur one time which received the correct sequence number.*/
#define BIT_BITMAP_FLAG_VI              ((u32)0x00000001 << 30)           /*!< RW1C 0x0  When BIT_BITMAP_VI = 1,  HW will check received packet's sequence number by BIT_BITMAP_CONDITION, and clear the bit after occur one time which received the correct sequence number.*/
#define BIT_BITMAP_FLAG_BE              ((u32)0x00000001 << 29)           /*!< RW1C 0x0  When BIT_BITMAP_BE = 1,  HW will check received packet's sequence number by BIT_BITMAP_CONDITION, and clear the bit after occur one time which received the correct sequence number.*/
#define BIT_BITMAP_FLAG_BK              ((u32)0x00000001 << 28)           /*!< RW1C 0x0  When BIT_BITMAP_BK = 1,  HW will check received packet's sequence number by BIT_BITMAP_CONDITION, and clear the bit after occur one time which received the correct sequence number.*/
#define BIT_MASK_BITMAP_CONDITION       ((u32)0x00000003 << 26)           /*!< R/W 0x0  ADDBA condition: 0: HW start sequence - 64. 1: HW start sequence - 128. 2: HW start sequence - 256. 3: HW start sequence - 512.*/
#define BIT_BITMAP_CONDITION(x)         (((u32)((x) & 0x00000003) << 26))
#define BIT_GET_BITMAP_CONDITION(x)     ((u32)(((x >> 26) & 0x00000003)))
#define BIT_BITMAP_SSNBK_COUNTER_CLR    ((u32)0x00000001 << 25)           /*!< RW1C 0x0  Clear BIT_BITMAP_SSNBK_COUNTER.*/
#define BIT_BITMAP_FORCE                ((u32)0x00000001 << 24)           /*!< R/W 0x0  Under the BIT_BITMAP_EN = 1 condition. 1: Rx's packet always checks sequence number by BIT_BITMAP_CONDITION. 0: Disable*/
#define BIT_MASK_RXPKT_TYPE             ((u32)0x0000003F << 18)           /*!< R 0x0  The type and subtype field of frame control of rx packet*/
...
#define BIT_MASK_BITMAP_SSNBK_COUNTER   ((u32)0x0000003F << 10)           /*!< R 0x0  Count the sequence number out of BITMAP condition (0x663[3:2]).*/
#define BIT_BITMAP_SSNBK_COUNTER(x)     (((u32)((x) & 0x0000003F) << 10))
#define BIT_GET_BITMAP_SSNBK_COUNTER(x) ((u32)(((x >> 10) & 0x0000003F)))
#define BIT_BITMAP_EN                   ((u32)0x00000001 << 9)            /*!< R/W 0x0  1:Enable of counter and WMAC_BITMAP_CTL(0x663) 0:Disable function*/
#define BIT_BACAM_RPMEN                 ((u32)0x00000001 << 8)            /*!< R/W 0x0  1:Enable repeat mode 0:Disable function*/
...
/** @defgroup REG_RXERR_RPT
  ...
  * @{
  */
#define BIT_MASK_RXERR_RPT_SEL_V1_3_0   ((u32)0x0000000F << 28)           /*!< R/W 0x0  Rx packet counter report selection bit3~bit0 RXERR_RPT_SEL[25,26,31:28]: Counter description 6'd0: OFDM MPDU OK counter 6'd1: OFDM MPDU Fail counter 6'd2: OFDM False Alarm counter 6'd3: CCK MPDU OK counter 6'd4: CCK MPDU Fail counter 6'd5: CCK False Alarm counter; 6'd6: HT MPDU OK counter 6'd7: HT MPDU Fail counter 6'd8: HT PPDU PLCP ok counter 6'd9: HT False Alarm counter 6'd10: Rx full drop packet counter 6'd11: RSVD 6'd12: user define 0 counter 6'd13: user define 1 counter 6'd14: user define 2 counter 6'd15: user define 3 counter 6'd16: VHT SU MPDU OK counter 6'd17: VHT SU MPDU Fail counter 6'd18: VHT SU PPDU plcp ok counter 6'd19: VHT SU False Alarm counter 6'd20: invalid_pkt counter 6'd21: VHT MU MPDU OK counter 6'd22: VHT MU MPDU Fail counter 6'd23: VHT MU PPDU plcp ok counter 6'd24: VHT MU False Alarm counter 6'd25: HE SU MPDU OK counter 6'd26: HE SU MPDU Fail counter 6'd27: HE SU PPDU plcp ok counter 6'd28: HE SU False Alarm counter 6'd29: HE MU MPDU OK counter 6'd30: HE MU MPDU Fail counter 6'd31: HE MU PPDU plcp ok counter 6'd32: HE MU False Alarm counter 6'd33: drop packet counter*/
#define BIT_RXERR_RPT_SEL_V1_3_0(x)     (((u32)((x) & 0x0000000F) << 28))
#define BIT_GET_RXERR_RPT_SEL_V1_3_0(x) ((u32)(((x >> 28) & 0x0000000F)))
#define BIT_RXERR_RPT_RST               ((u32)0x00000001 << 27)           /*!< WA0 0x0  Write "1" to set the counter to zero. One pulse*/
#define BIT_RXERR_RPT_SEL_V1_4          ((u32)0x00000001 << 26)           /*!< R/W 0x0  Rx packet counter report selection bit4*/
#define BIT_RXERR_RPT_SEL_V1_5          ((u32)0x00000001 << 25)           /*!< R/W 0x0  Rx packet counter report selection bit5*/
#define BIT_UD_SELECT_BSSID_1           ((u32)0x00000001 << 24)           /*!< R/W 0x0  {24,22} Select matched BSSID: 2'b0: Port 0 2'b1: Port 1 otherwise, do not care bssid match or not*/
#define BIT_W1S                         ((u32)0x00000001 << 23)           /*!< R/W 0x0  Write One Setting, it is only valid for RXERR_RPT_SEL (4'd12 ~ 4'd15)*/
#define BIT_UD_SELECT_BSSID_0           ((u32)0x00000001 << 22)           /*!< R/W 0x0  Select BSSID bit0*/
...
#define BIT_EN_STOP_UPDNAV            ((u32)0x00000001 << 28)           /*!< R/W 0x0  When this bit set 1. If RX packet with EDCA_REF is low, not update NAV.*/
#define BIT_RST_EDCA_ACKTO            ((u32)0x00000001 << 27)           /*!< R/W 0x1  While in ACKTO duration, reset scheduler top to TX*/
#define BIT_RST_EDCA_EIFS             ((u32)0x00000001 << 26)           /*!< R/W 0x1  While in EIFS duration, reset scheduler top to TX*/
#define BIT_PLCPCHK_RST_EIFS          ((u32)0x00000001 << 25)           /*!< R/W 0x1  Reset EIFS counter while receive correct PLCP.*/
#define BIT_CCA_RST_EIFS              ((u32)0x00000001 << 24)           /*!< R/W 0x0  Reset EIFS counter while CCA on*/
#define BIT_DIS_UPD_MYRXPKTNAV        ((u32)0x00000001 << 23)           /*!< R/W 0x1  Do not update NAV, while receiving my packet.*/
...
#define BIT_DIS_RESP_ACKINCCA         ((u32)0x00000001 << 14)           /*!< R/W 0x0  Disable to response ack when cca goes high after SIFS*/
#define BIT_DIS_RESP_CTSINCCA         ((u32)0x00000001 << 13)           /*!< R/W 0x0  8812 Disable to response cts when cca goes high after SIFS*/
...
#define BIT_RESP_CHK_A2_REFUGEE       ((u32)0x00000001 << 9)            /*!< R/W 0x0  if port 1 isacting as AP,this bit should set 0,otherwise should set 1 if relay mode enable and port1 is not AP mode*/
...
#define BIT_MASK_RESP_CTS_DYNBW_SEL   ((u32)0x00000003 << 5)            /*!< R/W 0x0  8812 Response cts bw selection when dynamic rts frame is received 00: current maximum bw indicated by secondary cca 01: bw fall back by one level based on bw in 2"b00 if not reach 20M 10: bw fall back by one level based on bw in 2"b01 if not reach 20M 11: bw fall back by one level based on bw in 2"b10 if not reach 20M e.g, current maximum bw indicated by secondary_cca is 80M, when set to 2"b00, the response cts bw is 80M, when set to 2"b01, cts bw is 40M, when set to 2"b10 or 2"b11 , cts bw is 20M*/
#define BIT_RESP_CTS_DYNBW_SEL(x)     (((u32)((x) & 0x00000003) << 5))
#define BIT_GET_RESP_CTS_DYNBW_SEL(x) ((u32)(((x >> 5) & 0x00000003)))
#define BIT_DLY_TX_WAIT_RXANTSEL      ((u32)0x00000001 << 4)            /*!< R/W 0x0  8188E/8812 In some Cases, the phy status may be received too late to be used in the response frame. Enable this bit to postpone the tx of response frame until the phy status is obtained. Otherwise, If the phy status unavailable for its delay, The IOREG value of 0x06D8[6] will be used as before.*/
#define BIT_TXRESP_BY_RXANTSEL        ((u32)0x00000001 << 3)            /*!< R/W 0x0  8188E/8812 Enable responder send the response frame with the antenna selection information which from the phy status of the previous rx frame.*/
#define BIT_TXACK_WITH_A1MATCH        ((u32)0x00000001 << 2)            /*!< R/W 0x0  SET TO 1 :check every bit of a1 of rxpkt when need to response*/
#define BIT_MASK_ORIG_DCTS_CHK        ((u32)0x00000003 << 0)            /*!< R/W 0x0  Txok condition for dual CTS frame exchange: 00: Either one Rx ok 01: 1st one Rx ok 10: 2nd one Rx ok 11: both Rx ok*/
...
/** @defgroup REG_WMAC_TRXPTCL_CTL_H
  ...
  * @{
  */
#define BIT_MASK_ACKBA_TYPSEL                ((u32)0x0000000F << 28)           /*!< R/W 0x0  Determine response type for RX BA, and the definition as the bellow 0: NAV 1: Send ACK ACKBA_TYPESEL[0]: used for Basic BA ACKBA_TYPESEL[1]: used for Compression BA ACKBA_TYPESEL[2]: RSVD ACKBA_TYPESEL[3]: used for MTID BA*/
...
#define BIT_RESP_ACK_NON_EOF                 ((u32)0x00000001 << 11)           /*!< R/W 0x0  response to trigger+mgt with eof=0*/
...
#define BIT_DIS_TXCFE_INFULL_V1              ((u32)0x00000001 << 5)            /*!< R/W 0x0  Disable to send CF-END for responding RX control wrapper CF-END dropped by rxpktbuffer full. This bit is valid when RESP_DCFE_EN is set to 1*/
...
#define BIT_EN_TXACKBA_INTX_RDG_V1           ((u32)0x00000001 << 3)            /*!< R/W 0x0  If this bit is set, then MAC will Tx ACK/BA to respond  previous rx my unicast packets send by another STA during TX RDG*/
#define BIT_EN_TXACKBA_INTXOP_V1             ((u32)0x00000001 << 2)            /*!< R/W 0x1  If this bit is set, then MAC will Tx ACK/BA to respond previous rx my unitcast packets send by another STA during my TXOP*/
#define BIT_EN_TXCTS_INRXNAV_V1              ((u32)0x00000001 << 1)            /*!< R/W 0x1  Enable to send CTS in Rx NAV*/
#define BIT_EN_TXCTS_INTXOP_V1               ((u32)0x00000001 << 0)            /*!< R/W 0x1  Enable to send CTS for responding RX RTS during our TXOP period*/
/** @} */
...
/** @defgroup REG_KEYCAMCMD
  ...
  * @{
  */
#define BIT_KEYCAM_POLLING   ((u32)0x00000001 << 31)          /*!< R 0x0  Security CAM Polling*/
#define BIT_KEYCAM_CLEAR     ((u32)0x00000001 << 30)          /*!< RW1C 0x0  Set to 1 to clear all valid bits in CAM. After reset will self clear to 0.*/
#define BIT_MFBCAM_CLEAR     ((u32)0x00000001 << 29)          /*!< RW1C 0x0  Write 1 to clear all MFB value in CAM to 7'h7F. After reset will self clear to 0*/
#define BIT_KEYCAM_DA_EN     ((u32)0x00000001 << 17)          /*!< R/W 0x1  Security CAM Direct Acess Enable*/
#define BIT_SECCAM_WE        ((u32)0x00000001 << 16)          /*!< R/W 0x0  Security CAM Write Enable*/
#define BIT_MASK_KEYCAM_AD   ((u32)0x000003FF << 0)           /*!< R/W 0x0  Security CAM Address Offset CAM address is organized into 8 double-words/entry.*/
...
/** @defgroup REG_KEYCAM_WD
  ...
  * @{
  */
#define BIT_MASK_KEYCAM_WDATA   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Security CAM Write Content*/
...
/** @defgroup REG_CAMREAD
  ...
  * @{
  */
#define BIT_MASK_CAMR_DATA   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Security CAM Read Content*/
...
/** @defgroup REG_CAMDBG
  ...
  * @{
  */
#define BIT_KEYCAM_DBGSEL                ((u32)0x00000001 << 31)           /*!< R/W 0x0  Select TX/RX CAM Information. Set to 1 to retrieve latest Tx search result. Set to 0 to retrieve latest Rx search result.*/
#define BIT_SEC_KEYFOUND_V1              ((u32)0x00000001 << 15)           /*!< R 0x0  Security Key Found in CAM 0: key not found 1: key found*/
#define BIT_MASK_CAMDBG_SEC_TYPE_V1      ((u32)0x00000007 << 12)           /*!< R 0x0  Found security key type*/
#define BIT_CAMDBG_SEC_TYPE_V1(x)        (((u32)((x) & 0x00000007) << 12))
#define BIT_GET_CAMDBG_SEC_TYPE_V1(x)    ((u32)(((x >> 12) & 0x00000007)))
#define BIT_EXT_SECTYPE                  ((u32)0x00000001 << 11)           /*!< R 0x0  Found security key ext_sectype*/
#define BIT_MASK_CAMDBG_MIC_KEY_IDX_V3   ((u32)0x0000001F << 5)            /*!< R 0x0  Mic KEY INDEX*/
#define BIT_CAMDBG_MIC_KEY_IDX_V3(x)     (((u32)((x) & 0x0000001F) << 5))
#define BIT_GET_CAMDBG_MIC_KEY_IDX_V3(x) ((u32)(((x >> 5) & 0x0000001F)))
#define BIT_MASK_CAMDBG_SEC_KEY_IDX_V2   ((u32)0x0000001F << 0)            /*!< R 0x0  Security KEY INDEX*/
...
/** @defgroup REG_SECCFG
  ...
  * @{
  */
#define BIT_MASK_RXFILTER_ACTION_1     ((u32)0x000000FF << 24)           /*!< R/W 0x0  Configured by FW, Refer to 0x68E[10] to decide accepting this frame or not*/
#define BIT_RXFILTER_ACTION_1(x)       (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_RXFILTER_ACTION_1(x)   ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_RXFILTER_CATEGORY_1   ((u32)0x000000FF << 16)           /*!< R/W 0x0  Configured by FW, Refer to 0x68E[10] to decide accepting this frame or not*/
...
#define BIT_DIS_GCLK_TKIP              ((u32)0x00000001 << 13)           /*!< R/W 0x0  Disable gated clock control for WEP/TKIP engine.*/
...
#define BIT_WMAC_CKECK_BMC             ((u32)0x00000001 << 9)            /*!< R/W 0x0  If this bit is set to 1, key search engine need to check if broadcast/multicast bit matched.*/
...
#define BIT_RXDEC                      ((u32)0x00000001 << 3)            /*!< R/W 0x1  Enable Rx Decryption Setting 1 to enable Rx hardware decryption.*/
#define BIT_TXENC                      ((u32)0x00000001 << 2)            /*!< R/W 0x1  Enable Tx Encryption Setting to 1 to enable Tx hardware encryption.*/
...
/** @defgroup REG_ADDRESS_TABLE0
  * @brief
  * @{
  */
#define BIT_MASK_R_ADDR_TABLE_USER_REG0_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  low 32 bit of address table reg0*/
#define BIT_R_ADDR_TABLE_USER_REG0_L(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_R_ADDR_TABLE_USER_REG0_L(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_ADDRESS_TABLE1
  * @brief
  * @{
  */
#define BIT_MASK_R_ADDR_TABLE_USER_REG1_L   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  low 16 bit of address table reg1*/
#define BIT_R_ADDR_TABLE_USER_REG1_L(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_R_ADDR_TABLE_USER_REG1_L(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_R_ADDR_TABLE_USER_REG0_H   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  high 16 bit of address table reg0*/
#define BIT_R_ADDR_TABLE_USER_REG0_H(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_R_ADDR_TABLE_USER_REG0_H(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_ADDRESS_TABLE2
  * @brief
  * @{
  */
#define BIT_MASK_R_ADDR_TABLE_USER_REG1_H   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  high 32 bit of address table reg1*/
#define BIT_R_ADDR_TABLE_USER_REG1_H(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_R_ADDR_TABLE_USER_REG1_H(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup REG_WOW_NAN_CTRL
  ...
  * @{
  */
#define BIT_WMMPS_UAPSD_TID7          ((u32)0x00000001 << 31)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID7*/
#define BIT_WMMPS_UAPSD_TID6          ((u32)0x00000001 << 30)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID6*/
#define BIT_WMMPS_UAPSD_TID5          ((u32)0x00000001 << 29)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID5*/
#define BIT_WMMPS_UAPSD_TID4          ((u32)0x00000001 << 28)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID4*/
#define BIT_WMMPS_UAPSD_TID3          ((u32)0x00000001 << 27)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID3*/
#define BIT_WMMPS_UAPSD_TID2          ((u32)0x00000001 << 26)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID2*/
#define BIT_WMMPS_UAPSD_TID1          ((u32)0x00000001 << 25)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID1*/
#define BIT_WMMPS_UAPSD_TID0          ((u32)0x00000001 << 24)           /*!< R/W 0x0  Disable interrupt 8051 when rx WMMPS UAPSD Qos data with TID0*/
#define BIT_MASK_PORTSEL_PS_RX_INFO   ((u32)0x00000007 << 21)           /*!< R/W 0x0  The selector for the source of PS RX information (0x692[4:0]).  0 for port 0, 1 for clint0, 2 for clint1, 3 for clint2, 4 for clint3.*/
#define BIT_PORTSEL_PS_RX_INFO(x)     (((u32)((x) & 0x00000007) << 21))
#define BIT_GET_PORTSEL_PS_RX_INFO(x) ((u32)(((x >> 21) & 0x00000007)))
#define BIT_RXCTRLIN0                 ((u32)0x00000001 << 20)           /*!< R 0x0  It is set to 1 if NIC received control frame with correct DA.*/
#define BIT_RXMGTIN0                  ((u32)0x00000001 << 19)           /*!< R 0x0  It is set to 1 if NIC received management frame with correct BSSID and DA (including unicast and BMC).*/
#define BIT_RXDATAIN2                 ((u32)0x00000001 << 18)           /*!< R 0x0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC).*/
#define BIT_RXDATAIN1                 ((u32)0x00000001 << 17)           /*!< R 0x0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC).*/
#define BIT_RXDATAIN0                 ((u32)0x00000001 << 16)           /*!< R 0x0  It is set to 1 if NIC received data frame with correct BSSID and DA (including unicast and BMC).*/
#define BIT_NAN_RX_CHKTA              ((u32)0x00000001 << 10)           /*!< R/W 0x0  Enable bit for check TSF filter When set to 1, the TSF address filter will enable. When set to 0, the TSF address filter will disable.*/
#define BIT_NAN_RX_CHKBSSID           ((u32)0x00000001 << 9)            /*!< R/W 0x0  Check BSSID_BCN for TSF When set to 1, MAC will check the BSSID (A3) of RX beacon or Probe to determine if this packet  will sync TSF or not*/
#define BIT_NAN_RX_FILTER_EN          ((u32)0x00000001 << 8)            /*!< R/W 0x0  When set to 1, the TSF address filter will enable. When set to 0, the TSF address filter will disable.*/
#define BIT_MASK_PSF_BSSIDSEL_H       ((u32)0x00000003 << 6)            /*!< R/W 0x0  Bit 1,2 of Select to check the MACID of which port for the WMAC PSF NSARP function. 0: to check the MACID of port0; 1: to check the MACID of port1. 2: to check the MACID of port2. 3: to check the MACID of port3. 4: to check the MACID of port4.*/
#define BIT_PSF_BSSIDSEL_H(x)         (((u32)((x) & 0x00000003) << 6))
#define BIT_GET_PSF_BSSIDSEL_H(x)     ((u32)(((x >> 6) & 0x00000003)))
#define BIT_WOWHCI                    ((u32)0x00000001 << 5)            /*!< R/W 0x0  This bit is set to allow wake host as wake on wlan event occurring*/
#define BIT_PSF_BSSIDSEL_L            ((u32)0x00000001 << 4)            /*!< R/W 0x0  Bit 0 of Select to check the MACID of which port for the WMAC PSF NSARP function. 0: to check the MACID of port0; 1: to check the MACID of port1. 2: to check the MACID of port2. 3: to check the MACID of port3. 4: to check the MACID of port4.*/
#define BIT_UWF                       ((u32)0x00000001 << 3)            /*!< R/W 0x0  Unicast Packet. 1: Enable to check packet"s DA match MAC address or not. 0: Disable. (default value)*/
#define BIT_MAGIC                     ((u32)0x00000001 << 2)            /*!< R/W 0x0  Magic Packet. This bit is valid when the PMEn bit of the PMR register is set. The RTL8192 will assert the PMEB signal to wakeup the operating system when a Magic Packet is received. Once the RTL8192 has been enabled for Magic Packet wakeup, it scans incoming packets addressed to the node for a data sequence. The correct sequence indicates to the controller that this is a Magic Packet frame. A Magic Packet frame must also meet the basic requirements: Frame Control + Duration/ID + Destination address + Address 2 + Address 3 + Sequence Control + data + CRC. The destination address may be the node ID of the receiving station or a multicast address, including the broadcast address. The specific sequence consists of 16 duplications of 6 byte ID registers, with no breaks or interrupts. This sequence can be located anywhere within the packet, but must be preceded by a synchronization stream, 6 bytes of FFh. The device will also accept a multicast address, as long as the 16 duplications of the IEEE address match the address of the ID registers. If the Node ID is 11h 22h 33h 44h 55h 66h, then the magic frame"s format is as follows: Frame Control + Duration/ID + Destination address + Address 2 + Address 3 + Sequence Control + MISC + FF FF FF FF FF FF + MISC + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + 11 22 33 44 55 66 + MISC + CRC.*/
#define BIT_WFMSK                     ((u32)0x00000001 << 1)            /*!< R/W 0x0  WoW function on or off.*/
/** @} */
...
/** @defgroup REG_WKFMCAM_CMD
  ...
  * @{
  */
#define BIT_WKFMCAM_WE        ((u32)0x00000001 << 16)          /*!< R/W 0x0  CAM Write Enable*/
#define BIT_MASK_WKFMCAM_AD   ((u32)0x000000FF << 8)           /*!< R/W 0x0  Entry address*/
#define BIT_WKFMCAM_AD(x)     (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_WKFMCAM_AD(x) ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_CAM_NUM      ((u32)0x000000FF << 0)           /*!< R/W 0x0  CAM Entry Number*/
...
/** @defgroup REG_BCN_PSR_RPT0
  ...
  * @{
  */
#define BIT_MASK_DTIM_CNT0      ((u32)0x000000FF << 24)           /*!< R 0x0  The DTIM count field of the TIM element of Rx beacon*/
#define BIT_DTIM_CNT0(x)        (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_DTIM_CNT0(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_DTIM_PERIOD0   ((u32)0x000000FF << 16)           /*!< R 0x0  The DTIM period field of the TIM element of Rx beacon*/
#define BIT_DTIM_PERIOD0(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_DTIM_PERIOD0(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_HAS_MY_BC0          ((u32)0x00000001 << 15)           /*!< R 0x0  Indicate BC/MC packets are buffered in transmitted BSSID or AP*/
#define BIT_HAS_MY_BSSID0       ((u32)0x00000001 << 14)           /*!< R 0x0  Indicate BC/MC packets are buffered in nontransmitted BSSID, SW need check crespponding dtim count field in multiple bssid index field*/
#define BIT_HAS_MYAID0          ((u32)0x00000001 << 13)           /*!< R 0x0  Indicate has my unicast packet*/
#define BIT_RPT_VALID0          ((u32)0x00000001 << 12)           /*!< R 0x0  when set to 1, indicate the tim report is valid*/
#define BIT_MASK_PS_AID_0       ((u32)0x000007FF << 0)            /*!< R/W 0x0  AID0 for MACID*/
...
/** @defgroup REG_FLC_CTRL
  ...
  * @{
  */
#define BIT_FLC_RPCT_V1      ((u32)0x00000001 << 31)           /*!< R/W 0x0  When write "1" to this bit, FLC_TRPC will be enabled.*/
#define BIT_FLC_MODSL        ((u32)0x00000001 << 30)           /*!< R/W 0x0  1:Timer Mode 0:Counter Mode*/
#define BIT_MASK_TORRD       ((u32)0x0000003F << 24)           /*!< R/W 0x0  It specifies the time-out duration. (unit: 32 ms)*/
#define BIT_TORRD(x)         (((u32)((x) & 0x0000003F) << 24))
#define BIT_GET_TORRD(x)     ((u32)(((x >> 24) & 0x0000003F)))
#define BIT_FLC_CMFEN        ((u32)0x00000001 << 18)           /*!< R/W 0x0  Count Management Frame (1: Enable, 0:Disable)*/
#define BIT_FLC_CCFEN        ((u32)0x00000001 << 17)           /*!< R/W 0x0  Count Control Frame (1: Enable, 0:Disable)*/
#define BIT_FLC_CDFEN        ((u32)0x00000001 << 16)           /*!< R/W 0x0  Count Data Frame (1: Enable, 0:Disable)*/
#define BIT_MASK_FLC_PKTTH   ((u32)0x000000FF << 8)            /*!< R/W 0x0  Rx PKT number threshold*/
#define BIT_FLC_PKTTH(x)     (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_FLC_PKTTH(x) ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_FLC_RPC     ((u32)0x000000FF << 0)            /*!< R 0x0  Number of Rx PKT in the interval which is specified by FLC_TRPC. The Rx PKT type is specified by 0x6AE[2:0]*/
...
/** @defgroup REG_STATE_MON
  ...
  * @{
  */
#define BIT_MASK_STATE_SEL    ((u32)0x0000001F << 24)           /*!< R/W 0x0  WMAC read and write FSM selection: 000,001:read mactx status 010,011:read mactx status 100:read response status 00xxx: write [6:0]to mactx fsm when [7] valid 01xxx:write [6:0]to macrx fsm when [7] valid 100xx: write [6:0]to response fsm when [7] valid*/
#define BIT_STATE_SEL(x)      (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_STATE_SEL(x)  ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_CUR_STATE1   ((u32)0x000000FF << 8)            /*!< R 0x0  when BIT_WRITE_FSM_EN is valid,is rsvd. When BIT_WRITE_FSM_EN is not valid, means read status*/
#define BIT_CUR_STATE1(x)     (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_CUR_STATE1(x) ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_WRITE_FSM_EN      ((u32)0x00000001 << 7)            /*!< R 0x0  when set 1, generate write pulse, otherwise means read status*/
#define BIT_MASK_CUR_STATE0   ((u32)0x0000007F << 0)            /*!< R/W 0x0  when BIT_WRITE_FSM_EN is valid,Indicate the FSM current state to write. When BIT_WRITE_FSM_EN is not valid, means read status*/
...
/** @defgroup REG_ERROR_EVT_CTL
  ...
  * @{
  */
#define BIT_PRI_MASK_TBTT_P2_1          ((u32)0x00000001 << 31) /*!< R/W 0x0  Priority Mask for P2 NAN sync Beacon*/
#define BIT_PRI_MASK_TBTT_P2_0          ((u32)0x00000001 << 30) /*!< R/W 0x0  Priority Mask for P2 NAN disc Beacon*/
#define BIT_CSIRPT_LEN_BB_MORE_THAN_MAC ((u32)0x00000001 << 23) /*!< R 0x0  Indicate MAC Rx csi rxd number overflow*/
#define BIT_CSI_CHKSUM_ERROR            ((u32)0x00000001 << 22) /*!< R 0x0  Indicate MAC Rx csi rpt checksum error*/
#define BIT_MACRX_ERR_4                 ((u32)0x00000001 << 20) /*!< R 0x0  Indicate last MPDU length of AMPDU or PPDU length is error.*/
#define BIT_MACRX_ERR_3                 ((u32)0x00000001 << 19) /*!< R 0x0  Indicate rxfifo or mac phy interface fifo overflow*/
#define BIT_MACRX_ERR_2                 ((u32)0x00000001 << 18) /*!< R 0x0  Indicate MAC Rx occurs internal halt event*/
...
#define BIT_MACTX_ERR_3                 ((u32)0x00000001 << 3)  /*!< R 0x0  Indicate PHY fetch plcp before it is ready*/
#define BIT_MACTX_ERR_2                 ((u32)0x00000001 << 2)  /*!< R 0x0  phy_txen is set ,but wait phy_phytxon time out*/
#define BIT_MACTX_ERR_1                 ((u32)0x00000001 << 1)  /*!< R 0x0  Indicate TXD FIFO underflow,ppdu fetch zld*/
#define BIT_MACTX_ERR_0                 ((u32)0x00000001 << 0)  /*!< R 0x0  Indicate TXD FIFO underflow,mpdu fetch zld*/
/** @} */
...
#define BIT_DIS_INFOSRCH             ((u32)0x00000001 << 14)           /*!< R/W 0x0  when set to 1,disable to search information*/
#define BIT_DISABLE_B0               ((u32)0x00000001 << 13)           /*!< R/W 0x0  when set to 1,disable to check a2[0]*/
#define BIT_MASK_INFO_ADDR_OFFSET    ((u32)0x00001FFF << 0)            /*!< R/W 0x0  per-macid information address offset (Unit:8bytes).*/
...
/** @defgroup REG_BT_COEX_TABLE_H_V1
  ...
  * @{
  */
#define BIT_PRI_MASK_DW_NAN      ((u32)0x00000001 << 31)           /*!< R/W 0x0  Priority Mask for P2 NAN DW*/
...
#define BIT_PRI_MASK_TBTT_P1     ((u32)0x00000001 << 5)            /*!< R/W 0x0  Priority Mask for P1 Beacon*/
#define BIT_PRI_MASK_TBTT_P0     ((u32)0x00000001 << 4)            /*!< R/W 0x0  Priority Mask for P0 Beacon*/
#define BIT_PRI_MASK_TXRESP      ((u32)0x00000001 << 3)            /*!< R/W 0x0  Priority Mask for Tx response*/
#define BIT_PRI_MASK_RXRESP      ((u32)0x00000001 << 2)            /*!< R/W 0x0  Priority Mask for Rx response*/
...
/** @defgroup REG_RXCMD_0
  ...
  * @{
  */
#define BIT_RXCMD_EN          ((u32)0x00000001 << 31)          /*!< R/W 0x0  RXCMD function enable*/
...
/** @defgroup REG_CSI_CTRL
  ...
  * @{
  */
#define BIT_CTL_IDLE_CLR_CSI_RPT_V1     ((u32)0x00000001 << 31)           /*!< R/W 0x0  ckr csi report request if response fsm idle*/
#define BIT_USE_NDPARATE                ((u32)0x00000001 << 30)           /*!< R/W 0x1  1: use ndpa rx rate to decide csi report rate 0: use ndp rx rate to decide csi report rate*/
...
#define BIT_CSI_GID_SEL                 ((u32)0x00000001 << 12)           /*!< R/W 0x0  SIG-A content 1 :  group id=0, 0 :  group id=63*/
#define BIT_RDCSIMD_FLAG_TRIG_SEL       ((u32)0x00000001 << 11)           /*!< R/W 0x0  0: Trigger read csi mode flag raising when mac_csi_granted & ndp_valid positive edge 1: Trigger read csi mode flag raising when mac_csi_granted positive edge*/
#define BIT_NDPVLD_POS_RST_FFPTR_DIS_V1 ((u32)0x00000001 << 10)           /*!< R/W 0x0  0: Reset rx_fifo read/wrtie pointer when ndp_valid positive edge 1: Not reset rx_fifo read/wrtie pointer when ndp_valid positive edge*/
#define BIT_NDPVLD_PROTECT_RDRDY_DIS    ((u32)0x00000001 << 9)            /*!< R/W 0x0  0: Protect write enable of rx_fifo when ndp_valid =1  1: Not Protect write enable of rx_fifo when ndp_valid =1*/
...
#define BIT_WMC_CSI_RATE_FB_EN          ((u32)0x00000001 << 7)            /*!< R/W 0x0  Enable CSI frame rate fallback (only one step in CSI RRSR) This bit is set to 1 to enable MAC to use previous latched csi resp rate for retry pkt.*/
...
/** @defgroup REG_P2P_RX_BCN_NOA
  ...
  * @{
  */
#define BIT_P2P_NOA_PARSER_EN       ((u32)0x00000001 << 15)           /*!< R/W 0x0  NoA Parser enabled.*/
#define BIT_MASK_P2P_BSSID_SEL_V1   ((u32)0x00000007 << 12)           /*!< R/W 0x0  When this valueis 0/1/2/3/4, then beacon with matched BSSID0/1/2/3/4 is parsed.*/
#define BIT_P2P_BSSID_SEL_V1(x)     (((u32)((x) & 0x00000007) << 12))
#define BIT_GET_P2P_BSSID_SEL_V1(x) ((u32)(((x >> 12) & 0x00000007)))
#define BIT_MASK_P2P_OUI_TYPE       ((u32)0x000000FF << 0)            /*!< R/W 0x0  NOA OUI Type*/
...
/** @defgroup REG_SOUNDING_CFG2
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_SOUNDING_RXADD_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  MACID of the associated beamformer1 bit[31:0]*/
...
#define BIT_MASK_R_WMAC_SOUNDING_RXADD_H   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  MACID of the associated beamformer1 bit[15:0]*/
...
/** @defgroup REG_ANTCD_INFO
  ...
  * @{
  */
#define BIT_MASK_WMAC_RESP_ANTD   ((u32)0x0000000F << 12)           /*!< R/W 0x0  used for antenna select d value  BIT_WMAC_RESP_ANTCD[3:2], used for antsel_d value;*/
#define BIT_WMAC_RESP_ANTD(x)     (((u32)((x) & 0x0000000F) << 12))
#define BIT_GET_WMAC_RESP_ANTD(x) ((u32)(((x >> 12) & 0x0000000F)))
#define BIT_MASK_WMAC_RESP_ANTC   ((u32)0x0000000F << 8)            /*!< R/W 0x0  used for antenna select c value  BIT_WMAC_RESP_ANTCD[3:3], used for antsel_d value;*/
#define BIT_WMAC_RESP_ANTC(x)     (((u32)((x) & 0x0000000F) << 8))
#define BIT_GET_WMAC_RESP_ANTC(x) ((u32)(((x >> 8) & 0x0000000F)))
#define BIT_MASK_WMAC_RESP_ANTB   ((u32)0x0000000F << 4)            /*!< R/W 0x0  used for antenna select b value  BIT_WMAC_RESP_ANTCD[3:4], used for antsel_d value;*/
#define BIT_WMAC_RESP_ANTB(x)     (((u32)((x) & 0x0000000F) << 4))
#define BIT_GET_WMAC_RESP_ANTB(x) ((u32)(((x >> 4) & 0x0000000F)))
#define BIT_MASK_WMAC_RESP_ANTA   ((u32)0x0000000F << 0)            /*!< R/W 0x0  used for antenna select a value  BIT_WMAC_RESP_ANTCD[3:5], used for antsel_d value;*/
...
/** @defgroup REG_CSI_PTR
  ...
  * @{
  */
#define BIT_MASK_CSI_RADDR_LATCH_V2   ((u32)0x0000FFFF << 16)           /*!< R 0x0  Tx_fifo read pointer latch value after Tx CSI report pkt (unit: 8B)*/
#define BIT_CSI_RADDR_LATCH_V2(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_CSI_RADDR_LATCH_V2(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_CSI_WADDR_LATCH_V2   ((u32)0x0000FFFF << 0)            /*!< R 0x0  Tx_fifo write pointer latch value at ndp_valid negative edge (unit: 8B)*/
...
/** @defgroup REG_BCN_PSR_RPT2
  ...
  * @{
  */
#define BIT_MASK_DTIM_CNT2      ((u32)0x000000FF << 24)           /*!< R 0x0  The DTIM count field of the TIM element of Rx beacon*/
#define BIT_DTIM_CNT2(x)        (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_DTIM_CNT2(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_DTIM_PERIOD2   ((u32)0x000000FF << 16)           /*!< R 0x0  The DTIM period field of the TIM element of Rx beacon*/
#define BIT_DTIM_PERIOD2(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_DTIM_PERIOD2(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_HAS_MY_BC2          ((u32)0x00000001 << 15)           /*!< R 0x0  Indicate BC/MC packets are buffered in transmitted BSSID or AP*/
#define BIT_HAS_MY_BSSID2       ((u32)0x00000001 << 14)           /*!< R 0x0  Indicate BC/MC packets are buffered in nontransmitted BSSID, SW need check crespponding dtim count field in multiple bssid index field*/
#define BIT_HAS_MYAID2          ((u32)0x00000001 << 13)           /*!< R 0x0  Indicate has my unicast packet*/
#define BIT_RPT_VALID2          ((u32)0x00000001 << 12)           /*!< R 0x0  when set to 1, indicate the tim report is valid*/
#define BIT_MASK_PS_AID_2       ((u32)0x000007FF << 0)            /*!< R/W 0x0  AID0 for MACID*/
...
/** @defgroup REG_BCN_PSR_RPT3
  ...
  * @{
  */
#define BIT_MASK_DTIM_CNT3      ((u32)0x000000FF << 24)           /*!< R 0x0  The DTIM count field of the TIM element of Rx beacon*/
#define BIT_DTIM_CNT3(x)        (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_DTIM_CNT3(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_DTIM_PERIOD3   ((u32)0x000000FF << 16)           /*!< R 0x0  The DTIM period field of the TIM element of Rx beacon*/
#define BIT_DTIM_PERIOD3(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_DTIM_PERIOD3(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_HAS_MY_BC3          ((u32)0x00000001 << 15)           /*!< R 0x0  Indicate BC/MC packets are buffered in transmitted BSSID or AP*/
#define BIT_HAS_MY_BSSID3       ((u32)0x00000001 << 14)           /*!< R 0x0  Indicate BC/MC packets are buffered in nontransmitted BSSID, SW need check crespponding dtim count field in multiple bssid index field*/
#define BIT_HAS_MYAID3          ((u32)0x00000001 << 13)           /*!< R 0x0  Indicate has my unicast packet*/
#define BIT_RPT_VALID3          ((u32)0x00000001 << 12)           /*!< R 0x0  when set to 1, indicate the tim report is valid*/
#define BIT_MASK_PS_AID_3       ((u32)0x000007FF << 0)            /*!< R/W 0x0  AID0 for MACID*/
...
/** @defgroup REG_BCN_PSR_RPT4
  ...
  * @{
  */
#define BIT_MASK_DTIM_CNT4      ((u32)0x000000FF << 24)           /*!< R 0x0  The DTIM count field of the TIM element of Rx beacon*/
#define BIT_DTIM_CNT4(x)        (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_DTIM_CNT4(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_DTIM_PERIOD4   ((u32)0x000000FF << 16)           /*!< R 0x0  The DTIM period field of the TIM element of Rx beacon*/
#define BIT_DTIM_PERIOD4(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_DTIM_PERIOD4(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_HAS_MY_BC4          ((u32)0x00000001 << 15)           /*!< R 0x0  Indicate BC/MC packets are buffered in transmitted BSSID or AP*/
#define BIT_HAS_MY_BSSID4       ((u32)0x00000001 << 14)           /*!< R 0x0  Indicate BC/MC packets are buffered in nontransmitted BSSID, SW need check crespponding dtim count field in multiple bssid index field*/
#define BIT_HAS_MYAID4          ((u32)0x00000001 << 13)           /*!< R 0x0  Indicate has my unicast packet*/
#define BIT_RPT_VALID4          ((u32)0x00000001 << 12)           /*!< R 0x0  when set to 1, indicate the tim report is valid*/
#define BIT_MASK_PS_AID_4       ((u32)0x000007FF << 0)            /*!< R/W 0x0  AID0 for MACID*/
...
#define BIT_RXGCK_OFDMCCA_EN          ((u32)0x00000001 << 16)           /*!< R/W 0x0  This bit is set to 1 to let OFDMCCA be one of the signals that can wakeup MAC from Rx_idle*/
#define BIT_MASK_RXPSF_PKTLENTHR      ((u32)0x00000007 << 13)           /*!< R/W 0x0  Packet length threshold 3'd0:  16 Bytes 3'd1:  32 Bytes 3'd2:  64 Bytes 3'd3:  128 Bytes 3'd4:  256 Bytes 3'd5:  512 Bytes 3'd6:  1024 Bytes 3'd7:  2048 Bytes Only the packet which packet length is longer than this threshold will trigger an invalid_pkt pulse.*/
#define BIT_RXPSF_PKTLENTHR(x)        (((u32)((x) & 0x00000007) << 13))
#define BIT_GET_RXPSF_PKTLENTHR(x)    ((u32)(((x >> 13) & 0x00000007)))
#define BIT_RXPSF_CTRLEN              ((u32)0x00000001 << 12)           /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=01.*/
#define BIT_RXPSF_VHTCHKEN            ((u32)0x00000001 << 11)           /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet rate = VHT*/
#define BIT_RXPSF_HTCHKEN             ((u32)0x00000001 << 10)           /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet rate = HT*/
#define BIT_RXPSF_OFDMCHKEN           ((u32)0x00000001 << 9)            /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet rate = OFDM*/
#define BIT_RXPSF_CCKCHKEN            ((u32)0x00000001 << 8)            /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet rate = CCK*/
#define BIT_RXPSF_OFDMRST             ((u32)0x00000001 << 7)            /*!< R/W 0x1  This bit is set to 1 to reset MAC Rx before sending OFDM (include OFDM, HT, VHT) packet triggered invalid_pkt pulse (0 for debug)*/
#define BIT_RXPSF_CCKRST              ((u32)0x00000001 << 6)            /*!< R/W 0x1  This bit is set to 1 to reset MAC Rx before sending CCK packet triggered invalid_pkt pulse(0 for debug)*/
#define BIT_RXPSF_MHCHKEN             ((u32)0x00000001 << 5)            /*!< R/W 0x0  This bit is set to 1 to enable MAC to inform BB enter power saving mode as rx unmatch my MACID unicast or unmatch my BSSID Broadcast/Mutlicast packets (including aggrigation and non-aggrigation)*/
#define BIT_RXPSF_CONT_ERRCHKEN       ((u32)0x00000001 << 4)            /*!< R/W 0x0  This bit is set to 1 to enable MAC to inform BB enter power saving mode as continuous rx FCS error packets number in a PPDU is large than the FCS error packet threshold defined by BBPSF_ERRTHR. This function is independent from rate, type and IDs.*/
#define BIT_RXPSF_ALL_ERRCHKEN        ((u32)0x00000001 << 3)            /*!< R/W 0x0  This bit is set to 1 to enable MAC to inform BB enter power saving mode as rx FCS error packets number in a PPDU is larger than the FCS error packet threshold defined by BBPSF_ERRTHR. This function is independent from rate, type and IDs.*/
#define BIT_MASK_RXPSF_ERRTHR         ((u32)0x00000007 << 0)            /*!< R/W 0x0  FCS error packet threshold 3'd0: 1 packet 3'd1: 4 packets 3'd2: 8 packets 3'd3: 12 packets 3'd4: 16 packets 3'd5: 20 packets 3'd6: 24 packets 3'd7: 28 packets*/
...
/** @defgroup REG_RXPSF_TYPE_CTRL
  ...
  * @{
  */
#define BIT_RXPSF_DATA15EN ((u32)0x00000001 << 31) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1111.*/
#define BIT_RXPSF_DATA14EN ((u32)0x00000001 << 30) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1110.*/
#define BIT_RXPSF_DATA13EN ((u32)0x00000001 << 29) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1101.*/
#define BIT_RXPSF_DATA12EN ((u32)0x00000001 << 28) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1100.*/
#define BIT_RXPSF_DATA11EN ((u32)0x00000001 << 27) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1011.*/
#define BIT_RXPSF_DATA10EN ((u32)0x00000001 << 26) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1010.*/
#define BIT_RXPSF_DATA9EN  ((u32)0x00000001 << 25) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1001.*/
#define BIT_RXPSF_DATA8EN  ((u32)0x00000001 << 24) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=1000.*/
#define BIT_RXPSF_DATA7EN  ((u32)0x00000001 << 23) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0111.*/
#define BIT_RXPSF_DATA6EN  ((u32)0x00000001 << 22) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0110.*/
#define BIT_RXPSF_DATA5EN  ((u32)0x00000001 << 21) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0101.*/
#define BIT_RXPSF_DATA4EN  ((u32)0x00000001 << 20) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0100.*/
#define BIT_RXPSF_DATA3EN  ((u32)0x00000001 << 19) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0011.*/
#define BIT_RXPSF_DATA2EN  ((u32)0x00000001 << 18) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0010.*/
#define BIT_RXPSF_DATA1EN  ((u32)0x00000001 << 17) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0001.*/
#define BIT_RXPSF_DATA0EN  ((u32)0x00000001 << 16) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=10 and subtype=0000.*/
#define BIT_RXPSF_MGT15EN  ((u32)0x00000001 << 15) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1111.*/
#define BIT_RXPSF_MGT14EN  ((u32)0x00000001 << 14) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1110.*/
#define BIT_RXPSF_MGT13EN  ((u32)0x00000001 << 13) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1101.*/
#define BIT_RXPSF_MGT12EN  ((u32)0x00000001 << 12) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1100.*/
#define BIT_RXPSF_MGT11EN  ((u32)0x00000001 << 11) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1011.*/
#define BIT_RXPSF_MGT10EN  ((u32)0x00000001 << 10) /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1010.*/
#define BIT_RXPSF_MGT9EN   ((u32)0x00000001 << 9)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1001.*/
#define BIT_RXPSF_MGT8EN   ((u32)0x00000001 << 8)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=1000.*/
#define BIT_RXPSF_MGT7EN   ((u32)0x00000001 << 7)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0111.*/
#define BIT_RXPSF_MGT6EN   ((u32)0x00000001 << 6)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0110.*/
#define BIT_RXPSF_MGT5EN   ((u32)0x00000001 << 5)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0101.*/
#define BIT_RXPSF_MGT4EN   ((u32)0x00000001 << 4)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0100.*/
#define BIT_RXPSF_MGT3EN   ((u32)0x00000001 << 3)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0011.*/
#define BIT_RXPSF_MGT2EN   ((u32)0x00000001 << 2)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0010.*/
#define BIT_RXPSF_MGT1EN   ((u32)0x00000001 << 1)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0001.*/
#define BIT_RXPSF_MGT0EN   ((u32)0x00000001 << 0)  /*!< R/W 0x0  This bit is set to 1 to enable MAC to consider trigging invalid_pkt as rx packet Type=00 and subtype=0000.*/
/** @} */
...
/** @defgroup REG_WAIT_PHYSTS_CTL
  ...
  * @{
  */
#define BIT_BB_RST_RESP             ((u32)0x00000001 << 7)           /*!< R/W 0x0  When set to 1,enable bb/rdrdy_err/cca_spoofing to reset mac and will not tx response*/
#define BIT_CCA_SPOOFING_EN         ((u32)0x00000001 << 6)           /*!< R/W 0x0  When set to 1,enable cca_spoofing reset macrx*/
#define BIT_RDRDY_NUM_CHK_EN        ((u32)0x00000001 << 5)           /*!< R/W 0x1  When set, enable check rdrdy number is enough or not. If number is not enough will rst macrx*/
#define BIT_WAIT_PHYSTS_EN          ((u32)0x00000001 << 4)           /*!< R/W 0x0  When set to 1,enable wait physts rpt valid function*/
#define BIT_MASK_WAIT_PHYSTS_TIME   ((u32)0x0000000F << 0)           /*!< R/W 0x4  Wait physts rpt timeout ,unit us(6us is the recommeded value)*/
...
/** @defgroup REG_MACID2
  ...
  * @{
  */
#define BIT_MASK_MACID2_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  MAC Identification Number 2 Register*/
...
/** @defgroup REG_MACID2_H
  ...
  * @{
  */
#define BIT_MASK_MACID2_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  MAC Identification Number 2 Register*/
...
/** @defgroup REG_BSSID2
  ...
  * @{
  */
#define BIT_MASK_BSSID2_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 2*/
...
/** @defgroup REG_BSSID2_H
  ...
  * @{
  */
#define BIT_MASK_BSSID2_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 2*/
...
/** @defgroup REG_MACID3
  ...
  * @{
  */
#define BIT_MASK_MACID3_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  MAC Identification Number 3 Register*/
...
/** @defgroup REG_MACID3_H
  ...
  * @{
  */
#define BIT_MASK_MACID3_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  MAC Identification Number 3 Register*/
...
/** @defgroup REG_BSSID3
  ...
  * @{
  */
#define BIT_MASK_BSSID3_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 3*/
...
/** @defgroup REG_BSSID3_H
  ...
  * @{
  */
#define BIT_MASK_BSSID3_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 3*/
...
/** @defgroup REG_MACID4
  ...
  * @{
  */
#define BIT_MASK_MACID4_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  MAC Identification Number 4 Register*/
...
/** @defgroup REG_MACID4_H
  ...
  * @{
  */
#define BIT_MASK_MACID4_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  MAC Identification Number 4 Register*/
...
/** @defgroup REG_BSSID4
  ...
  * @{
  */
#define BIT_MASK_BSSID4_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 4*/
...
/** @defgroup REG_BSSID4_H
  ...
  * @{
  */
#define BIT_MASK_BSSID4_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Basic Station Set Identification 4*/
...
/** @defgroup REG_NOA_REPORT
  ...
  * @{
  */
#define BIT_MASK_NOA_RPT   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_NOA_REPORT_1
  ...
  * @{
  */
#define BIT_MASK_NOA_RPT_1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_NOA_REPORT_2
  ...
  * @{
  */
#define BIT_MASK_NOA_RPT_2   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_NOA_REPORT_3
  ...
  * @{
  */
#define BIT_MASK_NOA_RPT_3   ((u32)0x000000FF << 0)           /*!< R/W 0x0  */
...
/** @defgroup REG_PWRBIT_SETTING
  ...
  * @{
  */
#define BIT_CLI3_PWRBIT_OW_EN ((u32)0x00000001 << 7) /*!< R/W 0x0  For client3 (port4). If this bit is set to 1, MAC will overwrite power bit of frame control according to CLI3_PWR_ST. (only for data frame)*/
#define BIT_CLI3_PWR_ST       ((u32)0x00000001 << 6) /*!< R/W 0x0  For client3 (port4). MAC will overwrite power bit of frame control according to CLI3_PWR_ST.(only for data frame)*/
#define BIT_CLI2_PWRBIT_OW_EN ((u32)0x00000001 << 5) /*!< R/W 0x0  For client2 (port3). If this bit is set to 1, MAC will overwrite power bit of frame control according to CLI2_PWR_ST. (only for data frame)*/
#define BIT_CLI2_PWR_ST       ((u32)0x00000001 << 4) /*!< R/W 0x0  For client2 (port3). MAC will overwrite power bit of frame control according to CLI2_PWR_ST.(only for data frame)*/
#define BIT_CLI1_PWRBIT_OW_EN ((u32)0x00000001 << 3) /*!< R/W 0x0  For client1 (port2). If this bit is set to 1, MAC will overwrite power bit of frame control according to CLI1_PWR_ST. (only for data frame)*/
#define BIT_CLI1_PWR_ST       ((u32)0x00000001 << 2) /*!< R/W 0x0  For client1 (port2). MAC will overwrite power bit of frame control according to CLI1_PWR_ST.(only for data frame)*/
#define BIT_CLI0_PWRBIT_OW_EN ((u32)0x00000001 << 1) /*!< R/W 0x0  For client0 (port1). If this bit is set to 1, MAC will overwrite power bit of frame control according to CLI0_PWR_ST. (only for data frame)*/
#define BIT_CLI0_PWR_ST       ((u32)0x00000001 << 0) /*!< R/W 0x0  For client0 (port1). MAC will overwrite power bit of frame control according to CLI0_PWR_ST.(only for data frame)*/
/** @} */
...
/** @defgroup REG_GENERAL_OPTION
  ...
  * @{
  */
#define BIT_EXT_DBGSEL       ((u32)0x00000001 << 6) /*!< R/W 0x0  enable extend dbg port sel*/
#define BIT_TXSERV_FIELD_SEL ((u32)0x00000001 << 2) /*!< R/W 0x0  */
/** @} */
...
/** @defgroup REG_RXAI_CTRL
  ...
  * @{
  */
#define BIT_RXAI_PRTCT_REL  ((u32)0x00000001 << 6) /*!< R 0x0  If MAC_reset_protect is set to 0 by MAC decision circuit (address/A-MPDU checking), set this bit to 1. Reset by BIT_RXAI_INFO_RST = 1*/
#define BIT_RXAI_PRTCT_VIO  ((u32)0x00000001 << 5) /*!< R 0x0  If MAC gets BB_reset_MAC pulse when MAC_reset_protect = 1, set this bit to 1. Reset by BIT_RXAI_INFO_RST = 1*/
#define BIT_RXAI_PRTCT_SEL  ((u32)0x00000001 << 2) /*!< R/W 0x0  MAC_reset_protect rises at 0: DATA_ON rises 1: PLCP check OK (OFDM/CCK) or receiving 3rd/2nd (VHT/HT) RDRDY*/
#define BIT_RXAI_AGG_CHKEN  ((u32)0x00000001 << 1) /*!< R/W 0x0  This bit is only workable when BIT_RXAI_ADDR_CHKEN = 1. 1: if and only if the receiving address matched PPDU is A-MPDU and is not VHT single MPDU, then MAC inform BB not doing reCCA.*/
#define BIT_RXAI_ADDR_CHKEN ((u32)0x00000001 << 0) /*!< R/W 0x0  This bit is set to 1 to enable MAC to inform BB not doing reCCA during receiving the address matched PPDU.*/
/** @} */
...
/** @defgroup REG_RX_BCN_TM
  ...
  * @{
  */
#define BIT_MASK_RX_BCN_TIMER   ((u32)0x0000FFFF << 0)           /*!< R 0x0  indicate rx beacon timer from cca up to fcs ok, units us*/
#define BIT_RX_BCN_TIMER(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_RX_BCN_TIMER(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_NAN_TA0
  * @brief
  * @{
  */
#define BIT_MASK_WMAC_NAN_TA_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Low 32bit tx address for NAN*/
#define BIT_WMAC_NAN_TA_L(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_WMAC_NAN_TA_L(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_NAN_TA1
  * @brief
  * @{
  */
#define BIT_MASK_WMAC_NAN_TA_H   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  High 16bit tx address for NAN*/
#define BIT_WMAC_NAN_TA_H(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_WMAC_NAN_TA_H(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup REG_MU_BF_OPTION
  ...
  * @{
  */
#define BIT_WMAC_NOCHK_BFPOLL_BMP           ((u32)0x00000001 << 31)           /*!< R/W 0x0  Set this bit to ignore retransmission bitmap of rx beamforming report poll*/
...
#define BIT_ARB_HW_ADAPT_EN                 ((u32)0x00000001 << 23)           /*!< R/W 0x0  Enable hardware to arbitrate data according to rate offset of user0 and user1*/
#define BIT_ARB_SW_EN                       ((u32)0x00000001 << 22)           /*!< R/W 0x0  Enable software to set initial state of MU arbiter*/
...
#define BIT_WMAC_RESP_NONSTA1_DIS           ((u32)0x00000001 << 7)            /*!< R/W 0x0  Disable response BA when receive non-STA1 user position MU PPDU*/
#define BIT_MASK_WMAC_MU_BFEE_PORT_SEL      ((u32)0x00000007 << 1)            /*!< R/W 0x0  Enable software to set initial state of MU arbiter*/
...
/** @defgroup REG_WMAC_MU_BF_CTL
  ...
  * @{
  */
#define BIT_MASK_BFRPT_PARA_USERID_SEL_V1   ((u32)0x00000007 << 29)           /*!< R/W 0x0  User ID of associated Bfee, MU: 2~7 ,SU:0~1*/
#define BIT_BFRPT_PARA_USERID_SEL_V1(x)     (((u32)((x) & 0x00000007) << 29))
#define BIT_GET_BFRPT_PARA_USERID_SEL_V1(x) ((u32)(((x >> 29) & 0x00000007)))
#define BIT_MASK_BFRPT_PARA_V1              ((u32)0x00001FFF << 16)           /*!< R 0x0  CSI report parameter of selected user ID BFee {bw[1:0],cb[1:0],ng[1:0],nr[2:0],nc[2:0]} ;*/
#define BIT_BFRPT_PARA_V1(x)                (((u32)((x) & 0x00001FFF) << 16))
#define BIT_GET_BFRPT_PARA_V1(x)            ((u32)(((x >> 16) & 0x00001FFF)))
#define BIT_WMAC_INVLD_BFPRT_CHK            ((u32)0x00000001 << 15)           /*!< R/W 0x0  Check invalid case of received beamforming report*/
#define BIT_WMAC_RETXBFRPTSEQ_UPD           ((u32)0x00000001 << 14)           /*!< R/W 0x0  Update sequence number and not set retry bit when retransmit beamforming report.*/
#define BIT_MASK_WMAC_MU_BFRPTSEG_SEL       ((u32)0x00000003 << 12)           /*!< R/W 0x0  Beamforming report segment length select 2'h00 :3895 bytes(also means csi segmentation enable),2'h01:7991bytes, 2'h10:11454bytes*/
#define BIT_WMAC_MU_BFRPTSEG_SEL(x)         (((u32)((x) & 0x00000003) << 12))
#define BIT_GET_WMAC_MU_BFRPTSEG_SEL(x)     ((u32)(((x >> 12) & 0x00000003)))
#define BIT_MASK_WMAC_MU_BF_MYAID           ((u32)0x00000FFF << 0)            /*!< R/W 0x0  When I'm one of Bfees, my AID12 to identify STA_info in NDPA*/
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE2
  ...
  * @{
  */
#define BIT_STATUS_BFEE3             ((u32)0x00000001 << 26)           /*!< R 0x0  beamforming report status of beamformee3 0: fail,  1: success*/
#define BIT_WMAC_MU_BFEE3_EN         ((u32)0x00000001 << 25)           /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee3, and CSI rpt of beamformee3  can be read  from 0x1682[11:0] when 0x1682[14:12] is 3*/
#define BIT_MASK_WMAC_MU_BFEE3_AID   ((u32)0x000001FF << 16)           /*!< R/W 0x0  P_AID of the target beamformee3*/
#define BIT_WMAC_MU_BFEE3_AID(x)     (((u32)((x) & 0x000001FF) << 16))
#define BIT_GET_WMAC_MU_BFEE3_AID(x) ((u32)(((x >> 16) & 0x000001FF)))
#define BIT_STATUS_BFEE2             ((u32)0x00000001 << 10)           /*!< R 0x0  beamforming report status of beamformee2  0: fail,  1: success*/
#define BIT_WMAC_MU_BFEE2_EN         ((u32)0x00000001 << 9)            /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee2, and CSI rpt of beamformee2 can be read from 0x1682[11:0] when 0x1682[14:12] is 2*/
#define BIT_MASK_WMAC_MU_BFEE2_AID   ((u32)0x000001FF << 0)            /*!< R/W 0x0  P_AID of the target beamformee2*/
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE4
  ...
  * @{
  */
#define BIT_WMAC_MU_BFEE5_EN         ((u32)0x00000001 << 25)           /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee5, and CSI rpt of beamformee5  can be read  from 0x1682[11:0] when 0x1682[14:12] is 5*/
#define BIT_MASK_WMAC_MU_BFEE5_AID   ((u32)0x000001FF << 16)           /*!< R/W 0x0  P_AID of the target beamformee5*/
#define BIT_WMAC_MU_BFEE5_AID(x)     (((u32)((x) & 0x000001FF) << 16))
#define BIT_GET_WMAC_MU_BFEE5_AID(x) ((u32)(((x >> 16) & 0x000001FF)))
#define BIT_WMAC_MU_BFEE4_EN         ((u32)0x00000001 << 9)            /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee4, and CSI rpt of beamformee4  can be read  from 0x1682[11:0] when 0x1682[14:12] is 4*/
#define BIT_MASK_WMAC_MU_BFEE4_AID   ((u32)0x000001FF << 0)            /*!< R/W 0x0  P_AID of the target beamformee4*/
...
/** @defgroup REG_WMAC_ASSOCIATED_MU_BFMEE6
  ...
  * @{
  */
#define BIT_WMAC_MU_BFEE7_EN         ((u32)0x00000001 << 25)           /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee7, and CSI rpt of beamformee7 can be read from 0x1682[11:0] when 0x1682[14:12] is 7*/
#define BIT_MASK_WMAC_MU_BFEE7_AID   ((u32)0x000001FF << 16)           /*!< R/W 0x0  P_AID of the target beamformee7*/
#define BIT_WMAC_MU_BFEE7_AID(x)     (((u32)((x) & 0x000001FF) << 16))
#define BIT_GET_WMAC_MU_BFEE7_AID(x) ((u32)(((x >> 16) & 0x000001FF)))
#define BIT_WMAC_MU_BFEE6_EN         ((u32)0x00000001 << 9)            /*!< R/W 0x0  If enabled, NDPA/BF-rpt-poll would be sent to beamformee6, and CSI rpt of beamformee6 can be read from 0x1682[11:0] when 0x1682[14:12] is 6*/
#define BIT_MASK_WMAC_MU_BFEE6_AID   ((u32)0x000001FF << 0)            /*!< R/W 0x0  P_AID of the target beamformee6*/
...
/** @defgroup REG_WMAC_BB_STOP_RX_COUNTER
  ...
  * @{
  */
#define BIT_RST_ALL_COUNTER                   ((u32)0x00000001 << 31)           /*!< RW1C 0x0  Write one to reset all counters to zero.*/
#define BIT_MASK_ABORT_RX_VBON_COUNTER        ((u32)0x000000FF << 16)           /*!< R 0x0  Increase when mac_abort_rx_vbon trigger. 0x120[29] / 0x124[29] : BB_STOP_RX mask/interrupt  0x0B8[0] / 0x0BC[0] : BB_STOP_RX mask/interrupt  Interrupts will be trigger when mac detect any counter of 0x1690 increase.*/
#define BIT_ABORT_RX_VBON_COUNTER(x)          (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_ABORT_RX_VBON_COUNTER(x)      ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_ABORT_RX_RDRDY_COUNTER       ((u32)0x000000FF << 8)            /*!< R 0x0  Increase when mac_abort_rx_rdrdy trigger 0x120[29] / 0x124[29] : BB_STOP_RX mask/interrupt  0x0B8[0] / 0x0BC[0] : BB_STOP_RX mask/interrupt  Interrupts will be trigger when mac detect any counter of 0x1690 increase.*/
#define BIT_ABORT_RX_RDRDY_COUNTER(x)         (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_ABORT_RX_RDRDY_COUNTER(x)     ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_VBON_EARLY_FALLING_COUNTER   ((u32)0x000000FF << 0)            /*!< R 0x0  Increase when VBON fall & no rx plcp error & rx_parser is waiting for rdrdy which is expected but not received . 0x120[29] / 0x124[29] : BB_STOP_RX mask/interrupt  0x0B8[0] / 0x0BC[0] : BB_STOP_RX mask/interrupt  Interrupts will be trigger when mac detect any counter of 0x1690 increase.*/
...
#define BIT_MASK_WMAC_PLCP_RDSIG_SEL   ((u32)0x00000007 << 28)           /*!< R/W 0x0  Selection of plcp header signal field  0:LSIG/CCK PLCP 1:HTSIG1/VHTSIGA1/HESIGA1 2:HTSIG2/VHTSIGA2/HESIGA2    3:VHTSIGB/HESIGB, low 4bit is dummy   4: HE USER FIELD 5: SERVICE*/
#define BIT_WMAC_PLCP_RDSIG_SEL(x)     (((u32)((x) & 0x00000007) << 28))
#define BIT_GET_WMAC_PLCP_RDSIG_SEL(x) ((u32)(((x >> 28) & 0x00000007)))
#define BIT_MASK_WMAC_RATE_IDX         ((u32)0x0000000F << 24)           /*!< R 0x0  PPDU type 0:Long PLCP, 1:Short PLCP, 2: Legacy, 3: HT_MF, 4:HT_GF, 5: VHT-SU, 6: VHT-MU, 7: HE-SU, 8: HE-ER_SU, 9: HE_MU, 10: HE_TB, 11~15:RSVD  U(4,0)*/
...
/** @defgroup REG_TRANSMIT_ADDRSS_0
  ...
  * @{
  */
#define BIT_MASK_TA0_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Transmitter address for port 0*/
...
/** @defgroup REG_TRANSMIT_ADDRSS_0_H
  ...
  * @{
  */
#define BIT_MASK_TA0_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Transmitter address for port 0*/
...
/** @defgroup REG_TRANSMIT_ADDRSS_1
  ...
  * @{
  */
#define BIT_MASK_TA1_V1   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  Transmitter address  for port 1*/
...
/** @defgroup REG_TRANSMIT_ADDRSS_1_H
  ...
  * @{
  */
#define BIT_MASK_TA1_H_V1   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  Transmitter address  for port 1*/
#define BIT_TA1_H_V1(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_TA1_H_V1(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_REFUGEE_ADDRESS_CTL0
  * @brief
  * @{
  */
#define BIT_MASK_R_REFUG_ADDR_CLRED_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  low 32 bit of refugee mac address that need to be remove from refugee cam*/
#define BIT_R_REFUG_ADDR_CLRED_L(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_R_REFUG_ADDR_CLRED_L(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_REFUGEE_ADDRESS_CTL1
  * @brief
  * @{
  */
#define BIT_R_REFUG_CLR_ALL             ((u32)0x00000001 << 18)          /*!< WA0 0x0  gnenerate one pulse when set 1. clear all address in refugee cam*/
#define BIT_R_REFUG_CLR_POLL            ((u32)0x00000001 << 17)          /*!< WA0 0x0  gnenerate one pulse when set 1. sw request hw to clear refug_addr_clred in refugee cam*/
#define BIT_REFUG_CLR_REQ               ((u32)0x00000001 << 16)          /*!< R 0x0  1 means hw is removing the refugee mac address. Set 1 when sw poll r_refug_clr_poll and set 0 when the refugee address is removed*/
#define BIT_MASK_R_REFUG_ADDR_CLRED_H   ((u32)0x0000FFFF << 0)           /*!< R/W 0x0  high 16 bit of refugee mac address that need to be remove from refugee cam*/
#define BIT_R_REFUG_ADDR_CLRED_H(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_R_REFUG_ADDR_CLRED_H(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_MBIDCAM_VALID
  * @brief
  * @{
  */
#define BIT_MASK_REFUGMBIDCAM_VALID   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  corresponding to 32 entries, 1 means the entry is valid. For refugee cam or mbidcam*/
#define BIT_REFUGMBIDCAM_VALID(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_REFUGMBIDCAM_VALID(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup REG_VENDOR_TSFT_CTL
  ...
  * @{
  */
#define BIT_R_RX_VENDOR_TSFT_EN          ((u32)0x00000001 << 26)           /*!< R/W 0x0  vendor tsft enable for rx*/
#define BIT_MASK_R_RX_VENDOR_NS_OFFSET   ((u32)0x000003FF << 16)           /*!< R/W 0x0  vendor ns offset for rx*/
#define BIT_R_RX_VENDOR_NS_OFFSET(x)     (((u32)((x) & 0x000003FF) << 16))
#define BIT_GET_R_RX_VENDOR_NS_OFFSET(x) ((u32)(((x >> 16) & 0x000003FF)))
#define BIT_R_TX_VENDOR_TSFT_EN          ((u32)0x00000001 << 10)           /*!< R/W 0x0  vendor tsft enable for tx*/
#define BIT_MASK_R_TX_VENDOR_NS_OFFSET   ((u32)0x000003FF << 0)            /*!< R/W 0x0  vendor ns offset for tx*/
#define BIT_R_TX_VENDOR_NS_OFFSET(x)     (((u32)((x) & 0x000003FF) << 0))
#define BIT_GET_R_TX_VENDOR_NS_OFFSET(x) ((u32)(((x >> 0) & 0x000003FF)))
/** @} */
...
/** @defgroup REG_TCR_TSFT_OFS
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_TCR_TSFT_NS_OFS   ((u32)0x3FFFFFFF << 0)           /*!< R/W 0x0  TCR TSFT NS OFS*/
#define BIT_R_WMAC_TCR_TSFT_NS_OFS(x)     (((u32)((x) & 0x3FFFFFFF) << 0))
#define BIT_GET_R_WMAC_TCR_TSFT_NS_OFS(x) ((u32)(((x >> 0) & 0x3FFFFFFF)))
/** @} */
...
/** @defgroup REG_CHINFO_CONTENT
  ...
  * @{
  */
#define BIT_MASK_R_CHINFO_CONTENT   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  the packet text vaule need hw to compare for channel info rx normal mode. When the content check function is enabled, channel info will be triggered only when the text match the cfg vaule.*/
#define BIT_R_CHINFO_CONTENT(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_R_CHINFO_CONTENT(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup REG_NAN_CTL
  ...
  * @{
  */
#define BIT_MASK_R_TXRPT_NAN_ENTRY_FLAG   ((u32)0x000000FF << 24)           /*!< R 0x0  indicate NAN beacon report(i) in txrptbuffer is valid, it is set by HW and clear by FW*/
...
/** @defgroup REG_NAN_ADDR
  ...
  * @{
  */
#define BIT_R_RX_NAN_ADDR_FILTER_EN        ((u32)0x00000001 << 13)          /*!< R/W 0x0  enable of rx nan beacon address filter, can not used in D2 testchip*/
...
/** @defgroup REG_NAN_ADDR_FLITER
  ...
  * @{
  */
#define BIT_MASK_R_RX_NAN_ADDR_FILTER   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  nan address filter*/
...
/** @defgroup REG_BCN_IEPSR0
  ...
  * @{
  */
#define BIT_R_WMAC_BCN_MBSSID_MASK     ((u32)0x00000001 << 31)           /*!< R/W 0x0  enable tim no hit don't check whether  BC/MC packets are buffered at nontransmitted BSSID*/
#define BIT_R_WMAC_BCN_CLR_N           ((u32)0x00000001 << 30)           /*!< R/W 0x0  enable clear macbssid indicator when no multiple BSSID element is found.*/
#define BIT_R_WMAC_BCN_IE1_PSR         ((u32)0x00000001 << 29)           /*!< R/W 0x0  enable parser specified ie 1 element*/
#define BIT_R_WMAC_BCN_IE0_PSR         ((u32)0x00000001 << 28)           /*!< R/W 0x0  enable parser specified ie0 element*/
#define BIT_R_WMAC_BCN_MBSSID_PSR      ((u32)0x00000001 << 27)           /*!< R/W 0x0  enable parser multiple BSSID element*/
#define BIT_R_WMAC_BCN_SW_MBSSID       ((u32)0x00000001 << 26)           /*!< R/W 0x0  enable the MaxBSSID indicator value from SW*/
#define BIT_MASK_R_WMAC_BCN_MBSSID_N   ((u32)0x000000FF << 18)           /*!< R/W 0x0  SW write the value of MaxBSSID Indicator field*/
#define BIT_R_WMAC_BCN_MBSSID_N(x)     (((u32)((x) & 0x000000FF) << 18))
#define BIT_GET_R_WMAC_BCN_MBSSID_N(x) ((u32)(((x >> 18) & 0x000000FF)))
#define BIT_R_WMAC_BCN_ID1_EXT         ((u32)0x00000001 << 17)           /*!< R/W 0x0  indicate current ie is the extend element which need to parser extend id field*/
#define BIT_MASK_R_WMAC_BCN_IE_ID1     ((u32)0x000000FF << 9)            /*!< R/W 0x0  specified Element ID, set corresponding interrupt when it is parsed*/
#define BIT_R_WMAC_BCN_IE_ID1(x)       (((u32)((x) & 0x000000FF) << 9))
#define BIT_GET_R_WMAC_BCN_IE_ID1(x)   ((u32)(((x >> 9) & 0x000000FF)))
#define BIT_R_WMAC_BCN_ID0_EXT         ((u32)0x00000001 << 8)            /*!< R/W 0x0  indicate current ie is the extend element which need to parser extend id field*/
#define BIT_MASK_R_WMAC_BCN_IE_ID0     ((u32)0x000000FF << 0)            /*!< R/W 0x0  specified Element ID, set corresponding interrupt when it is parsed*/
...
/** @defgroup REG_BCN_IEPSR1
  ...
  * @{
  */
#define BIT_MASK_R_WMAC_BCN_MBSSID_OFS   ((u32)0x0000FFFF << 16)           /*!< R 0x0  the multiple bssid element offset (byte unit) in frame body*/
#define BIT_R_WMAC_BCN_MBSSID_OFS(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_R_WMAC_BCN_MBSSID_OFS(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_R_WMAC_BCN_N0_CHG            ((u32)0x00000001 << 15)           /*!< R 0x0  indicate parsed maxmbssid indicator field value has changed which leads to the change of N0.*/
#define BIT_R_WMAC_BCN_MBSSID_VAL        ((u32)0x00000001 << 14)           /*!< R 0x0  indicate ofs and n0 change bit is valid.*/
#define BIT_R_WMAC_OPS_PSR_EN            ((u32)0x00000001 << 10)           /*!< R/W 0x0  enable parser ops frame tim elemnt and ops element*/
#define BIT_R_WMAC_TIM_TIMPSR_EN         ((u32)0x00000001 << 9)            /*!< R/W 0x0  enable parser tim frame tim element*/
#define BIT_R_WMAC_BCN_BMC_MASK          ((u32)0x00000001 << 8)            /*!< R/W 0x0  bcn tim hit bc/mc mask*/
#define BIT_MASK_R_WMAC_BCN_MBSSID_IDX   ((u32)0x000000FF << 0)            /*!< R/W 0x0  the multiple bssid index that current sta connect with*/
...
/** @defgroup REG_CHINFO_ADDR
  ...
  * @{
  */
#define BIT_MASK_R_CHINFO_TX_ADDR_L   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  low 32bit tx address for trigger channel info*/
...
/** @defgroup REG_CHINFO_CFG
  ...
  * @{
  */
#define BIT_R_CHINFO_CONTENT_EN       ((u32)0x00000001 << 30)           /*!< R/W 0x0  used for rx normal mode 1: the payload(excluding mac header/iv/eiv/icv/mic/fcs) of the specified location must match the configured value 0: do not check the payload value*/
#define BIT_R_CHINFO_DROP_INVALID     ((u32)0x00000001 << 29)           /*!< R/W 0x0  when set to 1, will not drop channe info if valid bit of bb header is 0*/
#define BIT_R_CHINFO_FCS              ((u32)0x00000001 << 28)           /*!< R/W 0x0  when set to 1, will not check channel info fcs ok flag*/
#define BIT_R_CHINFO_WTM_OUT          ((u32)0x00000001 << 27)           /*!< RW1C 0x0  BB does't send channel info when timeout occur*/
#define BIT_R_CHINFO_TIME_OUT         ((u32)0x00000001 << 26)           /*!< RW1C 0x0  BB send channel info length is less than report length*/
#define BIT_R_CSI_BUFF_FULL           ((u32)0x00000001 << 25)           /*!< RW1C 0x0  Indicate rxcsibuff full occur*/
...
#define BIT_R_CHINFO_TXADDR_EN        ((u32)0x00000001 << 21)           /*!< R/W 0x1  1: rx address2 must match the tx address for trigger channel info, except ack and cts 0: do not care of rx address2*/
#define BIT_R_CHINFO_A1_EN            ((u32)0x00000001 << 20)           /*!< R/W 0x1  1: rx address1 must match the self mac address 0: do not care of unicast rx address1*/
#define BIT_MASK_R_CHINFO_MODE        ((u32)0x00000003 << 17)           /*!< R/W 0x0  channel info mode setting. 0: enable normal rx trigger; 1: enable ndpa trigger; note: repsonse mode decided by tx descriptor. Valid when r_CHINFO_EN is 1.*/
#define BIT_R_CHINFO_MODE(x)          (((u32)((x) & 0x00000003) << 17))
#define BIT_GET_R_CHINFO_MODE(x)      ((u32)(((x >> 17) & 0x00000003)))
#define BIT_R_CHINFO_EN               ((u32)0x00000001 << 16)           /*!< R/W 0x0  enable for getting channel info from BB. When set to 0, will not trigger channel info function*/
#define BIT_MASK_R_CHINFO_TX_ADDR_H   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  high 16bit tx address for trigger channel info*/
...
/** @defgroup REG_RXCSIBUF_CFG
  ...
  * @{
  */
#define BIT_MASK_R_CHINFO_OFFSET      ((u32)0x000000FF << 24)           /*!< R/W 0x0  used for rx normal mode the payload offset for compare with configured value. 0 means the 0-3bytes payload need to compare after mac header/iv/eiv*/
#define BIT_R_CHINFO_OFFSET(x)        (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_R_CHINFO_OFFSET(x)    ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_R_CHINFO_REQ_SIZE    ((u32)0x0000003F << 16)           /*!< R/W 0x0  The channel info trigger request rxcsibuffer size, unit 32bytes, the actually request size = (r_chinfo_req_size + 1) * 32byte*/
...
/** @defgroup REG_BT_ZB_COEX_TB
  ...
  * @{
  */
#define BIT_MASK_R_BT_ZB_COEX_TABLE   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  bt and zigbee coexist table*/
...
/** @defgroup REG_CHINFO_TRIG_TYPE0
  ...
  * @{
  */
#define BIT_CTL_TRG_15EN ((u32)0x00000001 << 31) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1111 will trigger channel info*/
#define BIT_CTL_TRG_14EN ((u32)0x00000001 << 30) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1110 will trigger channel info*/
#define BIT_CTL_TRG_13EN ((u32)0x00000001 << 29) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1101 will trigger channel info*/
#define BIT_CTL_TRG_12EN ((u32)0x00000001 << 28) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1100 will trigger channel info*/
#define BIT_CTL_TRG_11EN ((u32)0x00000001 << 27) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1011 will trigger channel info*/
#define BIT_CTL_TRG_10EN ((u32)0x00000001 << 26) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1010 will trigger channel info*/
#define BIT_CTL_TRG_9EN  ((u32)0x00000001 << 25) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1001 will trigger channel info*/
#define BIT_CTL_TRG_8EN  ((u32)0x00000001 << 24) /*!< R/W 0x0  When set, control frames with type=01 and subtype=1000 will trigger channel info*/
#define BIT_CTL_TRG_7EN  ((u32)0x00000001 << 23) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0111 will trigger channel info*/
#define BIT_CTL_TRG_6EN  ((u32)0x00000001 << 22) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0110 will trigger channel info*/
#define BIT_CTL_TRG_5EN  ((u32)0x00000001 << 21) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0101 will trigger channel info*/
#define BIT_CTL_TRG_4EN  ((u32)0x00000001 << 20) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0100 will trigger channel info*/
#define BIT_CTL_TRG_3EN  ((u32)0x00000001 << 19) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0011 will trigger channel info*/
#define BIT_CTL_TRG_2EN  ((u32)0x00000001 << 18) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0010 will trigger channel info*/
#define BIT_CTL_TRG_1EN  ((u32)0x00000001 << 17) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0001 will trigger channel info*/
#define BIT_CTL_TRG_0EN  ((u32)0x00000001 << 16) /*!< R/W 0x0  When set, control frames with type=01 and subtype=0000 will trigger channel info*/
#define BIT_MGT_TRG_15EN ((u32)0x00000001 << 15) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1111 will trigger channel info*/
#define BIT_MGT_TRG_14EN ((u32)0x00000001 << 14) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1110 will trigger channel info*/
#define BIT_MGT_TRG_13EN ((u32)0x00000001 << 13) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1101 will trigger channel info*/
#define BIT_MGT_TRG_12EN ((u32)0x00000001 << 12) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1100 will trigger channel info*/
#define BIT_MGT_TRG_11EN ((u32)0x00000001 << 11) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1011 will trigger channel info*/
#define BIT_MGT_TRG_10EN ((u32)0x00000001 << 10) /*!< R/W 0x0  When set, management frames with type=00 and subtype=1010 will trigger channel info*/
#define BIT_MGT_TRG_9EN  ((u32)0x00000001 << 9)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=1001 will trigger channel info*/
#define BIT_MGT_TRG_8EN  ((u32)0x00000001 << 8)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=1000 will trigger channel info*/
#define BIT_MGT_TRG_7EN  ((u32)0x00000001 << 7)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0111 will trigger channel info*/
#define BIT_MGT_TRG_6EN  ((u32)0x00000001 << 6)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0110 will trigger channel info*/
#define BIT_MGT_TRG_5EN  ((u32)0x00000001 << 5)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0101 will trigger channel info*/
#define BIT_MGT_TRG_4EN  ((u32)0x00000001 << 4)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0100 will trigger channel info*/
#define BIT_MGT_TRG_3EN  ((u32)0x00000001 << 3)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0011 will trigger channel info*/
#define BIT_MGT_TRG_2EN  ((u32)0x00000001 << 2)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0010 will trigger channel info*/
#define BIT_MGT_TRG_1EN  ((u32)0x00000001 << 1)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0001 will trigger channel info*/
#define BIT_MGT_TRG_0EN  ((u32)0x00000001 << 0)  /*!< R/W 0x0  When set, management frames with type=00 and subtype=0000 will trigger channel info*/
/** @} */
...
/** @defgroup REG_CHINFO_TRIG_TYPE1
  ...
  * @{
  */
#define BIT_MASK_R_TXTRIG_STOP_SEL   ((u32)0x0000001F << 24)           /*!< R/W 0x0  select tx trigger stop signal for LA dump*/
#define BIT_R_TXTRIG_STOP_SEL(x)     (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_R_TXTRIG_STOP_SEL(x) ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_R_RXTRIG_STOP_SEL   ((u32)0x0000001F << 19)           /*!< R/W 0x0  select rx trigger stop signal for LA dump*/
#define BIT_R_RXTRIG_STOP_SEL(x)     (((u32)((x) & 0x0000001F) << 19))
#define BIT_GET_R_RXTRIG_STOP_SEL(x) ((u32)(((x >> 19) & 0x0000001F)))
#define BIT_R_NEW_RX_RST_EN          ((u32)0x00000001 << 18)           /*!< R/W 0x0  when set, enable new rx rst macrx when macrx is active*/
#define BIT_MASK_R_RXD_OFFSET_SEL    ((u32)0x00000003 << 16)           /*!< R/W 0x0  select 2bytes of rxd to debug port 0: 0~1 bytes; 1: 2~3 bytes; 2: 4~5 bytes; 3: 6~7 bytes;*/
#define BIT_R_RXD_OFFSET_SEL(x)      (((u32)((x) & 0x00000003) << 16))
#define BIT_GET_R_RXD_OFFSET_SEL(x)  ((u32)(((x >> 16) & 0x00000003)))
#define BIT_DATA_TRG_15EN            ((u32)0x00000001 << 15)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1111 will trigger channel info*/
#define BIT_DATA_TRG_14EN            ((u32)0x00000001 << 14)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1110 will trigger channel info*/
#define BIT_DATA_TRG_13EN            ((u32)0x00000001 << 13)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1101 will trigger channel info*/
#define BIT_DATA_TRG_12EN            ((u32)0x00000001 << 12)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1100 will trigger channel info*/
#define BIT_DATA_TRG_11EN            ((u32)0x00000001 << 11)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1011 will trigger channel info*/
#define BIT_DATA_TRG_10EN            ((u32)0x00000001 << 10)           /*!< R/W 0x0  When set, data frames with type=10 and subtype=1010 will trigger channel info*/
#define BIT_DATA_TRG_9EN             ((u32)0x00000001 << 9)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=1001 will trigger channel info*/
#define BIT_DATA_TRG_8EN             ((u32)0x00000001 << 8)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=1000 will trigger channel info*/
#define BIT_DATA_TRG_7EN             ((u32)0x00000001 << 7)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0111 will trigger channel info*/
#define BIT_DATA_TRG_6EN             ((u32)0x00000001 << 6)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0110 will trigger channel info*/
#define BIT_DATA_TRG_5EN             ((u32)0x00000001 << 5)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0101 will trigger channel info*/
#define BIT_DATA_TRG_4EN             ((u32)0x00000001 << 4)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0100 will trigger channel info*/
#define BIT_DATA_TRG_3EN             ((u32)0x00000001 << 3)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0011 will trigger channel info*/
#define BIT_DATA_TRG_2EN             ((u32)0x00000001 << 2)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0010 will trigger channel info*/
#define BIT_DATA_TRG_1EN             ((u32)0x00000001 << 1)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0001 will trigger channel info*/
#define BIT_DATA_TRG_0EN             ((u32)0x00000001 << 0)            /*!< R/W 0x0  When set, data frames with type=10 and subtype=0000 will trigger channel info*/
/** @} */
...
/** @defgroup REG_DFS_CFG
  ...
  * @{
  */
#define BIT_MASK_R_DFS_DROP_CNT           ((u32)0x000001FF << 23)           /*!< R 0x0  drop dfs packets number when dfsbuffer is full*/
#define BIT_R_DFS_DROP_CNT(x)             (((u32)((x) & 0x000001FF) << 23))
#define BIT_GET_R_DFS_DROP_CNT(x)         ((u32)(((x >> 23) & 0x000001FF)))
#define BIT_MASK_R_CHINFO_CONTENT_BMASK   ((u32)0x0000000F << 19)           /*!< R/W 0xF  byte mask of 4bytes content value that need to compare when set to 1,the corresponding byte need to compare*/
#define BIT_R_CHINFO_CONTENT_BMASK(x)     (((u32)((x) & 0x0000000F) << 19))
#define BIT_GET_R_CHINFO_CONTENT_BMASK(x) ((u32)(((x >> 19) & 0x0000000F)))
#define BIT_DFS_BUFF_FULL                 ((u32)0x00000001 << 18)           /*!< RW1C 0x0  dfs buffer is full*/
#define BIT_DFS_EN_INTRPT                 ((u32)0x00000001 << 17)           /*!< R 0x1  When valid, enable generate dfs interrupt*/
#define BIT_R_DFS_EN_INTRPT               ((u32)0x00000001 << 16)           /*!< WA0 0x0  When set to 1, enable generate DFS interrupt, one pulse*/
#define BIT_MASK_R_DFS_PKT_LEN            ((u32)0x000003FF << 6)            /*!< R 0x0  dfs packet length need Host to read, 4 bytes unit*/
#define BIT_R_DFS_PKT_LEN(x)              (((u32)((x) & 0x000003FF) << 6))
#define BIT_GET_R_DFS_PKT_LEN(x)          ((u32)(((x >> 6) & 0x000003FF)))
#define BIT_R_DFS_RST_DROP_CNT            ((u32)0x00000001 << 5)            /*!< WA0 0x0  When set to 1, clear r_dfs_drop_cnt, one pulse*/
#define BIT_R_DFS_READ_MODE               ((u32)0x00000001 << 1)            /*!< R/W 0x0  When set to 1,means host read mode for debug*/
#define BIT_R_DFS_STOP                    ((u32)0x00000001 << 0)            /*!< R/W 0x0  When set to 1, stop to get DFS from BB and clear the DFS buffer*/
/** @} */
...
/** @defgroup REG_DFS_AGG_TIME
  ...
  * @{
  */
#define BIT_MASK_R_TXTRIG_TYPE    ((u32)0x0000003F << 23)           /*!< R/W 0x0  mapping to frame control type and subtype filed, for LA trigger select*/
#define BIT_R_TXTRIG_TYPE(x)      (((u32)((x) & 0x0000003F) << 23))
#define BIT_GET_R_TXTRIG_TYPE(x)  ((u32)(((x >> 23) & 0x0000003F)))
#define BIT_MASK_R_RXTRIG_TYPE    ((u32)0x0000003F << 17)           /*!< R/W 0x0  mapping to frame control type and subtype filed, for LA trigger select*/
#define BIT_R_RXTRIG_TYPE(x)      (((u32)((x) & 0x0000003F) << 17))
#define BIT_GET_R_RXTRIG_TYPE(x)  ((u32)(((x >> 17) & 0x0000003F)))
#define BIT_MASK_R_DFS_AGG_TIME   ((u32)0x000000FF << 9)            /*!< R/W 0x0  DFS packet aggregation time. When reach the target, will inform host by interrupt, unit ms*/
#define BIT_R_DFS_AGG_TIME(x)     (((u32)((x) & 0x000000FF) << 9))
#define BIT_GET_R_DFS_AGG_TIME(x) ((u32)(((x >> 9) & 0x000000FF)))
#define BIT_MASK_R_DFS_AGG_NUM    ((u32)0x000001FF << 0)            /*!< R/W 0x0  aggregation DFS packet number selection. When reach the target, will inform host by interrupt, unit 4bytes*/
...
#define REG_ADDRESS_CAM_CTL                    0x644
#define REG_TXOPOWNER_L                        0x648
...
#define REG_NAN_TA0                            0x1670
#define REG_NAN_TA1                            0x1674
...
#define REG_REFUGEE_ADDRESS_CTL0               0x16B0
#define REG_REFUGEE_ADDRESS_CTL1               0x16B4
#define REG_MBIDCAM_VALID                      0x16B8
#define REG_VENDOR_TSFT_CTL                    0x16BC
#define REG_TCR_TSFT_OFS                       0x16C0
#define REG_CHINFO_CONTENT                     0x16C4
