#ifndef _RL7005_REG_PAGE5_H_
#define _RL7005_REG_PAGE5_H_
...
#define BIT_MGTQ_RTSMF_EN        ((u32)0x00000001 << 2)           /*!< R/W 0x0  When this bit is set, MTGQ will be TX, not wait until RTS or MF transaction finished.*/
#define BIT_HIQ_RTSMF_EN         ((u32)0x00000001 << 1)           /*!< R/W 0x0  When this bit is set, HIQ will be TX, not wait until RTS or MF transaction finished.*/
...
#define BIT_MASK_BK_TRIGGER_NUM       ((u32)0x0000000F << 12)           /*!< RW1C 0x0  The number is triggered by bkq inter collision*/
#define BIT_BK_TRIGGER_NUM(x)         (((u32)((x) & 0x0000000F) << 12))
#define BIT_GET_BK_TRIGGER_NUM(x)     ((u32)(((x >> 12) & 0x0000000F)))
#define BIT_MASK_BE_TRIGGER_NUM       ((u32)0x0000000F << 8)            /*!< RW1C 0x0  The number is triggered by beq inter collision*/
#define BIT_BE_TRIGGER_NUM(x)         (((u32)((x) & 0x0000000F) << 8))
#define BIT_GET_BE_TRIGGER_NUM(x)     ((u32)(((x >> 8) & 0x0000000F)))
#define BIT_MASK_VI_TRIGGER_NUM       ((u32)0x0000000F << 4)            /*!< RW1C 0x0  The number is triggered by viq inter collision*/
#define BIT_VI_TRIGGER_NUM(x)         (((u32)((x) & 0x0000000F) << 4))
#define BIT_GET_VI_TRIGGER_NUM(x)     ((u32)(((x >> 4) & 0x0000000F)))
#define BIT_MASK_VO_TRIGGER_NUM       ((u32)0x0000000F << 0)            /*!< RW1C 0x0  The number is triggered by voq inter collision*/
...
#define BIT_EN_AUTO_MASK_RXPRSP_UPD     ((u32)0x00000001 << 23)          /*!< R/W 0x1  valid when BIT_EN_RXPRSP_UPD = 1 1: auto disable RXPRSP's tsft update when rx probe response frame during bcn_early to tbtt*/
#define BIT_EN_RXPRSP_UPD               ((u32)0x00000001 << 22)          /*!< R/W 0x1  1: enable update tsft when RX probe response frame*/
...
/** @defgroup REG_BCN_ERLY_CTW_CTRL
  ...
  * @{
  */
#define BIT_ELY_IGNORE_LSB       ((u32)0x00000001 << 31)           /*!< R/W 0x1  1:add1ms, add128us, add32us only check tsft[10], tsft[7], tsft[5], ignore LSB 0:   add1ms, add128us, add32us check tsft[9:0], tsft[6:0], tsft[4:0] when active*/
...
#define BIT_BEACON_DROP_EN              ((u32)0x00000001 << 7)            /*!< R/W 0x0  enable beacon drop function*/
#define BIT_MASK_BEACON_DROP_IVL        ((u32)0x0000007F << 0)            /*!< R/W 0x0  indicate the timeout of beacon drop*/
...
/** @defgroup REG_P2_TSFTR_L
  ...
  * @{
  */
#define BIT_MASK_P2_TSF_TIMER_L   ((u32)0xFFFFFFFF << 0)           /*!< RO 0x1  low 32bits of port2's tsft (NAN)*/
...
/** @defgroup REG_P2_TSFTR_H
  ...
  * @{
  */
#define BIT_MASK_P2_TSF_TIMER_H   ((u32)0xFFFFFFFF << 0)           /*!< RO 0x1  high 32bits of port2's tsft(NAN)*/
...
#define BIT_TSFTR2_SYNC_EN           ((u32)0x00000001 << 29)           /*!< W 0x0  write this bit,  PORT2 backup TSFT will sync to PORT2 TSFT without TSFTF_SYN_OFFSET*/
...
#define BIT_DIS_BCN_P2_0             ((u32)0x00000001 << 23)           /*!< R/W 0x0  set 1 to mask the NAN disc beacon early interrupt of port2*/
...
#define BIT_MASK_TBTT_HOLD_PREDICT   ((u32)0x0000001F << 16)           /*!< R/W 0x2  the predicted hold time after tbtt for P0 RX beacon, unit is 1ms*/
#define BIT_TBTT_HOLD_PREDICT(x)     (((u32)((x) & 0x0000001F) << 16))
#define BIT_GET_TBTT_HOLD_PREDICT(x) ((u32)(((x >> 16) & 0x0000001F)))
#define BIT_DIS_BCN_P2_1             ((u32)0x00000001 << 15)           /*!< R/W 0x0  set 1 to mask the NAN sync beacon early interrupt of port2*/
...
#define BIT_FCSOK_CHK_BSSID              ((u32)0x00000001 << 16)           /*!< R/W 0x1  1:HW will check bssid when fcsok*/
...
/** @defgroup REG_BCN_SPACE_PORT1_2
  ...
  * @{
  */
#define BIT_MASK_BCN_SPACE4   ((u32)0x0000FFFF << 16)           /*!< R/W 0x64  Unit is ms. the beacon space of port2 disc beacon. default is 100ms*/
...
#define BIT_MASK_EVTQ_EARLY       ((u32)0x0000000F << 4)            /*!< R/W 0x1  the early time of evtq tx window. unit is TU*/
#define BIT_EVTQ_EARLY(x)         (((u32)((x) & 0x0000000F) << 4))
#define BIT_GET_EVTQ_EARLY(x)     ((u32)(((x >> 4) & 0x0000000F)))
#define BIT_MASK_EARLY_128US_P2   ((u32)0x00000007 << 0)            /*!< R/W 0x0  the BCN EARLY interrupt find tune with unit 128us. The Total Early time of BCN early interrupt is the ERLYINTIM x 1ms + EARLY_128us x 128us.*/
#define BIT_EARLY_128US_P2(x)     (((u32)((x) & 0x00000007) << 0))
#define BIT_GET_EARLY_128US_P2(x) ((u32)(((x >> 0) & 0x00000007)))
/** @} */
...
/** @defgroup REG_TXOP_AUDIO_CFG
  * @brief
  * @{
  */
#define BIT_R_AUDIO_SEL_P0              ((u32)0x00000001 << 31)           /*!< R/W 0x1  1: select P0's TSFT to trigger audio latch count*/
#define BIT_MASK_R_AUDIO_TRIG_UNIT      ((u32)0x00000007 << 28)           /*!< R/W 0x2  0: trigger audio latch period is 1ms 1: period is 2ms 2: period is 4ms 3: period is 8ms ...... 6: period is 64ms 7: period is 128ms*/
#define BIT_R_AUDIO_TRIG_UNIT(x)        (((u32)((x) & 0x00000007) << 28))
#define BIT_GET_R_AUDIO_TRIG_UNIT(x)    ((u32)(((x >> 28) & 0x00000007)))
#define BIT_MASK_R_AUDIO_STR_PLAY_SEL   ((u32)0x00000007 << 25)           /*!< R/W 0x0  select ps_timer interrput for audio start play function 1: select ps_timer_a int 2: select ps_timer_b int 3: select ps_timer_c int 4: select ps_timer_d int 5: select ps_timer_e int else: TIE0*/
#define BIT_R_AUDIO_STR_PLAY_SEL(x)     (((u32)((x) & 0x00000007) << 25))
#define BIT_GET_R_AUDIO_STR_PLAY_SEL(x) ((u32)(((x >> 25) & 0x00000007)))
...
/** @defgroup REG_CPUMGQ_PARAMETER
  ...
  * @{
  */
#define BIT_MASK_PS_TIMER_E_EARLY   ((u32)0x000000FF << 24)           /*!< R/W 0x0  It is used to wake up early at PS_Timer_E_Early Time.  Time unit is 32us.*/
...
/** @defgroup REG_PS_TIMER_EARLY
  ...
  * @{
  */
#define BIT_MASK_PS_TIMER_D_EARLY   ((u32)0x000000FF << 24)           /*!< R/W 0x0  It is used to wake up early at PS_Timer_D_Early Time.  Time unit is 32us.*/
#define BIT_PS_TIMER_D_EARLY(x)     (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_PS_TIMER_D_EARLY(x) ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_PS_TIMER_C_EARLY   ((u32)0x000000FF << 16)           /*!< R/W 0x0  It is used to wake up early at PS_Timer_C_Early Time.  Time unit is 32us.*/
#define BIT_PS_TIMER_C_EARLY(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_PS_TIMER_C_EARLY(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_PS_TIMER_B_EARLY   ((u32)0x000000FF << 8)            /*!< R/W 0x0  It is used to wake up early at PS_Timer_B_Early Time.  Time unit is 32us.*/
#define BIT_PS_TIMER_B_EARLY(x)     (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_PS_TIMER_B_EARLY(x) ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_PS_TIMER_A_EARLY   ((u32)0x000000FF << 0)            /*!< R/W 0x0  It is used to wake up early at PS_Timer_A_Early Time.  Time unit is 32us.*/
...
#define BIT_TSFT_DIFF_P0_EN           ((u32)0x00000001 << 2)            /*!< R/W 0x0  */
...
/** @defgroup REG_RX_TSFT_DIFF
  ...
  * @{
  */
#define BIT_RXBCN_TIME_VLD         ((u32)0x00000001 << 31)          /*!< RW1C   1: indicate [30:0] is valid. Write 1 to clear this bit*/
...
/** @defgroup REG_AUDIO_LAT_TSFT
  ...
  * @{
  */
#define BIT_MASK_AUDIO_LAT_TSFT_US   ((u32)0x00000FFF << 20)           /*!< RO 0x0  low 22bits of audio latch tsft_us*/
#define BIT_AUDIO_LAT_TSFT_US(x)     (((u32)((x) & 0x00000FFF) << 20))
#define BIT_GET_AUDIO_LAT_TSFT_US(x) ((u32)(((x >> 20) & 0x00000FFF)))
#define BIT_MASK_AUDIO_LAT_TSFT_NS   ((u32)0x000003FF << 0)            /*!< RO 0x0  audio latch tsft_ns*/
#define BIT_AUDIO_LAT_TSFT_NS(x)     (((u32)((x) & 0x000003FF) << 0))
#define BIT_GET_AUDIO_LAT_TSFT_NS(x) ((u32)(((x >> 0) & 0x000003FF)))
/** @} */

/** @defgroup REG_AUDIO_TSFT_CFG0
  * @brief
  * @{
  */
...
#define BIT_MASK_TSFT_AVG_THRES              ((u32)0x0000FFFF << 0)            /*!< R/W 0x800  The threshold of deltaTSFT(latch hioe_int_chn_on and  cca_up), unit us*/
#define BIT_TSFT_AVG_THRES(x)                (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_TSFT_AVG_THRES(x)            ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup REG_NAN_SETTING_3
  * @brief
  * @{
  */
#define BIT_MASK_BCN_SPACE5          ((u32)0x0000FFFF << 16)           /*!< R/W 0x200  Unit is ms. the beacon space of port2 sync beacon. default is 512ms*/
#define BIT_BCN_SPACE5(x)            (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_BCN_SPACE5(x)        ((u32)(((x >> 16) & 0x0000FFFF)))
...
#define BIT_MASK_BCN_PORT_PRI        ((u32)0x00000007 << 5)            /*!< R/W 0x1  the priority of ports  000: no priority 001: port2 sync bcn has higher priority than P0/P1, P2 sync > P0/P1 010: port0 has higher priority than P2 sync bcn, P0 > P2 sync > P1 011: port1 has higher priority than P2 sync bcn, P1 > P2 sync > P0 100: port0 and port1 has higher priority than P2 sync bcn, P0/P1 > P2 sync*/
#define BIT_BCN_PORT_PRI(x)          (((u32)((x) & 0x00000007) << 5))
#define BIT_GET_BCN_PORT_PRI(x)      ((u32)(((x >> 5) & 0x00000007)))
#define BIT_EN_PORT_ROND             ((u32)0x00000001 << 4)            /*!< R/W 0x0  1: enable round-robin of P2 disc beacon and P0/1 beacon*/
#define BIT_P2_TSFT_BACKUP_EN        ((u32)0x00000001 << 3)            /*!< R/W 0x0  1:en p2 backup tsft*/
#define BIT_UPD_TSFT_DIS_CHK_TA      ((u32)0x00000001 << 2)            /*!< R/W 0x0  1: don't check TA_FIT when update NAN tsft*/
#define BIT_P2_TSFT_AUTO_SYNC_EN     ((u32)0x00000001 << 1)            /*!< R/W 0x1  1: enable HW auto tsft sync, when sync beacon frames are received, auto update RX.timestamp + RX path delay to TSFT_P2_0*/
#define BIT_EN_5G_NAN                ((u32)0x00000001 << 0)            /*!< R/W 0x0  1: enable 5G NAN mode 0: only 2.4G NAN*/
/** @} */

/** @defgroup REG_P2_BACKUP_TSFTR_L
  * @brief
  * @{
  */
#define BIT_MASK_P2_BACKUP_TSF_TIMER_L   ((u32)0xFFFFFFFF << 0)           /*!< R/WOPD 0x1  low 32bits of port2's backup tsft (NAN)*/
#define BIT_P2_BACKUP_TSF_TIMER_L(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_P2_BACKUP_TSF_TIMER_L(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */

/** @defgroup REG_P2_BACKUP_TSFTR_H
  * @brief
  * @{
  */
#define BIT_MASK_P2_BACKUP_TSF_TIMER_H   ((u32)0xFFFFFFFF << 0)           /*!< R/WOPD 0x0  high 32bits of port2's backup tsft (NAN)*/
#define BIT_P2_BACKUP_TSF_TIMER_H(x)     (((u32)((x) & 0xFFFFFFFF) << 0))
#define BIT_GET_P2_BACKUP_TSF_TIMER_H(x) ((u32)(((x >> 0) & 0xFFFFFFFF)))
/** @} */
...
/** @defgroup REG_P0_UPDATETSFT_DIFF
  ...
  * @{
  */
#define BIT_TSFT_DIFF_VLD       ((u32)0x00000001 << 31)           /*!< RW1C   1: indicate [20:0] is valid. 0: wmac_rx_tsf <= TSFT*/
#define BIT_TSFT_DIFF_US_DIR    ((u32)0x00000001 << 20)           /*!< R   1: update_tsft_us > TSFT_us 0: update_tsft_us <= TSFT_us*/
#define BIT_MASK_TSFT_DIFF_US   ((u32)0x000000FF << 12)           /*!< R   unit:1us update_tsft_us - TSFT. [20] is the sign bit if diff >=255, this value would be 8'hff*/
#define BIT_TSFT_DIFF_US(x)     (((u32)((x) & 0x000000FF) << 12))
#define BIT_GET_TSFT_DIFF_US(x) ((u32)(((x >> 12) & 0x000000FF)))
#define BIT_TSFT_DIFF_NS_DIR    ((u32)0x00000001 << 10)           /*!< R   1: update_tsft_ns > TSFT_ns 0: update_tsft_ns <= TSFT_ns*/
#define BIT_MASK_TSFT_DIFF_NS   ((u32)0x000003FF << 0)            /*!< R   unit:1ns update_tsft_ns - TSFT. [10] is the sign bit*/
...
#define REG_TSFT_SYN_OFFSET_SLOT                    0x518
#define REG_PS_NOA_ERLY_TIME                        0x51C
#define REG_TXPAUSE_TXPTCL_DISTXREQ_CTRL            0x520
#define REG_NOA0_MBSSID_RD_CTRL                     0x524
#define REG_NOA0_PKT_LIFETIME_CTRL                  0x528
#define REG_P2PON_DIS_TXTIME                        0x530
#define REG_NAN_SETTING_2                           0x534
#define REG_QUEUE_INCOL_THR                         0x538
#define REG_QUEUE_INCOL_EN                          0x53C
#define REG_NOA0_TBTT_PROHIBIT                      0x540
#define REG_NAV_CTRL                                0x544
#define REG_FTM_CTRL                                0x548
#define REG_FTM_TSF_CNT                             0x54C
#define REG_TSTRST_P2PRST_BCN_CTRL_PORT0_1          0x550
#define REG_PORT0_BCN_SPACE                         0x554
#define REG_ATIMWND0_P0_BCN_ERLY_DMA_CTRL           0x558
#define REG_BCNERR_TSF_CTRL                         0x55C
#define REG_P0_TSFTR_L                              0x560
#define REG_P0_TSFTR_H                              0x564
#define REG_P1_TSFTR_L                              0x568
#define REG_P1_TSFTR_H                              0x56C
#define REG_BCN_ERLY_CTW_CTRL                       0x570
#define REG_BCNDROP_TO_MISC_CTRL                    0x574
#define REG_P2_TSFTR_L                              0x578
#define REG_P2_TSFTR_H                              0x57C
#define REG_TSF_TIMER1                              0x580
#define REG_TSF_TIMER2                              0x584
#define REG_TSF_TIMER3                              0x588
#define REG_BCN_IFS_TBTT_CTN                        0x58C
#define REG_TXOP_CTRL_PRE_BKF                       0x590
#define REG_FREERUN_CNT_L                           0x594
#define REG_FREERUN_CNT_H                           0x598
#define REG_BCN_ERLY_CTW_CTRL_P1_2                  0x59C
#define REG_ATIMWND2_5                              0x5A0
#define REG_ATIMWND6_7_URGENT_NOLIMTHGQ             0x5A4
#define REG_DTIM_COUNT_0_3                          0x5A8
#define REG_DTIM_COUNT_4_7                          0x5AC
#define REG_DISATIM_BCNERLY_TBTTHOLD_BCNCS          0x5B0
#define REG_FREERUN_CNT_P2POFF_DIS_TXTIME           0x5B4
#define REG_PTA_TRXBCN_CTRL                         0x5B8
#define REG_P2P_NOA1_CTRL_STATE                     0x5BC
#define REG_ACMHWCTRL                               0x5C0
#define REG_VO_VI_ADMTIME                           0x5C4
#define REG_BE_ADMTIME                              0x5C8
#define REG_NOACMD_SEL_EDCA_RANDOM_GEN              0x5CC
#define REG_TXPAUSE_CFG                             0x5D0
#define REG_NAN_SETTING                             0x5D4
#define REG_BCN_SPACE_PORT1_2                       0x5D8
#define REG_NAN_SETTING_1                           0x5DC
#define REG_NOA_PARAM_V1                            0x5E0
#define REG_NOA_PARAM_V2                            0x5E4
#define REG_NOA_PARAM_V3                            0x5E8
#define REG_NOA_PARAM_4                             0x5EC
#define REG_TXOP_AUDIO_CFG                          0x5F0
...
#define REG_AUDIO_LAT_TSFT                          0x155C
#define REG_AUDIO_TSFT_CFG0                         0x1578
...
#define REG_LPSOFFLOAD_RXBCN_DIFF_CFG0              0x15AC
#define REG_TSFT_AVG_VALUE                          0x15B0
#define REG_NAN_SETTING_3                           0x15B4
#define REG_P2_BACKUP_TSFTR_L                       0x15B8
#define REG_P2_BACKUP_TSFTR_H                       0x15BC
#define REG_P0_UPDATETSFT_DIFF                      0x15C0
