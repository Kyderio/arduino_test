#ifndef _RL7005_REG_PAGE2_H_
#define _RL7005_REG_PAGE2_H_
...
/** @defgroup REG_RQPN_CTRL_HLPQ
  ...
  * @{
  */
#define BIT_LOAD_R_PGNUM   ((u32)0x00000001 << 31)           /*!< WA0 0x0  Write 1 to set RQPN bit[79:0] value to page numbers for initialization*/
...
#define BIT_NPQ_PUBLIC_DIS ((u32)0x00000001 << 26)           /*!< R/W 0x0  When this bit is set, Normal queue available Tx page size excludes the public queue. Otherwise, Normal queue available Tx page size includes public queue*/
...
/** @defgroup REG_FIFOPAGE_INFO
  ...
  * @{
  */
#define BIT_MASK_TXPKTNUM       ((u32)0x000000FF << 24)           /*!< R 0x0  Packet number in TXPKTBUF (Normal/Low)*/
...
/** @defgroup REG_DWBCN0_CTRL
  ...
  * @{
  */
#define BIT_MASK_LLT_FREE_PAGE   ((u32)0x000000FF << 24)           /*!< R 0x0  RSVD*/
#define BIT_LLT_FREE_PAGE(x)     (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_LLT_FREE_PAGE(x) ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_RSVD_BYTE1      ((u32)0x0000007F << 17)           /*!< R/W 0x0  RSVD*/
#define BIT_RSVD_BYTE1(x)        (((u32)((x) & 0x0000007F) << 17))
#define BIT_GET_RSVD_BYTE1(x)    ((u32)(((x >> 17) & 0x0000007F)))
#define BIT_BCN_VALID            ((u32)0x00000001 << 16)           /*!< RW1C 0x0  When this bit is set, the beacon packet has finished to write to txpktbuffer. Clear by SW*/
...
#define BIT_MASK_BLK_DESC_NUM    ((u32)0x0000000F << 4)            /*!< R/W 0x1  The Most Number of Tx Descriptor per Bulk Out Only for USB*/
...
/** @defgroup REG_TXDMA_OFFSET_CHK
  ...
  * @{
  */
#define BIT_EN_CHKERR_FINISH   ((u32)0x00000001 << 31)           /*!< R/W 0x0  Let checksum offload statemachine finish if checksum parser error*/
#define BIT_EN_DMA_PERMU_P     ((u32)0x00000001 << 30)           /*!< R/W 0x0  Enable every dma latch fifo ptr for pcie as usb mode as one pkt trans in permu*/
#define BIT_EN_TXQUE_CLR       ((u32)0x00000001 << 29)           /*!< R/W 0x0  Enable tx queue clear tx pkt in tde in usb mode*/
#define BIT_EN_PCIE_FIFO       ((u32)0x00000001 << 28)           /*!< R/W 0x0  Enable pcie fifo store forward txdesc as before mode*/
...
#define BIT_DSC_CHKSUM_EN      ((u32)0x00000001 << 13)           /*!< R/W 0x0  Enable SDIO checksum*/
...
#define BIT_MASK_CHK_OFFSET    ((u32)0x000000FF << 0)            /*!< R/W 0x0  Offset value is check by Tx DMA engine*/
...
/** @defgroup REG_TXDMA_STATUS
  ...
  * @{
  */
#define BIT_MASK_TDE_TRIG_STOP_SEL   ((u32)0x00000003 << 18)           /*!< R/W 0x0  select txdma engine trigger stop signal for LA dump*/
#define BIT_TDE_TRIG_STOP_SEL(x)     (((u32)((x) & 0x00000003) << 18))
#define BIT_GET_TDE_TRIG_STOP_SEL(x) ((u32)(((x >> 18) & 0x00000003)))
#define BIT_HI_OQT_UDN               ((u32)0x00000001 << 17)           /*!< RW1C 0x0  High Priority Queue_Tx OQT underflow*/
#define BIT_HI_OQT_OVF               ((u32)0x00000001 << 16)           /*!< RW1C 0x0  High Priority Queue_Tx OQT overflow*/
#define BIT_PAYLOAD_CHKSUM_ERR       ((u32)0x00000001 << 15)           /*!< RW1C 0x0  Payload checksum error*/
#define BIT_PAYLOAD_UDN              ((u32)0x00000001 << 14)           /*!< RW1C 0x0  Payload is under the packet length of Tx descriptor. Clear by SW.*/
#define BIT_PAYLOAD_OVF              ((u32)0x00000001 << 13)           /*!< RW1C 0x0  Payload is over the packet length of Tx descriptor. Clear by SW.*/
#define BIT_DSC_CHKSUM_FAIL          ((u32)0x00000001 << 12)           /*!< RW1C 0x0  Tx descriptor checksum error. Clear by SW.*/
#define BIT_UNKNOWN_QSEL             ((u32)0x00000001 << 11)           /*!< RW1C 0x0  An unknown QSEL of Tx descriptor is detected. Clear by SW.*/
#define BIT_EP_QSEL_DIFF             ((u32)0x00000001 << 10)           /*!< RW1C 0x0  Tx Endpoint is unmatched with the QSEL of descriptor. Clear by SW.*/
#define BIT_TX_OFFS_UNMATCH          ((u32)0x00000001 << 9)            /*!< RW1C 0x0  Tx offset is unmatched. Clear by SW.*/
#define BIT_TXOQT_UDN                ((u32)0x00000001 << 8)            /*!< RW1C 0x0  TXOQT Underflow. Clear by SW.*/
#define BIT_TXOQT_OVF                ((u32)0x00000001 << 7)            /*!< RW1C 0x0  TXOQT Overflow. Clear by SW.*/
#define BIT_SFF_UDN                  ((u32)0x00000001 << 6)            /*!< RW1C 0x0  TXDMA Sync FIFO Underflow. Clear by SW.*/
#define BIT_SFF_OVF                  ((u32)0x00000001 << 5)            /*!< RW1C 0x0  TXDMA Sync FIFO Overflow. Clear by SW.*/
#define BIT_FREE_PG_FF               ((u32)0x00000001 << 4)            /*!< RW1C 0x0  TXDMA reads NULL page. Clear by SW.*/
#define BIT_PAGE_UNDER               ((u32)0x00000001 << 3)            /*!< RW1C 0x0  Total pages included PTCL un-return pages are under the total reserved pages minus the page threshold. Clear by SW.*/
#define BIT_PAGE_OVER                ((u32)0x00000001 << 2)            /*!< RW1C 0x0  Total pages included PTCL un-return pages are over the total reserved pages. Clear by SW.*/
#define BIT_PG_UDN                   ((u32)0x00000001 << 1)            /*!< RW1C 0x0  TXFF page underflow in TDE page controller. Clear by SW.*/
#define BIT_PG_OVF                   ((u32)0x00000001 << 0)            /*!< RW1C 0x0  TXFF page overflow in TDE page controller.. Clear by SW.*/
/** @} */
...
/** @defgroup REG_RQPN_NPQ
  ...
  * @{
  */
#define BIT_MASK_EPQ_PGNUM     ((u32)0x000000FF << 24)           /*!< R 0x0  Extra Queue Page Number*/
#define BIT_EPQ_PGNUM(x)       (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_EPQ_PGNUM(x)   ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_MASK_EPQ_R_PGNUM   ((u32)0x000000FF << 16)           /*!< R/W 0x0  Extra Queue Reserved Page Number*/
#define BIT_EPQ_R_PGNUM(x)     (((u32)((x) & 0x000000FF) << 16))
#define BIT_GET_EPQ_R_PGNUM(x) ((u32)(((x >> 16) & 0x000000FF)))
#define BIT_MASK_NPQ_PGNUM     ((u32)0x000000FF << 8)            /*!< R 0x0  Normal Priority Queue Page Number*/
#define BIT_NPQ_PGNUM(x)       (((u32)((x) & 0x000000FF) << 8))
#define BIT_GET_NPQ_PGNUM(x)   ((u32)(((x >> 8) & 0x000000FF)))
#define BIT_MASK_NPQ_R_PGNUM   ((u32)0x000000FF << 0)            /*!< R/W 0x0  Normal Priority Queue Reserved Page Number*/
...
/** @defgroup REG_AUTO_LLT
  ...
  * @{
  */
#define BIT_MASK_TXPKTNUM_H             ((u32)0x000000FF << 24)           /*!< R 0x0  Packet number in TXPKTBUF (High and Extra)*/
...
#define BIT_MASK_MAX_TX_PKT   ((u32)0x000000FF << 0)            /*!< R/W 0x0  Unit : packet number Max_tx_pkt_for_USB_and_SDIO*/
...
/** @defgroup REG_TDE_GCK_CTRL
  ...
  * @{
  */
#define BIT_TDE_CTRL_RST            ((u32)0x00000001 << 10)          /*!< WA0 0x0  Write this bit reset FSM of tde_ctrl, ioreg_txfail*/
#define BIT_TDE_PAGE_RST            ((u32)0x00000001 << 9)           /*!< WA0 0x0  Write this bit reset FSM of tde_page_cs, ioreg_txfail*/
#define BIT_TDE_PTR_RST             ((u32)0x00000001 << 8)           /*!< WA0 0x0  Write this bit reset FSM of tde_ptr_cs, ioreg_txfail*/
...
#define BIT_DMA_WAIT_MORE_CYCLE     ((u32)0x00000001 << 1)           /*!< R/W 0x1  enable this bit,tde_ctl will wait for 16 dma_clk when host dma last data to tde_sync_fifo 1:used for 20M mac clk 0:used for 40M/80M mac clk(will wait for 12 dma_clk)*/
#define BIT_TDE_GCLK_EN             ((u32)0x00000001 << 0)           /*!< R/W 0x1  enable this bit,txdma engine will use gated clk*/
/** @} */
...
/** @defgroup REG_RXDMA_AGG_PG_TH
  ...
  * @{
  */
#define BIT_RXDMA_STORE            ((u32)0x00000001 << 31)           /*!< R/W 0x0  usb rx dma old mode store pkt and forward*/
#define BIT_EN_PRE_CALC            ((u32)0x00000001 << 29)           /*!< R/W 0x0  0: rde start rxdma when aggregated length over specified threshold; 1: rde start rxdma when next packet, if aggregated, will cause the total length over specified threshold*/
#define BIT_MASK_PKT_NUM_WOL       ((u32)0x000000FF << 16)           /*!< R 0x0  In wol mode, 8051 should refer this packet counter in RXFF*/
...
/** @defgroup REG_RXPKT_NUM
  ...
  * @{
  */
#define BIT_MASK_RXPKT_QUEUED         ((u32)0x000000FF << 24)           /*!< R 0x0  The number of packets in RXPKTBUF.*/
#define BIT_RXPKT_QUEUED(x)           (((u32)((x) & 0x000000FF) << 24))
#define BIT_GET_RXPKT_QUEUED(x)       ((u32)(((x >> 24) & 0x000000FF)))
#define BIT_RXDMA_REQ                 ((u32)0x00000001 << 19)           /*!< R 0x0  rxdma has request*/
...
#define BIT_RXPKT_RELEASE_POLL        ((u32)0x00000001 << 16)           /*!< RW1C 0x0  When this bit is set, RXDMA will decrease RX PKT counter by one. Before this bit is polled,  FW shall update RXFF_RD_PTR first.*/
#define BIT_MASK_FW_UPD_RXPKT_RDPTR   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  FW shall update this register before FW write RXPKT_RELEASE_POLL to 1.*/
...
/** @defgroup REG_RXDMA_STATUS
  ...
  * @{
  */
#define BIT_C2H_PKT_OVF      ((u32)0x00000001 << 7) /*!< RW1C 0x0  CH2 pkt overflow. Clr by SW*/
#define BIT_AGG_CONFGI_ISSUE ((u32)0x00000001 << 6) /*!< RW1C 0x0  rxdma agg config error. Clr by SW*/
#define BIT_FW_POLL_ISSUE    ((u32)0x00000001 << 5) /*!< RW1C 0x0  FW Release Poll Error. Clear by SW.*/
#define BIT_RX_DATA_UDN      ((u32)0x00000001 << 4) /*!< RW1C 0x0  FW Release Poll Error. Clear by SW.*/
#define BIT_RX_SFF_UDN       ((u32)0x00000001 << 3) /*!< RW1C 0x0  RX Sync FIFO Underflow. Clear by SW.*/
#define BIT_RX_SFF_OVF       ((u32)0x00000001 << 2) /*!< RW1C 0x0  RX Sync FIFO Overflow. Clear by SW.*/
#define BIT_RXPKT_OVF        ((u32)0x00000001 << 0) /*!< RW1C 0x0  When RX Packet is more than 255 packets remaining in FF. Clear by SW.*/
/** @} */
...
/** @defgroup REG_RXDMA_DPR
  ...
  * @{
  */
#define BIT_MASK_RDE_DBG   ((u32)0xFFFFFFFF << 0)           /*!< R 0x0  rde debug port register.*/
...
/** @defgroup REG_RXDMA_MODE
  ...
  * @{
  */
#define BIT_RXDMA_RESET       ((u32)0x00000001 << 7)           /*!< WA0 0x0  rxdma rst*/
#define BIT_RXDMA_GCLK_EN     ((u32)0x00000001 << 6)           /*!< R/W 0x1  rxdma_engine clock gating control,1:enable clock gating;0:disable clock gating*/
...
#define BIT_MASK_RX_PKT_PS    ((u32)0x00000001 << 0)           /*!< R/W 0x0  RSVD*/
/** @} */
