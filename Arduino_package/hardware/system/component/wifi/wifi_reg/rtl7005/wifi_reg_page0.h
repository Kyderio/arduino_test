#ifndef _RL7005_REG_PAGE0_H_
#define _RL7005_REG_PAGE0_H_
...
/** @defgroup REG_SYS_PWC_ISO_CTRL
  ...
  * @{
  */
#define BIT_MASK_WL_SWR_STS_REQ       ((u16)0x00000007 << 13)           /*!< R 0x0  the swr request mode of wifi*/
#define BIT_WL_SWR_STS_REQ(x)         (((u16)((x) & 0x00000007) << 13))
#define BIT_GET_WL_SWR_STS_REQ(x)     ((u16)(((x >> 13) & 0x00000007)))
#define BIT_WL_PWR_SWITCH_DMY_EN      ((u16)0x00000001 << 12)           /*!< R/W 0x1  1:enable wl_dummy_en when wlan is switching power mode 0:disable wl_dummy_en when wlan is switching power mode*/
#define BIT_MASK_WL_SWR_STS_REQ_ACT   ((u16)0x00000007 << 9)            /*!< R/W 0x6  000: RSVD      001: state1  0.7/PC/PFM 010: state2  0.8/PC/PFM  011: state3  0.9/PC/PFM 100: state4  0.9/SLP/PFM   101: state5  0.9/SLP/PWM  110: state6  0.9/NORM/PWM  111: state7  1.0/NORM/PWM*/
#define BIT_WL_SWR_STS_REQ_ACT(x)     (((u16)((x) & 0x00000007) << 9))
#define BIT_GET_WL_SWR_STS_REQ_ACT(x) ((u16)(((x >> 9) & 0x00000007)))
#define BIT_MASK_WL_SWR_STS_REQ_LPS   ((u16)0x00000007 << 5)            /*!< R/W 0x2  000: RSVD      001: state1  0.7/PC/PFM 010: state2  0.8/PC/PFM  011: state3  0.9/PC/PFM 100: state4  0.9/SLP/PFM   101: state5  0.9/SLP/PWM  110: state6  0.9/NORM/PWM  111: state7  1.0/NORM/PWM*/
#define BIT_WL_SWR_STS_REQ_LPS(x)     (((u16)((x) & 0x00000007) << 5))
#define BIT_GET_WL_SWR_STS_REQ_LPS(x) ((u16)(((x >> 5) & 0x00000007)))
#define BIT_WL_SWR_REQ_TRG            ((u16)0x00000001 << 4)            /*!< WA0 0x0  trigger switch swr mode according to 0x0[11:9] when wlan is active, write 1 to generate one pulse*/
#define BIT_WL_PON_WAIT_ALL           ((u16)0x00000001 << 3)            /*!< R/W 0x1  gen req of pwc and swr and xtal and wait rdy together when power on*/
#define BIT_WL_POF_WAIT_ALL           ((u16)0x00000001 << 2)            /*!< R/W 0x1  gen req of swr and xtal and wait rdy together when power off*/
#define BIT_SPC_MAC_EN                ((u16)0x00000001 << 0)            /*!< R/W 0x0  1: Enable WLOFF power cut*/
/** @} */
...
#define BIT_TSF_CKSLP_SEL       ((u16)0x00000001 << 8)  /*!< R/W 0x0  1: TSF clock switch to 32.768KHz/32kHz; 0: TSF clock switch to MAC clock*/
...
#define BIT_BB_SAVE_EN         ((u32)0x00000001 << 18) /*!< R/W 0x0  1 to 0:gen req to restore register in power on flow 1:gen req to backup register in power on flow*/
...
#define BIT_BT_EN_WL_CK4M      ((u32)0x00000001 << 7)  /*!< R/W 0x1  enable 4m clk of wlon if bt is active or switches to active*/
#define BIT_FEN_WLON           ((u32)0x00000001 << 4)  /*!< R/W 0x0  1: enable WL partial ON; 0: reset*/
#define BIT_FEN_WLOFF          ((u32)0x00000001 << 1)  /*!< R/W 0x0  1: enable WLOFF; 0: reset*/
...
#define BIT_MASK_WL_RFC_PHASE   ((u32)0x0000000F << 8)            /*!< R/W 0x0  80M WLRFC clock phase control*/
...
/** @defgroup REG_CPWM
  ...
  * @{
  */
#define BIT_CPWM_TOGGLING   ((u32)0x00000001 << 15)          /*!< R/W 0x0  Toggling bit : one bit sequence number bit. When this bit is toggled, interrupt is send to HISR.CPWMINT.*/
#define BIT_MASK_CPWM_MOD   ((u32)0x00007FFF << 0)           /*!< R/W 0x0  The current power mode index.*/
...
/** @defgroup REG_RPWM
  ...
  * @{
  */
#define BIT_RPWM_TOGGLING   ((u32)0x00000001 << 15)          /*!< R/W 0x0  Toggling bit : one bit sequence number bit. When this bit is toggled, interrupt is send to FISR.RPWMINT.*/
#define BIT_MASK_RPWM_MOD   ((u32)0x00007FFF << 0)           /*!< R/W 0x0  The current power mode index.*/
...
#define BIT_LOCK_REGALL_EN  ((u32)0x00000001 << 7)            /*!< R/W 0x0  1:Register Write Locked, 0: Register Accessible by SW/FW (offset:0x001C[0])*/
...
#define BIT_WL_RETENTION_CELL_SEL ((u32)0x00000001 << 14)          /*!< R/W 0x0  1:choose retention cell type I(U22 ULP),which is controlled by 0x20[15] 2:choose retention cell type II(RTKM),which is controlled by 0x20[17:16]*/
...
/** @defgroup REG_P0_TBTT_TIMER
  ...
  * @{
  */
#define BIT_MASK_P0_ELY_BCNINT_CNT   ((u32)0x0000007F << 24)           /*!< R 0x0  Unit: bcn_space the total time to next specified TBTT is (new_ely_agg_cnt - 1) * r_bcn_space(0x554) + (beacon_cnt_down - 1)* 1ms + (cnt_128us + 1)* 128us*/
...
/** @defgroup REG_LPSOFFLOAD_LDO_CTL
  * @brief
  * @{
  */
#define BIT_MASK_R_WL_MLDO_TIMER       ((u32)0x00000003 << 23)           /*!< R/W 2'b00  wait analog ldo stable time 00:16us 01:32us 10:64us 11:128us*/
#define BIT_R_WL_MLDO_TIMER(x)         (((u32)((x) & 0x00000003) << 23))
#define BIT_GET_R_WL_MLDO_TIMER(x)     ((u32)(((x >> 23) & 0x00000003)))
#define BIT_R_WL_MLDO_MODE_REQ_TRG     ((u32)0x00000001 << 22)           /*!< WA0 1'b0  trigger switch LDO mode according to 0x2C[17:16] when wlan is active, write 1 to generate one pulse*/
#define BIT_MASK_WL_MLDO_MODE_REQ      ((u32)0x00000003 << 20)           /*!< R 2'b00  analog ldo mode lps option  00:off 01:sleep 10:normal-dummy load 11:normal-no dummy load*/
#define BIT_WL_MLDO_MODE_REQ(x)        (((u32)((x) & 0x00000003) << 20))
#define BIT_GET_WL_MLDO_MODE_REQ(x)    ((u32)(((x >> 20) & 0x00000003)))
#define BIT_MASK_R_WL_MLDO_MODE_LPS    ((u32)0x00000003 << 18)           /*!< R/W 2'b00  analog ldo mode lps option  00:off 01:sleep 10:normal-dummy load 11:normal-no dummy load*/
#define BIT_R_WL_MLDO_MODE_LPS(x)      (((u32)((x) & 0x00000003) << 18))
#define BIT_GET_R_WL_MLDO_MODE_LPS(x)  ((u32)(((x >> 18) & 0x00000003)))
#define BIT_MASK_R_WL_MLDO_MODE_ACT    ((u32)0x00000003 << 16)           /*!< R/W 2'b11  analog ldo mode lps option  00:off 01:sleep 10:normal-dummy load 11:normal-no dummy load*/
#define BIT_R_WL_MLDO_MODE_ACT(x)      (((u32)((x) & 0x00000003) << 16))
#define BIT_GET_R_WL_MLDO_MODE_ACT(x)  ((u32)(((x >> 16) & 0x00000003)))
#define BIT_R_BYPASS_HIOE_CHN_BCN_MODE ((u32)0x00000001 << 4)            /*!< R/W 0x1  when set 1, bypass request to CHN_BCN_MODE of hioe*/
#define BIT_R_BYPASS_HIOE_CHN_OFF      ((u32)0x00000001 << 3)            /*!< R/W 0x1  when set 1, bypass request to CHOFF of hioe*/
#define BIT_R_BYPASS_HIOE_CHN_ON       ((u32)0x00000001 << 2)            /*!< R/W 0x1  when set 1, bypass request to CHON of hioe*/
#define BIT_R_HW_AUTO_ENTER_LPS_EN     ((u32)0x00000001 << 1)            /*!< R/W 0x0  when set 1, enable hw auto enter lps when triggered by lpsoffload*/
#define BIT_R_RXBCN_LPSOFFLOAD_EN      ((u32)0x00000001 << 0)            /*!< R/W 0x0  when set 1, enable lpsoffload function*/
/** @} */
...
/** @defgroup REG_AFC_CTRL0
  ...
  * @{
  */
#define BIT_POW_AFE_REQ            ((u32)0x00000001 << 13)          /*!< R/W 0x0  AFE power on request to afe_ctrl 1:request to turn on AFE pwr 0:turn off AFE pwr*/
#define BIT_MASK_WL_XTAL_REQ       ((u32)0x00000007 << 7)           /*!< R 0x0  the xtal request mode of wifi*/
#define BIT_WL_XTAL_REQ(x)         (((u32)((x) & 0x00000007) << 7))
#define BIT_GET_WL_XTAL_REQ(x)     ((u32)(((x >> 7) & 0x00000007)))
...
#define BIT_WL_XTAL_REQ_TRG        ((u32)0x00000001 << 0)           /*!< WA0 0x0  trigger switch XTAL mode according to 0x30[6:4] when wlan is active, write 1 to generate one pulse*/
/** @} */
...
/** @defgroup REG_FSIMR_V1
  ...
  * @{
  */
#define BIT_FS_PWMERR_INT_EN_V1       ((u32)0x00000001 << 1) /*!< R/W 0x0  access page0 timeout error mask*/
#define BIT_FS_BTON_STS_UPDATE_INT_EN ((u32)0x00000001 << 0) /*!< R/W 0x0  BTON status update interrupt mask When 0x78[31] toggled, this interrupt is issue to indicate the status updated.*/
/** @} */
...
/** @defgroup REG_FSISR_V1
  ...
  * @{
  */
#define BIT_FS_PWMERR_INT_V1       ((u32)0x00000001 << 1) /*!< RW1C 0x0  access page0 timeout error*/
#define BIT_FS_BTON_STS_UPDATE_INT ((u32)0x00000001 << 0) /*!< RW1C 0x0  BTON status update interrupt When 0x78[31] toggled, this interrupt is issue to indicate the status updated.*/
/** @} */
...
/** @defgroup REG_SCOREBOARD_RD_BT2WL
  ...
  * @{
  */
#define BIT_MASK_RD_BT2WL_INFO   ((u32)0x000000FF << 24)           /*!< R 0x0  Read Data :  WL TO BT INFO, WLON Status Report*/
...
/** @defgroup REG_WL_MCUFW_CTRL
  ...
  * @{
  */
#define BIT_FW_INIT_RDY ((u32)0x00000001 << 15) /*!< R/W 0x0  CPU fw initialize ready, set by CPU(txrpt info update,used in ptcl)*/
/** @} */
...
/** @defgroup REG_FW_DBG8
  ...
  * @{
  */
#define BIT_MASK_BLK_TST   ((u32)0xFFFFFFFF << 0)           /*!< R/W 0x0  fw debug8*/
...
/** @defgroup REG_LPS_CTRL
  ...
  * @{
  */
#define BIT_LPS_OPT_GTSFOFF                   ((u32)0x00000001 << 30)           /*!< R/W 0x0  LPS option to gate tsf_off clock 1:enable tsf_off clock when enter LPS CG 0:disable tsf_off clock when enter LPS CG*/
#define BIT_WL_LPS_OPT_SAVE_REG               ((u32)0x00000001 << 29)           /*!< R/W 0x1  LPS option to save retention FF 1: enable request to save retention FF 0: disable request to save retention FF*/
...
#define BIT_LPS_MEMPM_MACOFF_SNPS             ((u32)0x00000001 << 17)           /*!< R/W 0x1  MAC OFF SNPS memory power mode when enable LPS memory power mode(txllt/rc4/txoqt/keysrch/rxbacam/dmafifo/txpwr) 0 : normal 1 : NAP*/
...
/** @defgroup REG_SCOREBOARD_CTRL
  ...
  * @{
  */
#define BIT_BT_INT_EN         ((u32)0x00000001 << 31)           /*!< W 0x0  For WL, write 1 to issue interrupt  1 : Issue one INT to BT 0 : Don't care*/
#define BIT_MASK_WL2BT_INFO   ((u32)0x0000007F << 24)           /*!< R/W 0x0  WLON Status Report TO BTON*/
...
/** @defgroup REG_PMC_DBG_CTRL1
  ...
  * @{
  */
#define BIT_PMC_WR_OVF          ((u32)0x00000001 << 8)           /*!< RW1C 0x0  PMC Write Access Timer Overflow(no use)*/
#define BIT_MASK_WLPMC_ERRINT   ((u32)0x000000FF << 0)           /*!< RW1C 0x0  WLPMC Error interrupt(tie 0)*/
...
/** @defgroup REG_PMC_DBG_CTRL2_V1
  ...
  * @{
  */
#define BIT_MASK_SYSON_REG_ARB   ((u32)0x00000003 << 0)           /*!< R/W 0x0  HW PMC Access Register Time Out Control(no use)*/
...
/** @defgroup REG_LBC_WATCHDOG
  ...
  * @{
  */
#define BIT_MASK_WATCH_DOG_RECORD   ((u32)0x00003FFF << 2)           /*!< R 0x0  Time out register address*/
#define BIT_WATCH_DOG_RECORD(x)     (((u32)((x) & 0x00003FFF) << 2))
#define BIT_GET_WATCH_DOG_RECORD(x) ((u32)(((x >> 2) & 0x00003FFF)))
#define BIT_IO_TIMEOUT_FLAG         ((u32)0x00000001 << 1)           /*!< RW1C 0x0  Lbc timeout flag.Write "1" to clear.*/
#define BIT_EN_WATCH_DOG            ((u32)0x00000001 << 0)           /*!< R/W 0x1  Enable lbc timeout watchdog*/
/** @} */
...
/** @defgroup REG_SYS_CONFIG0
  ...
  * @{
  */
#define BIT_IS_SCH_CLK_INSLP_V1 ((u32)0x00000001 << 8)           /*!< RO 0x0  WL TSF clock status: 0: MAC clock 1: 32K clock*/
...
#define BIT_PLL_CK_RDY          ((u32)0x00000001 << 0)           /*!< RO 0x0  indicate AFE PLL clock is ready*/
/** @} */
...
#define REG_RPWM                         0x014
#define REG_RSV_CTRL                     0x01C
#define REG_WL_PMC_CTRL                  0x020
#define REG_WL_SYSCONFIG                 0x024
#define REG_P0_TBTT_TIMER                0x028
#define REG_LPSOFFLOAD_LDO_CTL           0x02C
#define REG_AFC_CTRL0                    0x030
#define REG_FSIMR_V1                     0x040
#define REG_FSISR_V1                     0x044
#define REG_FW_DBG0                      0x050
#define REG_FW_DBG1                      0x054
#define REG_FW_DBG2                      0x058
#define REG_FW_DBG3                      0x05C
#define REG_FW_DBG4                      0x060
#define REG_FW_DBG5                      0x064
#define REG_FW_DBG6                      0x068
#define REG_FW_DBG7                      0x06C
#define REG_WL_PIN_FUNC_CTRL0            0x070
#define REG_WL_BTCOEX_CTRL               0x074
#define REG_SCOREBOARD_RD_BT2WL          0x078
#define REG_DBG_PORT_REG                 0x07C
#define REG_WL_MCUFW_CTRL                0x080
#define REG_FW_DBG8                      0x084
#define REG_FW_DBG9                      0x088
#define REG_FW_DBG10                     0x08C
#define REG_LPS_CTRL                     0x090
#define REG_FW_DBG11                     0x094
#define REG_BOOT_REASON                  0x098
#define REG_SCOREBOARD_CTRL              0x0A0
#define REG_SYSON_FSM_MON_V1             0x0A4
#define REG_PMC_DBG_CTRL1                0x0A8
#define REG_PMC_DBG_CTRL2_V1             0x0AC
#define REG_LBC_WATCHDOG                 0x0B0
#define REG_DUMMY0                       0x0C8
#define REG_DUMMY1                       0x0D0
#define REG_DUMMY2                       0x0E4
#define REG_SDM_IDR_CTRL0                0x0E8
#define REG_WL_CK32KGEN_RWD              0x0EC
