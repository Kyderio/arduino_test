#ifndef _RL7005_REG_PAGE4_H_
#define _RL7005_REG_PAGE4_H_
...
/** @defgroup REG_DARFRC0_L
  ...
  * @{
  */
#define BIT_MASK_DATA_FALLBACK_RC4   ((u32)0x0000001F << 24)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK_RC4(x)     (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_DATA_FALLBACK_RC4(x) ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK_RC3   ((u32)0x0000001F << 16)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK_RC3(x)     (((u32)((x) & 0x0000001F) << 16))
#define BIT_GET_DATA_FALLBACK_RC3(x) ((u32)(((x >> 16) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK_RC2   ((u32)0x0000001F << 8)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
...
/** @defgroup REG_DARFRC0_H
  ...
  * @{
  */
#define BIT_MASK_DATA_FALLBACK_RC8   ((u32)0x0000001F << 24)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK_RC8(x)     (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_DATA_FALLBACK_RC8(x) ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK_RC7   ((u32)0x0000001F << 16)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK_RC7(x)     (((u32)((x) & 0x0000001F) << 16))
#define BIT_GET_DATA_FALLBACK_RC7(x) ((u32)(((x >> 16) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK_RC6   ((u32)0x0000001F << 8)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK_RC6(x)     (((u32)((x) & 0x0000001F) << 8))
#define BIT_GET_DATA_FALLBACK_RC6(x) ((u32)(((x >> 8) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK_RC5   ((u32)0x0000001F << 0)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
...
#define BIT_BCN_PORT_SEL            ((u32)0x00000001 << 5)            /*!< R/W 0x1  This bit use to select BCN on port 1 or port 0. This just useful in USB/SDIO interface.*/
...
/** @defgroup REG_GCLK_CFG
  ...
  * @{
  */
#define BIT_TBQ_BLK_ACQ_REQ   ((u32)0x00000001 << 4) /*!< R/W 0x1  1: start select acq to gen_cmd need to wait tbq_txreq == 1*/
#define BIT_TIME_UNIT_SEL_1US ((u32)0x00000001 << 3) /*!< R/W 0x0  select queue_time and lifetime unit 1: unit 1us 0: unit 256us*/
...
/** @defgroup REG_EXTRA_PKT_CTRL
  * @brief
  * @{
  */
#define BIT_EN_HTC_RATE_ADPT      ((u32)0x00000001 << 10)          /*!< R/W 0x1  1: if tx data rate fallback to CCK/OFDM rate, HW will remove HTC field in mac header*/
#define BIT_EN_ONLY_TB_HTC        ((u32)0x00000001 << 9)           /*!< R/W 0x0  1: only TB can carry HTC field*/
#define BIT_EN_CTRL_HTC           ((u32)0x00000001 << 8)           /*!< R/W 0x0  1: rts/cts2s/cts2ap/bar will carry HTC field by ctrl_wrapper frame, valid when txdesc.HTC = 1 0: rts/cts2s/cts2ap/bar will NOT carry HTC field even though txdesc.HTC = 1*/
#define BIT_MASK_TXDESC_PWR_OFT   ((u32)0x0000000F << 4)           /*!< R/W 0x0  indicate the tx power compensation of  TXDESC.TX_PWR_OFT, unit: 1dbm*/
#define BIT_TXDESC_PWR_OFT(x)     (((u32)((x) & 0x0000000F) << 4))
#define BIT_GET_TXDESC_PWR_OFT(x) ((u32)(((x >> 4) & 0x0000000F)))
#define BIT_IGNORE_QOS_NULL       ((u32)0x00000001 << 1)           /*!< R/W 0x0  1: will not TX QoS Null when rx Basic trigger*/
#define BIT_SEL_DESC_INDEX        ((u32)0x00000001 << 0)           /*!< R/W 0x0  1: select rate index from txdesc*/
/** @} */
...
#define BIT_PTCL_RATE_TABLE_INVALID ((u32)0x00000001 << 15)           /*!< R0 0x0  during rate fallback process, if the all rate table is invalid, then assert ERROR FLAG*/
#define BIT_MASK_RD_UPT_TAIL_CNT    ((u32)0x00000007 << 12)           /*!< RO 0x0  SW update free_tail page counter*/
#define BIT_RD_UPT_TAIL_CNT(x)      (((u32)((x) & 0x00000007) << 12))
#define BIT_GET_RD_UPT_TAIL_CNT(x)  ((u32)(((x >> 12) & 0x00000007)))
#define BIT_CLR_UPT_TAIL_CNT        ((u32)0x00000001 << 11)           /*!< RW1C 0x0  write 1 to clear BIT_RD_UPT_TAIL_CNT, pulse*/
...
#define BIT_MASK_DROP_PKT_NUM    ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  Statistic the number of dropped packets*/
#define BIT_DROP_PKT_NUM(x)      (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_DROP_PKT_NUM(x)  ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_SW_BUFFERED_SIZE_0
  * @brief
  * @{
  */
#define BIT_MASK_SW_BUFFERED_SZ_VI   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  SW update. Buffered packet size of VIQ, used to update BSR. Unit: byte*/
#define BIT_SW_BUFFERED_SZ_VI(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_SW_BUFFERED_SZ_VI(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_SW_BUFFERED_SZ_VO   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  SW update. Buffered packet size of VOQ, used to update BSR. Unit: byte*/
#define BIT_SW_BUFFERED_SZ_VO(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_SW_BUFFERED_SZ_VO(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */
...
/** @defgroup REG_SW_BUFFERED_SIZE_1
  * @brief
  * @{
  */
#define BIT_MASK_SW_BUFFERED_SZ_BK   ((u32)0x0000FFFF << 16)           /*!< R/W 0x0  SW update. Buffered packet size of BKQ, used to update BSR. Unit: byte*/
#define BIT_SW_BUFFERED_SZ_BK(x)     (((u32)((x) & 0x0000FFFF) << 16))
#define BIT_GET_SW_BUFFERED_SZ_BK(x) ((u32)(((x >> 16) & 0x0000FFFF)))
#define BIT_MASK_SW_BUFFERED_SZ_BE   ((u32)0x0000FFFF << 0)            /*!< R/W 0x0  SW update. Buffered packet size of BEQ, used to update BSR. Unit: byte*/
#define BIT_SW_BUFFERED_SZ_BE(x)     (((u32)((x) & 0x0000FFFF) << 0))
#define BIT_GET_SW_BUFFERED_SZ_BE(x) ((u32)(((x >> 0) & 0x0000FFFF)))
/** @} */

/** @defgroup REG_DUMMY_P4_BCNRPT
  * @brief
  * @{
  */
...
/** @defgroup REG_BF0_TIME_SETTING
  ...
  * @{
  */
#define BIT_BF0_TIMER_SET           ((u32)0x00000001 << 31)           /*!< RW1C 0x0  write 1 to set beamforming 0 timer to BIT_bf0_lifetime*/
#define BIT_BF0_TIMER_CLR           ((u32)0x00000001 << 30)           /*!< RW1C 0x0  write 1 to clear beamforming 0 timer to 0*/
...
/** @defgroup REG_BF1_TIME_SETTING
  ...
  * @{
  */
#define BIT_BF1_TIMER_SET           ((u32)0x00000001 << 31)           /*!< RW1C 0x0  write 1 to set beamforming 1 timer to BIT_bf1_lifetime*/
#define BIT_BF1_TIMER_CLR           ((u32)0x00000001 << 30)           /*!< RW1C 0x0  write 1 to clear beamforming 1 timer to 0*/
...
/** @defgroup REG_DARFRC1_L
  ...
  * @{
  */
#define BIT_MASK_DATA_FALLBACK1_RC4   ((u32)0x0000001F << 24)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK1_RC4(x)     (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_DATA_FALLBACK1_RC4(x) ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK1_RC3   ((u32)0x0000001F << 16)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK1_RC3(x)     (((u32)((x) & 0x0000001F) << 16))
#define BIT_GET_DATA_FALLBACK1_RC3(x) ((u32)(((x >> 16) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK1_RC2   ((u32)0x0000001F << 8)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
...
/** @defgroup REG_DARFRC1_H
  ...
  * @{
  */
#define BIT_MASK_DATA_FALLBACK1_RC8   ((u32)0x0000001F << 24)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK1_RC8(x)     (((u32)((x) & 0x0000001F) << 24))
#define BIT_GET_DATA_FALLBACK1_RC8(x) ((u32)(((x >> 24) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK1_RC7   ((u32)0x0000001F << 16)           /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK1_RC7(x)     (((u32)((x) & 0x0000001F) << 16))
#define BIT_GET_DATA_FALLBACK1_RC7(x) ((u32)(((x >> 16) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK1_RC6   ((u32)0x0000001F << 8)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
#define BIT_DATA_FALLBACK1_RC6(x)     (((u32)((x) & 0x0000001F) << 8))
#define BIT_GET_DATA_FALLBACK1_RC6(x) ((u32)(((x >> 8) & 0x0000001F)))
#define BIT_MASK_DATA_FALLBACK1_RC5   ((u32)0x0000001F << 0)            /*!< R/W 0x01  Data Auto Rate Fallback Retry Count After the number of retry, HW will fall back the rate to the next enabled MAC in ARFR.*/
...
#define REG_MGQ_INFO                                      0x410
#define REG_HIQ_INFO                                      0x414
#define REG_QUE_EMPTY_BCNQ_INFO                           0x418
#define REG_CPU_MGQ_INFO                                  0x41C
#define REG_FWHW_TXQ_HWSSN_CTRL                           0x420
#define REG_BNDY_LIFETIME_TAIL                            0x424
#define REG_RETRY_LIMIT_SIFS                              0x428
#define REG_TXBF_CTRL                                     0x42C
#define REG_DARFRC0_L                                     0x430
#define REG_DARFRC0_H                                     0x434
#define REG_RARFRC_L                                      0x438
#define REG_RARFRC_H                                      0x43C
#define REG_RRSR                                          0x440
#define REG_BCN_AMPDU_CTCL                                0x454
#define REG_AMPDU_MAX_LENGTH                              0x458
#define REG_NDPA_CTRL_LBK_ACQ_STOP                        0x45C
#define REG_RD_RESP_PKT_TH                                0x460
...
#define REG_GCLK_CFG                                      0x478
#define REG_TXRPT_CTRL                                    0x47C
#define REG_CFEND_RATE_SC_CTRL                            0x480
#define REG_MACID_SLEEP3                                  0x484
#define REG_MACID_SLEEP1                                  0x488
#define REG_TXRPT_START_OFFSET                            0x4AC
#define REG_EXTRA_PKT_CTRL                                0x4B0
#define REG_PTA_WL_PRI_MASK                               0x4B4
#define REG_EVTQ_RPT                                      0x4B8
#define REG_SW_AMPDU_BURST_MODE_CTRL                      0x4BC
#define REG_PKT_LIFE_TIME                                 0x4C0
#define REG_PTA_STBC_CTRL                                 0x4C4
#define REG_PROT_MODE_CTRL                                0x4C8
#define REG_BAR_MODE_CTRL                                 0x4CC
#define REG_MACID_SLEEP2                                  0x4D0
#define REG_MACID_SLEEP                                   0x4D4
#define REG_HW_SEQ0_1                                     0x4D8
#define REG_HW_SEQ2_3                                     0x4DC
#define REG_PTCLERR_NULLPKT_STATUS                        0x4E0
#define REG_PRETX_DROP_CTRL                               0x4E4
#define REG_BT_POLLUTE_PKT_CNT                            0x4E8
#define REG_DROP_PKT_NUM                                  0x4EC
#define REG_SW_BUFFERED_SIZE_0                            0x4F0
#define REG_CPUMGQ_TIMER_CTRL                             0x4F4
#define REG_SW_BUFFERED_SIZE_1                            0x4F8
#define REG_DUMMY_P4_BCNRPT                               0x4FC
