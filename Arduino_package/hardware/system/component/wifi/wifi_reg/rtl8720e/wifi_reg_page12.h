#ifndef _AMEBAD2_REG_PAGE12_H_
#define _AMEBAD2_REG_PAGE12_H_
...
/** @defgroup REG_PAGE12
* @brief REG_PAGE12 driver modules
* @{
*/

/* Registers Definitions --------------------------------------------------------*/

/** @defgroup REG_PAGE12_Register_Definitions REG_PAGE12 Register Definitions
 * @{
 *****************************************************************************/
...
#define BIT_DDMACH0_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
...
#define BIT_DDMACH1_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
...
#define BIT_DDMACH2_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
...
#define BIT_DDMACH3_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
...
#define BIT_DDMACH4_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
...
#define BIT_DDMACH5_CHKSUM_STS           ((u32)0x00000001 << 27)          /*!<RW1C 0  0: Exclusive OR checksum ok 1: Exclusive OR checksum fail */
 ...
 * @{
 **/
#define BIT_DDMACH5_DDMA_DONE            ((u32)0x00000001 << 5)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
#define BIT_DDMACH4_DDMA_DONE            ((u32)0x00000001 << 4)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
#define BIT_DDMACH3_DDMA_DONE            ((u32)0x00000001 << 3)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
#define BIT_DDMACH2_DDMA_DONE            ((u32)0x00000001 << 2)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
#define BIT_DDMACH1_DDMA_DONE            ((u32)0x00000001 << 1)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
#define BIT_DDMACH0_DDMA_DONE            ((u32)0x00000001 << 0)          /*!<RW1C 0  When this bit is set, this DDMA channel will generate interrupt when the DMA done. */
/** @} */
 ...
 * @{
 **/
#define BIT_IDDMA0_PERMU_UNDERFLOW       ((u32)0x00000001 << 14)          /*!<RW1C 0  IDDMA0 permu underflow,, write clear */
#define BIT_IDDMA0_FIFO_UNDERFLOW        ((u32)0x00000001 << 13)          /*!<RW1C 0  IDDMA0 fifo underflow, write clear */
#define BIT_IDDMA0_FIFO_OVERFLOW         ((u32)0x00000001 << 12)          /*!<RW1C 0  IDDMA0 fifo overflow, write clear */
#define BIT_CH5_ERR                      ((u32)0x00000001 << 5)          /*!<RW1C 0  Ch5 is busy when it is set again, write clear */
#define BIT_CH4_ERR                      ((u32)0x00000001 << 4)          /*!<RW1C 0  Ch4 is busy when it is set again, write clear */
#define BIT_CH3_ERR                      ((u32)0x00000001 << 3)          /*!<RW1C 0  Ch3 is busy when it is set again, write clear */
#define BIT_CH2_ERR                      ((u32)0x00000001 << 2)          /*!<RW1C 0  Ch2 is busy when it is set again, write clear */
#define BIT_CH1_ERR                      ((u32)0x00000001 << 1)          /*!<RW1C 0  Ch1 is busy when it is set again, write clear */
#define BIT_CH0_ERR                      ((u32)0x00000001 << 0)          /*!<RW1C 0  Ch0 is busy when it is set again, write clear */
/** @} */


/*==========REG_PAGE12 Register Address Definition==========*/
