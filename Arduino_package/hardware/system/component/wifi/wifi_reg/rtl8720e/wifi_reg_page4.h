 ...
 * @{
 **/
#define BIT_BF0_TIMER_SET                              ((u32)0x00000001 << 31)          /*!<WA0 0x0  write 1 to set beamforming 0 timer to BIT_bf0_lifetime */
#define BIT_BF0_TIMER_CLR                              ((u32)0x00000001 << 30)          /*!<WA0 0x0  write 1 to clear beamforming 0 timer to 0 */
 ...
 * @{
 **/
#define BIT_BF1_TIMER_SET                              ((u32)0x00000001 << 31)          /*!<WA0 0x0  write 1 to set beamforming 1 timer to BIT_bf1_lifetime */
#define BIT_BF1_TIMER_CLR                              ((u32)0x00000001 << 30)          /*!<WA0 0x0  write 1 to clear beamforming 1 timer to 0 */
