...
#endif
#endif
//void rtw_psk_deauth_info_flash(u8 *data, s32 len, s32 flags);/*RTW_EVENT_DEAUTH_INFO_FLASH*/



static inline void rtw_psk_set_psk_info(struct psk_info *psk_data)
{
	return 0;
}

static inline void rtw_psk_get_psk_info(struct psk_info *psk_data)
{
	return 0;
}

static inline void rtw_wpa_init(u8 port)
{
	return 0;
}

static inline void rtw_psk_wpa_deinit(u8 port)
{
	return 0;
}

static inline void rtw_sae_sta_rx_auth(u8 *evt_info)
{
	return 0;
}

static inline void rtw_sae_ap_rx_auth(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_sta_recv_eapol(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_set_psk_info_evt_hdl(u8 *evt_info)
{
	return 0;
}

static inline void rtw_owe_start_calc(u8 *evt_info)
{
	return 0;
}

static inline void rtw_sae_sta_start(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_sta_start_4way(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_ap_start_4way(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_ap_recv_eapol(u8 *evt_info)
{
	return 0;
}

static inline void rtw_owe_peer_key_recv(u8 *evt_info)
{
	return 0;
}

static inline void rtw_psk_deauth_info_flash(u8 *data, s32 len, s32 flags)
{
	return 0;
}

static inline void rtw_psk_disconnect_hdl(u8 *mac_addr, u8 iface_type)
{
	return 0;
}

static inline void rtw_psk_deauth_info_flash_event_hdl(u8 *evt_info)
{
	return 0;
}
