...
enum wpa_event_type {
	...
	/**
	 * EVENT_NAN_PASN_TRIGGER - publisher starts nan pasn process
	 */
	EVENT_NAN_PASN_TRIGGER,

	/**
	 * EVENT_NAN_PASN_RX - publisher/subscriber gets auth frames
	 */
	EVENT_NAN_PASN_RX,

	/**
	 * EVENT_NAN_PASN_UPD_PMKID - update pmkid as tag+nounce after nik exchange
	 */
	EVENT_NAN_PASN_UPD_PMKID,
};
...
union wpa_event_data {
	...
	/**
	 * struct nan_pasn_trigger - Data for EVENT_NAN_PASN_TRIGGER
	 */
	struct nan_pasn_trigger {
		u8 deinit;
		enum {
			PASN_ROLE_INITIATOR = 1,
			PASN_ROLE_RESPONDER
		} role;
		enum {
			SETUP = 1,
		...
		u16 auth_frame_len;
		u8 *auth_frame;
		u16 append_nan_attr_len;
		const u8 *append_nan_attr;
		u8 *own_pmkid;
		u8 *peer_pmkid;
	} nan_pasn_trigger;

	/**
	 * struct nan_pasn_rx - Data for EVENT_NAN_PASN_RX
	 */
	struct nan_pasn_rx {
		u8 seq;
		u8 pairing_type;
	...
	/**
	 * struct nan_pasn_upd_pmkid - Data for EVENT_NAN_PASN_UPD_PMKID
	 */
	struct nan_pasn_upd_pmkid {
		u8 role;
		enum {
			NIK_EX_SUCCESS = 1,
			NIK_EX_FAIL
...
#ifdef CONFIG_AMEBA_WPAS_STD
extern const struct wpa_driver_ops wpa_driver_ameba_ops;

#ifdef poll
#undef poll
#endif

#endif /* CONFIG_AMEBA_WPAS_STD */
