...
#ifndef CFG_PARSE_CONFIG_SSID_H
#define CFG_PARSE_CONFIG_SSID_H
...
int wpa_config_set(struct wpa_ops_ssid *ssid, const char *var, const char *value,
				   int line);
