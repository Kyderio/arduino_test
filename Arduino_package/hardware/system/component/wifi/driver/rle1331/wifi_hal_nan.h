...
#define START_LOC_NAN_ATTRI		(TXDESC_SIZE + 42)	//attri offset+tx desc len
#define START_LOC_A3			(TXDESC_SIZE + 16)	//A3 offset + tx desc len
...
#define NAN_MAX_FAW_REQ_CNT				MAX_SCHEDULE_NUM
#define MAX_ACTION_REQUEST_ENTRY_NUM	8

#define FAW_PSTIMER		TWTCLIENTA
