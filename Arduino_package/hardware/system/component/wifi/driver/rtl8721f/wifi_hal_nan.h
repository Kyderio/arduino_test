...
//register define for compatibility
#define REG_NAN_TA_L REG_NAN_TA0
#define REG_NAN_P2_CFG1 REG_NAN_SETTING_3
...
#ifdef NAN_TEST
void wifi_hal_nan_construct_sdf(void);
void wifi_hal_nan_enable_p0(void);
void wifi_hal_nan_enable_p1(void);
#endif
