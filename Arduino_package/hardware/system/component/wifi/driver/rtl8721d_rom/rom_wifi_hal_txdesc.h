...
struct txdesc_priv {
	...
	u32 morefrag: 1;
	u32 raw: 1;
	u32 ccx: 1;	//spe_rpt, rename for common
	u32 ampdu_density: 3;
	u32 bt_null: 1;
	u32 g_id: 6;
	u32 rsvd0830: 2;
	...
	// Offset 20
	u32 data_sc: 4;
	u32 data_gi: 1;		//data_short, rename for common
	u32 data_bw: 2;
	u32 data_ldpc: 1;
	u32 data_stbc: 2;
	u32 vcs_stbc: 2;
	...
	u32 tx_ant: 4;
	u32 txpwr_offset: 3;
	u32 polluted: 1;	//D have polluted fileld, sync with DD

	// Offset 24
	u32 sw_define_l: 12;	//sw_define, rename for common
	u32 mbssid: 4;
	u32 antsel_A: 3;
	u32 antsel_B: 3;
	u32 antsel_C: 3;
