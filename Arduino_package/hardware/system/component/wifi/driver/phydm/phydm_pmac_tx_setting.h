 ...
 * 1 ============================================================
 */
void phydm_set_pmac_tx(struct phydm_pmac_info *tx_info,
					   enum rf_path mpt_rf_path);

void phydm_set_tmac_tx(void);

void phydm_set_cck_disable_cca_jgr3(bool value);

void phydm_pmac_tx_dbg(char input[][16], u32 *_used,
