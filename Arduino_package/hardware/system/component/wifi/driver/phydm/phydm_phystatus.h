...
void phydm_physts_auto_switch_jgr3_set(bool enable, u8 bitmap_en);
#endif

void phydm_reset_phystatus_avg(void);

void phydm_reset_phystatus_statistic(void);

void phydm_get_cck_rssi_table_from_reg(void);

bool odm_phy_status_query(struct rxphyinfo_struct *phy_info,
							 u8 *phy_sts,
							 struct phydm_perpkt_info_struct *pktinfo);

void phydm_rx_phy_status_init(void);
