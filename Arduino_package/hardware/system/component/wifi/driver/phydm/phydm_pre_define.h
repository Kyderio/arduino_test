...
/* @Max RF path */
#define PHYDM_MAX_RF_PATH_N		1	/*@For old N-series IC*/
#define PHYDM_MAX_RF_PATH		1
...
/*[AC-4SS]*/
#if defined(CONFIG_AMEBADPLUS) || defined(CONFIG_AMEBAD)
...
enum phydm_ic {
	ODM_RTL8721D	=	BIT(22),
	ODM_RTL8721DA	=	BIT(29)
};


#define ODM_IC_N_1SS		(ODM_RTL8721D)
#define ODM_IC_JGR3_1SS		(ODM_RTL8721DA)

/*@====the following macro DO NOT need to update when adding a new IC======= */
#define ODM_IC_1SS		(ODM_IC_N_1SS | ODM_IC_JGR3_1SS)


#define PHYDM_IC_ABOVE_1SS	(ODM_IC_1SS)

#define ODM_IC_11N_SERIES	(ODM_IC_N_1SS)

#define ODM_IC_11AC_SERIES	0
#define ODM_IC_JGR3_SERIES	(ODM_IC_JGR3_1SS)
/*@====================================================*/

#define ODM_IC_11AC_1_SERIES	0
#define ODM_IC_11AC_2_SERIES	0

/*@[Phy status type]*/
#define PHYSTS_2ND_TYPE_IC	(ODM_RTL8721D)
#define PHYSTS_3RD_TYPE_IC	(ODM_RTL8721DA)
/*@[FW Type]*/
#define PHYDM_IC_8051_SERIES	(ODM_RTL8721D)
#define PHYDM_IC_3081_SERIES	(ODM_RTL8721DA)
/*@[LA mode]*/
#define PHYDM_IC_SUPPORT_LA_MODE (ODM_RTL8721DA)
/*@[BF]*/
#define ODM_IC_TXBF_SUPPORT	0
#define PHYDM_IC_SUPPORT_MU_BFEE 0
#define PHYDM_IC_SUPPORT_MU_BFER 0

#define PHYDM_IC_SUPPORT_MU 0
/*@[PHYDM API]*/
#define CMN_API_SUPPORT_IC (ODM_RTL8721DA | ODM_RTL8721D)

/* fw offload ability*/
#define PHYDM_IC_SUPPORT_FW_PARAM_OFFLOAD 0

/* halmac offload ability*/
#define PHYDM_IC_SUPPORT_HALMAC_PARAM_OFFLOAD 0

/*[CCX]*/
#define PHYDM_IC_SUPPORT_FAHM	(ODM_RTL8721DA)
#define PHYDM_IC_SUPPORT_IFS_CLM (ODM_RTL8721DA)
#define PHYDM_IC_SUPPORT_EDCCA_CLM (ODM_RTL8721DA)
...
#if (defined(PHYDM_COMPILE_IC_1SS))
...
#define PHYSTS_AUTO_SWITCH_IC 0
#endif
...
#if defined(CONFIG_AMEBADPLUS) || defined(CONFIG_AMEBAD)
/* ODM_CMNINFO_POWER_SUPPLY_MODE */
enum odm_power_supply_mode {
	ODM_POWER_SUPPLY_33V		= 0,
	ODM_POWER_SUPPLY_18V		= 1,
	ODM_POWER_SUPPLY_33V_125V		= 2,
};
#endif
...
enum odm_antdiv_gpio {
	...
	ANTDIV_GPIO_PB1PA0 = 8, // for Resideo, Jiao Qi, Jan.12,2021
};
