...
void phydm_dynamic_tx_power(void);

void phydm_dynamic_tx_power_init(void);

void phydm_dtp_debug(char input[][16], u32 *_used, char *output,
					 u32 *_out_len);

void phydm_rd_reg_pwr(u32 *_used, char *output, u32 *_out_len);

void phydm_wt_reg_pwr(bool is_ofst1, bool pwr_ofst_en,
					  s8 pwr_ofst);

void phydm_wt_ram_pwr(u8 macid, bool is_ofst1,
					  bool pwr_ofst_en, s8 pwr_ofst);
