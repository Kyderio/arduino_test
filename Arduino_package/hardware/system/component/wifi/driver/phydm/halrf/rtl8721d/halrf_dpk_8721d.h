...
void dpk_enable_disable_8721d(void);

void do_dpk_8721d(void);
void phy_dpk_track_8721d(void);
void dpk_reload_8721d(void);
u8 _dpk_check_fail_8721d(bool is_fail, u8 group);
