...
#define RX_DMA_RESERVED_SIZE          0x80	// 128B, reserved for tx report //D2 change  0x5
...
#define CRC5_BASE            	0x40040A80
#define SECURE_CAM_BASE            	0x40050800
#define RATE_MASK	                0x1FF

// Note: We will divide number of page equally for each queue other than public queue!
#define LPS_OFFLOAD_PAGE_NUM      0x15  /*reuse with BCNQ0/BCN1/NAN PAGE NUM*/

#define SOUNDING_CSI_PAGE_NUM      0x9
...
#define TX_TOTAL_PAGE_NUMBER      (0xFF - FW_USED_OFFSET - FW_USED_PAGE_NUM - SOUNDING_CSI_PAGE_NUM)
