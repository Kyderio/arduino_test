...
/*@--------------------------[Prptotype]-------------------------------------*/
void halbb_la_re_trig_watchdog(void);
void halbb_la_run(void);
void halbb_la_deinit(void);
void halbb_la_init(void);
void halbb_la_io_en(void);
void halbb_la_timer_init(void);
void halbb_la_callback(void *context);
void halbb_la_cmd_dbg(char input[][16], u32 *_used, char *output,
					  u32 *_out_len);
#endif
