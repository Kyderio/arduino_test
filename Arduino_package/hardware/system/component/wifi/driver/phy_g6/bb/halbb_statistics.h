...
void halbb_chk_hang(void);
void halbb_print_cnt3(enum phl_phy_idx phy_idx);
void halbb_print_cnt2(enum phl_phy_idx phy_idx);
void halbb_print_cnt(bool cck_enable, enum phl_phy_idx phy_idx, enum phl_phy_idx phy_idx_2);
void halbb_cnt_reg_reset(void);
void halbb_set_crc32_cnt2_rate(u16 rate_idx);
void halbb_set_crc32_cnt3_format(u8 usr_type_sel);
void halbb_crc32_cnt_dbg(char input[][16], u32 *_used,
						 char *output, u32 *_out_len);
void halbb_cck_cnt_statistics(void);
void halbb_ofdm_cnt_statistics(enum phl_phy_idx phy_idx);
void halbb_cck_tx_cnt_statistics(void);
void halbb_ofdm_tx_cnt_statistics(enum phl_phy_idx phy_idx);
void halbb_statistics_reset(void);
void halbb_statistics(void);
void halbb_statistics_init(void);
void halbb_pmac_statistics(void);
void halbb_statistics_print(enum phl_phy_idx phy_idx);
#endif
