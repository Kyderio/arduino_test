...
/*@--------------------------[Prptotype]-------------------------------------*/
#ifdef BB_DYN_CFO_TRK_LOP
void halbb_dyn_cfo_trk_loop_en(bool en);
void halbb_cfo_trk_loop_cr_cfg(enum bb_dctl_state_t state);
void halbb_dyn_cfo_trk_loop(void);
void halbb_dyn_cfo_trk_loop_init(void);
#endif
void halbb_cfo_trk_init(void);
void halbb_set_crystal_cap(u8 crystal_cap);
void halbb_set_cfo_pause_val(u32 *val_buf, u8 val_len);
void halbb_cfo_dm(void);
void halbb_cfo_watchdog(void);
void halbb_parsing_cfo(u32 physts_bitmap,
					   struct physts_rxd *desc);
void halbb_cfo_trk_dbg(char input[][16], u32 *_used,
					   char *output, u32 *_out_len);
void halbb_cfo_ul_ofdma_acc_enable(void);
void halbb_cfo_ul_ofdma_acc_disable(void);
void halbb_cfo_diver_init(void);
void halbb_digital_cfo_comp_init(void);
#endif
