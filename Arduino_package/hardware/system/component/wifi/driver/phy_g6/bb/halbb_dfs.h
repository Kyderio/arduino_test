...
struct hal_dfs_rpt;
void halbb_dfs(void);
void halbb_dfs_rgn_dmn_dflt_cnfg(void);
void halbb_dfs_rgn_dmn_cnfg_by_ch(bool w53_band,
								  bool w56_band);
void halbb_radar_chrp_mntr(bool chrp_flag, bool is_sg1);
void halbb_radar_seq_inspctn(u16 dfs_rpt_idx,
							 u8 c_num, u8 p_num, bool is_sg1);
void halbb_radar_ptrn_cmprn(u16 dfs_rpt_idx,
							u8 pri, u16 pw, bool chrp_flag, bool is_sg1);
void halbb_radar_info_processing(
	struct hal_dfs_rpt *dfs_rpt, u16 dfs_rpt_idx);
void halbb_parsing_aci2sig(u32 physts_bitmap);
void halbb_dfs_dyn_setting(void);
void halbb_dfs_debug(char input[][16], u32 *_used,
