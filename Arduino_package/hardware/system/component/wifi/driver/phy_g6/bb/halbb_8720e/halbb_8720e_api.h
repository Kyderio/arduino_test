...
u8 halbb_sco_mapping(u8 central_ch);
...
void halbb_set_normal_efuse(enum rtw_band_type band_type, enum rf_path path);
void halbb_set_hidden_efuse(enum rf_path path);
void halbb_get_normal_efuse_init(void);
void halbb_get_hidden_efuse_init(void);
void halbb_set_rxsc_rpl_comp(u8 central_ch);
u8 halbb_band_determine(bool is_normal_efuse);
