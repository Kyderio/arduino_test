...
u8 halbb_find_intrvl(u16 val, u8 *threshold, u8 len);
void halbb_seq_sorting(u32 *val, u32 *idx, u32 *idx_out,
					   u8 seq_length);
...
void halbb_print_sign_frac_digit(u32 val, u8 total_bit_num,
								 u8 frac_bit_num, char *buf, u16 buf_size);
char *halbb_print_sign_frac_digit2(u32 val, u8 total_bit_num,
								   u8 frac_bit_num, char *buf);
void halbb_print_buff_64(u8 *addr, u16 length);
void halbb_print_buff_32(u8 *addr, u16 length);
#endif
