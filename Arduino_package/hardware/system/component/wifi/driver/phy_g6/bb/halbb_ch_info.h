...
/*@--------------------------[Prptotype]-------------------------------------*/
bool halbb_ch_info_valid_chk_8852a(struct physts_rxd *desc);
void halbb_ch_info_buf_rls(void);
bool halbb_ch_info_buf_alloc(void);
void halbb_ch_info_dbg(char input[][16], u32 *_used,
					   char *output, u32 *_out_len);
void halbb_ch_info_deinit(void);
void halbb_ch_info_init(void);
#endif
#endif
