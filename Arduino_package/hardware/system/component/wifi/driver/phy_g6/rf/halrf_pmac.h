...
/*@--------------------------[Prptotype]-------------------------------------*/
void halrf_set_pmac_cw(enum rf_path path, u16 txagc_cw, bool en);

void halrf_set_pmac_tx(enum phl_phy_idx phy_idx,
					   enum rf_path path, struct rf_pmac_tx_info *tx,
					   u8 enable, bool by_cw);

void halrf_set_pseudo_cw(enum rf_path path,
