...
#define SET_TX_DESC_ACK_CHNINFO(__pTxDesc, __Value) SET_BITS_TO_LE_4BYTE(__pTxDesc, 31, 1, __Value)
...
#define SET_TX_DESC_TX_SWAP(__pTxDesc, __Value) SET_BITS_TO_LE_4BYTE(__pTxDesc+20, 18, 1, __Value)
#define SET_TX_DESC_UL_SWAP(__pTxDesc, __Value) SET_BITS_TO_LE_4BYTE(__pTxDesc+20, 19, 1, __Value)
...
struct txdesc_priv {
	...
	u32 txbf_path: 1;
	u32 seq: 12;
	u32 sw_define_h: 8;//dplus don't have, for common
};
