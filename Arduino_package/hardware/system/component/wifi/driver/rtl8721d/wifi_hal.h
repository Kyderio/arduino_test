...
#define MAC_TXPKTBUF_OFFSET		(0x10000) /* Note: AmebaD KM4 can't direct access TXPKTBUF!! just to fix compile err of halcom file*/

#define REG_TSFT_SYN_OFFSET_SLOT REG_SLOT
#define BIT_MASK_SLOTTIME BIT_MASK_SLOT
#define BIT_SLOTTIME BIT_SLOT
