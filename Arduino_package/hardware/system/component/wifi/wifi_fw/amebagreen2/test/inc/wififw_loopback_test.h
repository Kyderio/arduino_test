...
/*--------------------------Define -------------------------------------------*/
//FWLBK DBG REG List
#define FWLBK_DBG_TXBUF_DATA           			REG_FW_DBG16		//1100, The value of TXPKTBUF compared error
#define FWLBK_DBG_RXBUF_DATA              		REG_FW_DBG16+1		//1101, The value of RXPKTBUF compared error
#define FWLBK_DBG_RX_OK_CNT              		REG_FW_DBG16+3		//1103
#define FWLBK_DBG_CAM_0                    		REG_FW_DBG19		//110c
#define FWLBK_DBG_CAM_1                    		REG_FW_DBG19+1		//110d
#define FWLBK_DBG_POLL_OK_CNT              		REG_FW_DBG19+2		//110e
#define FWLBK_DBG_CTL                      		REG_FW_DBG19+3		//110f

#define FWLBK_DBG_PAYLD_OFSET           		REG_FW_DBG17		//1104, The n'th byte of payload which compare error
#define FWLBK_DBG_RX_LEN                   		REG_FW_DBG17+2		//1106, length field of RxDESC
#define FWLBK_DBG_RXFF_RP                  		REG_FW_DBG18		//1108, RXFF Read Pointer
#define FWLBK_DBG_PKTCNT                   		REG_FW_DBG18+2		//110a, Tx packet count or Rx Receive packet count
