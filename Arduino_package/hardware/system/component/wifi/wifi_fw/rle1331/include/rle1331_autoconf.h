...
#define CONFIG_CRC5_SUPPORT                     1
#define CONFIG_CSI_CHINFO_BUF                   1
/*WOWLAN*/
...
/*patch macro block*/
#define PHYSTS_CHINFO_WPTR_BINDING_MACTRX_PATCH
...
#define GNT_BT_GLITCH_PATCH                     0
#define CONFIG_TSFT_PATCH			            0
#endif  /* #ifndf _AUTOCONF_H_ */