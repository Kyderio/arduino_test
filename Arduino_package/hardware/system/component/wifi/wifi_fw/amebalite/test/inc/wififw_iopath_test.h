#ifndef __WIFIFW_IOPATH_TEST_H__
#define __WIFIFW_IOPATH_TEST_H__

#if CONFIG_IOPATH_TEST
/*--------------------------Define -------------------------------------------*/
#define IOPATH_BB_DBG_REG           0x0928
#define IOPATH_BB_DBG_REG1           0x092A
#define IOPATH_RF_DBGREG_A           0x05 //RF test REG
#define IOPATH_DIRECT_RF_DBGREG_A           0x3860 //RF A test REG
#define IOPATH_RF_DBGREG_B           0x18 //RF test REG
#define IOPATH_DIRECT_RF_DBGREG_B           0x4C60 //RF B test REG
#define IOPATH_LSON_DBGREG           0xE0//REG_AON_BACKUP0
...
#define BACAM_SIZE       512
#define CRC5_SIZE                   1
#define CTRLINFO_SIZE         40
#define NANRPT_SIZE 	368
#define RPT_SIZE          16
#define RPTID_NUM	128
#define MBIDCAM_SIZE       128
#define MBIDCAM_INDIRECT_ENTRY_SIZE  8
#define MBIDCAM_ENTRY_SIZE                  8
#define MBIDCAM_ENTRY_NUM     16
...
extern void IOPATHTest(const char *argv[]);
#endif
