...
#define BBREG_AHB_BASE             				RTL8720E_BBREG_AHB_BASE
//3 RF base address
#define RTL8720E_ARFCREG_AHB_BASE             	0x40017000
#define ARFCREG_AHB_BASE             			RTL8720E_ARFCREG_AHB_BASE
#define RTL8720E_DRFCREG_AHB_BASE             	0x4001E000
#define DRFCREG_AHB_BASE             			RTL8720E_DRFCREG_AHB_BASE
...
#define BT_MAILBOX_AHB_BASE						RTL8720E_BT_MAILBOX_AHB_BASE
//3 LLT Table base
...
#define RTL8720E_TRXRPT_AHB_BASE            	(RTL8720E_RPTBUF_AHB_BASE + TXRPT_START_OFFSET)
...
#define RXFF_AHB_BASE              				RTL8720E_RXFF_AHB_BASE
//3 Tx packet buffer base address
#define RTL8720E_TXFF_AHB_BASE              	0x40020000
#define TXFF_AHB_BASE              				RTL8720E_TXFF_AHB_BASE
//3 CAM base address
#define RTL8720E_SECCAM_AHB_BASE            	0x40050800
#define SECCAM_AHB_BASE							RTL8720E_SECCAM_AHB_BASE
...
//3 TXFF
#define GetTXFFAddr(offset)     			(u32)((offset)+RTL8720E_TXFF_AHB_BASE)
#define GetMACHeaderAddr(offset)     		(u32)((offset)+RTL8720E_TXFF_AHB_BASE+SIZE_TX_DESC_MAC)
...
#define ReadCtrlInfoByte(macid, offset) 		rtl_inb(RTL8720E_CtrlInfo_AHB_BASE + (macid*SIZE_CTRLINFO_ENTRY) + (offset))    //macid range: 0~16; offset range: 0~40
#define ReadCtrlInfoDWord(macid, offset) 	rtl_inl(RTL8720E_CtrlInfo_AHB_BASE + (macid*SIZE_CTRLINFO_ENTRY) + (offset))    //macid range: 0~16; offset range: 0~40
#define WriteCtrlInfoByte(macid, offset, val)		rtl_outb(RTL8720E_CtrlInfo_AHB_BASE + (macid*SIZE_CTRLINFO_ENTRY) + (offset), val)
#define WriteCtrlInfoDWord(macid, offset, val)	rtl_outl(RTL8720E_CtrlInfo_AHB_BASE + (macid*SIZE_CTRLINFO_ENTRY) + (offset), val)
...
//==PA22==bt_tx=7=#
//==PA31==gnt_bt=3=#
#define BTC_TDMA0_3_PIN						_PB_2
#define BTC_TDMA1_4_PIN						_PB_3
#define BTC_TDMA2_5_PIN						_PB_4
#define BTC_TBTT_PIN						_PB_5
#define BTC_RF_PIN							_PA_25
#define BTC_CLK_PIN							_PA_17
#define PS_PIN_STATE2						_PA_11
#define PS_PIN_STATE1						_PA_12
#define PS_PIN_STATE0						_PA_24
