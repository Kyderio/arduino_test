...
/*--------------------Define --------------------------------------------*/
#define RF_ENTER_BCNMODE_2G_SIZE	8*3
#define	RF_ENTER_BCNMODE_5G_SIZE	11*3
#define	RF_EXIT_BCNMODE_2G_SIZE		7*3
#define	RF_EXIT_BCNMODE_5G_SIZE		9*3

#define PHY_REG_TO_CHANGE 0xffffffff
#define IGI_BCN_MODE_ADD    5//for receive further signals
...
extern const u32 array_mp_8721da_Set_Ionly_reg[];
extern const u32 array_mp_8721da_Cancel_Ionly_reg[];
extern const u32 array_mp_8721da_BCNmode_2G_reg[];
extern const u32 array_mp_8721da_BCNmode_5Gcom_reg[];
extern const u32 array_mp_8721da_BCNmode_5GL_reg[];
extern const u32 array_mp_8721da_BCNmode_5GM_reg[];
extern const u32 array_mp_8721da_BCNmode_5GH_reg[];
extern const u8 array_bcn_mode_reg_size[];
extern const u32 *array_bcn_mode_reg_table[];
extern const u32 array_rf_enter_bcnmode_2G_reg[];
extern const u32 array_rf_enter_bcnmode_5G_reg[];
extern const u32 array_rf_exit_bcnmode_2G_reg[];
extern const u32 array_rf_exit_bcnmode_5G_reg[];
extern const u8 array_rf_bcnmode_reg_size[];
