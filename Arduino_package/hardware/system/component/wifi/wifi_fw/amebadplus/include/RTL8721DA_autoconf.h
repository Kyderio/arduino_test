...
/*PHY Dynamic*/
#define RA_V3
#define CONFIG_NEW_RATE_ADAPTIVE            1//must enable in formal FW
...
#define CONFIG_PS_TIMER_KEEP_ALIVE          1
...
#define CONFIG_CONSTANT_ARPREQ_POWERSAVE_PATCH 1
/*for special AP behavior patch configs  end*/
#if CONFIG_LPS_Offload
#define CONFIG_TSFT_PATCH                   1
#else
#define CONFIG_TSFT_PATCH                   0
#endif
#if (CONFIG_LPS_Offload && CONFIG_BEACON_MODE)
#define BCN_MODE_MIRROR_CHANNEL_PATCH
#endif
#define GNT_BT_GLITCH_PATCH
#define GNT_BT_CCA_RESET_PATCH
