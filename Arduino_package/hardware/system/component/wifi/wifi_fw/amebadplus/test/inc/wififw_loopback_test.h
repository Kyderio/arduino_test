...
/*--------------------------Define -------------------------------------------*/
//FWLBK DBG REG List
#define FWLBK_DBG_TXBUF_DATA           			REG_FW_DBG16		//0x1100, The value of TXPKTBUF compared error
#define FWLBK_DBG_RXBUF_DATA              		REG_FW_DBG16+1		//0x1101, The value of RXPKTBUF compared error
#define FWLBK_DBG_RX_OK_CNT              		REG_FW_DBG16+3		//0x1103
#define FWLBK_DBG_CAM_0                     	REG_FW_DBG19		//0x110c
#define FWLBK_DBG_CAM_1                     	REG_FW_DBG19+1		//0x110d
#define FWLBK_DBG_POLL_OK_CNT              		REG_FW_DBG19+2		//0x110e
#define FWLBK_DBG_CTL                       	REG_FW_DBG19+3		//0x110f

#define FWLBK_DBG_PAYLD_OFSET           		REG_FW_DBG17		//0x1104, The n'th byte of payload which compare error
#define FWLBK_DBG_RX_LEN                    	REG_FW_DBG17+2		//0x1106, length field of RxDESC
#define FWLBK_DBG_RXFF_RP                  		REG_FW_DBG18		//0x1108, RXFF Read Pointer
#define FWLBK_DBG_PKTCNT                    	REG_FW_DBG18+2		//0x110a, Tx packet count or Rx Receive packet count
#define FWLBK_DBG_DATARATE                		REG_FW_DBG8+2		//86

#define REG_FTR                 		    	REG_FW_DBG10 		//8C
#define REG_FWLBK_CTRL          		    	REG_FW_DBG8			//84
#define REG_FWLBK_CTRL_EXT              		REG_FW_DBG9+3		//8b
...
#define FUNC_EN_TX_PATH             (BIT_HCI_TXDMA_EN/*|TXDMA_EN*/|BIT_PROTOCOL_EN|BIT_SCHEDULE_EN|BIT_MACTXEN)
...
extern void FwlbkDbgPrtU16_8721DA(
	u16     addr,
	u16     wdata
);

extern void FwlbkLLTWrite_8721DA(
	u8 address,
	u8 value
);

extern void FwlbkHWInitialLLT_8721DA(
	void
);


extern void FwlbkMode_8721DA(
	void
);

extern void FwlbkPreparePkt_8721DA(
	void
);

extern void FwlbkModeSel_8721DA(
	void
);

extern void FwlbkCheckRxPayload_8721DA(
	void
);

extern void FwlbkSetCAM_8721DA(
	u8   sec_type
);

extern void FwlbkUpdateParam_8721DA(
	u8 Datarate
);

extern u8 FwlbkMcuPollMgq_8721DA(
	void
);

extern void FwlbkModeTxNoCheck_8721DA(
	void
);

extern void FwlbkModeTx_8721DA(
	void
);

extern void FwlbkModeMaclbk_8721DA(
	void
);

extern void FwlbkModeSecTest_8721DA(
	void
) ;
extern void FwlbkModeAFElbk_8721DA(
	void
);

extern bool CheckFWLBKEnable_8721DA(
	void
);
