...
extern void FwCmdRomHelp(
	u16 argc,
	const char  *argv[]
);

extern void FwCmdBufTest(
	u16 argc,
	const char  *argv[]
);

extern void FwCmdRegTest(
	u16 argc,
	const char  *argv[]
);

extern void FwCmdIntTest(
	u16 argc,
	const char  *argv[]
);


extern void FwCmdIOPATH(
	u16   argc,
	const char  *argv[]
);


extern void CmdFwLbkTest(
	u16 argc,
	const char *argv[]
);

extern void FwCmdCoexTest(
	u16 argc,
	const char *argv[]
);

extern void GTimer1WKTest(
	void
);

extern void BcnelyWKTest(
	void
);

extern void CheckTSFIsStable(
	u8  ReqState
);

extern void LPSPGOperation(
	void
);

extern void LPSPG_In(
	void
);

extern void LPSPG_Out(
	void
);
