...
extern void ParseTRXRptTest(
	void
);

extern void AllPortReset(
	void
);

extern void FwIntTest(
	void
) ;

extern void FwIntTestExt(
	const char *argv[]
);

extern void FwIntInit(
	void
);

extern void RptbufTestInit(
	void
);

extern void Port0ClientEn(
	u16 bcnspace,
	u8 elytime
);

extern void PrepareIntPkt(
	u8 pktType
) ;
extern void PrintISRBitMap(void);
extern void ClrISRBitMap(void);

extern void WLAN_INT_HDL_TEST(
	void
);

extern void FT_INT_HDL_TEST(
	void
);
...
extern void HIOEBackupAndRestoreTest(
	bool mode
);

extern void SetHIOEConfigFileTest(
	void
);

extern void PrintISRREG(
	void
);
