...
/* for mac test */
#ifdef CONFIG_MAC_CERT_TEST_HACKS
#define MAC_CERT_TEST_HACKS CONFIG_MAC_CERT_TEST_HACKS
#endif

#ifdef CONFIG_ZB_SEND_BEACON_IMMEDIATELY
#define ZB_SEND_BEACON_IMMEDIATELY
#endif
/* for mac test */

/* for r22_autotests */
#ifdef CONFIG_ZB_ENABLE_SE
#define ZB_ENABLE_SE
#endif

#ifdef CONFIG_ZB_ENABLE_SE_SAS
#define ZB_ENABLE_SE_SAS
#endif

#ifdef CONFIG_ZB_SE_ENABLE_SERVICE_DISCOVERY_PROCESSING
#define ZB_SE_ENABLE_SERVICE_DISCOVERY_PROCESSING
#endif

#ifdef CONFIG_ZB_SE_ENABLE_STEADY_STATE_PROCESSING
#define ZB_SE_ENABLE_STEADY_STATE_PROCESSING
#endif

#ifdef CONFIG_ZB_ENABLE_SE_CLUSTERS
#define ZB_ENABLE_SE_CLUSTERS
#endif

#ifdef CONFIG_ZB_SE_DEFINE_DEVICE_PCT
...
/* regression tests */
#ifdef CONFIG_ZB_SE_BDB_MIXED
#define ZB_SE_BDB_MIXED
#endif

#ifdef CONFIG_ZB_SE_COMMISSIONING
