...
#define TX_GDMA_BLOCK_SIZE 128    //128/64 / 32 / 16 / 4
#define TX_GDMA_BLOCK_DEPTH 320   //32/16 / 8  / 4  / 1 / TX_GDMA_BLOCK_SIZE >> GDMA_InitStruct->GDMA_SrcDataWidth
...
#define RX_ERR_PKT_DEBUG 0  // record error packet index
	...
	/*packet dection*/
#define CCA_IS_DCFI 1
#define DCFI_DCCL 1
#define CCA_POST_PD_BREAK 1

#define SBD_SYM_THREE 0
#define SBD_BACK 1

#define RSSI_POP_FUNC 1
#define RF_GAIN_REG 0x7000

#define LNA_GAIN_ACUT 0
