...
#define hci_platfrom_DOWNLOAD_PATCH_TO_SHRMEM 1

#if hci_platfrom_DOWNLOAD_PATCH_TO_SHRMEM
#define hci_platform_DOWNLOAD_PATCH    0
#else
#define hci_platform_DOWNLOAD_PATCH    1
#endif

#define hci_platform_MP_RESET_BAUDRATE 1
#define hci_platform_WRITE_PHY_EFUSE   0

/* share memory layout is not continuous
 * DMEM :
 *      0x22000000 ~ 0x2202FFFF  192k
 *      0x220C0000 ~ 0x220C7FFF  32k
 * IMEM :
 *      0x22030000 ~ 0x2209FFFF  448k
 *      0x220C8000 ~ 0x220CFFFF  32k
 * BMEM :
 *      0x220A0000 ~ 0x220BFFFF  128k
 *      0x220D0000 ~ 0x220DBFFF  48k
 */
#define BT_SHRMEM_SYSADDR_BMEM      ((uint8_t *)0x220A0000)
#define BT_SHRMEM_SYSADDR_IMEM      ((uint8_t *)0x22030000)
#define BT_SHRMEM_BTADDR_IMEM       ((uint8_t *)0x00180000)

#define BT_SHARE_MEM_VEFUSE     BT_SHRMEM_SYSADDR_BMEM
#define BT_SHARE_MEM_CFGDATA    (BT_SHRMEM_SYSADDR_BMEM + 0)
#define BT_SHARE_MEM_PATCH      BT_SHRMEM_SYSADDR_IMEM
#define BT_SHARE_MEM_PATCH_END  ((uint8_t *)0x2209FFFF)
