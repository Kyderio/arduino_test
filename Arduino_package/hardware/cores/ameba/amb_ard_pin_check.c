...
void amb_ard_pin_check_name(pin_size_t pin) {
...
// TYPE_ANALOG                     (1UL<<21)
// TYPE_DIGITAL                    (1UL<<22)
void amb_ard_pin_check_type(pin_size_t pin, uint32_t pin_type) {
    // char pin_type_name[] = "";
...
// PIO_UART                        (1UL<<8)
// PIO_SPI                         (1UL<<9)
void amb_ard_pin_check_fun(pin_size_t pin, uint32_t pin_fun) {
    // char pin_fun_name[] = "";
